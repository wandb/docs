...
- **Use offline mode during testing**: If you do not need live syncing while iterating, run offline and sync later:
...
## Slow startup of `wandb-service` process
...
Disabling the service process removes some reliability improvements in newer SDK versions.
