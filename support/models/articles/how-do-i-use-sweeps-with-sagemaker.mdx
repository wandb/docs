...
You can use W&B Sweeps with Amazon SageMaker to run hyperparameter searches on SageMaker training jobs. To authenticate W&B when you use a built-in Amazon SageMaker estimator, create a `requirements.txt` file.
