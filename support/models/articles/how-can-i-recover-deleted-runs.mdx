...
keywords: ["Runs"]
description: "Learn how to recover recently deleted runs in W&B for up to 7 days."
---

If you accidentally delete a run, you can restore it from W&B so you don't lose your experiment history. To recover deleted runs:
