...
W&B has no JAX-specific integration. Use `wandb.log()` in your training loop like any other Python workflow. Convert JAX device arrays to Python scalars before logging so values serialize correctly.
