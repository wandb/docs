...
description: "Learn how to save the git commit associated with your run in W&B: When `wandb.init` is invoked, the system automatically collects git information, including..."
