...
If you need to continue an interrupted training job outside of a sweep, use `wandb.init(resume="allow", id="YOUR_RUN_ID")` in a standalone script instead. See [Resume runs](/models/runs/resuming) and [Troubleshoot sweeps](/models/sweeps/troubleshoot-sweeps).
