...
description: "Learn how to send run alerts to Microsoft Teams in W&B: To receive W&B alerts in Teams, follow these steps: - Set up an email address for your Teams channel."
keywords: ["Alerts"]
---
