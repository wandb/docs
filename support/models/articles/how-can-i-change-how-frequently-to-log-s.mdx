...
description: "Learn how to change how frequently to log system metrics in W&B: To configure the frequency to log system metrics, set `_stats_sampling_interval` to a..."
