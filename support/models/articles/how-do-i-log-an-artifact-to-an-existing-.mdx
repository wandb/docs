...
description: "Learn how to log an artifact to an existing run in W&B: Occasionally, it is necessary to mark an artifact as the output of a previously logged run."
keywords: ["Artifacts"]
---
