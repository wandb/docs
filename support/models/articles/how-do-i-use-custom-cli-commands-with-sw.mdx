...
description: "Learn how to use custom CLI commands with sweeps in W&B: You can use W&B Sweeps with custom CLI commands if training configuration passes command-line..."
keywords: ["Sweeps"]
featured: true
---
