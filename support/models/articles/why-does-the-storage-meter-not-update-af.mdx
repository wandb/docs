...
If the meter still hasn't updated after a few hours, confirm your actual usage on the **Manage storage** page at `https://wandb.ai/account-settings/[ENTITY]/usage/manage/[ENTITY]/`, replacing `[ENTITY]` with your team or username. This page shows which projects and runs consume the most space, so you can target what to delete next. If your usage there is already under your limit but the warning persists, [contact support](mailto:support@wandb.com).
