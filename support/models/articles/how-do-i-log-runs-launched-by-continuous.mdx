...
<Frame>
<img src="/images/track/common_questions_automate_runs.png" alt="Team settings page showing the Service Accounts section where you can create a service account for automated jobs." />
</Frame>
