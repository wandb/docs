...
For more information, see [Console logs](/models/app/console-logs) and [Why is console output not captured for my run?](/support/models/articles/why-is-console-output-not-captured-for-my-run).
