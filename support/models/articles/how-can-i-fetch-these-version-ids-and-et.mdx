...
description: "Learn how to fetch these Version IDs and ETags in W&B: If an artifact reference is logged with W&B and versioning is enabled on the buckets, the version IDs..."
keywords: ["Artifacts"]
---
