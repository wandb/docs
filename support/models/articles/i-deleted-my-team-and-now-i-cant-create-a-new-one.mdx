...
Support will manually create a team for your account and restore your access. Choose the team name carefully: you can't rename a team after it's created. See [Can I rename a team or entity?](/support/models/articles/can-i-rename-a-team-or-entity).

**If you are on an academic or free plan**

The **Create team** button may be absent even on a fresh account. Only an organization admin can create a team, so check whether you hold that role. For details, see [Teams](/platform/app/settings-page/teams). If you still can't create the team you need, contact support with your username and the team name you want, and include a note that you are using W&B for academic or research purposes.
