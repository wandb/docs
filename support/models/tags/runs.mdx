...
<Card title="How can I recover deleted runs?" href="/support/models/articles/how-can-i-recover-deleted-runs" arrow="true" horizontal>
  To recover deleted runs, complete the following steps: Navigate to the Project Overview page. Click the action menu in the top right corner, then select **Undelete recently deleted runs**.
</Card>
