...
A 403 error with the message "Country, region, or territory not supported" means you're accessing Serverless Inference from an unsupported location.

## Why this happens

Serverless Inference has geographic restrictions due to compliance and regulatory requirements. The service is only accessible from supported geographic locations.
