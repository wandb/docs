...
For additional resilience against data loss, consider enabling the [write-ahead log](/weave/guides/tracking/write-ahead-log), which persists trace data to disk before sending it to the server.
