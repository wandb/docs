...
Both are part of the same `weave` API — the right choice depends on whether you're tracing functions and pipelines,or weather your application has agent sessions and turns.

---

{/* AUTO-GENERATED: tab badges */}
<Badge stroke shape="pill" color="orange" size="md">[Agents](/support/weave/tags/agents)</Badge>
<Badge stroke shape="pill" color="orange" size="md">[Tracing](/support/weave/tags/tracing)</Badge>
