...
Weave displays cost and token usage estimates based on data captured from your LLM calls, and discrepancies between Weave's numbers and your provider's invoice or dashboard are common and have several causes.
