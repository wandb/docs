...
Serverless SFT trains low-rank adapters (LoRAs) to specialize a model for your specific task. The LoRAs you train are automatically stored as artifacts in your W&B account, and can be saved locally or to a third party for backup. Models that you train through Serverless SFT are also automatically hosted on Serverless Inference.
