...
Serverless Inference gives you access to leading open-source foundation models through W&B Weave and an OpenAI-compatible API. You can:
...
With Weave, you can trace, evaluate, monitor, and improve your Serverless Inference-powered applications.
