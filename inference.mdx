...
<Note>
**Troubleshooting**: If you encounter an error stating "the inference gateway is not enabled for your organization", your organization needs to have the inference gateway enabled. Contact your W&B administrator or [W&B support](mailto:support@wandb.com) for assistance. See [API Errors](/inference/api-reference/errors/) for more details.
</Note>
