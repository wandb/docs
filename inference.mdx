...
Navigate to [https://wandb.ai/inference](https://wandb.ai/inference) to explore available models and try them out in the Weave Playground.

For more information on the web interface, see the [UI Guide](/inference/ui-guide/).
...
1. Set up your account using the [prerequisites](/inference/prerequisites/).
1. Review the [available models](/inference/models) and [usage information and limits](/inference/usage-limits/).
1. Use the service through the [API](/inference/api-reference/) or [UI](/inference/ui-guide/).
1. Try out supported models in the [W&B Weave Playground](/weave/guides/tools/playground).
1. Try the [usage examples](/inference/examples/).
