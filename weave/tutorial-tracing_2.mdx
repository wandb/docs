...
keywords: ["nested traces", "weave.op", "parent-child calls", "weave.attributes", "metadata"]
---
...
<Tabs>
  <Tab title="Python">
    ...
    **Nested functions**
    ...
    ![Nested Weave Traces page showing the trace tree panel and the details panel for the selected Call](/images/tutorial_tracing_2_nested_dinos.png)
  ...
  <Tab title="TypeScript">
    ...
    **Nested functions**
    ...
    ![Nested Weave Traces page showing the center trace tree panel and the details panel for the selected Call](/images/tutorial_tracing_2_nested_dinos.png)
