...
First, initialize Weave with your W&B team and project. Replace `[YOUR-TEAM]` and `[YOUR-PROJECT]` with your own values, and set `implicitly_patch_integrations` to `false` to turn off Weave's autopatching:
