...
Serverless Inference provides access to multiple models. Use the following code to compare the performance of Llama and DeepSeek's respective responses:
...
For a complete list of available models, see the [Available Models section](https://docs.wandb.ai/inference/models/) in the Serverless Inference documentation.
...
For more details, see the [limits documentation for Serverless Inference](https://docs.wandb.ai/inference/usage-limits/).
