...
However, you can still use Weave log traces for unsupported LLM providers by adding a one-line decorator (`weave.op`) to your call function. You can also use the decorator on any function in your app to track its input, output, and code.
