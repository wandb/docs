...
description: "Powerful tracing capabilities to track and version objects and function calls"
---
...
[Calls](/weave/guides/tracking/tracing) trace function calls, inputs, and outputs, enabling you to:
...
[Ops](/weave/guides/tracking/ops) are automatically versioned and tracked functions (which produce Calls) that allow you to:
...
[Objects](/weave/guides/tracking/objects) form Weave's extensible serialization layer, automatically versioning runtime objects (often the inputs and outputs of Calls). This feature allows you to:
...
For answers to common questions about Weave tracing, see the [FAQs page](/weave/guides/tracking/faqs)
