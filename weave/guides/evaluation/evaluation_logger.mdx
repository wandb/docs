...
description: "Flexible, incremental way to log evaluation data from Python code"
---
...
If you prefer a more opinionated evaluation framework with predefined datasets and scorers, see [Weave's standard Evaluation framework](../core-types/evaluations.mdx). 
...
4. Click the **Compare** button. In the Compare view, you can:
   ...
   For more information on comparisons, see [Comparisons](../tools/comparison.mdx)
