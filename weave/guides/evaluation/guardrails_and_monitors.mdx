...
The foundation of Weave's evaluation system is the [**Scorer**](./scorers.mdx) - a component that evaluates your function's inputs and outputs to measure quality, safety, or any other metric you care about. Scorers are versatile and can be used in two ways:
...
3. In the drawer, configure the monitor:
   ...
   - **LLM-as-a-Judge configuration**: 
        ...
        - **Judge model**: Select the model that will score your ops. Three types of models are available:
            ...
            - [W&B Inference models](../integrations/inference.mdx)
...
- Explore [Available Scorers](./scorers.mdx)
