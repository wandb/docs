...
Monitors require no code changes to your application and you set them up using the W&B Weave UI.
...
You can also [compare](/weave/guides/tools/comparison) and [visualize](/weave/guides/tools/comparison) the monitor's trace data in the Weave UI, or download it in various formats (such as CSV and JSON) using the download button (<Icon icon="download" iconType="regular" />) in the Traces tab. 
