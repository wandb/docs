...
The **Meta summary** sidebar shows aggregate statistics for the selected
conversation.
...
**Chat** shows the reconstructed conversation for the selected trace, giving
narrative context for the spans you're inspecting.

**Spans** shows the individual spans belonging to that trace with their
