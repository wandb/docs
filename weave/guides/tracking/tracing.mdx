...
<Tabs>
    ...
    <Tab title="Python">
    To view a call using the Python API, you can use the [`get_call`](/weave/reference/python-sdk/weave/trace/weave_client#method-get-call) method:
    ...
    <Tab title="HTTP API">
    To view a call using the Service API, you can make a request to the [`/call/read`](/api-reference/calls/call-read) endpoint.
...
<Tabs>
    <Tab title="Python">
    In order to set the display name of a call, you can use the [`Call.set_display_name`](/weave/reference/python-sdk/weave/trace/weave_client#property-display-name) method.
    ...
    <Tab title="HTTP API">
    To set the display name of a call using the Service API, you can make a request to the [`/call/update`](/api-reference/calls/call-update) endpoint.
...
<Tabs>
    ...
    <Tab title="HTTP API">
    The most powerful query layer is at the Service API. To fetch calls using the Service API, you can make a request to the [`/calls/stream_query`](/api-reference/calls/calls-query-stream) endpoint.
