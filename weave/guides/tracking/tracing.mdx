...
<Tab title="Python">
To view a call using the Python API, you can use the [`get_call`](/weave/reference/python-sdk/trace/weave_client#method-get_call) method:
...
<Tab title="TypeScript">
    To set the display name of a call, use the [`client.updateCall`](/weave/reference/typescript-sdk/classes/weaveclient#updatecall) method:
...
The TypeScript SDK only supports autopatching for OpenAI. OpenAI is automatically patched when you import Weave and doesn't require any additional configuration.
