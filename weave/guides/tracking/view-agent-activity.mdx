...
#### Add agent messages to a dataset

To add agent messages to a `Dataset`:

1. In the conversation details panel header, click **Add to dataset** to open the **Add example to dataset** drawer.
