...
| **Only score turns matching** | Optional filters to restrict which turns this signal scores. Multiple filters are combined with AND logic. Leave empty to score every turn. |
