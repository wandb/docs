...
The Agents view opens on the **Agents** tab, where each agent that has logged traces to the project appears as a card. From here, you can drill into individual conversations, spans, and signals using the tabs described in the following sections.
