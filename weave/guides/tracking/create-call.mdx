...
If you want more control over automatic behavior, see [Configure automatic LLM call tracking](/weave/guides/tracking/autopatching).
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    **Using decorators in TypeScript**
    ...
    You can apply `@weave.op` to trace instance methods.
