...
This page describes how to modify Calls in W&B Weave after they've been created. Most Call properties are immutable after creation, but Weave supports the following mutations:
...
From the Call detail page, you can edit the display name of the Call, add feedback, or delete the Call.
<Frame>
...
To set the display name of a Call, use [`client.updateCall`](/weave/reference/typescript-sdk/interfaces/weaveclient#updatecall) to update by call ID directly:
...
For more information, see [Collect feedback and use annotations](/weave/guides/tracking/feedback).
...
<Tabs>
    ...
    <Important>
    - You can delete a maximum of `1000` Calls at a time.
