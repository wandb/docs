...
description: "Filter, sort, and export your Weave call data"
---
...
The Export Modal (shown above) allows you to export your data in a number of formats, as well as shows the Python & CURL equivalents for the selected calls. The easiest way to get started is to construct a view in the UI, then learn more about the export API through the generated code snippets.
...
You can save your Trace table configurations, filters, and sorts as _saved views_ for quick access to your preferred setup. You can configure and access saved views through the UI and the Python SDK. For more information, see [Saved Views](/weave/guides/tools/saved-views).
