...
keywords: ["export traces", "stream_query", "call metrics", "calls stats", "trace export"]
---
...
1. In the **Traces** table toolbar, click the export or download button.
1. In the **Export** modal, choose **Selected rows** or **All rows**.
1. Click **Export**.
...
<Tabs>
  ...
  To fetch Calls using the TypeScript API, use the [`client.getCalls`](/weave/reference/typescript-sdk/interfaces/weaveclient#getcalls) method:
  ```typescript lines
