...
The example response shows two days' worth of metrics. Each day is broken up into its own object in the `usage_buckets` and `call_buckets` arrays. Each array breaks down the metrics differently:
