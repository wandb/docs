...
| ![Screenshot showing Groq Weave dashboard with tracked LLM calls](./imgs/groq/groq_weave_dasboard.png) |
|---|
...
| ![Screenshot showing Groq Weave tracing with op decoration](./imgs/groq/groq_weave_tracing.png) |
|---|
...
| ![Screenshot showing Groq Weave Model tracing and versioning](./imgs/groq/groq_weave_model.png) |
|---|
