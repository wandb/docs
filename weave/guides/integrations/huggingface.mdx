...
![Weave also renders the call as a chat view in the UI, displaying the entire chat history with the model.](/weave/guides/integrations/imgs/huggingface/trace_chat.png)
