...
Before you begin, ensure you have AutoGen and Weave installed. You'll also need any SDKs for the LLM providers you intend to use (for example, OpenAI or Anthropic).
...
<Warning>
**Docker Required**
This example involves code execution using Docker and may not work in all environments (for example, Colab directly). Ensure Docker is running locally if you try this.
</Warning>
