...
After you run this snippet, Weave is configured to send traces to the `autogen-demo` project, and Weave automatically captures any subsequent AutoGen activity from your script.
...
Read the following guides to get a better understanding of Weave tracing and Ops.
