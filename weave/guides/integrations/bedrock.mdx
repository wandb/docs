---
title: Bedrock
description: "Track and monitor Amazon Bedrock LLM calls with Weave, capturing foundation model interactions, converse API usage, and multi-provider model deployments through AWS's unified API for comprehensive observability."
---
...
Do you want to experiment with Amazon Bedrock models in the Weave UI without any set up? Try the [LLM Playground](../tools/playground.mdx).
