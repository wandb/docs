...
_Serverless Inference_ provides access to leading open-source foundation models via W&B Weave and an OpenAI-compliant API. With Serverless Inference, you can:
...
<Warning>
Serverless Inference credits are included with Free, Pro, and Academic plans for a limited time. Availability may vary for Enterprise. Once credits are consumed:
...
The following prerequisites are required to access the Serverless Inference service via the API or the W&B Weave UI.
...
<Note>
The `weave` library is only required if you'll be using Weave to trace your LLM applications. For information on getting started with Weave, see the [Weave Quickstart](/weave/quickstart). 
...
This section provides several examples demonstrating how to use Serverless Inference with Weave:
...
The following Python code sample shows how to send a prompt to the **Llama 3.1 8B** model using the Serverless Inference API and trace the call in Weave. Tracing lets you capture the full input/output of the LLM call, monitor performance, and analyze results in the Weave UI.
...
Once you run the code sample, you can view the trace in Weave by clicking the link printed in the terminal (for example, `https://wandb.ai/<your-team>/<your-project>/r/call/01977f8f-839d-7dda-b0c2-27292ef0e04g`), or:
...
<Frame>
![View your model evaluations](/weave/guides/integrations/imgs/inference-advanced-evals.png)
</Frame>
<Frame>
![View your traces](/weave/guides/integrations/imgs/inference-advanced-leaderboard.png)
</Frame>
...
2. From the LLM dropdown list, mouseover **Serverless Inference**. A dropdown with available Serverless Inference models displays to the right.
...
<Frame>
![The Inference models dropdown in Playground](/weave/guides/integrations/imgs/inference-playground.png)
</Frame>
...
<Frame>
![Using an Inference model in the Playground](/weave/guides/integrations/imgs/inference-playground-single.png)
</Frame>
...
<Frame>
![Select multiple models to compare in Playground](/weave/guides/integrations/imgs/inference-playground-compare.png)
</Frame>
