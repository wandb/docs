---
title: Koog
description: "Trace Kotlin-based Koog agents with Weave's built-in OpenTelemetry support, capturing single-run and complex workflow executions, tool calls, prompts, and completions for full observability of your Kotlin AI applications."
---
