...
This guide shows you how to use Weave to monitor and trace [CrewAI](https://docs.crewai.com/introduction) multi-agent applications, including both [Crews](https://docs.crewai.com/guides/crews/first-crew) and [Flows](https://docs.crewai.com/guides/flows/first-flow). By the end of this guide, you'll know how to capture agent interactions, tool usage, and guardrail logic in Weave.
