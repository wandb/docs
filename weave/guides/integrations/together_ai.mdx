---
title: "Together AI"
description: "Track and evaluate Together AI's open source LLMs using Weave's OpenAI SDK compatibility for seamless integration with model calls, fine-tuning workflows, and hosted models."
---
