---
title: MistralAI
description: "Track and monitor MistralAI model calls with Weave's automatic tracing, capturing chat completions, function calling, and model interactions for open-weight and commercial Mistral models."
---
...
> We support the new Mistral v1.0 SDK, check the migration guide [here](https://github.com/mistralai/client-python/blob/main/MIGRATION.mdx)
