...
In CommonJS, it is critical that the import of weave libraries happens **before** the import of the agent library. If your code cannot follow this ordering, use the manual instrumentation technique that follows.
