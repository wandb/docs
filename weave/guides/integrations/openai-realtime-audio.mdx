...
keywords: ["speech-to-speech", "voice assistant", "WebSockets", "Agents SDK", "audio tracing"]
---
...
This guide shows you how to enable Realtime API tracing in your application and walks through two end-to-end voice assistant examples that you can run locally.
