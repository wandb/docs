...
The Next.js and Node.js in this article examples require the same dependencies. To start:
...
Call `provider.shutdown()` before the process exits to flush any pending spans.
