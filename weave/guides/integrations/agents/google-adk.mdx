...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    Weave automatically traces `@google/adk` runners via module loader hooks for CommonJS projects. For ESM projects and more background on how Weave's loader hooks work, see the [TypeScript SDK third-party integration guide](/weave/guides/integrations/js).
