...
This guide describes how to integrate third-party libraries (for example, OpenAI) with the Weave TypeScript SDK. It's intended for TypeScript developers who want Weave to automatically trace calls to supported libraries in their application. By the end of this guide, you have a CommonJS or ESM TypeScript project configured so that Weave can automatically instrument supported libraries, plus an understanding of how to handle advanced scenarios when automatic instrumentation doesn't apply.
