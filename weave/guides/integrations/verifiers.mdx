...
Weave enables [implicit patching](/weave/guides/integrations/index#automatic-implicit-patching) for the library by default. This allows you to use Weave with Verifiers without requiring explicit call patch functions.
