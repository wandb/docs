---
title: "Anthropic"
description: "Use Weave to automatically track and log LLM calls made via the Anthropic Python library"
---
...
<Note>
Do you want to experiment with Anthropic models on Weave without any set up? Try the [LLM Playground](../tools/playground).
</Note>
