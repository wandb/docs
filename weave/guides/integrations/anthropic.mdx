...
While `weave.init()` alone captures Anthropic SDK calls, wrapping your own functions as ops gives you richer traces that include your application logic around each model call.
...
When you decorate or wrap a function with `weave.op()`, Weave captures the function's code, input, and output. You can use ops to track any function you want, including nested functions.
