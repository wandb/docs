...
In TypeScript, you can get the current attributes using `client.getCurrentAttributes()`. Unlike Python, you can access TypeScript attributes within a `withAttributes()` context, not just inside an op.
