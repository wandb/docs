...
The function attaches the attributes to all traced operations within the context manager block.
...
Global attributes are set during Weave initialization and automatically apply to **all** traces and evaluations in your project. This is useful for project-wide metadata like environment, deployment version, or team information.
...
You can use both global attributes and per-call attributes together. Per-call attributes with the same key override global attributes:
