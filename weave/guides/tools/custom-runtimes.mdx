...
Using the runtime's information outlined in the previous section, update the appropriate fields in the following `client.register_custom_runtime` request, and then run it to either create or update a custom runtime in your project:
