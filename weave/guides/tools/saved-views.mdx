...
3. Save the view using one of two options:
   ...
   - Click the action menu (☰) to the left of **Save view**. In the dropdown menu, click **+ Save as new view**.

### Load a saved view

1. Navigate to your **Traces** or **Evals** tab.
2. Click the action menu (☰) to the left of the tab title. A dropdown menu showing all saved views displays. 
...
3. Click the action menu (☰) to the left of **Save view**. 
...
1. Navigate to your **Traces** or **Evals** tab.
2. Click the action menu (☰) to the right of the **Traces** or **Evals** tab. A dropdown menu showing all saved views displays. 
