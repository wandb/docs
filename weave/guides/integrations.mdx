...
For agent SDKs, harnesses, and custom instrumentation that render in the **Agents** view, see [Trace agent integrations](/weave/guides/tracking/trace-agent-integrations).
