...
- **[Self-Managed instances](/weave/guides/platform/weave-self-managed):** For teams that prefer to host Weave independently, your W&B team provides guidance to evaluate deployment options. Self-managed instances can use [ingest sampling](/weave/guides/platform/ingest-sampling) to control costs at high trace volume.
