...
Click the **Weights & Biases logo** in the upper-left corner to open the **Global navigation menu**.
The menu lists your most recent projects and the teams you belong to, allowing you to quickly switch context.
