...
- Aliases are named pointers to a specific prompt version.
...
Tags and aliases can also be managed in code, such as publishing prompts with tags and aliases inline, pointing aliases at specific versions and resolving them to load prompts, and adding, removing, or listing tags and aliases on versions.

The following code example will add a prompt `my-prompt` to your project with three versions, each having various tags and aliases. Update `'your-team-name/your-project-name'` accordingly for your project.
