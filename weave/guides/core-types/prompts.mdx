...
```typescript TypeScript twoslash lines {8,23}
// @noErrors
import * as weave from 'weave';
import OpenAI from 'openai';
...
```typescript TypeScript twoslash lines {8,29}
// @noErrors
import * as weave from 'weave';
import OpenAI from 'openai';
