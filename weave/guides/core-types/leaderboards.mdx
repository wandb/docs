...
1. Define a test dataset. You can use the built-in [`Dataset`](./datasets.mdx), or define a list of inputs and targets manually:
...
2. Define one or more [scorers](../evaluation/scorers.mdx):
...
3. Create an [`Evaluation`](../core-types/evaluations.mdx):
