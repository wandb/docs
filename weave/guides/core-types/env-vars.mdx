...
| `WEAVE_USE_OTEL_V2` | `bool` | `false` | When set to `true`, Weave integrations emit GenAI semantic-convention OTEL spans for Agent, Task, Turn, and Function events in the Agents tab. |
