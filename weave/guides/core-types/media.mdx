...
W&B Weave supports logging and has dedicated displays for numerous content types such as videos, images, audio files, PDFs, CSVs and HTML. Each section of this guide provides a basic configuration example and a more advanced example of how to log the media type.
...
<Note>
The TypeScript SDK currently only supports logging images and audio. Video, documents, and HTML logging are available in the Weave Python SDK.
</Note>
