...
W&B Weave supports logging and has dedicated displays for numerous content types such as videos, images, audio files, PDFs, CSVs and HTML. Each section of this guide demonstrates how to configure Weave to log each media type and provides a use case example.
