...
- `scorers`: `list[typing.Annotated[trace.op_protocol.Op | flow.scorer.Scorer, BeforeValidator(func=<function cast_to_scorer at 0x7f4965b256c0>, json_schema_input_type=PydanticUndefined)]] | None`
...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7f49661610d0>
