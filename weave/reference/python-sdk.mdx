...
- `scorers`: `list[typing.Annotated[trace.op_protocol.Op | flow.scorer.Scorer, BeforeValidator(func=<function cast_to_scorer at 0x7f0f1b5007c0>, json_schema_input_type=PydanticUndefined)]] | None`
...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7f0f1bbd8980>
