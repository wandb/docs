...
- **[POST `/v2/{entity}/{project}/calls/complete`](https://docs.wandb.ai/weave/reference/service-api/calls/calls-complete)** - Calls Complete
...
- **[POST `/feedback/aggregate`](https://docs.wandb.ai/weave/reference/service-api/feedback/feedback-aggregate)** - Feedback Aggregate
...
- **[GET `/inference/catalog/models`](https://docs.wandb.ai/weave/reference/service-api/inference/inference-catalog-models)** - Inference Catalog Models
- **[GET `/inference/modelsdev/models`](https://docs.wandb.ai/weave/reference/service-api/inference/inference-modelsdev-models)** - Inference Modelsdev Models
...
- **[POST `/agents/agent-versions/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-agent-versions-query)** - Genai Agent Versions Query
- **[POST `/agents/conversations/chat`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-conversation-chat)** - Genai Conversation Chat
- **[POST `/agents/conversations/spans`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-conversation-spans)** - Genai Conversation Spans
- **[POST `/agents/otel/v1/traces`](https://docs.wandb.ai/weave/reference/service-api/agents/export-genai-trace)** - Export Genai Trace
- **[POST `/agents/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-agents-query)** - Genai Agents Query
- **[POST `/agents/search`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-search)** - Genai Search
- **[POST `/agents/spans/custom-attrs/schema`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-custom-attrs-schema)** - Genai Custom Attrs Schema
- **[POST `/agents/spans/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-spans-query)** - Genai Spans Query
- **[POST `/agents/spans/stats`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-spans-stats)** - Genai Spans Stats
- **[POST `/agents/traces/chat`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-traces-chat)** - Genai Traces Chat
...
- **[POST `/evaluations/rescore`](https://docs.wandb.ai/weave/reference/service-api/evaluations/rescore-evaluation)** - Rescore Evaluation
