...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7f57c7758e50>
...
- `scorers`: `typing.Optional[list[typing.Annotated[typing.Union[trace.op_protocol.Op, flow.scorer.Scorer], BeforeValidator(func=<function cast_to_scorer at 0x7f57c7507e20>, json_schema_input_type=PydanticUndefined)]]]`
