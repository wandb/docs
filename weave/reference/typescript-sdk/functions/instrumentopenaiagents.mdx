...
description: "API reference for the instrumentOpenAIAgents function in the Weave TypeScript SDK, which manually registers Weave tracing with OpenAI Agents."
---
