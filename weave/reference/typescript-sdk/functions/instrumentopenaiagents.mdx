---
title: "Function: instrumentOpenAIAgents()"
...
[weave](../) / instrumentOpenAIAgents



> **instrumentOpenAIAgents**(): `Promise`\<`boolean`\>

Defined in: [src/integrations/openai.agent.ts:169](https://github.com/wandb/weave/blob/ebaa175f4434046995224aafad3b9e2939258601/sdks/node/src/integrations/openai.agent.ts#L169)
