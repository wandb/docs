---
title: "Function: patchRealtimeSession()"
...
Defined in: [src/integrations/openai.realtime.agent.ts:836](https://github.com/wandb/weave/blob/ebaa175f4434046995224aafad3b9e2939258601/sdks/node/src/integrations/openai.realtime.agent.ts#L836)
