...
description: "API reference for the patchRealtimeSession function in the Weave TypeScript SDK, which patches OpenAI RealtimeSession for automatic tracing."
---
