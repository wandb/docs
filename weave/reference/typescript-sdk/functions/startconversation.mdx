---
title: "Function: startConversation()"
...
Defined in: [src/genai/api.ts:26](https://github.com/wandb/weave/blob/ebaa175f4434046995224aafad3b9e2939258601/sdks/node/src/genai/api.ts#L26)
