...
description: "Learn how to use custom model cost with W&B Weave"
---

<Note>
This is an interactive notebook. You can run it locally or use the links below:
- [Open in Google Colab](https://colab.research.google.com/github/wandb/weave/blob/master/docs/notebooks/custom_model_cost.ipynb)
- [View source on GitHub](https://github.com/wandb/weave/blob/master/docs/notebooks/custom_model_cost.ipynb)
</Note>
