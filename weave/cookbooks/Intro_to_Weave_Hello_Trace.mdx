...
- [Open in Google Colab](https://colab.research.google.com/github/wandb/docs/blob/weave/cookbook-rescue/weave/cookbooks/source/Intro_to_Weave_Hello_Trace.ipynb)
- [View source on GitHub](https://github.com/wandb/docs/blob/weave/cookbook-rescue/weave/cookbooks/source/Intro_to_Weave_Hello_Trace.ipynb)
</Note>
