...
@app.cell
def _():
    # '%pip install wandb weave datetime --quiet' command supported automatically in marimo
    return
...
def _():
    ...
    wandb.login()
    return name_of_wandb_project, weave


@app.cell
def _(name_of_wandb_project, weave):
