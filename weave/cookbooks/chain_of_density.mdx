...
<Frame>
![Evaluation dashboard showing Chain of Density summarization results](/media/summarization/eval_dash.png)
</Frame>
...
<Frame>
![Weave trace visualization showing Chain of Density summarization pipeline execution](/media/summarization/summarization_trace.png)
</Frame>
...
<Frame>
![Screenshot showing Weave Model configuration for Chain of Density summarization](/media/summarization/model.png)
</Frame>
...
<Frame>
![Screenshot showing Weave Dataset configuration for evaluation](/media/summarization/dataset.png)
</Frame>
