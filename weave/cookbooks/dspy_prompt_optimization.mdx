...
<Frame>
![Screenshot showing DSPy dataset loading and preparation](/media/dspy_optimization/1.png)
</Frame>
...
We will use the [`dspy.OpenAI`](https://dspy.ai/api/language_model_clients/OpenAI) abstraction to make LLM calls to [GPT3.5 Turbo](https://platform.openai.com/docs/models/gpt-3.5-turbo).
...
A [signature](https://dspy.ai/docs/building-blocks/signatures) is a declarative specification of input/output behavior of a [DSPy module](https://dspy.ai/docs/building-blocks/modules) which are task-adaptive components—akin to neural network layers—that abstract any particular text transformation.
...
<Frame>
![Screenshot showing baseline DSPy program evaluation results](/media/dspy_optimization/2.png)
...
<Frame>
![Screenshot showing Weave evaluation dashboard for DSPy program](/media/dspy_optimization/3.png)
</Frame>
...
<Frame>
![Screenshot showing DSPy program optimization process](/media/dspy_optimization/4.png)
</Frame>
...
<Frame>
![Screenshot showing optimized DSPy program evaluation results](/media/dspy_optimization/5.png)
</Frame>
