...
<Note>
This is an interactive notebook. You can run it locally or use the options below.

<Accordion title="Run in marimo">
  <Frame>
    <iframe
      src="https://marimo.app/github/wandb/docs/blob/marimo-cookibooks/weave/cookbooks/source/dspy_prompt_optimization.py/wasm?embed=true"
...
- [View source on GitHub](https://github.com/wandb/docs/blob/marimo-cookibooks/weave/cookbooks/source/dspy_prompt_optimization.py)
</Note>
