...
<Accordion title="Run in marimo">
  <Frame>
    <iframe
      src="https://marimo.app/github/wandb/docs/blob/marimo-cookbooks/weave/cookbooks/source/dspy_prompt_optimization.py/wasm?embed=true"
...
- [View source on GitHub](https://github.com/wandb/docs/blob/main/weave/cookbooks/source/dspy_prompt_optimization.py)
</Note>
