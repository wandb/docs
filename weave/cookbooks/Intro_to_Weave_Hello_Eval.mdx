...
This tutorial introduces W&B Weave evaluations by walking you through a minimal end-to-end example. You'll define a Weave `Model`, run it against a small dataset, score the outputs with a custom scoring function, and review the results in Weave. It's intended for developers who are new to Weave and want a quick, hands-on starting point before exploring more advanced evaluation workflows.
...
With your environment set up, you're ready to define and run an evaluation.
...
- Learn how to [build an evaluation pipeline end-to-end](/weave/tutorial-eval).
- Learn how to [evaluate a RAG application](/weave/tutorial-rag).
