...
<Accordion title="Run in marimo">
  <Frame>
    <iframe
      src="https://marimo.app/github/wandb/docs/blob/marimo-cookbooks/weave/cookbooks/source/Intro_to_Weave_Hello_Eval.py/wasm?embed=true"
...
- [View source on GitHub](https://github.com/wandb/docs/blob/main/weave/cookbooks/source/Intro_to_Weave_Hello_Eval.py)
</Note>
