...
```typescript TypeScript twoslash lines {9}
// @noErrors
...
```typescript TypeScript twoslash lines {3-6}
// @noErrors
import * as weave from 'weave';
await weave.init('eval_pipeline_quickstart');
...
```typescript TypeScript twoslash lines {5-9}
// @noErrors
import * as weave from 'weave';
