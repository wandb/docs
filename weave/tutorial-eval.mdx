...
<MolabLink url="https://molab.marimo.io/github/wandb/docs/blob/main/weave/cookbooks/source/build_an_evaluation_pipeline.py" />
<GitHubLink url="https://github.com/wandb/docs/blob/main/weave/cookbooks/source/build_an_evaluation_pipeline.py" />
</div>
