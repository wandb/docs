---
title: "Quickstart: Track LLM inputs and outputs"
description: "Get started with W&B Weave by adding tracing to your LLM application to debug and monitor model interactions."
mode: "wide"
keywords: ["tracing", "LLM observability", "weave.op", "OpenAI tracing", "trace quickstart"]
---
...
The following example code tracks your first project with Weave:

<CodeGroup>

```python Python lines {1-2,7-8,27-28}
...
```typescript TypeScript twoslash lines {1-2,7-8,20,24-25}
// @noErrors
// Imports the Weave library
...
![Weave UI Traces panel showing the trace for the extract_dinos function, including its input, output, latency, and token usage.](/images/tutorial_trace_1.png)

You have now logged and viewed your first Weave trace.
