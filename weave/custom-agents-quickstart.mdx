...
If you're looking to integrate Weave with SDKs or harnesses such as the Claude Agent SDK or Codex, see [Choose an agent integration](/weave/agent-integration-quickstart). Weave autopatches into several agent-building SDKs and agent harnesses for quick integration.
