...
<Note>
You can't delete a user account that is the **Billing admin** for an organization. Before deleting the account, transfer the Billing admin role to another user from the [Billing settings](/platform/app/settings-page/billing-settings#billing-admin) page.
</Note>
