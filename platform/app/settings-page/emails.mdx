...
Select the action menu (⋮) to change the primary email associated with your Weights And Biases account:
...
Select the action menu (⋮) and choose **Delete Emails** to delete an email that is registered to your W&B account
