...
These alerts are not configurable, and are sent when your organization's accumulated average charges for a billing period exceed these thresholds: $200, $450, $700, and $1000. These overage charges are incurred when your organization accumulates more usage than your plan includes for storage or W&B Weave data ingestion.
