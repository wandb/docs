...
<Note>
Customizing usage alerts is not yet available in **Multi-tenant Cloud**. For questions, contact [Sales](mailto:sales@wandb.com).
</Note>
...
<Note>
Customizing spending alerts is not yet available in **Multi-tenant Cloud**. For questions, contact [Sales](mailto:sales@wandb.com).
</Note>
