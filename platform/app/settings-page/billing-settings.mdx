...
In the **Current cycle** and **All teams** view, a stats bar above the chart summarizes **Usage**, **Allowance**, and **Daily Average Usage**. Storage charts do not display a stats bar or daily average usage; instead, historical views show the aggregated total usage for that specific time range.
