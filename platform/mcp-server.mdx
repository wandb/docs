...
To install the W&B MCP server on your local machine, choose `uv` or `pip`.
...
2. Once you have installed the MCP server locally, configure your MCP client to use it. Select an MCP client to continue.
