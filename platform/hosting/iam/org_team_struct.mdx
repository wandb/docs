...
slug: guides/hosting/iam/org_team_struct
cascade:
...
If you are using [Multi-tenant Cloud](/platform/hosting/hosting-options/saas_cloud), you may have more than one organization where each may correspond to a business unit, a personal user, a joint partnership with another business and more.
