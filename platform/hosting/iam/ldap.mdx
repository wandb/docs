...
Choose one of the following methods to configure the LDAP connection. Use the W&B UI tab to configure LDAP through the system settings UI, or use the Environment variable tab to configure LDAP at deployment time.

<Tabs>
<Tab title="W&B UI">
To configure LDAP through the W&B UI:
