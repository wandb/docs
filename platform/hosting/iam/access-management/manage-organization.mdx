...
Users designated as **billing admins** can perform billing actions, including configuring usage alerts, even if their organization role is **Member**. Billing admins can't perform other organization admin actions such as inviting users or creating teams.
