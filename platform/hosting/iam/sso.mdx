...
- In W&B, go to **System Console** > **Settings** > **Advanced** > **User Spec** and add `GORILLA_OIDC_SECRET` to the `extraENV` section as shown in the following example.
...
2. Navigate to W&B.
    ...
    <Frame>
    <img src="/images/hosting/system_settings.png" alt="W&B navigation"  />
    </Frame>
