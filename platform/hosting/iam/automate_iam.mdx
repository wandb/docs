...
For more details and examples about SCIM, including using API keys for Bearer token and HTTP Basic authentication, see [Authentication](./scim#authentication) on the SCIM reference page.
