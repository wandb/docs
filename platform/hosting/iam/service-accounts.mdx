...
3. Click the **Create API key** button next to the service account.
4. Copy the displayed API key immediately and store it securely.

<ApiKeyViewOnceWarning/>

You can delete individual API keys from the **API Keys** tab in the organization settings page without deleting the service account itself.
