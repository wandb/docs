...
<Note>
User deactivation and reactivation operations are not supported in [Multi-tenant Cloud](/platform/hosting/hosting-options/multi_tenant_cloud).
</Note>
...
<Note>
User deactivation and reactivation operations are not supported in [SaaS Cloud](/platform/hosting/hosting-options/multi_tenant_cloud).
</Note>
