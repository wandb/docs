...
<Note>Your instance also needs the `iam.serviceAccounts.signBlob` permission in Google Cloud to create signed file URLs. Add `Service Account Token Creator` role to the service account or IAM member that your instance is running as to enable permission.</Note>
...
<Note> You must use the CLI to create a notification stream. Ensure you have `gcloud` installed.</Note>
...
<Frame><img src="/images/hosting/configure_file_store_gcp.png" alt="Google Cloud file storage configuration"/></Frame>
...
<Frame><img src="/images/hosting/active_spec.png" alt="W&B System Console - ActiveSpec"/></Frame>
...
<Frame><img src="/images/hosting/user_spec.png" alt="W&B System Console - UserSpec"/></Frame>

4. Click Save.
5. Access the tab `Operator` and click `Trigger reapply`.
   <Frame><img src="/images/hosting/operator.png" alt="W&B System Console - Operator"/></Frame>
