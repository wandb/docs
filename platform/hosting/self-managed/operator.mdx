...
**_Before_ upgrading to W&B Self-Managed to Server v0.81+**, you must either set these to `false` in your Helm values, or upgrade upgrade **both** ClickHouse Server and ClickHouse Keeper to 26.3 or newer.
