...
| --- | --- | --- |
| `GORILLA_DEFAULT_RATE_LIMITS_FILESTREAM` | `5` | Default filestream request limit. |
...
| `GORILLA_DEFAULT_RATE_LIMITS_GRAPHQL` | `50` | GraphQL request limit. |
...
| `GORILLA_LIMITER` | `unset` | Redis connection string for the rate limiter (required to enable rate limiting). |
