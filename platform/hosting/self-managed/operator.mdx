...
W&B Self-Managed does not work with ClickHouse 26.1 or 26.2.

ClickHouse 26.3 is supported for W&B Self-Managed v0.81 and above.


### Models OLAP features

W&B Server 0.81.0+ introduces schema migrations that require ClickHouse 26.3. These migrations run when any of the following Models OLAP features are enabled in your Helm values:
...
- Upgrade both ClickHouse Server and ClickHouse Keeper to 26.3 or newer.
