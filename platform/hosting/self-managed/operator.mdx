...
<Note>
Registry Search in preview for Self-Managed deployments. To migrate ClickHouse automatically, install Operator Helm chart [v0.43.3+](https://github.com/wandb/helm-charts/releases/tag/operator-wandb-0.43.3). Afterward, W&B runs the migration job automatically. For more information or questions, contact [support](mailto:support@wandb.com).
</Note>
