...
ARIA (AI Research & Iteration Agent) helps you analyze runs, metrics, configs, sweeps, artifacts, and reports in your W&B projects.
...
In the mobile app, ARIA keeps context across multi-turn chats and shows reasoning and tool-call details while it works. Chat history is kept in sync so you can move seamlessly between the web app and mobile app.
