...
- Chat with ARIA from anywhere in the mobile app. It's available in the bottom navigation of each app screen.
- In the mobile app, ARIA keeps context across multi-turn chats and shows reasoning and tool-call details while it works.
- Chat history is kept in sync so you can move seamlessly between the web app and mobile app.
