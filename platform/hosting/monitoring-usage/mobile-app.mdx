...
- **View console logs**: View or download [console logs](/models/runs/view-logged-runs#logs) for a completed run. The app polls completed runs for new log lines every 5 seconds, and shows the most recent 10,000 log lines.
