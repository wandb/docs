...
- **Stop runs**: When viewing a run, click the **action (<Icon icon="ellipsis" iconType="solid"/>)** menu, then click **Stop run**.
...
- **Star panels**: See your most important panels at a glance. Click the star icon at the top of a panel to star it. Click the **Starred** tab at the top of the list to view only starred panels.
- **Star projects**: Click the star next to a project to sort it to the top of the project list.
