...
In the mobile app, ARIA keeps context across multi-turn chats and shows reasoning and action details while it works. Shell steps show when ARIA takes an action, such as creating a panel, filtering runs, creating and running Python scripts, and more. Chat history is kept in sync so you can move seamlessly between the web app and mobile app.
