...
To chat with ARIA, click <img alt="ARIA icon" src="/images/agent/aria-logo.svg" style={{ display: "inline", height: "0.95em", width: "0.95em", verticalAlign: "-0.1em", margin: 0 }} /> in the bottom navigation.
