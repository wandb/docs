...
1. In W&B on your computer, click your profile image in the upper-right corner, then click **Log in on mobile**. If you don't have this menu item, your organization is not enrolled in the preview. To request access for your organization, contact [support](mailto:support@wandb.com) or your AISE.
2. In the **Log in on mobile** dialog, click **Generate login code**. W&B displays the login code as a QR code and adds an API key named **W&B iOS** to your [user settings](/platform/app/settings-page/user-settings#api-keys). If W&B can't generate a key, an error appears in the dialog. If your organization restricts who can create API keys, ask your organization admin for help.
3. On your iPhone or iPad, open the app, then tap **Log in to Dedicated Cloud**. If prompted, allow the app to use your camera.
4. Point your device's camera at the QR code. The app logs you in to your Dedicated Cloud instance and closes the scanner.
5. On your computer, click **Done** to close the dialog.
