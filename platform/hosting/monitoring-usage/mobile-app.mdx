...
You can't create a W&B account from the mobile app, so log in with an account that already exists.

How you log in depends on the deployment your W&B account belongs to. Select your deployment type to continue.

<Tabs>
<Tab title="Multi-tenant Cloud">
To log in to a Multi-tenant Cloud account, follow these steps:
...
Logging in to Dedicated Cloud is in preview and available by invitation only.

To log in to a Dedicated Cloud instance, generate a login code in W&B on your computer, then scan the code with your mobile device. Before you start, have both your computer and your mobile device with you.
