...
* Allow users with matching organization email domain to join this team.
    * This setting is applicable only to [SaaS Cloud](./hosting-options/saas_cloud). It's not available in [Dedicated Cloud](/platform/hosting/hosting-options/dedicated_cloud/) or [Self-managed](/platform/hosting/hosting-options/self-managed/) instances.
