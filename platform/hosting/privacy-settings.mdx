...
* Allow users with matching organization email domain to join this team.
    * This setting is applicable only to [SaaS Cloud](./hosting-options/multi_tenant_cloud). It's not available in [Dedicated Cloud](/platform/hosting/hosting-options/dedicated_cloud/) or [Self-managed](/platform/hosting/hosting-options/self-managed/) instances.
...
* Enforce privacy for future projects
    * Enable this option to enforce all future projects in all teams to be private or [restricted](./iam/access-management/restricted-projects)
