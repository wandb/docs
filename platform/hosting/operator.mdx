...
Refer to the [reference architecture](/platform/hosting/self-managed/ref-arch/#infrastructure-requirements). In addition, [obtain a valid W&B Server license](../#obtain-your-wb-server-license).
