...
Refer to the [reference architecture](/platform/hosting/self-managed/ref-arch/#infrastructure-requirements). In addition, [obtain a valid W&B Server license](/platform/hosting/hosting-options/self-managed#obtain-your-wb-server-license).

See the [bare-metal installation guide](/platform/hosting/self-managed/bare-metal/) for a detailed explanation on how to set up and configure a Self-Managed installation.
