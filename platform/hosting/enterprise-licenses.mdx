...
After you [obtain an Enterprise license](#obtain-an-enterprise-license), you can configure it programmatically as part of your deployment or in the W&B UI after deployment. Select the tab that matches your deployment method.
