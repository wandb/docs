...
For **Self-Managed**, you can configure instance level BYOB using W&B:
...
You can configure team level BYOB when you create a team in W&B or using the [SCIM API](/platform/hosting/iam/scim#create-team) (POST Groups with optional `storageBucket`). You have two options:
