...
<Tip>W&B Multi-tenant Cloud does not meet the requirements of the [Health Insurance Portability and Accountability Act of 1996 (HIPAA)](https://www.hhs.gov/hipaa/for-professionals/index.html). If your organization is subject to HIPAA, consider [W&B Dedicated Cloud](/platform/hosting/hosting-options/dedicated_cloud) instead.</Tip>
