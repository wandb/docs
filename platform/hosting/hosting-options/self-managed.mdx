...
cascade:
- slug: guides/hosting/self-managed/:filename
---
...
See specific cloud provider documentation for more information on how to set up W&B Server in [AWS](/platform/hosting/self-managed/aws-tf/), [GCP](/platform/hosting/self-managed/gcp-tf/), or [Azure](/platform/hosting/self-managed/azure-tf/).
