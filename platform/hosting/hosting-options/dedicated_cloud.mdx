...
Migration to Dedicated Cloud from a [Self-Managed instance](/platform/hosting/hosting-options/self-managed/) or [Multi-tenant Cloud](/platform/hosting/hosting-options/saas_cloud/) is supported, subject to specific limits and migration-related constraints
