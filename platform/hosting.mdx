...
no_list: true
---
W&B Platform is the foundational infrastructure, tooling and governance scaffolding which supports the W&B products like [Core](/guides/core), [Models](/models/) and [Weave](/guides/weave/). 
...
See [W&B Multi-tenant Cloud](/platform/hosting/#wb-multi-tenant-cloud) for more information. 
