...
* Secrets are included as a core part of W&B, including in [W&B Server deployments](/platform/hosting/) that you host in Azure, GCP, or AWS. Connect with your W&B account team to discuss how you can use secrets in W&B if you use a different deployment type.
