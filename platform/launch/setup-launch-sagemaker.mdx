...
With the AWS prerequisites in place, you can create the W&B Launch queue that routes jobs to SageMaker. Create a queue in W&B that uses SageMaker as its compute resource:
