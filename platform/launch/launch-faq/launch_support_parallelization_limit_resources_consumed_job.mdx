...
title: Does Launch support parallelization?  How can I limit the resources consumed
  by a job?
description: Learn how to scale Launch jobs across GPUs and nodes, set resource limits, and control concurrent runs.
---

Launch supports scaling jobs across multiple GPUs and nodes. Refer to the [Volcano integration guide](/models/tutorials/volcano/) for details.
