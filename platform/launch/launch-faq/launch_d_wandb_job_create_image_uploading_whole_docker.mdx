...
The launch agent then spins up a job pointing to the specified container. See [Advanced agent setup](/guides/launch/setup-agent-advanced/#agent-configuration) for examples on configuring agent access to pull images from a container registry.
