...
slug: guides/launch/walkthrough
weight: 1
---
## What is Launch? 
...
* Learn how to set up [W&B Launch](/launch/set-up-launch/).
* Create a [launch job](/guides/launch/launch-terminology/#launch-job).
...
For advanced queue configuration options, see the [advanced queue setup page](/guides/launch/setup-queue-advanced/).
