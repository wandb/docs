...
description: "View launch job details, list available jobs, and check job statuses in the W&B UI and CLI."
keywords: ["job status", "list jobs", "inspect job", "CLI job list"]
---

This page describes how to view information about launch jobs in queues. You can inspect job details in the W&B UI, list jobs from the CLI, and interpret the status of a queued run.

## View jobs

To view jobs in a queue, use the W&B UI:

1. Navigate to W&B at https://wandb.ai/home.
...
In the W&B UI, you can find additional information about runs created from launch jobs, such as the:
