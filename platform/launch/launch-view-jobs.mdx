...
description: "View launch job details, list available jobs, and check job statuses in W&B and CLI."
keywords: ["job status", "list jobs", "inspect job", "CLI job list"]
---

This page describes how to view information about launch jobs in queues. You can inspect job details in W&B, list jobs from the CLI, and interpret the status of a queued run.

## View jobs

To view jobs in a queue, use W&B:
...
In W&B, you can find additional information about runs created from launch jobs, such as the:
