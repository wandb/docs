...
slug: guides/launch/launch-terminology
weight: 2
---
...
- [Docker](/guides/launch/setup-launch-docker/)
- [Kubernetes](/guides/launch/setup-launch-kubernetes/)
- [AWS SageMaker](/guides/launch/setup-launch-sagemaker/)
- [GCP Vertex](/guides/launch/setup-vertex/)
