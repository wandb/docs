...
slug: guides/launch/add-job-to-queue
---
...
<Tab title="W&B CLI">
Use the `wandb launch` command to add jobs to a queue. Create a JSON configuration with hyperparameter overrides. For example, using the script from the [Quickstart](/guides/launch/walkthrough/) guide, we create a JSON file with the following overrides:
