...
description: "Add launch jobs to a W&B Launch queue using the W&B UI or CLI to schedule ML workloads on target resources."
...
Add jobs to your queue interactively with the W&B UI or programmatically with the W&B CLI.

<Tabs>
<Tab title="W&B UI">
To add a job to your queue interactively with the W&B UI:
