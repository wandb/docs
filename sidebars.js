export default {
  ...
  support: [{type: 'doc',id: 'support/index',label: 'Support',},'support/index_charts','support/index_tensorboard','support/index_administrator','support/index_adminstrator','support/index_artifacts','support/index_aws','support/index_charts','support/index_connectivity','support/index_crashing and hanging runs','support/index_environment variables','support/index_experiments','support/index_gcc','support/index_hyperparameter','support/index_launch','support/index_local','support/index_logs','support/index_other','support/index_reports','support/index_resuming','support/index_runs table','support/index_sweeps','support/index_system metrics','support/index_tables','support/index_team management','support/index_tensorboard','support/index_user management','support/index_workspace','support/index_workspaces','support/index_wysiwyg',]
};
