...
def test_unknown_keyword_distinct():
    ...
    """
    text = """
    /path/gen.py:1: UserWarning: Unknown keyword 'Foo' used in article 'A'.
    /path/gen.py:2: UserWarning: Unknown keyword 'Foo' used in article 'B'.
    /path/gen.py:3: UserWarning: Unknown keyword 'Bar' used in article 'C'.
    """
