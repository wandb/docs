...
<CardGroup cols={2}>
  <Card title="Serverless RL: How to use" href="/serverless-rl/usage">
    Post-train models with reinforcement learning.
  </Card>
  <Card title="Serverless RL: Use Serverless SFT" href="/serverless-rl/sft/usage">
    Fine-tune models with Serverless SFT using the OpenPipe ART framework.
  </Card>
  <Card title="Serverless RL: Use trained models" href="/serverless-rl/use-trained-models">
