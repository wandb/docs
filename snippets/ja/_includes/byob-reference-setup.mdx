...
* この機能は、[W&amp;B Multi-tenant Cloud](/ja/platform/hosting/hosting-options/multi_tenant_cloud) でサポートされており、[専用クラウド](/ja/platform/hosting/hosting-options/dedicated-cloud) および [セルフマネージド](https://docs.wandb.ai/platform/hosting/hosting-options/self-managed) v0.84.0 以降ではプレビュー提供です。
...
## バケットを設定する {#configure-your-bucket}
...
## 参照バケットを登録する {#register-the-reference-bucket}
