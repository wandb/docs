...
## Stockez et manipulez les clés API en toute sécurité {#store-and-handle-api-keys-securely}
...
### Méthodes de stockage recommandées {#recommended-storage-methods}
...
### Ce qu’il faut éviter {#what-to-avoid}
...
### Compatibilité des versions du SDK {#sdk-version-compatibility}
