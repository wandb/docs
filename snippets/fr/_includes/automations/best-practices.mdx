...
* **Testez avant la mise en production** : créez d&#39;abord des automatisations dans un projet de test ou avec un webhook ou un salon Slack de test. Déclenchez manuellement l&#39;événement et vérifiez que l&#39;action s&#39;exécute et que la charge utile ou le message est correct.
