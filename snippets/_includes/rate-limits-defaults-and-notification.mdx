...
When a limit is exceeded, the W&B SDK returns HTTP response `429`, and the message `HTTP 429: rate limited exceeded` appears in the SDK logs. How the SDK responds depends on which limit was exceeded:
