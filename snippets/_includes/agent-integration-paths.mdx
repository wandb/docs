...
- [Send OpenTelemetry spans to the Agents view](/weave/guides/tracking/trace-agents-otel) — point an existing OTel pipeline at the Weave agents endpoint, with no Weave SDK required.
