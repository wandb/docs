...
<Columns cols={4}>
  <Card title="Quickstarts" icon="rocket">
    Short, concise guides to help you get up and running with Weave.
  </Card>
  <Card title="How-Tos" icon="lightbulb">
    Step-by-step instructions for common tasks and features in Weave.
  </Card>
  <Card title="Tutorials" icon="graduation-cap">
    In-depth, hands-on walkthroughs that teach concepts while building real applications.
  </Card>
  <Card title="Reference" icon="book">
    Complete technical documentation of APIs, SDKs, configuration options, and specifications.
  </Card>
</Columns>
