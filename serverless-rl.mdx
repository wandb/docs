...
In addition to reinforcement learning, you can use [Serverless SFT](/serverless-rl/sft) to fine-tune models with curated datasets. Use SFT for distillation, teaching output style and format, or warming up a model before applying RL.
