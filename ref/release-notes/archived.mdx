...
type: docs
slug: /ref/release-notes/archived/
cascade:
- slug: /ref/release-notes/archived/:filename/
- type: docs
- weight: 1
...
<Warning>
Customers using [Self-managed](/platform/hosting/hosting-options/self-managed/) are responsible to upgrade to a [supported release](/ref/release-notes) in time to maintain support. For assistance or questions, contact [support](mailto:support@wandb.com).
</Warning>
