...
| [`Teams`](/models/ref/python/public-api/team) | Query team information and manage team-level resources. |
| [`Users`](/models/ref/python/public-api/user/) | Access user profiles and user-specific data. |
