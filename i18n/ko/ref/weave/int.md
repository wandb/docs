...
| `rhs` | 나누는 [숫자](https://docs.wandb.ai/ref/weave/number)입니다. |

#### 반환 값
두 [숫자](https://docs.wandb.ai/ref/weave/number)의 나머지입니다.
...
[숫자](https://docs.wandb.ai/ref/weave/number)를 지수로 거듭제곱합니다.
...
#### 반환 값
기본 [숫자](https://docs.wandb.ai/ref/weave/number)를 n번 거듭제곱한 값입니다.
...
| `rhs` | 비교할 대상 [숫자](https://docs.wandb.ai/ref/weave/number)입니다. |

#### 반환 값
첫 번째 [숫자](https://docs.wandb.ai/ref/weave/number)가 두 번째 [숫자](https://docs.wandb.ai/ref/weave/number)보다 작으면 참입니다.
...
#### 반환 값
첫 번째 [숫자](https://docs.wandb.ai/ref/weave/number)가 두 번째 [숫자](https://docs.wandb.ai/ref/weave/number)보다 작거나 같으면 참입니다.
...
#### 반환 값
첫 번째 [숫자](https://docs.wandb.ai/ref/weave/number)가 두 번째 [숫자](https://docs.wandb.ai/ref/weave/number)보다 크면 참입니다.
...
#### 반환 값
첫 번째 [숫자](https://docs.wandb.ai/ref/weave/number)가 두 번째 [숫자](https://docs.wandb.ai/ref/weave/number)보다 크거나 같으면 참입니다.
