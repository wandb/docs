...
임의의 막대 차트를 로그로 기록하는 데 이를 사용할 수 있습니다. 목록에 있는 레이블과 값의 수가 정확히 일치해야 합니다(즉, 각 데이터 포인트에는 둘 다 있어야 함).
...
![새 사용자 정의 차트 추가, 그런 다음 쿼리 편집](/images/app_ui/customize_chart.gif)
