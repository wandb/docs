...
<Note>
Versions below summarize user-facing SDK and trace server changes. Internal-only test, CI, and refactor work is omitted. For every merged change, see the GitHub release entry for that tag.
</Note>
