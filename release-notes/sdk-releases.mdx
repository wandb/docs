...
## Fixed
- `File.download()` no longer fails after a hard-coded 5-second timeout; downloads go through `wandb-core` and respect the file transfer setting.
