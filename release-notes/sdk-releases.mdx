...
- W&B LEET TUI media panels no longer paint black bars around images in the ANSI view or flash black when you switch to the full-resolution view. The area around the image now shows the terminal background, and switching modes no longer flashes or moves the image.
