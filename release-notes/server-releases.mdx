...
<Update label="v0.82.1" description="June 30, 2026">
**June 30, 2026**
...
- Fixed a bug where adding a custom Vega chart could hang the workspace in projects with a large number of logged metrics.
