...
- Organization admins can disable GraphQL introspection with the `graphql-disable-introspection` config option or the environment variable `GORILLA_GRAPHQL_DISABLE_INTROSPECTION`. Requires [W&B SDK v0.26.0](/release-notes/sdk-releases#0-26-0)+.
