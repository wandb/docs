...
- The run selector and Runs list now support filtering by Git commit.
- Added defensive caching for project fields to reduce database load.

### Inference

- Inference adds support for models MiniMax M2.5 and MiniMaxAI M2.5. See [Model Catalog](/inference/models).
