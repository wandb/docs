...
- Improved performance and responsiveness when loading run history data.
- Improved reliability when loading line plots by reducing cases where slow queries could return partial results prematurely.
