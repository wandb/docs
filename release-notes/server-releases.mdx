...
- Customize how your line plots display full-fidelity data by specifying the panel’s mode in the **Data** settings tab of a workspace, section, or panel.
    ...
    ![Animation showing a chart with band and line mode](/images/release-notes/v0-84-0/chart-line-mode.gif)
- Add reference lines to scatter plots to highlight important thresholds, benchmarks, or target values on your charts. Configure up to five lines with customizable colors in the **Reference lines** tab of a plot’s settings.
    ![Two scatter plots with reference lines](/images/release-notes/v0-84-0/scatter-plot-reference-lines.png)
