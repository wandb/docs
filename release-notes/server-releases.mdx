...
W&B v0.76 includes features and functionality to streamline observability and analysis of your experiments, like multi-video sync with autoplay and looping and simplified navigation between multi-run and single-run workspace views. The W&B SDK includes the LEET terminal UI, a powerful new way to observe and analyze runs without leaving the command line.
...
{/* PLACEHOLDER FOR DATA LOSS ANNOUNCEMENT */}
