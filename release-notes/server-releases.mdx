...
- Confirmation is now required to delete a service account or an API key from W&B.
...
### Weave
- Weave onboarding pages in the empty state in W&B now include TypeScript example code alongside the Python example code.
