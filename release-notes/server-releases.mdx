...
- In a workspace, you can now hide the sidebar directly from the page by clicking the **Hide sidebar** control (<Icon icon="fa-angle-double-right" iconType="solid" />) without first opening the action menu (<Icon icon="ellipsis" iconType="solid" />).
