...
W&B Server 0.82.0 brings richer artifact insights with editable collection overviews and version-level metric charts, along with workspace and run table quality-of-life improvements. To support enterprise administration, you can now assign Models seats and Weave roles when inviting members, and audit logs capture API key activity.

## Support and end of life

- W&B Server v0.70 has reached end of life.

## Features

- The W&B App now shows the latest available W&B SDK version, so you can tell when a newer release is available.
