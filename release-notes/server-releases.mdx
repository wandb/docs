...
<Update label="v0.81.0" description="May 27, 2026">
**May 27, 2026**
...
- Fixed a privilege escalation bug that could allow a non-admin user to upgrade the deployment's subscription.
...
- Improved line plot performance for projects with very large run counts by skipping expensive total-count queries. The legend shows a warning if the UI cannot cannot tell whether additional runs match the panel filters, and these warnings may be less accurate.
