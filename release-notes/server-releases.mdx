...
- Improved the display of long aliases and tags in W&B.
...
- W&B’s home page has been improved.
...
- Access release notes for your deployment’s current version from within W&B. In the top navigation, click **?** to open the **Resources & Help** menu, then click **Release Notes**.
...
- Confirmation is now required to delete a service account or an API key from the W&B UI.
...
### Weave
- Weave onboarding pages in the empty state in the W&B UI now include TypeScript example code alongside the Python example code.
