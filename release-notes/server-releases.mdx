...
<Warning>
This release is impacted by a critical security issue that allows unauthorized access access to an artifact. Do not install or upgrade to this version. Instead, install [v0.78.2](#v0-78-2), which includes the fix.
</Warning>
