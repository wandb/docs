...
- [Azure workload identities](/platform/hosting/data-security/secure-storage-connector#provision-your-bucket) for BYOB storage in preview. To try it, upgrade the Operator Helm chart to v0.44.0+ before upgrading W&B.
