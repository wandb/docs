...
You can access the information we've captured in three ways: inside the original Python process being logged using the [`wandb` client library]({{< relref "../../../ref/python/README.md" >}}), with the [web app UI]({{< relref "../../track/workspaces.md" >}}), or programmatically using [our Public API]({{< relref "../../../ref/python/public-api/README.md" >}}). `Parameter`s are saved to W&B's [`config`]({{< relref "../../track/config.md" >}}) and can be found in the [Overview tab]({{< relref "../../runs/intro.md#overview-tab" >}}). `datasets`, `models`, and `others` are saved to [W&B Artifacts]({{< relref "../../artifacts/intro.md" >}}) and can be found in the [Artifacts tab]({{< relref "../../runs/intro.md#artifacts-tab" >}}). Base python types are saved to W&B's [`summary`]({{< relref "../../track/log/intro.md" >}}) dict and can be found in the Overview tab. See our [guide to the Public API]({{< relref "../../track/public-api-guide.md" >}}) for details on using the API to get this information programmatically from outside .
