...
If you want to save the model checkpoints to [W&B Artifacts]({{< relref "../artifacts/intro.md" >}}), the simplest solution is to override the `save_checkpoint` functions inside the corresponding recipe. 
