...
-  Use [reference artifacts](../../artifacts/track-external-files/) to track files saved outside the W&B system, instead of uploading them to W&B storage.
- Use an [external cloud storage bucket](../features/teams/) for storage. *(Enterprise only)*
...
- [Set a TTL policy](../../artifacts/ttl/) on Artifacts so they are automatically deleted.