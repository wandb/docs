...
You can access the complete history of metrics logged during a run using the [W&B Run API](../../../../../ref/python/public-api/run/). The following example demonstrates how to retrieve and process the loss values from a specific run:
