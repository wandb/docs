...
## Add a media panel
To quick add a media panel for a logged key using the default configuration:

1. To add it globally, click **Add panels** in the control bar near the panel search field.
1. To add it directly to a section instead, click the section's action `...` menu, then click **Add panels**.
...
To add a custom media panel manually:
1. To add it globally, click **Add panels** in the control bar near the panel search field.
1. To add it directly to a section instead, click the section's action `...` menu, then click **Add panels**.
