...
{{< tabpane text=true >}}
  {{% tab header="CLI" %}}
Use the [`wandb agent`](../../ref/cli/wandb-agent/) command to parallelize your W&B Sweep agent across multiple CPUs with the terminal. Provide the sweep ID that was returned when you [initialized the sweep](./initialize-sweeps/). 
