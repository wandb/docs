...
W&B will transition assets from the legacy [W&B Model Registry]({{< relref "../model_registry/intro.md" >}}) to the new [W&B Registry]({{< relref "./intro.md" >}}). This migration will be fully managed and triggered by W&B, requiring no intervention from users. The process is designed to be as seamless as possible, with minimal disruption to existing workflows.
...
For more details and to learn about the full range of features in the W&B Registry, visit the [W&B Registry Guide]({{< relref "./intro.md" >}}).
