...
Next, upload the dataset to W&B. To do this, create an [artifact](../artifacts/) object and add the dataset to that artifact. 
...
Use the [`link_model`](../../ref/python/run.md#link_model) API to log model one ore more files to a W&B run and link it to the [W&B Model Registry](./).
