...
| **WANDB_BASE_URL**        | If you're using [wandb/local]({{< relref "../hosting/intro.md" >}}) you should set this environment variable to `http://YOUR_IP:YOUR_PORT`        |
...
| **WANDB_JOB_TYPE**        | Specify the job type, like "training" or "evaluation" to indicate different types of runs. See [grouping]({{< relref "../runs/grouping.md" >}}) for more info.               |
...
| **WANDB_RUN_GROUP**       | Specify the experiment name to automatically group runs together. See [grouping]({{< relref "../runs/grouping.md" >}}) for more info.                                 |
