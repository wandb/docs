...
* **Panel sections**: A section that contains one or more [panels]({{< relref "../app/features/panels/intro.md" >}}). Create new panels, organize them, and export to reports to save snapshots of your workspace.
