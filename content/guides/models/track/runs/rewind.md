...
- **Run archiving**: W&B archives the original runs. Runs are accessible from the [**Run Overview**]({{< relref "./intro.md#overview-tab" >}}) tab.
...
1. **Access the Overview Tab:** Navigate to the [**Overview tab**]({{< relref "./intro.md#overview-tab" >}}) on the run's page. This tab provides a comprehensive view of the run's details and history.
