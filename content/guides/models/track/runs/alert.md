...
If you're using [W&B Server]({{< relref "../hosting/intro.md" >}}) in your Private Cloud or on W&B Dedicated Cloud, then please refer to [this documentation]({{< relref "../hosting/monitoring-usage/slack-alerts.md" >}}) to setup Slack alerts.
{{% /alert %}}
