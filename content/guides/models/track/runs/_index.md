...
* **Git state**: The most recent ("last") git commit SHA of a repository or working directory where the run is initialized. This field is empty if you do not enable git when you create the run or if the git information is not available.
