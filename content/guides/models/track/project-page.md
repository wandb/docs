...
{{% alert %}}
Each project has a visibility setting that determines who can access it. For more information about who can access a project, see [Project visibility]({{< relref "../hosting/iam/restricted-projects.md" >}}).
{{% /alert %}}
...
* **Project visibility**: The visibility of the project. The visibility setting that determines who can access it. See [Project visibility]({{< relref "../hosting/iam/restricted-projects.md" >}}) for more information.
...
[Tables]({{< relref "../tables/tables-walkthrough.md" >}}) associated with artifacts are particularly rich and interactive in this context. Learn more about using Tables with Artifacts [here]({{< relref "../tables/visualize-tables.md" >}}).
