...
View all the [artifacts]({{< relref "/guides/core/artifacts/" >}}) associated with a project, from training datasets and [fine-tuned models]({{< relref "/guides/models/registry/model_registry/" >}}) to [tables of metrics and media]({{< relref "/guides/models/tables//tables-walkthrough.md" >}}).
