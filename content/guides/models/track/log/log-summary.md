...
You can update the summary attribute of an existing W&B Run after training has completed. Use the [W&B Public API](../../../ref/python/public-api/README/) to update the summary attribute:
