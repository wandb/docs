...
2. Convert the CSV file to a W&B Table to utilize [W&B Dashboards]({{< relref "../../track/workspaces.md" >}}). 
...
Below is the full example script that converts the above sample table into a [W&B Dashboard]({{< relref "../../track/workspaces.md" >}}):
