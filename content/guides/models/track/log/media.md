...
If histograms are in your summary they will appear on the Overview tab of the [Run Page](../../runs/). If they are in your history, we plot a heatmap of bins over time on the Charts tab.
...
On the W&B [Run](../../runs/) and [Project](../../track/project-page/) Pages, you will see your videos in the Media section.    
    {{% /tab %}}
    {{% tab header="Text" %}}
