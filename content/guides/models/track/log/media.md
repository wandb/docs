...
{{% alert %}}
Looking for reference docs for our media types? You want [this page](../../../ref/python/data-types/README/).
{{% /alert %}}
...
If histograms are in your summary they will appear on the Overview tab of the [Run Page](../../runs/intro/). If they are in your history, we plot a heatmap of bins over time on the Charts tab.
...
Videos are logged using the [`wandb.Video`](../../../ref/python/data-types/video/) data type:
...
On the W&B [Run](../../runs/intro/) and [Project](../../track/project-page/) Pages, you will see your videos in the Media section.    
    {{% /tab %}}
    {{% tab header="Text" %}}
