...
1. In the sidebar, click **Automations**, then click **Create automation**. For a run metric, you can instead create an automation from a line plot for the metric. Hover over the panel, then click the bell icon at the top of the panel.
...
1. Click **Advanced configuration** to configure a webhook automation.
