...
{{% alert %}}
To quickly create a [run metrics notification]({{< relref "/guides/core/automations/automation-events.md#run-events" >}}) from a line plot panel, hover over the panel, then click the bell icon. Configure the automation using the basic or advanced configuration controls.
{{% /alert %}}
