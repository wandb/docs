...
{{% /alert %}}
{{% alert %}}
* Only team admins can view a [team's settings](../app/settings-page/team-settings/) and access team level TTL settings such as (1) permitting who can set or edit a TTL policy or (2) setting a team default TTL.  
...
You can check an Artifact's type on the [W&B platform](../artifacts/explore-and-traverse-an-artifact-graph/) or programmatically:
