...
Default aliases are not mutable. Meaning that you can not modify or delete a default alias.
...
Any user with a [Member or Admin registry role]({{< relref "guides/core/registry/configure_registry/#registry-roles" >}}) can add or remove a custom alias from a linked artifact.
