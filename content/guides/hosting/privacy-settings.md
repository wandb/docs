...
* Allow users with matching organization email domain to join this team.
    * This setting is applicable only to [SaaS Cloud](./hosting-options/saas_cloud/). It's not available in [Dedicated Cloud](./hosting-options/dedicated_cloud/) or [Self-managed](./hosting-options/self-managed/) instances.
...
* Enforce privacy for future projects
    * Enable this option to enforce all future projects in all teams to be private or [restricted](./iam/restricted-projects/)
