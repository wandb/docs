...
no_list: true
---
W&B Platform is the foundational infrastructure, tooling and governance scaffolding which supports the W&B products like [Core](../core/), [Models](../models/) and [Weave](../weave_platform/). 
...
See [W&B Dedicated Cloud](./hosting-options/dedicated_cloud/) for more information.
...
See [W&B Self Managed](./hosting-options/self-managed/) for more information.
