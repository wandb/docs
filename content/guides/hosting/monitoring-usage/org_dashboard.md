...
Organization dashboard is only available with [Dedicated Cloud]({{< relref "../hosting-options/dedicated_cloud.md" >}}) and [Self-managed instances]({{< relref "../hosting-options/self-managed.md" >}}).
{{% /alert %}}
