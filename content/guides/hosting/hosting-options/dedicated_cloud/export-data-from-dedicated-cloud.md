...
If you manage artifacts stored in the Dedicated cloud with [Secure Storage Connector]({{< relref "/guides/models/app/features/teams/#secure-storage-connector" >}}), you may not need to export the artifacts using the W&B SDK API.
