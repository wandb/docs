...
See the [Deploy W&B in airgapped environment with Kubernetes]({{< relref "/guides/hosting/hosting-options/self-managed/kubernetes-operator/operator-airgapped" >}}) tutorial on how to install the W&B Kubernetes Operator in an airgapped environment.
