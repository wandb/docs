...
### Kubernetes
The W&B Server application is deployed as a [Kubernetes Operator]({{< relref "../operator.md" >}}) that deploys multiple Pods. For this reason, W&B requires a Kubernetes cluster with:
