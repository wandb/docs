...
|  `dir` |  An absolute path to the directory where metadata files will be stored. This does not affect the location where artifacts are stored when calling `download()`. |
