...
This release also marks the end of life for v0.54 and older, which are now officially unsupported.<!--more-->

<!--The latest patch is **v0.69.0**.  Refer to [Patches]({{< relref "#patches" >}}). -->
