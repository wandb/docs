...
You can log data to a run with `wandb.log()`. Anything you log using `wandb.log()` is sent to that run. See [Create an experiment](https://docs.wandb.ai/guides/track/launch) or [`wandb.init`](https://docs.wandb.ai/ref/python/init/) API reference page or more information. 
...
### <kbd>property</kbd> Run.starting_step

The first step of the run. 

---

### <kbd>property</kbd> Run.step
...
log_code(
    root: 'str | None' = '.',
    name: 'str | None' = None,
    include_fn: 'Callable[[str, str], bool] | Callable[[str], bool]' = <function _is_py_requirements_or_dockerfile at 0x1021a8af0>,
    exclude_fn: 'Callable[[str, str], bool] | Callable[[str], bool]' = <function exclude_wandb_fn at 0x11b367370>
) → Artifact | None
```
