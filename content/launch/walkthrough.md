...
Easily scale training [runs](../runs/) from your desktop to a compute resource like Amazon SageMaker, Kubernetes and more with W&B Launch. Once W&B Launch is configured, you can quickly run training scripts, model evaluation suites, prepare models for production inference, and more with a few clicks and commands. 
...
See the [Terms and concepts](./launch-terminology/) page for more information on launch jobs, how queues work, launch agents, and additional information on how W&B Launch works.
...
* Learn how to set up [W&B Launch](./setup-launch/).
* Create a [launch job](./create-launch-job/).
...
For advanced queue configuration options, see the [advanced queue setup page](./setup-queue-advanced/).
