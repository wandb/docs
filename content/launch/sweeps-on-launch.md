...
1. Standard sweep scheduler: Use the default W&B Sweep scheduling engine that controls [W&B Sweeps](../sweeps/)The familiar `bayes`, `grid`, and `random` methods are available.
...
For more information on W&B Sweeps, see the [Tune Hyperparameters](../sweeps/)hapter.
