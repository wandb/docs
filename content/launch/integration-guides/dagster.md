...
* Use and create [W&B Artifacts]({{< relref "../artifacts/" >}}).
* Use and create Registered Models in [W&B Model Registry]({{< relref "../model_registry/" >}}).
...
3. **W&B project**: The name of the project where [W&B Runs]({{< relref "../runs/" >}}) are stored.
...
## Write W&B Artifacts
Before continuing, we recommend you to have a good understanding of how to use W&B Artifacts. Consider reading the [Guide on Artifacts]({{< relref "../artifacts/" >}}).
