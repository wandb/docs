...
## Features
- Release notes for W&B Server are now published [in the W&B documentation](/release-notes/releases/) in addition to on GitHub. [Subscribe using RSS](/release-notes/releases/index.xml).
