...
Migration to Dedicated Cloud from a [Self-managed instance]({{< relref path="../self-managed/" lang="ja" >}}) or [Multi-tenant Cloud]({{< relref path="../saas_cloud.md" lang="ja" >}}) is supported.
