...
The recommended installation method is with the official W&B Helm chart. Follow [this section]({{< relref path="./kubernetes-operator/#deploy-wb-with-helm-cli" lang="ja" >}}) to deploy the W&B Server application.
