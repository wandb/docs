...
オートメーションは以下のいずれかのステータスを持つことができます：

| ステータス | アイコン | 説明 |
|--------|------|-------------|
| **成功** | ✅ 緑のチェックマーク | オートメーションが正常に完了し、アクションが実行されました |
| **失敗** | ❌ 赤いX | オートメーションでエラーが発生し、完了できませんでした |
| **進行中** | 🔄 回転アイコン | オートメーションが現在実行中です |
| **キャンセル** | ⏹️ グレーの四角 | オートメーションが完了前に手動で停止されました |
| **スキップ** | ⏭️ グレーの前進 | オートメーションがトリガーされましたが、条件が満たされずスキップされました |
