...
An artifact version can also be deleted programmatically via the [delete()]({{< relref path="/ref/python/sdk/classes/artifact.md#delete" lang="ja" >}}) method. See the examples below. 
...
Artifacts with protected aliases have special deletion restrictions. [Protected aliases]({{< relref path="/guides/core/registry/model_registry/access_controls.md" lang="ja" >}}) are aliases in the Model Registry that registry admins can set to prevent unauthorized deletion.
