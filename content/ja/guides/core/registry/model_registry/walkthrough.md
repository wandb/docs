...
Use the [`link_model`]({{< relref path="/ref/python/run.md#link_model" lang="ja" >}}) API to log model one ore more files to a W&B run and link it to the [W&B Model Registry]({{< relref path="./" lang="ja" >}}).
