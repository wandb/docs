...
[Registry admins]({{< relref path="/guides/core/registry/configure_registry/#registry-roles" lang="ja" >}}) and [service accounts]({{< relref path="/support/kb-articles/service_account_useful" lang="ja" >}}) with the Admin role can create protected aliases and add or remove protected aliases from an artifact version. Members and Viewers cannot unlink a protected version or delete a collection that contains a protected . See [Configure registry access]({{< relref path="/guides/core/registry/configure_registry.md" lang="ja" >}}) for details.
