...
{{% alert %}}
See the [OpenAI fine-tuning integration]({{< relref path="./openai-fine-tuning.md" lang="ja" >}}) to learn how to use W&B to track your fine-tuning experiments, models, and datasets and share your results with your colleagues.
{{% /alert %}}
...
You can optionally pass a dictionary with argument that `wandb.init()` accepts to `autolog`. This includes a project name, team name, entity, and more. For more information about [`wandb.init()`]({{< relref path="/ref/python/sdk/functions/init.md" lang="ja" >}}), see the API Reference Guide.
...
Click on the W&B [run]({{< relref path="/guides/models/track/runs/" lang="ja" >}}) link generated by `autolog` in **step 1**. This redirects you to your project workspace in the W&B App.
