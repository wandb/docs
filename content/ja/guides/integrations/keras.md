...
- **`WandbEvalCallback`**: This base callback logs model predictions to Weights and Biases [Tables]({{< relref path="/guides/core/tables/" lang="ja" >}}) for interactive visualization.
