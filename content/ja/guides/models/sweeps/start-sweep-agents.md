...
Optionally specify the number of W&B Runs a Sweep agent should try. The following code snippets demonstrate how to set a maximum number of [W&B Runs]({{< relref path="/ref/python/run.md" lang="ja" >}}) with the CLI and within a Jupyter Notebook, Python script.
