...
You can use the Registry to [track artifact versions]({{< relref path="./link_version.md" lang="ja" >}}), audit the history of an artifact's usage and changes, ensure governance and compliance of your artifacts, and [automate downstream processes such as model CI/CD]({{< relref path="/guides/models/automations/" lang="ja" >}}).
...
- Track an [artifact’s lineage]({{< relref path="/guides/models/registry/lineage.md" lang="ja" >}}) and audit the history of changes.
- [Automate]({{< relref path="/guides/models/automations/model-registry-automations.md" lang="ja" >}}) downstream processes such as model CI/CD.
