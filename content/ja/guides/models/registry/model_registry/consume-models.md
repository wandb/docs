...
Use the W&B Registry to track, organize and consume model artifacts. For more information see the [Registry docs]({{< relref path="/guides/models/registry/" lang="ja" >}}).
{{% /alert %}}
