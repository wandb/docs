...
View all the [artifacts]({{< relref path="/guides/core/artifacts/" lang="ja" >}}) associated with a project, from training datasets and [fine-tuned models]({{< relref path="/guides/core/registry/model_registry/" lang="ja" >}}) to [tables of metrics and media]({{< relref path="/guides/models/tables//tables-walkthrough.md" lang="ja" >}}).
