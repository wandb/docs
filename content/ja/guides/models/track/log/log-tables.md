...
For more information on Artifacts, see the [Artifacts Chapter]({{< relref path="/guides/core/artifacts/" lang="ja" >}}) in the Developer Guide. 

### Visualize tables

Any table logged this way will show up in your Workspace on both the Run Page and the Project Page. For more information, see [Visualize and Analyze Tables]({{< relref path="/guides/models/tables//visualize-tables.md" lang="ja" >}}).
