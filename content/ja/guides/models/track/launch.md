...
Use [`wandb.init()`]({{< relref path="/ref/python/init.md" lang="ja" >}}) to create a W&B Run.
...
`wandb.init()` returns a [Run]({{< relref path="/ref/python/run.md" lang="ja" >}}) object.
...
For more information on different data types you can log with W&B, see [Log Data During Experiments]({{< relref path="./log/" lang="ja" >}}).
