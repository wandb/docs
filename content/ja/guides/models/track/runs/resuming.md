...
Use the [`mark_preempting`]({{< relref path="/ref/python/sdk/classes/run#mark_preempting" lang="ja" >}}) function to automatically requeue interrupted sweep runs. For example:
