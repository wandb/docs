...
{{% alert %}}
Ensure that you, or someone on your team, has already configured a launch queue. For more information, see the [Set up Launch]({{< relref path="../set-up-launch/" lang="ja" >}}) page.
{{% /alert %}}
