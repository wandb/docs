...
If you want the launch agent to build images for you that are executed in Vertex AI, see [Advanced agent set up]({{< relref path="./setup-agent-advanced.md" lang="ko" >}}).
