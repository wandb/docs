...
* Create and use a [W&B Artifact]({{< relref path="/guides/core/artifacts/" lang="ko" >}}).
...
{{% /tab %}}
{{% tab "W&B Object" %}}
Any W&B object, such as a [Table]({{< relref path="/ref/python/sdk/data-types/table.md" lang="ko" >}}) or [Image]({{< relref path="/ref/python/sdk/data-types/image.md" lang="ko" >}}), is added to an Artifact created by the integration. This example adds a Table to an Artifact:
...
* [`add_dirs`]({{< relref path="/ref/python/sdk/classes/artifact#add_dir" lang="ko" >}}): (list[dict[str, Any]]): An array containing configuration for each local directory to include in the Artifact. 
* [`add_files`]({{< relref path="/ref/python/sdk/classes/artifact#add_file" lang="ko" >}}): (list[dict[str, Any]]): An array containing configuration for each local file to include in the Artifact. 
* [`add_references`]({{< relref path="/ref/python/sdk/classes/artifact#add_reference" lang="ko" >}}): (list[dict[str, Any]]): An array containing configuration for each external reference to include in the Artifact. 
...
Before continuing, we recommend you to have a good understanding of how to use W&B Launch. Consider reading the [Guide on Launch]({{< relref path="/launch/" lang="ko" >}}).
...
Refer to the [Launch page]({{< relref path="/launch/" lang="ko" >}}).
...
Avoid using [`Artifact.download()`]({{< relref path="/ref/python/sdk/classes/artifact#download" lang="ko" >}}) or [`Run.log_artifact()`]({{< relref path="/ref/python/sdk/classes/run#log_artifact" lang="ko" >}}) directly. Those methods are handled by integration. Instead, return the data you want to store in the Artifact and let the integration do the rest. This approach provides better lineage for the Artifact.
