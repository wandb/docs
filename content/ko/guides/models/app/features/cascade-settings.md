...
The workspace layout options page shows whether the workspace generates panels automatically or manually. To adjust a workspace's panel generation mode, refer to [Panels]({{< relref path="/guides/models/app/features/panels/" lang="ko" >}}).
