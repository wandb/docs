...
1. **Log data**: From your script, log [config]({{< relref path="/guides/models/track/config.md" lang="ko" >}}) and summary data as you normally would when running with W&B. To visualize a list of multiple values logged at one specific time, use a custom`wandb.Table`
