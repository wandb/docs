...
* **Axes**: Different hyperparameters from [`wandb.config`]({{< relref path="/guides/models/track/config.md" lang="ko" >}}) and metrics from [`wandb.log`]({{< relref path="/guides/models/track/log/" lang="ko" >}}).
