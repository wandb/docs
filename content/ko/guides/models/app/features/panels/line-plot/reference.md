...
You can set the [smoothing coefficient]({{< relref path="/support/formula_smoothing_algorithm.md" lang="ko" >}}) to be between 0 and 1 where 0 is no smoothing and 1 is maximum smoothing.
