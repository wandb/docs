...
See [Link a model version]({{< relref path="/guides/models/registry/link_version.md" lang="ko" >}}) and [Create a custom alias]({{< relref path="/guides/core/artifacts/create-a-custom-alias.md" lang="ko" >}}).
