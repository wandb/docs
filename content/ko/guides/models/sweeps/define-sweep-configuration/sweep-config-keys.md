...
A sweep configuration consists of nested key-value pairs. Use top-level keys within your sweep configuration to define qualities of your sweep search such as the parameters to search through ([`parameter`]({{< relref path="./sweep-config-keys.md#parameters" lang="ko" >}}) key), the methodology to search the parameter space ([`method`]({{< relref path="./sweep-config-keys.md#method" lang="ko" >}}) key), and more. 
...
| [`method`]({{< relref path="#method" lang="ko" >}}) | (required) The search strategy |
| [`metric`]({{< relref path="#metric" lang="ko" >}}) | The metric to optimize (only used by certain search strategies and stopping criteria) |
| [`parameters`]({{< relref path="#parameters" lang="ko" >}}) | (required) Parameter bounds to search |
| [`early_terminate`]({{< relref path="#early_terminate" lang="ko" >}}) | Any early stopping criteria |
| [`command`]({{< relref path="#command" lang="ko" >}}) | Command structure for invoking and passing arguments to the training script |
| `run_cap` | Maximum number of runs for this sweep |

See the [Sweep configuration]({{< relref path="./sweep-config-keys.md" lang="ko" >}}) structure for more information on how to structure your sweep configuration.
...
| `distribution`  | Specify a probability [distribution]({{< relref path="#distribution-options-for-random-and-bayesian-search" lang="ko" >}}). See the note following this table for information on default values. |
...
{{% alert %}}
W&B sets the following distributions based on the following conditions if a [distribution]({{< relref path="#distribution-options-for-random-and-bayesian-search" lang="ko" >}}) is not specified:
...
Bayesian search runs forever unless you stop the process from the command line, within your python script, or [the W&B App]({{< relref path="../sweeps-ui.md" lang="ko" >}}). 
...
{{% alert %}}
Hyperband checks which [runs]({{< relref path="/ref/python/sdk/classes/run.md" lang="ko" >}}) to end once every few minutes. The end run timestamp might differ from the specified brackets if your run or iteration are short.
{{% /alert %}}

## `command` 

<!-- Agents created with [`wandb agent`]({{< relref path="/ref/cli/wandb-agent.md" lang="ko" >}}) receive a command in the following format by default: -->
