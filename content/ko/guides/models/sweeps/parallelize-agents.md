...
{{< tabpane text=true >}}
  {{% tab header="CLI" %}}
Use the [`wandb agent`]({{< relref path="/ref/cli/wandb-agent.md" lang="ko" >}}) command to parallelize your sweep agent across multiple CPUs with the terminal. Provide the sweep ID that was returned when you [initialized the sweep]({{< relref path="./initialize-sweeps.md" lang="ko" >}}). 
