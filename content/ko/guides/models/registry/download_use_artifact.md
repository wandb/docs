...
See [`use_artifact`]({{< relref path="/ref/python/run.md#use_artifact" lang="ko" >}}) and [`Artifact.download()`]({{< relref path="/ref/python/artifact#download" lang="ko" >}}) in the API Reference guide for more information on possible parameters and return type.
