...
Use the [`log_model`]({{< relref path="/ref/python/sdk/classes/run.md#log_model" lang="ko" >}}) to log a model artifact that contains content within a directory you specify. The [`log_model`]({{< relref path="/ref/python/sdk/classes/run.md#log_model" lang="ko" >}}) method also marks the resulting model artifact as an output of the W&B run. 
...
{{% alert %}}
Keep track of the `name` that you, or W&B assigns, to the model. You will need the name of the model to retrieve the model path with the [`use_model`]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) method. 
{{% /alert %}}

See [`log_model`]({{< relref path="/ref/python/sdk/classes/run.md#log_model" lang="ko" >}}) in the API Reference for parameters.
...
Use the [`use_model`]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) function to access and download models files previously logged to a W&B run. 
...
The [use_model]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) function returns the path of downloaded model files. Keep track of this path if you want to link this model later. In the preceding code snippet, the returned path is stored in a variable called `downloaded_model_path`.
...
See [`use_model`]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) in the API Reference for parameters and return type.

## Log and link a model to the W&B Model Registry

{{% alert %}}
The [`link_model`]({{< relref path="/ref/python/sdk/classes/run.md#link_model" lang="ko" >}}) method is currently only compatible with the legacy W&B Model Registry, which will soon be deprecated. To learn how to link a model artifact to the new edition of model registry, visit the [Registry linking guide]({{< relref path="/guides/core/registry/link_version.md" lang="ko" >}}). 
{{% /alert %}}
...
The proceeding code snippet shows how to link a model with the [`link_model`]({{< relref path="/ref/python/sdk/classes/run.md#link_model" lang="ko" >}}) API. Ensure to replace other the values enclosed in `<>` with your own:
...
See [`link_model`]({{< relref path="/ref/python/sdk/classes/run.md#link_model" lang="ko" >}}) in the API Reference guide for optional parameters.
