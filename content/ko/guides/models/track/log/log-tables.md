...
1. [Create Tables]({{< relref path="./log-tables.md#create-tables" lang="ko" >}})
2. [Add Data]({{< relref path="./log-tables.md#add-data" lang="ko" >}})
3. [Retrieve Data]({{< relref path="./log-tables.md#retrieve-data" lang="ko" >}})
4. [Save Tables]({{< relref path="./log-tables.md#save-tables" lang="ko" >}})
...
For more information on Artifacts, see the [Artifacts Chapter]({{< relref path="/guides/core/artifacts/" lang="ko" >}}) in the Developer Guide. 

### Visualize tables

Any table logged this way will show up in your Workspace on both the Run Page and the Project Page. For more information, see [Visualize and Analyze Tables]({{< relref path="/guides/models/tables//visualize-tables.md" lang="ko" >}}).
