...
Use the [W&B Public API]({{< relref path="/ref/python/public-api/index.md" lang="ko" >}}) to update a completed run's config. 

You must provide the API with your entity, project name and the run's ID. You can find these details in the Run object or in the [W&B App]({{< relref path="/guides/models/track/workspaces.md" lang="ko" >}}):
