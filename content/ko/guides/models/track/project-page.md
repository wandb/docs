...
* [Automations]({{< relref path="#automations-tab" lang="ko" >}}): Automations configured in your project
...
## Automations tab
Automate downstream actions for versioning artifacts. To create an automation, define trigger events and resulting actions. Actions include executing a webhook or launching a W&B job. For more information, see [Automations]({{< relref path="/guides/core/automations/" lang="ko" >}}).
...
View all [artifacts]({{< relref path="/guides/core/artifacts/" lang="ko" >}}) associated with a project, from training datasets and [fine-tuned models]({{< relref path="/guides/core/registry/" lang="ko" >}}) to [tables of metrics and media]({{< relref path="/guides/models/tables/tables-walkthrough.md" lang="ko" >}}).
...
[Tables]({{< relref path="/guides/models/tables//tables-walkthrough.md" lang="ko" >}}) associated with artifacts are particularly rich and interactive in this context. Learn more about using Tables with Artifacts [here]({{< relref path="/guides/models/tables//visualize-tables.md" lang="ko" >}}).
...
Refer to the [`wandb.init()` API reference]({{< relref path="/ref/python/sdk/functions/init/#examples" lang="ko" >}}).
   {{% /tab %}}  
{{< /tabpane >}}
