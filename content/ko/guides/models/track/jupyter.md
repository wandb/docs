...
2. **Code saving**: When reproducing a model, it's hard to know which cells in a notebook ran, and in which order. Turn on code saving on your [settings page]({{< relref path="/guides/models/app/settings-page/" lang="ko" >}}) to save a record of cell execution for each experiment.
...
{{% alert %}}
Want to know more about what you can do with W&B? Check out our [guide to logging data and media]({{< relref path="log/" lang="ko" >}}), learn [how to integrate us with your favorite ML toolkits]({{< relref path="/guides/integrations/" lang="ko" >}}), or just dive straight into the [reference docs]({{< relref path="/ref/python/" lang="ko" >}}) or our [repo of examples](https://github.com/wandb/examples).
{{% /alert %}}
