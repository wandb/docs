...
If you're using [W&B Server]({{< relref path="/guides/hosting/" lang="ko" >}}) in your Private Cloud or on W&B Dedicated Cloud, then please refer to [this documentation]({{< relref path="/guides/hosting/monitoring-usage/slack-alerts.md" lang="ko" >}}) to setup Slack alerts.
{{% /alert %}}
