...
Use the [`mark_preempting`]({{< relref path="/ref/python/run.md#mark_preempting" lang="ko" >}}) function to enable W&B to automatically requeue interrupted sweep runs. For example, the following code snippet
