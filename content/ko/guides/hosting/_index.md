...
W&B Platform is the foundational infrastructure, tooling and governance scaffolding which supports the W&B products like [Core]({{< relref path="../core.md" lang="ko" >}}), [Models]({{< relref path="../models.md" lang="ko" >}}) and [Weave]({{< relref path="/guides/weave/" lang="ko" >}}). 
...
See [W&B Dedicated Cloud]({{< relref path="./hosting-options/dedicated_cloud.md" lang="ko" >}}) for more information.
...
See [W&B Self Managed]({{< relref path="./hosting-options/self-managed.md" lang="ko" >}}) for more information.
