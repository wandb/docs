...
More information on creating the preceding configuration file can be found [here]({{< relref path="../kubernetes-operator/#configuration-reference-for-wb-server" lang="ko" >}}). 
