...
See the [Deploy W&B in airgapped environment with Kubernetes]({{< relref path="./operator-airgapped.md" lang="ko" >}}) tutorial on how to install the W&B Kubernetes Operator in an airgapped environment.
