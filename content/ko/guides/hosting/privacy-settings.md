...
* Allow users with matching organization email domain to join this team.
    * This setting is applicable only to [SaaS Cloud]({{< relref path="/guides/hosting/hosting-options/saas_cloud.md" lang="ko" >}}). It's not available in [Dedicated Cloud]({{< relref path="/guides/hosting/hosting-options/dedicated_cloud" lang="ko" >}}) or [Self-managed]({{< relref path="/guides/hosting/hosting-options/self-managed" lang="ko" >}}) instances.
...
* Enforce team self joining restrictions
    ...
    * This setting is applicable only to [SaaS Cloud]({{< relref path="./hosting-options/saas_cloud.md" lang="ko" >}}). It's not available in [Dedicated Cloud]({{< relref path="/guides/hosting/hosting-options/dedicated_cloud" lang="ko" >}}) or [Self-managed]({{< relref path="/guides/hosting/hosting-options/self-managed" lang="ko" >}}) instances.
