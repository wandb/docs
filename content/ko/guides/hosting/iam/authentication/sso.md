...
You can configure SSO using either the W&B Server UI or by passing [environment variables]({{< relref path="/guides/hosting/env-vars.md" lang="ko" >}}) to the `wandb/local` pod. The environment variables take precedence over UI.
