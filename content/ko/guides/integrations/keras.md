...
- **`WandbEvalCallback`**: This base callback logs model predictions to Weights and Biases [Tables]({{< relref path="/guides/core/tables/" lang="ko" >}}) for interactive visualization.
