...
| `init_kwargs`                   | Params to pass to `wandb.init` such as your wandb `config` etc [See here]({{< relref path="/ref/python/init" lang="ko" >}}) for the full list `wandb.init` accepts                                                                                                                                                                                   
