...
[Learn more about `run.log`]({{< relref path="/guides/models/track/log" lang="ko" >}}).
...
[Learn more about logging]({{< relref path="/guides/models/track/log" lang="ko" >}}) media, objects, plots, and more.
