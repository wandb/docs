...
You can access the information we've captured in three ways: inside the original Python process being logged using the [`wandb` client library]({{< relref path="/ref/python/" lang="ko" >}}), with the [web app UI]({{< relref path="/guides/models/track/workspaces.md" lang="ko" >}}), or programmatically using [our Public API]({{< relref path="/ref/python/public-api/" lang="ko" >}}). `Parameter`s are saved to W&B's [`config`]({{< relref path="/guides/models/track/config.md" lang="ko" >}}) and can be found in the [Overview tab]({{< relref path="/guides/models/track/runs/#overview-tab" lang="ko" >}}). `datasets`, `models`, and `others` are saved to [W&B Artifacts]({{< relref path="/guides/core/artifacts/" lang="ko" >}}) and can be found in the [Artifacts tab]({{< relref path="/guides/models/track/runs/#artifacts-tab" lang="ko" >}}). Base python types are saved to W&B's [`summary`]({{< relref path="/guides/models/track/log/" lang="ko" >}}) dict and can be found in the Overview tab. See our [guide to the Public API]({{< relref path="/guides/models/track/public-api-guide.md" lang="ko" >}}) for details on using the API to get this information programmatically from outside .
