...
Any additional, optional arguments that you might like to pass to [`wandb.init`]({{< relref path="/ref/python/init" lang="ko" >}}) can also be added under the `wandb` header in the yaml file:
