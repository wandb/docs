...
| \*\*kwargs_wandb_init  | Aany additional argument passed directly to [`wandb.init()`]({{< relref path="/ref/python/init.md" lang="ko" >}})                    |
...
This model (metadata) artifact can further be linked to a model in the [W&B Model Registry]({{< relref path="/guides/models/registry/model_registry/" lang="ko" >}}).
