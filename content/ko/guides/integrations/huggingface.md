...
Using W&B's [Artifacts]({{< relref path="/guides/core/artifacts/" lang="ko" >}}), you can store up to 100GB of models and datasets for free and then use the W&B [Model Registry]({{< relref path="/guides/models/registry/model_registry/" lang="ko" >}}) to register models to prepare them for staging or deployment in your production environment.
