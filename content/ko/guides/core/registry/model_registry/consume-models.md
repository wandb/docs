...
W&B suggests that you document information on how to load models into memory with model cards. For more information, see the [Document machine learning models]({{< relref path="./create-model-cards.md" lang="ko" >}}) page. 
{{% /alert %}}
...
See [`use_model`]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) in the API Reference guide for more information on possible parameters and return type.
...
Use the W&B Registry to track, organize and consume model artifacts. For more information see the [Registry docs]({{< relref path="/guides/core/registry/" lang="ko" >}}).
{{% /alert %}}
...
See [`use_model`]({{< relref path="/ref/python/sdk/classes/run.md#use_model" lang="ko" >}}) in the API Reference guide for parameters and return type.  
  {{% /tab %}}
  {{% tab header="W&B App" %}}
