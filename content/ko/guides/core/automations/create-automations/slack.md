...
1. [Add a Slack integration]({{< relref path="#add-a-slack-channel" lang="ko" >}}), which authorizes W&B to post to the Slack instance and channel.
1. [Create the Slack automation]({{< relref path="#create-slack-automation" lang="ko" >}}), which defines the [event]({{< relref path="/guides/core/automations/automation-events.md" lang="ko" >}}) to watch for and the channel to post to.
...
Now you can [create an automation]({{< relref path="#create-a-slack-automation" lang="ko" >}}) that notifies the Slack channel you configured.
...
After you [connect your W&B team to Slack]({{< relref path="#connect-to-slack" lang="ko" >}}), select **Registry** or **Project**, then follow these steps to create an automation that notifies the Slack channel.
