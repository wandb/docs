...
menu:
  default:
    identifier: ko-guides-core-automations-model-registry-automations
    parent: automations
title: Model registry automations
url: guides/model_registry/model-registry-automations
---

Create an automation to trigger workflow steps, such as automated model testing and deployment. To create an automation, define the action you want to occur based on an [event type]({{< relref path="#event-types" lang="ko" >}}).
...
See [Link a model version]({{< relref path="/guides/core/registry/link_version.md" lang="ko" >}}) and [Create a custom alias]({{< relref path="/guides/core/artifacts/create-a-custom-alias.md" lang="ko" >}}).
