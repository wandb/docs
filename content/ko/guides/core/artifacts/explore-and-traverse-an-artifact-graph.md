...
Use the artifact object's [`logged_by`]({{< relref path="/ref/python/artifact.md#logged_by" lang="ko" >}}) and [`used_by`]({{< relref path="/ref/python/artifact.md#used_by" lang="ko" >}}) methods to walk the graph from the artifact:
