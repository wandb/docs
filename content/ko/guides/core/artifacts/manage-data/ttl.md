...
{{% /alert %}}
{{% alert %}}
* Only team admins can view a [team's settings]({{< relref path="/guides/models/app/settings-page/team-settings.md" lang="ko" >}}) and access team level TTL settings such as (1) permitting who can set or edit a TTL policy or (2) setting a team default TTL.  
...
You can check an Artifact's type on the [W&B platform]({{< relref path="/guides/core/artifacts/explore-and-traverse-an-artifact-graph.md" lang="ko" >}}) or programmatically:
...
{{% alert %}}
Defining a TTL policy when you create an artifact is similar to how you normally [create an artifact]({{< relref path="../construct-an-artifact.md" lang="ko" >}}). With the exception that you pass in a time delta to the artifact's `ttl` attribute.
{{% /alert %}}

The steps are as follows: 

1. [Create an artifact]({{< relref path="../construct-an-artifact.md" lang="ko" >}}).
2. [Add content to the artifact]({{< relref path="../construct-an-artifact.md#add-files-to-an-artifact" lang="ko" >}}) such as files, a directory, or a reference.
...
4. [Log the artifact]({{< relref path="../construct-an-artifact.md#3-save-your-artifact-to-the-wb-server" lang="ko" >}}).
...
1. [Fetch your artifact]({{< relref path="../download-and-use-an-artifact.md" lang="ko" >}}).
2. Pass in a time delta to the artifact's `ttl` attribute. 
3. Update the artifact with the [`save`]({{< relref path="/ref/python/sdk/classes/run.md#save" lang="ko" >}}) method.
