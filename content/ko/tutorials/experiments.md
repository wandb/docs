...
1. Initialize a [W&B run]({{< relref path="/guides/models/track/runs/" lang="ko" >}}) and pass in the hyperparameters you want to track.
...
W&B runs automatically log [metrics]({{< relref path="/guides/models/track/runs/#workspace-tab" lang="ko" >}}),
[system information]({{< relref path="/guides/models/track/runs/#system-tab" lang="ko" >}}),
[hyperparameters]({{< relref path="/guides/models/track/runs/#overview-tab" lang="ko" >}}),
[terminal output]({{< relref path="/guides/models/track/runs/#logs-tab" lang="ko" >}}) and
you'll see an [interactive table]({{< relref path="/guides/core/tables/" lang="ko" >}})
...
W&B also makes it easy to share your saved models and model checkpoints with other members of your team or organization. To learn how to share your model and model checkpoints with members outside of your team, see [W&B Registry]({{< relref path="/guides/models/registry/" lang="ko" >}}).
...
Create a [W&B Alerts]({{< relref path="/guides/models/track/runs/alert/" lang="ko" >}}) to send alerts to your Slack or email from your Python code. 
...
You can find the full docs for [W&B Alerts here]({{< relref path="/guides/models/track/runs/alert" lang="ko" >}}).
