...
1. Initialize a [run]({{< relref path="/guides/models/track/runs/" lang="ko" >}}) and pass in the hyperparameters you want to track.
...
For more details, see the [W&B Alerts overview]({{< relref path="/guides/models/track/runs/alert" lang="ko" >}}).
