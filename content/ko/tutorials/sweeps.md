...
* [`wandb.init()`]({{< relref path="/ref/python/init" lang="ko" >}}): Initialize a new W&B run. Each run is a single execution of the training function.
* [`wandb.config`]({{< relref path="/guides/models/track/config" lang="ko" >}}): Pass sweep configuration with the hyperparameters you want to experiment with.
* [`wandb.log()`]({{< relref path="/ref/python/log" lang="ko" >}}): Log the training loss for each epoch.
