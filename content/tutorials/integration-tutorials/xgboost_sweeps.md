...
[a dictionary or a YAML file]({{< relref "/guides/sweeps/define-sweep-configuration" >}}).
...
For details, see the [list of all sweep configuration options]({{< relref "/guides/sweeps/define-sweep-configuration" >}}).
...
or until you [turn the sweep off from the app UI]({{< relref "/guides/sweeps/sweeps-ui" >}}).
