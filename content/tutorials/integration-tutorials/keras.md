...
This Colab notebook introduces the `WandbMetricsLogger` callback. Use this callback for [Experiment Tracking]({{< relref "/guides/track" >}}). It will log your training and validation metrics along with system metrics to Weights and Biases.
