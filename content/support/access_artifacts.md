...
This section outlines workflows for managing and editing Artifacts. Many workflows utilize [the W&B API](../guides/track/public-api-guide/), a component of [the client library](../ref/python/README/) that provides access to W&B-stored data.