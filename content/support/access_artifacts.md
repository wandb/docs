...
This section outlines workflows for managing and editing Artifacts. Many workflows utilize [the W&B API]({{< relref "../guides/track/public-api-guide.md" >}}), a component of [the client library]({{< relref "../ref/python/README.md" >}}) that provides access to W&B-stored data.