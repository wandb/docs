...
To fully remove a deactivated user from the user list, you must [remove the user from the organization]({{< relref "access-management/manage-organization.md#remove-a-user" >}}).
...
Just like how SCIM API allows you to automate user and team management, you can also use some of the methods available in the [W&B Python SDK API]({{< relref "/ref/python/sdk/public-api/api.md" >}}) for that purpose. Keep a note of the following methods:
