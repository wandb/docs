...
| `GORILLA_CUSTOMER_SECRET_STORE_SOURCE` | Sets the secret manager to be used by the Weave application when enabling Team Secrets. Can be set to the internal Kubernetes secret manager, `k8s-secretmanager://wandb-secret`, or to a cloud secret manger, `aws-secretmanager://wandb-secret`, when deployed in a cloud provider.                                                                                                         |
