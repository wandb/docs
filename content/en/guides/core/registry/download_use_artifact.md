...
See [`use_artifact`]({{< relref "/ref/python/sdk/experiments/run.md#use_artifact" >}}) and [`Artifact.download()`]({{< relref "/ref/python/sdk/experiments/artifact.md#download" >}}) in the API Reference for parameters and return type.
