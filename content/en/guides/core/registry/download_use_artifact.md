...
See [`use_artifact`]({{< relref "/ref/python/run.md#use_artifact" >}}) and [`Artifact.download()`]({{< relref "/ref/python/artifact#download" >}}) in the API Reference for parameters and return type.
