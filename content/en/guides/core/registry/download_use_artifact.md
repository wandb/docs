...
See [`use_artifact`]({{< relref "/ref/python/sdk/run.md#use_artifact" >}}) and [`Artifact.download()`]({{< relref "/ref/python/sdk/artifact.md#download" >}}) in the API Reference for parameters and return type.
