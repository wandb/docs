...
{{< img src="/images/registry/artifact_types_model_card.png" alt="Artifact types selection interface showing model card template options for registry collections" >}}
