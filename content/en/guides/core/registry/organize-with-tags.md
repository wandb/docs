...
{{< img src="/images/registry/tag_collection_selected.png" alt="Registry collection view showing selected tags and filtered results for better artifact discovery" >}}
...
{{< img src="/images/registry/add_tag_linked_artifact_version.gif" alt="Demonstration of adding tags to linked artifact versions for enhanced metadata management" >}}
...
{{< img src="/images/registry/search_tags.gif" alt="Tag-based search functionality showing how to filter and discover artifacts using tag queries" >}}
