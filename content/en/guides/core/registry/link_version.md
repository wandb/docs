...
1. Navigate to the Registry App.
    {{< img src="/images/registry/navigate_to_registry_app.png" alt="Navigation to Registry App showing access path from main workspace interface" >}}
...
{{< img src="/images/registry/get_autogenerated_code.gif" alt="Auto-generated code snippet demonstration for linking artifacts to registry collections programmatically" >}}
