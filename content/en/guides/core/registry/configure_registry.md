...
- [`Run.use_artifact()`]({{< relref "/ref/python/sdk/experiments/run/#method-runuse_artifact" >}})
- [`Artifact.download()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactdownload" >}})
- [`Artifact.file()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactfile" >}})
- [`Artifact.files()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactfiles" >}})

The following methods are limited to artifact metadata:
- [`Artifact.get_entry()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactget_entry" >}})
- [`Artifact.get_path()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactget_path" >}})
- [`Artifact.get()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactget" >}})
- [`Artifact.verify()`]({{< relref "/ref/python/sdk/experiments/artifact/#method-artifactverify" >}})
