...
```
For a complete list of an artifact object's attributes, see the [Artifacts Class]({{< relref "/ref/python/sdk/actions/classes/Artifact/_index.md" >}}) in the API Reference docs. 
