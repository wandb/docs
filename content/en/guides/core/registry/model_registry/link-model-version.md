...
Use the [`link_model`]({{< relref "/ref/python/sdk/run.md#link_model" >}}) method to programmatically log model files to a W&B run and link it to the [W&B Model Registry]({{< relref "./" >}}). 
