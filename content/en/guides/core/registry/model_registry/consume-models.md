...
See [`use_model`]({{< relref "/ref/python/sdk/experiments/run.md#use_model" >}}) in the API Reference guide for more information on possible parameters and return type.
...
See [`use_model`]({{< relref "/ref/python/sdk/experiments/run.md#use_model" >}}) in the API Reference guide for parameters and return type.  
  {{% /tab %}}
  {{% tab header="W&B App" %}}
