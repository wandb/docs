...
Use the [`link_model`]({{< relref "/ref/python/sdk/run.md#link_model" >}}) API to log model one ore more files to a W&B run and link it to the [W&B Model Registry]({{< relref "./" >}}).
