...
An artifact version can also be deleted programmatically via the [delete()]({{< relref "/ref/python/sdk/artifact.md#delete" >}}) method. See the examples below. 
...
You can also delete artifact collection programmatically with the [delete()]({{< relref "/ref/python/sdk/artifact.md#delete" >}}) method. Provide the name of the project and entity for the `project` and `entity` keys in `wandb.Api`, respectively:
