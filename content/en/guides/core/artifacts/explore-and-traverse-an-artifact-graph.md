...
Use the artifact object's [`logged_by`]({{< relref "/ref/python/sdk/classes/artifact#logged_by" >}}) and [`used_by`]({{< relref "/ref/python/sdk/classes/artifact#used_by" >}}) methods to walk the graph from the artifact:
