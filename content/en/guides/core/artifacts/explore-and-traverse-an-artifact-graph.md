...
Use the artifact object's [`logged_by`]({{< relref "/ref/python/sdk/actions/classes/Artifact#logged_by" >}}) and [`used_by`]({{< relref "/ref/python/sdk/actions/classes/Artifact#used_by" >}}) methods to walk the graph from the artifact:
