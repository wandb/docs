...
Use the W&B Public API ([`wandb.Api`]({{< relref "/ref/python/sdk/public-api/api.md" >}})) to update an artifact outside of a run. Use the Artifact API ([`wandb.Artifact`]({{< relref "/ref/python/sdk/experiments/artifact.md" >}})) to update an artifact during a run.
...
The proceeding code example demonstrates how to update the description of an artifact using the [`wandb.Artifact`]({{< relref "/ref/python/sdk/experiments/artifact.md" >}}) API:
...
For more information, see the Weights and Biases [Artifact API]({{< relref "/ref/python/sdk/experiments/artifact.md" >}}).  
  {{% /tab %}}
