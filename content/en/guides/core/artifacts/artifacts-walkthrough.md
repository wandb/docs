...
Use the [`wandb.init()`]({{< relref "/ref/python/sdk/actions/functions/init" >}}) API to generate a background process to sync and log data as a W&B Run. Provide a project name and a job type:
