...
2. Create an artifact object with the [`wandb.Artifact`]({{< relref "/ref/python/sdk/experiments/artifact.md" >}}) API.
...
Indicate the artifact you want to mark as input to your run with the [`use_artifact`]({{< relref "/ref/python/sdk/experiments/run.md#use_artifact" >}}) method.
...
* Explore the [Python SDK]({{< relref "/ref/python/sdk/experiments/artifact.md" >}}) and [CLI]({{< relref "/ref/cli/wandb-artifact/" >}}) reference guides.
