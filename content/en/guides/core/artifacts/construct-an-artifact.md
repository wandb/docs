...
You can also add multiple files with the [`add_dir`]({{< relref "/ref/python/artifact.md#add_dir" >}}) method. For adding files, see [Update an artifact]({{< relref "./update-an-artifact.md" >}}).
