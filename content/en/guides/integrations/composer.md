...
| `init_kwargs`                   | Params to pass to `wandb.init` such as your wandb `config` etc [See here]({{< relref "/ref/python/sdk/actions/functions/init" >}}) for the full list `wandb.init` accepts                                                                                                                                                                                   
