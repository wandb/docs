...
| `init_kwargs`                   | Params to pass to `wandb.init` such as your wandb `config` etc. See the [`wandb.init` parameters]({{< relref "/ref/python/sdk/functions/init.md" >}}) for the full list `wandb.init` accepts.
