...
| `init_kwargs`                   | Params to pass to `wandb.init()` such as your wandb `config` etc. See the [`wandb.init()` parameters]({{< relref "/ref/python/sdk/functions/init.md" >}}) for parameters that `wandb.init()` accepts.
