...
An example of what you might want to pass to `init` is below. For more details on how to use `wandb.init`, see the [`wandb.init` reference]({{< relref "/ref/python/init.md" >}}).
