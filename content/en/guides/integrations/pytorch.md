...
To automatically log gradients, you can call [`wandb.Run.watch()`]({{< relref "/ref/python/sdk/experiments/run.md/#method-runwatch" >}}) and pass in your PyTorch model.
...
If you need to track multiple models in the same script, you can call [`wandb.Run.watch()`]({{< relref "/ref/python/sdk/experiments/run/#method-runwatch" >}}) on each model separately.
