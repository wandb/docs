...
If you need to track multiple models in the same script, you can call `wandb.watch` on each model separately. See the [`wandb.watch` reference]({{< relref "/ref/python/watch.md" >}}) for more details.
