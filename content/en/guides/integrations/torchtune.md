...
You can also pass any other `kwargs` as you would to the [wandb.init]({{< relref "/ref/python/sdk/actions/functions/init.md" >}}) method. For example, if you are working on a team, you can pass the `entity` argument to the `WandBLogger` class to specify the team name.
