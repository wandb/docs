...
Any additional, optional arguments that you might like to pass to [`wandb.init`]({{< relref "/ref/python/sdk/functions/init" >}}) can also be added under the `wandb` header in the yaml file:
