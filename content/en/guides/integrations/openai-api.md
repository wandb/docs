...
You can optionally pass a dictionary with argument that `wandb.init()` accepts to `autolog`. This includes a project name, team name, entity, and more. For more information about [`wandb.init`]({{< relref "/ref/python/sdk/actions/functions/init.md" >}}), see the API Reference Guide.
...
Click on the W&B [run]({{< relref "/guides/models/track/runs/" >}}) link generated by `autolog` in **step 1**. This redirects you to your project workspace in the W&B App.
