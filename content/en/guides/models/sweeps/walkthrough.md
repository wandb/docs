...
Optionally provide the name of the project where you want the output of the W&B Run to be stored (project parameter in [`wandb.init()`]({{< relref "/ref/python/functions/init.md" >}})). If the project is not specified, the run is put in an "Uncategorized" project.
...
Use the [`wandb.agent()`]({{< relref "/ref/python/functions/agent.md" >}}) API call to start a sweep.
