...
{{% alert %}}
Hyperband checks which [W&B runs]({{< relref "/ref/python/sdk/classes/run" >}}) to end once every few minutes. The end run timestamp might differ from the specified brackets if your run or iteration are short.
{{% /alert %}}
