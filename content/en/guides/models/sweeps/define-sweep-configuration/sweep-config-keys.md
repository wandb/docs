...
{{% alert %}}
Hyperband checks which [runs]({{< relref "/ref/python/sdk/run.md" >}}) to end once every few minutes. The end run timestamp might differ from the specified brackets if your run or iteration are short.
{{% /alert %}}
