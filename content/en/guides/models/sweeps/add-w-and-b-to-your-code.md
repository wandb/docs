...
4. Use the [`wandb.init()`]({{< relref "/ref/python/sdk/actions/functions/init" >}}) API to generate a background process to sync and log data as a [W&B Run]({{< relref "/ref/python/sdk/actions/classes/run" >}}).
...
[`wandb.init()`]({{< relref "/ref/python/sdk/actions/functions/init" >}}) API within a `with`
...
3. Use the [`wandb.init()`]({{< relref "/ref/python/sdk/actions/functions/init" >}}) API to generate a background process to sync and log data as a [W&B Run]({{< relref "/ref/python/sdk/actions/classes/run" >}}). We pass the config object to the config parameter.
