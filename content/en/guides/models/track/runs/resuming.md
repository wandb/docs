...
Use the [`mark_preempting`]({{< relref "/ref/python/sdk/actions/classes/run#mark_preempting" >}}) function to enable W&B to automatically requeue interrupted sweep runs. For example, the following code snippet
