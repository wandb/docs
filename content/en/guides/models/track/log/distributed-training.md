...
Within the rank 0 process, initialize a W&B run with [`wandb.init`]({{< relref "/ref/python/sdk/functions/init" >}}) and log experiments ([`wandb.log`]({{< relref "/ref/python/sdk/actions/legacy_functions/log" >}})) to that run. 
