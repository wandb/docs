...
See [`log_model`]({{< relref "/ref/python/run.md#log_model" >}}) in the API Reference for parameters.
...
See [`link_model`]({{< relref "/ref/python/run.md#link_model" >}}) in the API Reference for optional parameters.
