...
Use [`wandb.init()`]({{< relref "/ref/python/sdk/actions/functions/init.md" >}}) to create a W&B Run.
...
For more information about available parameters when defining a W&B Experiment, see the [`wandb.init`]({{< relref "/ref/python/sdk/actions/functions/init.md" >}}) API docs in the [API Reference Guide]({{< relref "/ref/python/" >}}).