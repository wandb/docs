...
{{% /tab %}}
{{% tab "W&B Object" %}}
Any native W&B object (e.g [Table]({{< relref "/ref/python/sdk/data-types/table.md" >}}), [Image]({{< relref "/ref/python/sdk/data-types/image.md" >}})) is added to an Artifact created by the integration. Here’s an example using a Table.
