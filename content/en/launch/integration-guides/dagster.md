...
{{% /tab %}}
{{% tab "W&B Object" %}}
Any W&B object, such as a [Table]({{< relref "/ref/python/data-types/table.md" >}}) or [Image]({{< relref "/ref/python/data-types/image.md" >}}), is added to an Artifact created by the integration. This example adds a Table to an Artifact:
...
* [`add_dirs`]({{< relref "/ref/python/experiments/artifact#add_dir" >}}): (list[dict[str, Any]]): An array containing configuration for each local directory to include in the Artifact. 
* [`add_files`]({{< relref "/ref/python/experiments/artifact#add_file" >}}): (list[dict[str, Any]]): An array containing configuration for each local file to include in the Artifact. 
* [`add_references`]({{< relref "/ref/python/experiments/artifact#add_reference" >}}): (list[dict[str, Any]]): An array containing configuration for each external reference to include in the Artifact. 
