...
{{< img src="/images/launch/aws_template_example.png" alt="AWS CloudFormation template example for advanced Launch queue configuration with resource specifications" >}}
