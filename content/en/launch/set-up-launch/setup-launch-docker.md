...
To learn more about how connect the launch agent with a cloud registry, see the [Advanced agent setup]({{< relref "./setup-agent-advanced.md#agent-configuration" >}}) page.