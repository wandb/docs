...
See [Saved workspace views](https://docs.wandb.ai/guides/app/pages/workspaces#create-saved-workspace-views) to learn how Saved views can enhance your team's collaboration and project organization.
