---
title: API overview
description: "Browse the Serverless Training API endpoints for chat completions, models, training jobs, and health checks with authentication details."
...
- **[GET `/v1/preview/base-models`](https://docs.wandb.ai/serverless-training/api-reference/models/list-base-models)** - List Base Models
