...
Store your OpenAI API key in an environment variable named `OPENAI_API_KEY` to run this tutorial.
...
with Sandbox.run(
    ...
    environment_variables={"OPENAI_API_KEY": os.environ["OPENAI_API_KEY"]},
) as sandbox:
