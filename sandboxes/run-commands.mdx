...
{/* See the [Read output and exit codes](#read-output-and-exit-codes) section below for more details on how to read command output and exit codes from the result object returned by `Sandbox.exec()`. */}
