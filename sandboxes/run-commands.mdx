---
title: Run commands
description: Learn how to run commands in a W&B Sandbox and read output and exit codes.
---

Use the sandboxes you create to run shell commands in an isolated environment. This page shows how to run commands, check output and exit codes, and reuse the same sandbox for multiple steps.
