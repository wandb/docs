...
API または UI から Serverless Inference サービスを使用する前に、以下の手順を完了してください。
...
Serverless Inference にアクセスするには、次の項目が必要です。
...
<Note>
  **注記**
  ...
  Weave で Serverless Inference を使用するコードサンプルについては、[使用例](/ja/inference/examples)を参照してください。
</Note>
