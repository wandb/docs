...
title: "前提条件"
linkTitle: "前提条件"
description: "API または UI を通じて W&B Inference サービスを使用する前に、環境、API キー、依存関係を設定します。"
---
...
* 利用可能なエンドポイントについて把握するには、[API リファレンス](/ja/inference/api-reference/)を確認してください
* サービスの動作を確認するには、[使用例](/ja/inference/examples/)を試してください
* Web インターフェースを通じてモデルにアクセスするには、[UI ガイド](/ja/inference/ui-guide/)を使用してください