...
- **Inference usage** - LoRA アーティファクトを使用するコールは、[標準モデルの推論](/ja/inference/usage-limits#account-tiers-and-default-usage-caps) と同じレートで課金されます。カスタム LoRA のサービングに追加料金はかかりません。