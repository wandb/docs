...
W&amp;B Inference API は、foundation モデルとやり取りするための OpenAI 互換エンドポイントを提供します。

* **[Chat Completions](/ja/inference/api-reference/chat-completions)** - さまざまな foundation モデルを使用してチャット補完を生成します
...
すべての API リクエストには、W&amp;B の API キー を使用した認証が必要です。[wandb.ai/settings](https://wandb.ai/settings) で API キー を作成してください。

リクエストヘッダーに API キー を含めてください:
