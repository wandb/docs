...
3. 利用可能なモデルとモデル情報が表示されたページが表示されます

<Frame>
  <img src="/images/inference/inference-playground-single.png" alt="Playground での Inference モデルの使用" />
</Frame>
...
Playground 内で Inference モデルを並べて比較できます。Compare ビューには、2 か所からアクセスできます。
...
これでモデルを比較できるようになり、[Try a model in the Playground](#try-a-model-in-the-playground) のすべての機能を利用できます。

<div id="view-billing-and-usage-information">
  ## 請求および利用状況を確認する
</div>

組織管理者は、W&amp;B UI からクレジット残高、利用履歴、今後の請求を確認できます。
...
* ニーズに最適な [利用可能なモデル](/ja/inference/models) を確認する
