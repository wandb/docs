...
プライベートクラウドまたは W&B 専用クラウドで [W&B Server](/ja/platform/hosting/) を使用している場合は、Slack アラートの設定については[こちらのドキュメント](/ja/platform/hosting/monitoring-usage/slack-alerts)を参照してください。
</Note>
