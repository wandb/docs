...
### Key-based colors を有効にする {#turn-on-key-based-colors}
...
### 例: 損失メトリクスを使用したキーに基づく色分け {#example-key-based-coloring-with-loss-metric}
...
## 設定キーを設定する {#set-a-configuration-key}
...
## バケットをカスタマイズする {#customize-buckets}
