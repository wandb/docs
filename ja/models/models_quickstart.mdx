...
## パッケージをインストールしてインポートする {#install-and-import-packages}
...
## ダッシュボードでトレーニングデータを確認する {#view-the-training-data-in-the-dashboard}
...
## モデルを W&amp;B Registry に公開する {#publish-the-model-to-the-wb-registry}
...
## 推論用にRegistryからモデルのアーティファクトを取得する {#retrieve-model-artifact-from-registry-for-inference}
...
## 調査結果をreportで共有する {#share-your-findings-with-a-report}
...
## Registryをクエリする {#query-the-registry}
