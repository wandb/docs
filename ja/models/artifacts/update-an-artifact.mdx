...
Run の外で Artifacts を更新するには、 W&B Public API ([`wandb.Api`](/ja/models/ref/python/public-api/api)) を使用します。 Run の実行中に Artifacts を更新するには、 Artifact API ([`wandb.Artifact`](/ja/models/ref/python/experiments/artifact)) を使用します。
...
<Tabs>
<Tab title="Run の実行中">
次のコード例は、 [`wandb.Artifact`](/ja/models/ref/python/experiments/artifact) API を使用して Artifacts の説明（description）を更新する方法を示しています。
...
with wandb.init(project="<example>") as run:
    ...
    artifact.save()
```
詳細については、 [Artifacts Collection](/ja/models/ref/python/public-api/api) のリファレンスを参照してください。
</Tab>
</Tabs>