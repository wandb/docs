...
## 2. run を初期化する {#2-initialize-a-run}
...
## 3. artifact オブジェクトを作成する {#3-create-an-artifact-object}
...
## 4. データセットをartifactに追加する {#4-add-the-dataset-to-the-artifact}
...
## 5. データセットをログする {#5-log-the-dataset}
...
## 6. artifact をダウンロードして使用する {#6-download-and-use-the-artifact}
