...
description: "W&B App でワークスペース、セクション、パネルの設定を管理します。これには、レイアウトや折れ線グラフの設定オプションが含まれます。"
---

特定のワークスペースページには、ワークスペース、セクション、パネルという 3 つの異なる設定レベルがあります。[ワークスペース設定](#workspace-settings)はワークスペース全体に適用されます。[セクション設定](#section-settings)はセクション内のすべてのパネルに適用されます。[パネル設定](#panel-settings)は個々のパネルに適用されます。
