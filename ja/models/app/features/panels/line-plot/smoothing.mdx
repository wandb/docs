...
## 時間加重指数移動平均 (TWEMA) スムージング (デフォルト) {#time-weighted-exponential-moving-average-twema-smoothing-default} 
...
## 移動平均スムージング {#running-average-smoothing}
