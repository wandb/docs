...
これらのキーボードショートカットは W&B LEET (Lightweight Experiment Exploration Tool) ターミナル UI で機能します。 LEET を起動するには、ターミナルで `wandb beta leet` を実行してください。詳細については、 [`wandb beta leet`](/ja/models/ref/cli/wandb-beta/wandb-beta-leet/) を参照してください。
