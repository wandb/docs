...
## トレーニングコードを設定する {#set-up-your-training-code}
...
## sweep 設定で探索空間を定義する {#define-the-search-space-with-a-sweep-configuration}
...
## Sweep を初期化する {#initialize-the-sweep}
...
## オプション: 結果を可視化する {#optional-visualize-results}
...
## 任意: エージェントを停止する {#optional-stop-the-agent}
