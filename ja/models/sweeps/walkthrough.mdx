...
4. [sweep agent を起動する](#start-the-sweep)
...
<Warning>
  **マルチプロセシング**
  ...
  マルチプロセシングの詳細については、[Python 標準ライブラリの `multiprocessing`](https://docs.python.org/3/library/multiprocessing.html#the-spawn-and-forkserver-start-methods) または [PyTorch の `multiprocessing`](https://docs.pytorch.org/docs/stable/notes/multiprocessing.html#asynchronous-multiprocess-training-e-g-hogwild) を参照してください。`if __name__ == '__main__':` の慣例については、https://realpython.com/if-name-main-python/ を参照してください。
</Warning>
