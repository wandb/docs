---
title: Sweep 設定オプション
description: "method、metric、parameters、early termination、command を含む、すべての sweep 設定キーのリファレンス。"
---
...
### ランダム探索およびベイズ探索の分布オプション {#distribution-options-for-random-and-bayesian-search}
