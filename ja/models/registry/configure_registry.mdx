...
### ユーザーまたはチームを追加する {#add-a-user-or-a-team}
...
<div id="remove-a-user-or-team">
  ### ユーザーまたはチームを削除する {#remove-a-user-or-team}
</div>
...
<div id="change-the-owner-of-a-registry">
  ### レジストリの所有者を変更する {#change-the-owner-of-a-registry}
</div>
...
<div id="configure-registry-roles">
  ## Registry ロールを設定する {#configure-registry-roles}
</div>
...
## Registry ロールの詳細 {#details-about-registry-roles}
...
### 有効な Registry ロールと継承された Registry ロール {#effective-and-inherited-registry-roles}
...
### サービスアカウントのアクセス {#service-account-access}
...
<div id="restricted-viewer-role-details">
  ### Restricted Viewer ロールの詳細 {#restricted-viewer-role-details}
</div>
...
### Registry 間の権限 {#cross-registry-permissions}
