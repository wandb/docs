...
`wandb.Api().registries()` メソッドを使用するには、まず W&B Python SDK ([`wandb`](/ja/models/ref/python/)) ライブラリ をインポートします。
...
artifact オブジェクト の属性の完全なリストについては、API リファレンスドキュメントの [Artifacts Class](/ja/models/ref/python/experiments/artifact/) を参照してください。
