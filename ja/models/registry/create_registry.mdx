...
<Tabs>
  <Tab title=" W&B Registry UI">
    ...
    5. **Registry visibility** ドロップダウンから、レジストリを表示できる対象を選択します。レジストリの公開設定オプションの詳細については、[Registry visibility types](./configure_registry#registry-visibility-types) を参照してください。
