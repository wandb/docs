...
## コレクションにタグを追加する {#add-a-tag-to-a-collection}
...
<div id="update-tags-that-belong-to-a-collection">
  ## コレクションに属するタグを更新する {#update-tags-that-belong-to-a-collection}
</div>
...
<div id="view-tags-that-belong-to-a-collection">
  ## コレクションに追加されたタグを表示する {#view-tags-that-belong-to-a-collection}
</div>
...
<div id="remove-a-tag-from-a-collection">
  ## コレクションからタグを削除する {#remove-a-tag-from-a-collection}
</div>
...
## artifact バージョンにタグを追加する {#add-a-tag-to-an-artifact-version}
...
<div id="update-tags-that-belong-to-an-artifact-version">
  ## artifact バージョンに属するタグを更新する {#update-tags-that-belong-to-an-artifact-version}
</div>
...
<div id="view-tags-that-belong-to-an-artifact-version">
  ## artifact バージョンに属するタグを表示する {#view-tags-that-belong-to-an-artifact-version}
</div>
...
## artifact バージョンからタグを削除する {#remove-a-tag-from-an-artifact-version}
...
{/* ## 既存のタグを検索する
  ...
  W&B App UI を使用して、コレクションと artifact バージョンにある既存のタグを検索します:
...
<div id="find-artifact-versions-with-a-specific-tag">
  ## 特定のタグが付いたartifactバージョンを検索する {#find-artifact-versions-with-a-specific-tag}
</div>
