...
description: "デフォルト、カスタム、保護されたエイリアスを使用して、W&B Registry 内の特定の artifact version を参照します。"
---
