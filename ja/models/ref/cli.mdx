...
description: "W&B Command Line Interface (CLI) を使用して、シェルコマンドでログイン、ジョブの実行、sweep の実行などを行います"
---
...
| [docker](/ja/models/ref/cli/wandb-docker)             | コードを Docker コンテナー内で実行します。                                               |
...
| [job](/ja/models/ref/cli/wandb-job)                   | W&amp;B ジョブの管理および表示用コマンドです。                                             |
...
| [local](/ja/models/ref/cli/wandb-local)               | ローカルの W&amp;B コンテナーを起動します (非推奨。`wandb server --help` を参照)。              |
...
| [purge-cache](/ja/models/ref/cli/wandb-purge-cache)   | ローカルの W&amp;B キャッシュから、キャッシュされたログ、run history、アーティファクトを削除します。            |
