...
### <kbd>method</kbd> `ensure_baseline_pinned` {#method-ensure_baseline_pinned}
...
### <kbd>method</kbd> `validate_and_setup_columns` {#method-validate_and_setup_columns}
...
### <kbd>プロパティ</kbd> auto_generate_panels {#property-auto_generate_panels}
...
### <kbd>method</kbd> `save_as_new_view` {#method-save_as_new_view}
