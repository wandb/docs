...
| Data Type | 説明 |
|-----------|-------------|
| [`Image`](/ja/models/ref/python/data-types/image) | マスク、バウンディングボックス、セグメンテーションをサポートする画像を ログ します。 |
| [`Video`](/ja/models/ref/python/data-types/video) | モデル の出力や データセット サンプルのビデオデータをトラックします。 |
| [`Audio`](/ja/models/ref/python/data-types/audio) | オーディオ プロセッシング タスク用のオーディオサンプルを ログ します。 |
| [`Table`](/ja/models/ref/python/data-types/table) | 混合メディアタイプを含めることができる テーブル を作成します。 |
| [`Plotly`](/ja/models/ref/python/data-types/plotly) | Data Visualization のための Plotly チャートを ログ します。 |
| [`Html`](/ja/models/ref/python/data-types/html) | カスタム HTML コンテンツを埋め込みます。 |
| [`Object3D`](/ja/models/ref/python/data-types/object3d) | 3D ポイントクラウドやメッシュを可視化します。 |
| [`Molecule`](/ja/models/ref/python/data-types/molecule) | 計算化学用の分子構造を ログ します。 |
