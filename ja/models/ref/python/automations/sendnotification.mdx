...
## <Badge color="yellow" size="lg" shape="rounded">クラス</Badge> wandb.automations.SendNotification {#class-wandbautomationssendnotification}
...
### <Badge color="blue" size="lg" shape="rounded">メソッド</Badge> SendNotification.from_integration() {#method-sendnotificationfrom_integration}
