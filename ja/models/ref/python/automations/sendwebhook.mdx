...
## <Badge color="yellow" size="lg" shape="rounded">クラス</Badge> wandb.automations.SendWebhook {#class-wandbautomationssendwebhook}
...
### <Badge color="blue" size="lg" shape="rounded">メソッド</Badge> SendWebhook.from_integration() {#method-sendwebhookfrom_integration}
