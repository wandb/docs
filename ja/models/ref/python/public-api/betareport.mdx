...
## <Badge color="yellow" size="lg" shape="rounded">クラス</Badge> wandb.apis.public.BetaReport {#class-wandbapispublicbetareport}
...
### <Badge color="blue" size="lg" shape="rounded">メソッド</Badge> BetaReport.runs() {#method-betareportruns}
...
### <Badge color="blue" size="lg" shape="rounded">メソッド</Badge> BetaReport.to_html() {#method-betareportto_html}
