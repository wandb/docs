...
### 名とエイリアスで Artifact をダウンロードする {#download-an-artifact-by-name-and-alias}
...
### RegistryからArtifactをダウンロードする {#download-an-artifact-from-a-registry}
...
### W&amp;B Registry をクエリする {#query-wb-registry}
