...
`wandb_workspaces` からアクセスできる W&B Reports および Workspaces API を使用すると、 学び を Web 上で共有するための [Reports](/ja/models/reports/) を作成したり、 トレーニング や ファインチューニング を行った [Workspace](/ja/models/app/features/cascade-settings/) をカスタマイズしたりできます。
