...
[number](/ja/models/ref/query-panel/number/) を別の値で割り、剰余を返します

| 인수    | 説明                                             |
| :---- | :--------------------------------------------- |
| `lhs` | 割られる [number](/ja/models/ref/query-panel/number/) |
| `rhs` | [number](/ja/models/ref/query-panel/number/) を割る値 |
...
[number](/ja/models/ref/query-panel/number/) が別の number より小さいかどうかを確認します
...
[number](/ja/models/ref/query-panel/number/) のべき乗を計算します
...
基数となる [number](/ja/models/ref/query-panel/number/) を n 乗した値
...
[number](/ja/models/ref/query-panel/number/) が別のnumberより小さいかどうかを確認します
...
| 인수        | 説明                                                                                                                |
| :-------- | :---------------------------------------------------------------------------------------------------------------- |
| `numbers` | 最大の[number](/ja/models/ref/query-panel/number/)のインデックスを求める対象の[number](/ja/models/ref/query-panel/number/)の&#95;リスト&#95; |
...
| 인수        | 説明                                                        |
| :-------- | :-------------------------------------------------------- |
| `numbers` | 平均を計算する [number](/ja/models/ref/query-panel/number/) の *リスト* |
...
| 인수        | 説明                                                                                                       |
| :-------- | :------------------------------------------------------------------------------------------------------- |
| `numbers` | 最大の [number](/ja/models/ref/query-panel/number/) を求める対象の [number](/ja/models/ref/query-panel/number/) の *list* |
