...
| コマンド | 説明 |
| :--- | :--- |
| [create](/ja/models/ref/cli/wandb-job/wandb-job-create) | wandb run を介さずに、ソースから Job を作成します。 |
| [describe](/ja/models/ref/cli/wandb-job/wandb-job-describe) | Launch Job の詳細を表示します。 |
| [list](/ja/models/ref/cli/wandb-job/wandb-job-list) | プロジェクト 内の Job を一覧表示します。 |