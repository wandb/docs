...
Artifacts の詳細については、開発者ガイドの [Artifacts チャプター](/ja/models/artifacts/) を参照してください。

### テーブルの可視化

この方法でログに記録されたテーブルは、Run ページと Project ページの両方の Workspace に表示されます。詳細については、[テーブルの可視化と分析](/ja/models/tables/visualize-tables/) を参照してください。
