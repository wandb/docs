...
### モデル評価用チャート {#model-evaluation-charts}
...
### インタラクティブなカスタムチャート {#interactive-custom-charts}
...
### Matplotlib と Plotly のプロット {#matplotlib-and-plotly-plots}
...
### カスタムHTMLをW&amp;B Tablesにログする {#log-custom-html-to-wb-tables}

W&amp;Bでは、Plotly と Bokeh のインタラクティブなチャートを HTML としてログし、Tables に追加できます。

#### Plotly の figure を HTML として Tables にログする {#log-plotly-figures-to-tables-as-html}
...
#### Bokeh の図を HTML として Tables にログする {#log-bokeh-figures-to-tables-as-html}
