...
* **Saved views:** Saved views は Workspace の共同作業用スナップショットです。チーム内の誰でも、saved Workspace ビュー を閲覧、編集、および変更の保存ができます。Saved Workspace ビュー を使うと、experiments や runs などをレビューして議論できます。
