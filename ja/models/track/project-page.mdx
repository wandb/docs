...
<Note>
各プロジェクトには、その公開範囲を決定する公開設定があります。公開範囲についての詳細は、[プロジェクトの公開範囲](/ja/platform/hosting/iam/access-management/restricted-projects)を参照してください。
</Note>

各プロジェクトには、サイドバーからアクセスできる次の項目が含まれています:

* [**Overview**](/ja/models/track/project-page/#overview-tab): プロジェクトのスナップショット
* [**Workspace**](/ja/models/track/project-page/#workspace-tab): 個人の可視化サンドボックス
* [**Runs**](#runs-tab): プロジェクト内のすべての run を一覧表示するテーブル
* **Automations**: プロジェクトで設定されたオートメーション
* [**Sweeps**](/ja/models/track/project-page/#sweeps-tab): 自動探索と最適化
* [**Reports**](/ja/models/track/project-page/#reports-tab): メモ、run、およびグラフの保存されたスナップショット
...
* **Project visibility**: プロジェクトの公開範囲。それにアクセスできる人を決定する公開設定です。詳細は[プロジェクトの公開範囲](/ja/platform/hosting/iam/access-management/restricted-projects)を参照してください。
...
[スイープ](/ja/models/sweeps/)をプロジェクトから新たに開始します。
...
プロジェクトに関連付けられたすべての[Artifacts](/ja/models/track/project-page/#artifacts-tab)をトレーニングデータセットや [ファインチューンされたモデル](/ja/models/core/registry/)から[メトリクスやメディアのテーブル](/ja/models/tables/tables-walkthrough/)まで表示します。
...
Artifacts に関連付けられた[テーブル](/ja/models/tables/tables-walkthrough/)は、このコンテキストでは特にリッチでインタラクティブです。Artifacts で Tables を使用する方法についての詳細は[こちら](/ja/models/tables/visualize-tables/)から学べます。
