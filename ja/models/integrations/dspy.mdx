...
W&B を DSPy と組み合わせて使用することで、言語モデルプログラムの追跡と最適化が可能になります。W&B は [Weave DSPy integration](/ja/weave/guides/integrations/dspy) を補完し、以下の機能を提供します。
...
1. `WANDB_API_KEY` [環境変数](/ja/models/track/environment-variables/)を設定してログインします：
...
W&B を初めて使用される方は、[クイックスタートガイド](/ja/models/quickstart/)をご覧ください。
...
DSPy を使用した Weave のトレース、評価、最適化に関する詳細については、[Weave DSPy integration guide](/ja/weave/guides/integrations/dspy) を参照してください。
...
詳細は [W&B Tables ガイド](/ja/models/tables/visualize-tables/) および [Tables チュートリアル](/ja/models/tutorials/tables) をご覧ください。
