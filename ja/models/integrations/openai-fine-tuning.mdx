...
## OpenAI Python API をインストールまたは更新する {#install-or-update-openai-python-api}
...
## OpenAI のファインチューニング結果を同期する {#sync-your-openai-fine-tuning-results}
...
### ファインチューニングを同期する {#sync-your-fine-tunes}
...
## データセットのバージョン管理と可視化 {#dataset-versioning-and-visualization}
...
## ファインチューニングしたモデルとモデルのバージョン管理 {#the-fine-tuned-model-and-model-versioning}
...
### チームでファインチューニング結果を共有する {#share-fine-tune-results-with-your-team}
...
### ファインチューニングしたモデルにアクセスする {#access-your-fine-tuned-model}
...
### Sync されなかったファインチューニングを復元する {#recover-a-fine-tune-that-didnt-sync}
...
### W&amp;B でデータセットとモデルをトラッキングする {#track-datasets-and-models-with-wb}
