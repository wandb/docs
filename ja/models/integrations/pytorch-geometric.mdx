...
APIキー は、マシンを W&amp;B に対して認証するためのものです。APIキー はユーザープロファイルから生成できます。
...
<Tabs>
  <Tab title="Command Line">
    1. `WANDB_API_KEY` [environment variable](/ja/models/track/environment-variables/) 環境変数に APIキー を設定します。
