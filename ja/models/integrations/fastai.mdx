...
1. `WANDB_API_KEY` [環境変数](/ja/models/track/environment-variables/) を API キーに設定します。
...
<Note>
Fastai のバージョン1を使用している場合は、 [Fastai v1 ドキュメント](/ja/models/integrations/fastai/v1/) を参照してください。
</Note>
