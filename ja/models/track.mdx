---
description: "W&B で機械学習 Experiments を記録・追跡し、メトリクス、ハイパーパラメーター、システム メトリクス、モデル アーティファクトをログします。"
...
Experiments とロギングに関するベストプラクティスとヒントについては、[ベストプラクティス: Experiments とロギング](https://wandb.ai/wandb/pytorch-lightning-e2e/reports/W-B-Best-Practices-Guide--VmlldzozNTU1ODY1#w\&b-experiments-and-logging) を参照してください。