...
W&B SDK の内部動作の詳細については、次のページを参照してください。

- [SDK Architecture](/models/track/sdk-architecture/) — イベント駆動型アーキテクチャとデータフロー
- [SDK Performance](/models/track/sdk-performance/) — パフォーマンスのガイドライン、GPU/CPU の同期、ベストプラクティス