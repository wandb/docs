...
Serverless RL の推論リクエストの料金は、W&B Inference の料金に準じます。詳細は [モデルごとのコスト](https://site.wandb.ai/pricing/reinforcement-learning) を参照してください。クレジットの購入、アカウントティア、および使用制限の詳細については、[W&B Inference ドキュメント](/ja/inference/usage-limits#purchase-more-credits) をご覧ください。
