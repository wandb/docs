...
Serverless SFT の利用を開始するには、まず W&amp;B ツールを使用するための[前提条件](/ja/training/prerequisites)を満たし、その後 ART の [Serverless SFT ドキュメント](https://art.openpipe.ai/fundamentals/sft-training)に従ってください。
