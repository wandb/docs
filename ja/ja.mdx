...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    >
        ...
        <br/>
        <br/>
        • <a href="/ja/inference/">イントロダクション</a><br/>
        • <a href="/ja/inference/models/">利用可能なモデル</a><br/>
        • <a href="/ja/inference/api-reference/">API リファレンス</a><br/>
    ...
    >
        ...
        <br/>
        <br/>
        • <a href="/ja/training/">イントロダクション</a><br/>
        • <a href="/ja/training/prerequisites/">前提条件</a><br/>
        • <a href="/ja/training/serverless-rl/">サーバーレス RL</a><br/>
        • <a href="/ja/training/api-reference/">API リファレンス</a>
    </ProductCard>
</div>
</HomeWrapper>
</HomeWrapper>
