...
## `weave.Model` の使用 {#use-weavemodel}
...
## ログした `weave.Model` をエクスポートして再利用する {#export-and-reuse-a-logged-weavemodel}
...
### モデル ref を取得する {#get-the-model-ref}

Weave UI では、特定のバージョンの モデル ref を取得できます。

### モデル を使用する {#use-the-model}
