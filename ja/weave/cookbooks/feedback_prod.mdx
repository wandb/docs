    ...
    if prompt := st.chat_input("Ask me anything!"):
        ...
        with st.chat_message("assistant"):
            ...
            with weave.attributes(
                ...
                # 特定のレスポンスにフィードバックを紐付けるために weave の呼び出しオブジェクトを保存する
...
関連付けられたフィードバックを確認するには、Weave UI にアクセスしてください。
...
このチュートリアルでは、入出力を Weave で記録し、ユーザー フィードバックを収集するための 👍👎 ボタンを備えた Streamlit のチャット UI を構築しました。