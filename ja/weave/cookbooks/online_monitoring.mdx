...
## Weave で統合する: 本番ダッシュボード {#integrate-with-weave-production-dashboard}
...
### Weave クライアントを初期化してコストを定義する {#initialize-the-weave-client-and-define-costs}
...
### Weave から Call データを取得する {#fetch-calls-data-from-weave}
...
#### データを Call ごとに取得する {#fetch-data-call-by-call}
...
#### 高レベル API の使用 {#use-high-level-apis}
...
### 入力データを集約して可視化を生成する {#gather-inputs-and-generate-visualizations}
