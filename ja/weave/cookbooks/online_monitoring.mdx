...
* `filter` dictionary: この辞書には、calls データを取得するためのフィルターパラメーターが含まれます。詳しくは[こちら](/ja/weave/reference/python-sdk/trace_server/trace_server_interface#class-callschema)を参照してください。
