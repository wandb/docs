...
keywords: ["トークン使用量", "add_cost", "llm_id", "include_costs"]
---
...
## カスタムコストモデルを設定する {#set-up-a-custom-cost-model}
...
### Weave でモデルを設定する {#set-up-a-model-with-weave}
...
### カスタムコストを追加する {#add-a-custom-cost}
