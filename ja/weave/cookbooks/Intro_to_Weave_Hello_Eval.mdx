...
description: "W&B Weave を使って Evaluations の概要を学びます"
---
...
1. W&amp;B Weave SDK をインストールし、[APIキー](https://wandb.ai/settings#apikeys) を使ってログインします。
2. OpenAI SDK をインストールし、[APIキー](https://platform.openai.com/api-keys) を使ってログインします。
3. W&amp;B プロジェクトを初期化します。
...
* エンドツーエンドの[評価パイプラインを構築する方法](/ja/weave/tutorial-eval)を学びましょう。
