...
## オーディオのストリーミングと保存の例 {#audio-streaming-and-storage-example}
...
## 高度な使い方: Weave での Realtime API {#advanced-usage-realtime-api-with-weave}
...
## マイクの設定 {#microphone-configuration}
...
## OpenAI Realtime API スキーマの実装 {#openai-realtime-api-schema-implementation}
...
### OpenAI Realtime API 用の Pydantic スキーマ {#pydantic-schema-for-the-openai-realtime-api}
...
## オーディオストリームライター (ディスクおよびメモリ内に書き込み) {#audio-stream-writer-to-disk-and-in-memory}
...
## Realtime audio model {#realtime-audio-model}
