...
<img src="/images/weave/cookbooks/openai-chat-completions-audio.png" alt="GPT 4o Audio Preview インテグレーションと音声応答生成ワークフローを備えた OpenAI chat completions API インターフェース" />
