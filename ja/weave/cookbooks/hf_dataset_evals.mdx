...
## HuggingFace データセットを読み込んで準備する {#load-and-prepare-huggingface-dataset}
...
## 処理関数と評価関数を定義する {#define-processing-and-evaluation-functions}
...
## 評価を作成して実行します {#create-and-run-the-evaluation}
