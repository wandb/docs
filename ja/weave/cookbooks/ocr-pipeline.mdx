...
## Weave でプロンプトを作成して改善する {#create-and-iterate-on-prompts-with-weave}
...
## NER パイプラインを構築する {#build-the-ner-pipeline}
...
## Weave を使ってパイプラインを評価する {#evaluate-the-pipeline-using-weave}
...
### プログラムによる Scorer {#programatic-scorer}
