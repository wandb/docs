...
## 依存関係のインストール {#install-the-dependencies}
...
## Weave でマルチエージェントのトラッキングを有効にする {#enable-multi-agent-tracking-with-weave}
...
## マルチエージェントシステムを実行し、Weaveで可視化する {#execute-the-multi-agent-system-and-visualize-in-weave}
