...
Weave、Groq、E2B を使ったコード生成パイプラインを視覚的に確認するには、次のビデオをご覧ください:

<iframe width="560" height="315" src="https://www.youtube.com/embed/B70jJYPVAzE?si=75Z4Fg_DBxAiu9_6&amp" title="YouTube 動画プレーヤー" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />

このビデオでは、プロセスをステップごとに解説し、Weave が Groq と連携して強力なコード生成ツールを構築し、その後コードを E2B 上で実行して検証する様子を紹介します。以下の例では OpenAI を使用していますが、Weave では任意の LLM プロバイダーを組み合わせて使用できます。
