...
## structured outputs と Pydantic モデル {#structured-outputs-and-pydantic-models}
...
## コードフォーマッターを実装する {#implement-a-code-formatter}
...
## `CodeGenerationPipeline` を定義する {#define-the-codegenerationpipeline}
...
## 評価メトリクスを実装する {#implement-evaluation-metrics}
...
## Weave データセットを作成して評価を実行する {#create-a-weave-dataset-and-run-evaluation}
