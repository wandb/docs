...
<Frame>
  ![Chain of Density の要約パイプラインの実行を示す Weave trace visualization](/media/summarization/summarization_trace.png)
</Frame>
...
<Frame>
  ![データセットの選択と設定オプションを備えた、評価用 Weave データセットの設定インターフェース](/media/summarization/dataset.png)
</Frame>
...
<Frame>
  ![Chain of Density の要約結果、メトリクス、パフォーマンス比較を示す Weave 評価ダッシュボード](/media/summarization/eval_dash.png)
</Frame>
