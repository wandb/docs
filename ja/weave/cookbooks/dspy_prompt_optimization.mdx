...
## 依存ライブラリのインストール {#install-the-dependencies}
...
## Weave を使ってトラッキングを有効にする {#enable-tracking-using-weave}
...
## BIG-Bench Hardデータセットを読み込む {#load-the-big-bench-hard-dataset}
...
### 因果推論シグネチャを作成する {#write-the-causal-reasoning-signature}
...
## DSPy プログラムを評価する {#evaluate-the-dspy-program}
...
## DSPy プログラムを最適化する {#optimize-the-dspy-program}
