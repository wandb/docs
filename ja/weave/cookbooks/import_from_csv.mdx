...
## サードパーティシステムからトレースをインポート {#import-traces-from-third-party-systems}
...
## 環境を設定する {#set-up-the-environment}
...
## トレースを Weave にログする {#log-the-traces-to-weave}
...
## 結果: Weave にログされたトレース {#result-traces-logged-to-weave}
...
## オプション: トレースをエクスポートして評価を実行する {#optional-export-your-traces-to-run-evaluations}
