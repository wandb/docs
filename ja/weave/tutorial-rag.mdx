...
<div id="build-a-knowledge-base">
  ## ナレッジベースを構築する {#build-a-knowledge-base}
</div>
...
<div id="evaluate-with-an-llm-judge">
  ## LLM judge を用いた評価 {#evaluate-with-an-llm-judge}
</div>
...
<div id="define-a-scoring-function">
  ### スコアリング関数を定義する {#define-a-scoring-function}
</div>
...
<div id="optional-define-a-scorer-class">
  ### 任意: `Scorer` クラスを定義する {#optional-define-a-scorer-class}
</div>
