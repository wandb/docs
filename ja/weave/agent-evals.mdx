...
## エージェントを構築してトレースする {#build-and-trace-the-agent}
...
## LLM judge でエージェントをスコアリングする {#score-the-agent-with-an-llm-judge}
...
## 評価を整理して比較する {#organize-and-compare-evaluations}
...
## マルチターンの会話をスコアリングする {#score-a-multi-turn-conversation}
...
## Scorer を拡張する {#extend-your-scorers}
