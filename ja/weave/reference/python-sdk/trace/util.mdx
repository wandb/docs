...
### <kbd>関数</kbd> `deprecated` {#function-deprecated}
...
### <kbd>関数</kbd> `is_colab` {#function-is_colab}
...
### <kbd>関数</kbd> `is_notebook` {#function-is_notebook}
...
### <kbd>関数</kbd> `log_once` {#function-log_once}
