...
## <kbd>クラス</kbd> `RemoteHTTPTraceServer` {#class-remotehttptraceserver}
...
### <kbd>method</kbd> `ensure_project_exists` {#method-ensure_project_exists}
...
時系列の集計スコアを取得するには、フィードバック表をクエリします。
...
### <kbd>クラスメソッド</kbd> `from_env` {#classmethod-from_env}
...
### <kbd>method</kbd> `get_call_processor` {#method-get_call_processor}
...
### <kbd>method</kbd> `get_feedback_processor` {#method-get_feedback_processor}
...
### <kbd>method</kbd> `post` {#method-post}
...
### <kbd>method</kbd> `projects_info` {#method-projects_info}
...
### <kbd>method</kbd> `server_info` {#method-server_info}
...
### <kbd>method</kbd> `set_auth` {#method-set_auth}
