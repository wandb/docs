...
* **[POST `/call/read`](https://docs.wandb.ai/weave/reference/service-api/calls/call-read)** - Call読み取り
...
* **[POST `/call/upsert_batch`](https://docs.wandb.ai/weave/reference/service-api/calls/call-start-batch)** - Call一括開始
...
* **[POST `/calls/stats`](https://docs.wandb.ai/weave/reference/service-api/calls/call-stats)** - Call統計
...
* **[POST `/v2/{entity}/{project}/calls/complete`](https://docs.wandb.ai/weave/reference/service-api/calls/calls-complete)** - Call完了
...
* **[POST `/feedback/aggregate`](https://docs.wandb.ai/weave/reference/service-api/feedback/feedback-aggregate)** - フィードバックの集計
...
* **[GET `/inference/modelsdev/models`](https://docs.wandb.ai/weave/reference/service-api/inference/inference-modelsdev-models)** - Inference Modelsdev モデル
...
* **[POST `/agents/agent-versions/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-agent-versions-query)** - GenAI エージェントのバージョンをクエリ
...
* **[POST `/agents/conversations/spans`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-conversation-spans)** - GenAI 会話スパン
* **[POST `/agents/otel/v1/traces`](https://docs.wandb.ai/weave/reference/service-api/agents/export-genai-trace)** - GenAI トレースをエクスポート
* **[POST `/agents/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-agents-query)** - GenAI エージェントをクエリ
...
* **[POST `/agents/spans/query`](https://docs.wandb.ai/weave/reference/service-api/agents/genai-spans-query)** - GenAI スパンをクエリ
