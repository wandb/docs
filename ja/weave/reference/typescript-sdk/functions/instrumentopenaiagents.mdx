...
description: "OpenAI Agents SDK にパッチを適用してトレースを Weave に送信する instrumentOpenAIAgents のリファレンス"
---
...
// OpenAI Agents はフック経由でインストルメントされているため、手動での setup は不要です
...
[integrations/openai.agent.ts:727](https://github.com/wandb/weave/blob/a383d080ca97801c327ddeac4a2fc17875cabe2f/sdks/node/src/integrations/openai.agent.ts#L727)
