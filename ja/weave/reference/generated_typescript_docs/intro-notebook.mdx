...
# TypeScript で始める Weave クイックスタートガイド {#weave-with-typescript-quickstart-guide}
...
## OpenAI インテグレーション {#openai-integration}
...
## ネストした関数のトラッキング {#nested-function-tracking}
