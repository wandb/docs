...
## Weave ガードレールの仕組み {#how-weave-guardrails-work}
...
### Weave ガードレールのパフォーマンスを最適化する {#optimize-your-weave-guardrail-performance}
...
## 例: 組み込みの モデレーション Scorer を使用してガードレールを作成する {#example-create-a-guardrail-using-a-built-in-moderation-scorer}
...
## 例: カスタム Scorer を使用してガードレールを作成する {#example-create-a-guardrail-using-a-custom-scorer}
...
## Weave を AWS Bedrock Guardrails と統合する {#integrate-weave-with-aws-bedrock-guardrails}
