...
<Frame>
![ADK エージェントのトレース可視化](./imgs/google_adk/adk_agent_trace.png)
</Frame>
...
<Frame>
![ADK ツール呼び出しのトレース可視化](./imgs/google_adk/adk_tool_calls.png)
</Frame>
...
<Frame>
![Sequential ワークフローエージェントのトレース可視化](./imgs/google_adk/adk_workflow_trace.png)
</Frame>
