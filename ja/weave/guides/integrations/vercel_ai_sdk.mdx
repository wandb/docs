...
## Next.js 向けに OTel トレースを設定する {#configure-otel-tracing-for-nextjs}
...
### インストルメンテーションを設定する {#configure-instrumentation}
...
### 関数のテレメトリーを設定する {#configure-telemetry-on-a-function}
...
## Node.js 用に OTel トレースを設定する {#configure-otel-tracing-for-nodejs}
