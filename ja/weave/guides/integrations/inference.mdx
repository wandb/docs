---
title: W&B Inference
description: "Weave と組み合わせて W&B Inference を使用し、OpenAI 互換 API を通じてオープンソースの基盤モデルの呼び出しをトレースおよび監視します。"
---
...
<Warning>
  このエンドポイントにアクセスするには、Inference サービスクレジットが割り当てられている W&amp;B アカウント、有効な W&amp;B API キー、そして W&amp;B entity（「team」とも呼ばれます）と プロジェクトが必要です。このガイドのコードサンプルでは、entity（team）と プロジェクトは `<your-team>\<your-project>` と表記されています。
</Warning>
