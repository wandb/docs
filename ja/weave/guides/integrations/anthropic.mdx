...
Weave の ops は、実験を行う際のコードに自動的にバージョンを付け、その入力と出力をキャプチャします。[`@weave.op()`](/ja/weave/guides/tracking/ops) (Python) で関数をデコレートするか、[`weave.op()`](/ja/weave/reference/typescript-sdk/functions/op) (TypeScript) でラップして [`Anthropic.messages.create`](https://platform.claude.com/docs/en/build-with-claude/working-with-messages) を呼び出すと、Weave が入力と出力を自動的に追跡します。
...
[![anthropic\_ops.png](/weave/guides/integrations/imgs/anthropic_ops.png)](/ja/weave/guides/tracking/ops)
