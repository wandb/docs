---
title: Groq
description: "Weave で Groq LPU 推論をトラッキングおよびモニタリングし、LLM アプリケーション向けにモデル呼び出し、パフォーマンス メトリクス、関数チェーンを記録します。"
---
...
任意の `weave.Model` オブジェクトへの weave リファレンスがあれば、FastAPI サーバーを起動して、そのモデルを [serve](/ja/weave/guides/tools/serve) できます。
