...
<Frame>![シンプルなPydanticAIエージェントのトレースの可視化](/weave/guides/integrations/imgs/pydantic_ai/pydanticai_agent_trace.png)</Frame>
...
<Frame>![ツール call のトレース可視化](/weave/guides/integrations/imgs/pydantic_ai/pydanticai_tool_call.png)</Frame>
