...
### Weave で Azure AI Model Inference API を使用する {#use-the-azure-ai-model-inference-api-with-weave}
...
### Weave で Azure OpenAI モデルをトレースする {#trace-azure-openai-models-with-weave}
