...
### 任意: 明示的なパッチ適用 {#optional-explicit-patching}
...
## ストリーミングのサポート {#streaming-support}
...
## 関数Callのトレース {#tracing-function-calls}
...
## カスタム関数のトレース {#tracing-custom-functions}
