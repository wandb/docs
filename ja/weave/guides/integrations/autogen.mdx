...
<div id="traces-for-a-client-create-call-with-streaming">
...
<div id="traces-for-cached-client-calls">
...
<div id="traces-for-an-agent-with-tool-calls">
...
<div id="traces-for-a-round-robin-groupchat">
...
<div id="traces-for-rag-workflows">
  ## RAG ワークフローのトレース
</div>
...
<div id="traces-for-agent-runtimes">
  ## エージェントランタイムのトレース
</div>
...
<div id="traces-for-sequential-workflows">
  ## 逐次ワークフローのトレース
</div>
...
<div id="traces-for-code-executors">
  ## コードエグゼキュータのトレース
</div>
