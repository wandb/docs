---
title: Instructor
description: "Weave の Instructor インテグレーションを使用して、LLM からの構造化データ抽出をトレースします。Pydantic の検証とリトライ ロジックを記録します。"
---
...
`weave.Model` オブジェクトへの weave リファレンスがあれば、FastAPI サーバーを立ち上げて、それを [`serve`](/ja/weave/guides/tools/serve) できます。
