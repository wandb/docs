...
keywords: [Hugging Face Hub, InferenceClient, huggingface_hub, LLM トレース, モデル実験]
---
...
## 実験には `Model` を使用する {#use-models-for-experimentation}
...
<Frame>
  ![Weave はモデルを自動的にログし、各バージョンをトラッキングするため、パフォーマンスや実験履歴を分析できます。](/weave/guides/integrations/imgs/huggingface/trace_model.png)
</Frame>