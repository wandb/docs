...
2. [LMStudio](https://lmstudio.ai/) - Local Server による OpenAI SDK サポート [docs](https://lmstudio.ai/docs/local-server)
3. [Ollama](https://ollama.com/) - OpenAI SDK 向けの[実験的サポート](https://github.com/ollama/ollama/blob/main/docs/openai.mdx)
