...
keywords: ["プロンプト", "プロンプトのバージョン", "プロンプトのタグ", "プロンプトのエイリアス", "タグ", "エイリアス","プロンプトのバージョン管理"]
---
...
## プロンプトのバージョンがどのように作成されるか {#how-prompt-versions-are-created}
...
## 完全修飾された ref URI を作成する {#construct-a-fully-qualified-ref-uri}
...
## コードでプロンプトのバージョンを取得する {#retrieve-a-prompt-version-in-code}
...
## 本番環境でプロンプトを使用する {#use-prompts-in-production}
...
## <a id="view-prompts" aria-label="プロンプトのバージョンを表示して比較する" />プロンプトのバージョンを表示して比較する {#view-and-compare-prompt-versions}
...
## プロンプトのタグとエイリアスを追加する {#add-prompt-tags-and-aliases}
...
### コードでタグとエイリアスを変更する {#modify-tags-and-aliases-in-code}
