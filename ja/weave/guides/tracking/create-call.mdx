...
<Tabs>
  ...
  <Tab title="HTTP API">
    * Call を開始: [POST `/call/start`](https://docs.wandb.ai/ja/weave/reference/service-api/calls/call-start)。
    * Call を終了: [POST `/call/end`](https://docs.wandb.ai/ja/weave/reference/service-api/calls/call-end)。
