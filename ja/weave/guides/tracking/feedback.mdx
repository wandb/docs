...
<Warning>フィードバックノートの最大文字数は 1024 文字です。この上限を超えるノートは作成されません。</Warning>
...
<Frame>![Human Annotation スコアラーの履歴](/weave/guides/tracking/imgs/human-annotation-scorer-history.png)</Frame>
