...
### Call details パネルを使用する {#use-the-call-details-panel}
...
### フィードバックアイコンを使用する {#use-the-feedback-icons}
...
## SDK を使用してフィードバックを送信する {#provide-feedback-through-the-sdk}
...
### Weave プロジェクトのフィードバックをクエリする {#query-a-projects-feedback}
...
### Call にフィードバックを追加する {#add-feedback-to-a-call}
...
### Call からフィードバックを削除する {#delete-feedback-from-a-call}
...
### UI で Human Annotation スコアラーを作成する {#create-a-human-annotation-scorer-in-the-ui}
...
### UI で Human Annotation スコアラーを使用する {#use-the-human-annotation-scorer-in-the-ui}
...
### API を使用して Human Annotation スコアラーを作成する {#create-a-human-annotation-scorer-using-the-api}
...
### API を使用して Human Annotation スコアラーを更新する {#modify-a-human-annotation-scorer-using-the-api}
...
### API を使用して Human Annotation スコアラーを利用する {#use-a-human-annotation-scorer-using-the-api}
