...
keywords: ["トレースのエクスポート", "stream_query", "Call メトリクス", "Calls 統計", "トレースのエクスポート"]
---
...
## Weave UI から Calls をエクスポートする {#export-calls-from-the-weave-ui}
...
## プログラムから Calls を取得する {#fetch-calls-programmatically}
...
<Tabs>
  ...
  <Tab title="TypeScript">
    TypeScript API を使用して Calls を取得するには、[`client.getCalls`](/ja/weave/reference/typescript-sdk/interfaces/weaveclient#getcalls) メソッドを使用します。
...
## Call メトリクスをエクスポートする {#export-call-metrics}
