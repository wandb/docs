...
| 会話           | `Conversation` | *(no スパン, turns are grouped by the `conversation_id` 属性)* | 1 つ以上のターンを含む会話または run                               | [Python](/ja/weave/reference/python-sdk#class-conversation) <br /> [TypeScript](/ja/weave/reference/typescript-sdk/classes/conversation) |
