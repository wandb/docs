...
<div id="end-to-end-workflow">
  ## エンドツーエンドのワークフロー {#end-to-end-workflow}
</div>
...
<div id="define-annotation-fields">
  ## アノテーションフィールドを定義する {#define-annotation-fields}
</div>
...
<div id="create-an-annotation-queue">
  ## アノテーションキューを作成する {#create-an-annotation-queue}
</div>
...
<div id="add-traces-to-a-queue">
  ### キューにトレースを追加する {#add-traces-to-a-queue}
</div>
...
<div id="monitor-review-progress">
  ## レビューの進捗を確認する {#monitor-review-progress}
</div>
...
<div id="filter-and-export-annotations">
  ## アノテーションのフィルタリングとエクスポート {#filter-and-export-annotations}
</div>
...
<div id="filter-annotated-traces">
  ### 注釈付きトレースをフィルターする {#filter-annotated-traces}
</div>
...
<div id="export-annotated-traces-to-datasets">
  ### 注釈付きトレースをデータセットにエクスポートする {#export-annotated-traces-to-datasets}
</div>

データの使用目的に応じて、注釈付きトレースは UI またはプログラムからエクスポートできます。

<div id="add-annotated-traces-to-a-dataset">
  #### 注釈付きトレースをデータセットに追加する {#add-annotated-traces-to-a-dataset}
</div>
...
## プログラムからアノテーションにアクセスする {#access-annotations-programmatically}
