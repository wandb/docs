...
keywords: ["ジェネレーター関数", "async ジェネレーター", "ストリーミング トレース", "アキュムレーター", "weave.op"]
---
...
## ジェネレーターを消費する {#consume-generators}
...
## yield された値を 1 つのトレースに集約する {#accumulate-yielded-values-into-a-single-trace}
