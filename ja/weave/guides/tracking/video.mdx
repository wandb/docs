...
## 使用するための前提条件 {#usage-prerequisites}
...
## サポートされている動画タイプ {#supported-video-types}
...
### ファイルベースのクリップの直接アップロード {#direct-upload-of-file-based-clips}
...
### インメモリクリップのサポート {#in-memory-clip-support}
...
## 例: 動画関数をトレースする {#example-trace-a-video-function}
