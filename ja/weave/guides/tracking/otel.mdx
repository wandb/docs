...
この例では、OpenAI のインストルメンテーションの使い方を示します。利用できるものは他にも多数あり、[公式リポジトリ](https://github.com/Arize-ai/openinference)で確認できます。
...
以下の例では、OpenAI インストルメンテーションの使い方を示します。その他の例は [OpenLLMetry リポジトリ](https://github.com/traceloop/openllmetry) を参照してください。
