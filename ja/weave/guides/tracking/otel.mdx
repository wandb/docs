...
特定の属性をスパンに追加することで、OpenTelemetry トレースを [Weave のスレッド](/ja/weave/guides/tracking/threads) に整理できます。その後、Weave のスレッド UI を使用して、マルチターンの会話やユーザーセッションなどの関連する操作を分析できます。
