...
<Tip>
詳細なリファレンスアーキテクチャーについては、 [W&B Self-Managed Reference Architecture](/ja/guides/hosting/self-managed/ref-arch/#models-and-weave) を参照してください。
</Tip>
...
- **W&B プラットフォーム**: すでにインストールされ実行されていること（ [W&B Self-Managed Deployment Guide](/ja/guides/hosting/hosting-options/self-managed/) を参照）
