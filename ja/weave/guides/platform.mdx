...
* **[W&amp;B Multi-tenant Cloud](/ja/platform/hosting/hosting-options/multi_tenant_cloud):** 北米リージョンにある W&amp;B の Google Cloud Platform (Google Cloud) アカウントにデプロイされた、マルチテナント型の完全マネージドプラットフォームです。
* **[W&amp;B Dedicated Cloud](/ja/platform/hosting/hosting-options/dedicated-cloud):** AWS、Google Cloud、Azure で一般提供されている専用クラウドです。
