---
title: "Serve"
description: "Weave の ops とモデルを API エンドポイントとして公開し、予測をサーブし、本番環境で推論を実行できるようにします。"
---
...
そのモデル用の FastAPI サーバーを実行するにはこれを使います。[http://0.0.0.0:9996/docs](http://0.0.0.0:9996/docs) にアクセスして、モデルに対して対話的にクエリを実行できます。
