...
<Frame>
![Playground メッセージボタンのスクリーンショット](/weave/guides/tools/imgs/playground_message_buttons.png)
</Frame>
<Frame>
![Playground 編集のスクリーンショット](/weave/guides/tools/imgs/playground_message_editor.png)
</Frame>
...
<Frame>
![Playground でのモデルの保存](/weave/guides/tools/imgs/saved-model.png)
</Frame>
...
<Frame>
![Saved Models が選択された LLM ドロップダウン](/weave/guides/tools/imgs/saved-models-dropdown.png)
</Frame>
