...
<Columns cols={2}>
  ...
  <Card title="W&B 101 コース" href="https://www.youtube.com/watch?v=UHYU2OZKGJI&list=PLD80i8An1OEEgxMpH-SOdBCjWpT5Io5rJ">
    実験管理に重点を置き、理解度を確認するためのクイズも含まれる動画中心のコースです。
  </Card>

  <Card title="YouTube チュートリアル" href="https://www.youtube.com/@WeightsBiases/courses">
...
<Columns cols={2}>
  ...
  <Card title="YouTube 再生リスト" href="https://www.youtube.com/playlist?list=PLD80i8An1OEFWB5JYk1bnWVPhLRzvNkVx">
