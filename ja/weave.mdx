...
* LLM application の [オブザーブ（観察）とデバッグ](/ja/weave/quickstart)
* LLM 評価モデル（LLM judges）やカスタムスコアラーを使用した、アプリケーションの応答の [評価](/ja/weave/tutorial-eval)
