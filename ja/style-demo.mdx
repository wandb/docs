---
title: "スタイルガイドのデモ"
description: "タイポグラフィ、カラー、バナー、UI コンポーネントの表示例を含むカスタム W&B ブランドスタイルのプレビュー。"
---
...
このページでは、W&amp;B ドキュメント向けに実装されたカスタムブランドスタイルを紹介します。
...
本文テキストは、さまざまなプラットフォームで最適な可読性を確保するため、システムフォントスタックを使用しています。
...
リンクは一貫性を保つために <a href="#">ティール系のカラー</a> を使用します。
...
<div className="help-banner custom-banner">
  <h2>ヘルプ &amp; サポート バナー</h2>
  <p>このバナーは、テキストに影を施したサポートの背景画像を使用しています。</p>
</div>

<div className="card-banner custom-banner">
  <h3>カードバナー</h3>
  <p>情報コンテンツ向けの控えめなグレー背景バナーです。</p>
</div>

<div className="gradient-banner custom-banner">
  <h3>グラデーションバナー</h3>
  <p>目を引く告知にサンセットグラデーションを使用しています。</p>
</div>
...
<div className="hero-gradient">
  ...
  <p>ヒーローセクションや重要なアナウンスメントにサンセットグラデーションを使用しています。</p>
</div>

<div className="card-gradient">
  <h3>控えめなグラデーション付きカード</h3>
  <p>視覚的な魅力を加えつつ圧倒的にならない、カードコンポーネント向けの控えめなグラデーションオーバーレイです。</p>
</div>

<div style={{fontSize: '2rem', fontWeight: 'bold', marginTop: '2rem'}}>
  <span className="text-gradient-wandb">W&amp;B グラデーション文字効果</span>
</div>
...
* カラーは保守しやすいよう CSS 変数として定義しています
* グラデーションはブランドカラーを一貫して使用します
* ホバー効果はインタラクティブなフィードバックを提供します