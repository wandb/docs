...
<Card title="一時的な環境で run データを保持するにはどうすればよいですか？" href="/ja/support/models/articles/how-do-i-preserve-run-data-from-ephemeral-env" arrow="true" horizontal>
  一時的な環境でローカルの run データと診断ログを保持するには、WANDB&#95;DIR を永続ストレージ上のディレクトリに設定し ...
</Card>
