...
<Card title="W&B へのシステムメトリクスの logging を無効にするにはどうすればよいですか？" href="/ja/support/models/articles/how-can-i-disable-logging-of-system-metr" arrow="true" horizontal>
  システムメトリクスの logging を無効にするには、&#95;disable&#95;stats を True に設定します:
</Card>
...
<Card title="削除した Runs を復元するにはどうすればよいですか？" href="/ja/support/models/articles/how-can-i-recover-deleted-runs" arrow="true" horizontal>
  削除した Runs を復元するには、次の step に従う: プロジェクトの Overview ページにアクセスする。th ...
</Card>
...
<Card title="run の logging 時に発生する権限エラーはどうすれば解決できますか？" href="/ja/support/models/articles/how-do-i-resolve-permission-errors-when-" arrow="true" horizontal>
  W&amp;B entity への run の logging 時に発生する権限エラーを解決するには、次の step に従う: entity とプロジェクト名を Verify: En ...
</Card>
...
<Card title="プロジェクトごとにいくつの Runs を作成できますか？" href="/ja/support/models/articles/how-many-runs-can-i-create-per-project" arrow="true" horizontal>
  最適なパフォーマンスを得るには、各プロジェクトの Runs 数をおよそ 10,000 件までに抑えてください。
</Card>
...
<Card title="run をあるプロジェクトから別のプロジェクトに移動できますか？" href="/ja/support/models/articles/is-it-possible-to-move-a-run-from-one-pr" arrow="true" horizontal>
  次の手順に従うことで、run をあるプロジェクトから別のプロジェクトに移動できます。移動する run があるプロジェクトページにアクセスする ...
</Card>
