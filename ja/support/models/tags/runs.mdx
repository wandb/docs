...
<Card title="一時的な環境から run データを保持するにはどうすればよいですか？" href="/ja/support/models/articles/how-do-i-preserve-run-data-from-ephemeral-env" arrow="true" horizontal>
  一時的な環境でローカル run データと診断ログを保持するには、永続ストレージ上のディレクトリに WANDB&#95;DIR を設定します ...
</Card>
