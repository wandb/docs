...
<Card title="Code を保存するにはどうすればよいですか?‌" href="/ja/support/models/articles/how-do-i-save-code" arrow="true" horizontal>
  各 run とともに Code を保存すると、Experiments を再現しやすくなり、どのバージョンのコードが特定の結果を生成したかを追跡できます。 ...
</Card>
