...
## チーム entity でアーティファクトをログする {#log-artifacts-with-a-team-entity}
...
## チーム entity を検索する {#find-your-team-entity}

チーム entity はチーム名と同じです。確認するには、チームの W&amp;B プロフィールページにアクセスしてください。URL は `https://wandb.ai/[TEAM]` の形式で、`[TEAM]` がチーム entity です。

## 個人 entity にログされたアーティファクトを再度ログする {#re-log-artifacts-logged-to-a-personal-entity}
