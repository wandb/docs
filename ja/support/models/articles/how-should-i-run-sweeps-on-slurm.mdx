...
## 単一プロセスまたは単一 GPU ジョブ {#single-process-or-single-gpu-jobs}
...
## 分散トレーニングでのマルチ GPU ジョブ {#multi-gpu-jobs-with-distributed-training}
...
### `SLURM_PROCID` と `SLURM_LOCALID` の使い分け {#choose-between-slurm_procid-and-slurm_localid}
...
### rank 0 以外の rank からログする {#log-from-non-rank-0-ranks}
