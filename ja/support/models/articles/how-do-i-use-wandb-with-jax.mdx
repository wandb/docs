...
## JAX のトレーニングループからメトリクスをログする {#log-metrics-from-a-jax-training-loop}
...
## 検証メトリクスをログする {#log-validation-metrics}
...
## チェックポイントをアーティファクトとして保存する {#save-checkpoints-as-artifacts}
