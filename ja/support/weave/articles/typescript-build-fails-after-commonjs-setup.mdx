...
## `TS1295` および `TS1287`: ECMAScript の import と export は CommonJS ファイルに記述できません {#ts1295-and-ts1287-ecmascript-imports-and-exports-cannot-be-written-in-a-commonjs-file}
