---
title: サンドボックス のライフサイクル
description: Serverless サンドボックス のライフサイクル（状態、状態遷移を待機する方法、サンドボックスを停止する方法など）について説明します。
---

<Warning>
  Serverless Sandboxes は招待制のプライベートプレビューです。利用登録を希望する場合は、[サポート](mailto:support@wandb.com) または担当の AISE にお問い合わせください。
</Warning>
