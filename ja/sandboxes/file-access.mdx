---
title: ファイル操作
description: Serverless Sandboxes でファイルを読み取り、書き込み、マウントする方法を学びます。
---

<Warning>Serverless Sandboxes は招待制のプライベートプレビューです。登録をリクエストするには、[サポート](mailto:support@wandb.com) または担当の AISE にお問い合わせください。</Warning>
