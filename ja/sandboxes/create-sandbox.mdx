---
title: サンドボックスを作成する
description: Serverless Sandboxes を作成する方法を説明します。
---

<Warning>Serverless Sandboxes はプライベートプレビュー段階にあり、招待制でのみ利用できます。利用登録を希望する場合は、[サポート](mailto:support@wandb.com) または担当の AISE にお問い合わせください。</Warning>
