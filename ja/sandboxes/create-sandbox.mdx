---
title: サンドボックスを作成する
description: W&B Sandboxes を作成する方法を説明します。
---

<Warning>W&amp;B Sandboxes はプライベートプレビュー段階にあり、招待制でのみ利用できます。利用登録を希望する場合は、[サポート](mailto:support@wandb.com) または担当の AISE にお問い合わせください。</Warning>
