---
title: Secrets
description: Serverless Sandboxes でシークレットを管理する方法を説明します。
---

<Warning>Serverless Sandboxes は招待制のプライベートプレビューです。利用を希望する場合は、[サポート](mailto:support@wandb.com) または担当の AISE にお問い合わせください。</Warning>
