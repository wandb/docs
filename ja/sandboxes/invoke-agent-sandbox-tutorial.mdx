...
keywords: ["チュートリアル", "サンドボックスでエージェントを呼び出す"]
---
...
### W&amp;B Python SDK をインストールする {#install-wb-python-sdk}
...
### Secret Manager に APIキーを保存する {#store-api-keys-in-secret-manager}
...
## エージェントのコードをコピーする {#copy-agent-code}
