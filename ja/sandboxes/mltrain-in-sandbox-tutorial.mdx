...
### W&amp;B Python SDK をインストール {#install-the-wb-python-sdk}
...
### W&amp;B にログインして認証する {#log-in-and-authenticate-with-wb}
...
## トレーニングスクリプトと依存関係をコピーする {#copy-the-training-script-and-dependencies}
...
## サンドボックスを作成してトレーニングスクリプトを実行する {#create-the-sandbox-and-run-the-training-script}
