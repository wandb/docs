...
<Update label="v0.82.0" description="2026年6月23日">
  **2026年6月23日**
  ...
  W&amp;B 0.82.0 では、編集可能なコレクション概要とバージョン単位のメトリクスチャートにより、アーティファクトに関する分析情報がさらに充実しました。加えて、Workspace と run テーブルの使い勝手も改善されています。監査ログには APIキー のアクティビティも記録されるようになりました。
