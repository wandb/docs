...
<Update label="v0.80.0" description="2026年4月28日">
  ...
  * **Monitors** ページでは、提案された分類器カードから分類器モニターを作成して管理できます。
  ...
  * 組織管理者は、`graphql-disable-introspection` 設定オプションまたは環境変数 `GORILLA_GRAPHQL_DISABLE_INTROSPECTION` を使用して、GraphQL のイントロスペクションを無効にできます。[W&amp;B SDK v0.26.0](/ja/release-notes/sdk-releases#0-26-0)+ が必要です。
