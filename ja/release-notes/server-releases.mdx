...
<Update label="v0.82.0" description="2026年6月23日">
  ...
  * 異なる Projects の Runs をピン留めして比較したり、別の project の run をベースライン run として指定したりできるようになりました。[Compare runs across projects](/ja/models/runs/compare-runs#compare-runs-across-projects)を参照してください。
    <Frame>
