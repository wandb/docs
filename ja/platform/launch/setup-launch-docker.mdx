...
## Docker キューを設定する {#configure-a-docker-queue}
...
## ローカルマシン上で Launch エージェントを設定する {#configure-a-launch-agent-on-a-local-machine}
...
### エージェント の基本設定オプション {#core-agent-config-options}
...
### Docker image ビルダー {#docker-image-builders}
...
### コンテナーレジストリ {#container-registries}
