...
* 初めて W&B Launch を使用する場合は、[Launch ウォークスルー](#ウォークスルー) ガイドを確認することをお勧めします。
* [W&B Launch のセットアップ方法](/ja/platform/launch/set-up-launch/) を学ぶ。
* [launch job](/ja/platform/launch/launch-terminology/#launch-job) を作成する。
...
高度なキュー設定オプションについては、[高度なキューセットアップページ](/ja/platform/launch/setup-queue-advanced/) を参照してください。
