...
keywords: ["キューを作成する", "エージェントをデプロイする", "Launch設定", "先入れ先出しキュー"]
---
...
## Launch エージェントを設定する {#set-up-a-launch-agent}
...
### コンテナー ビルダーを設定する {#configure-a-container-builder}
...
### コンテナー レジストリを設定する {#configure-a-container-registry}
...
## Launch エージェント を有効にする {#activate-the-launch-agent}
