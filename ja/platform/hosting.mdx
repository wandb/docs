...
W&B Platformは、W&Bの製品である[Core](/ja/guides/core)、[Models](/ja/models/)、および[Weave](/ja/guides/weave/)をサポートするための基本となるインフラストラクチャー、ツール、およびガバナンスの枠組みです。
...
| Object Storage (S3/GCS/Blob storage) | **オプション 1**: W&Bが完全にホスト<br />**オプション 2**: [Secure Storage Connector](/ja/platform/hosting/data-security/secure-storage-connector)を使用して、顧客がチームごとに独自のバケットを設定可能 | **オプション 1**: W&Bが完全にホスト<br />**オプション 2**: [Secure Storage Connector](/ja/platform/hosting/data-security/secure-storage-connector)を使用して、顧客がインスタンスまたはチームごとに独自のバケットを設定可能 | 完全に顧客がホストおよび管理 |
...
詳細は、[W&B Multi-tenant Cloud](/ja/platform/hosting/#wb-multi-tenant-cloud)をご覧ください。
...
詳細は、[W&B Dedicated Cloud](/ja/platform/hosting/hosting-options/dedicated_cloud/)をご覧ください。
...
詳細は、[W&B Self-Managed](/ja/platform/hosting/hosting-options/self-managed/)をご覧ください。
