...
keywords: ["Claude Code スキル", "Codex スキル", "エージェントの指示", "コーディングエージェント", "スキルのインストール"]
---
...
## W&amp;B Skills の機能 {#wb-skills-capabilities}
...
## W&amp;B Skills をインストールする {#install-wb-skills}
...
## W&amp;B Skills を使用する {#use-wb-skills}
