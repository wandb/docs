...
menu:
  default:
    ...
    parent: self-managed
slug: /ja/platform/hosting/operator
weight: 2
---
...
[リファレンスアーキテクチャ](/ja/platform/hosting/self-managed/ref-arch/#infrastructure-requirements)を参照してください。また、[有効な W&B サーバーライセンスを取得](/#obtain-your-wb-server-license)します。
...
これらのモジュールの使用方法の詳細な説明については、これを[セクション](/#deploy-wb-server-within-self-managed-cloud-accounts)のセルフマネージドインストールセクションのドキュメントを参照してください。
