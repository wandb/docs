...
このページでは、W&B Server の自動バージョンアップグレードを無効にし、特定のバージョンに固定（ピン留め）する方法について説明します。以下の手順は、[W&B Kubernetes Operator](/ja/platform/hosting/operator/) によって管理されているデプロイメントにのみ適用されます。
