...
<Note>
W&B は、[W&B Multi-tenant Cloud](/ja/platform/hosting/hosting-options/saas_cloud) や [W&B Dedicated Cloud](/ja/platform/hosting/hosting-options/dedicated_cloud/) のような完全管理されたデプロイメントオプションを推奨しています。W&B の完全管理サービスは、シンプルで安全に使用でき、ほとんど設定が不要です。
</Note>
