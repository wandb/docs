...
<Note>
W&Bでは、[W&B Multi-tenant Cloud](/ja/platform/hosting/hosting-options/multi_tenant_cloud) や [W&B 専用クラウド](/ja/platform/hosting/hosting-options/dedicated_cloud/) などのフルマネージドデプロイメントオプションを推奨しています。W&Bのフルマネージドサービスは、設定をほとんど、あるいは全く必要とせず、シンプルかつ安全に利用できます。
</Note>
