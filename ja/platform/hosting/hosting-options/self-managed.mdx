...
<Note>
W&B は、[W&B Multi-tenant Cloud](/ja/platform/hosting/hosting-options/saas_cloud/) や [W&B Dedicated Cloud](/ja/platform/hosting/hosting-options/dedicated_cloud/) のようなフルマネージドデプロイメントオプションを推奨します。W&B のフルマネージドサービスは、簡単で安全に使用でき、ほとんど設定が不要です。
</Note>
