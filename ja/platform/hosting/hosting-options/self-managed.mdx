...
sidebarTitle: デプロイ概要
keywords: ["セルフホスト型 W&B", "オンプレミス デプロイ", "プライベートクラウド", "W&B Server", "helm chart"]
---
...
## W&amp;B Kubernetes Operator について {#about-the-wb-kubernetes-operator}
...
## 必須のインフラストラクチャー {#required-infrastructure}
...
## W&amp;B Server ライセンスを取得する {#obtain-your-wb-server-license}
