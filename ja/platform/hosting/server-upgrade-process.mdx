...
## Terraform を使用して更新する {#update-with-terraform}
...
### spec を使って W&amp;B を更新 {#update-wb-with-spec}
...
### ライセンスとバージョンを直接更新する {#update-license-and-version-directly}
...
## admin UI で更新 {#update-with-admin-ui}
