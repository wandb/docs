...
基本的な[環境変数](/ja/platform/hosting/env-vars/)に加えて、環境変数を使用して、[専用クラウド](/ja/platform/hosting/hosting-options/dedicated_cloud)または[自己管理](/ja/platform/hosting/hosting-options/Self-Managed)インスタンスの IAM オプションを設定できます。
