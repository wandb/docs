...
## W&amp;B で SSO を設定する {#set-up-sso-in-wb}
...
## Customer Namespace を確認する {#find-your-customer-namespace}
  ...
  <Tab title="System settings">
    ...
    3. ユーザープロフィールアイコンをクリックします。ドロップダウンから **System Settings** を選択します。
