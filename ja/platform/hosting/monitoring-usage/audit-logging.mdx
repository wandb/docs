...
### 監査ログの取得時に PII を除外する <a id="exclude-pii" /> {#exclude-pii-when-fetching-audit-logs}
...
### 基本認証を使用する {#use-basic-authentication}
