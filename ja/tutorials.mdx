...
<CardGroup cols={2}>
<Card title="実験を追跡する" href="/models/tutorials/experiments/">
W&B を使用して、機械学習の実験管理、モデルのチェックポイント、チームとのコラボレーションなどを行います。
</Card>
<Card title="予測を可視化する" href="/models/tutorials/tables/">
PyTorch を使用して、トレーニングの過程でモデル予測を追跡、可視化、比較します。データは MNIST を使用。
</Card>
</CardGroup>

<CardGroup cols={2}>
<Card title="ハイパーパラメーターを調整する" href="/models/tutorials/sweeps/">
W&B Sweeps を使用して、学習率、バッチサイズ、隠れ層の数などのハイパーパラメーターの組み合わせを自動的に検索するための組織化された方法を作成します。
</Card>
<Card title="モデルとデータセットを追跡する" href="/models/tutorials/artifacts/">
