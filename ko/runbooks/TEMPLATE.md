...
이 작업을 시작하기 전에 충족해야 하는 액세스 요구 사항 또는 사전 요구 사항을 나열하십시오:
...
**예상 결과**: 이 step을 완료한 후에 기대되는 동작입니다.
