...
# 기술 문서 작성자를 위한 Locadex 자동 번역 {#locadex-auto-translation-for-tech-writers}
...
## 개요 및 범위 {#overview-and-scope}

### Locadex가 현지화하는 항목 {#what-locadex-localizes}
...
### Locadex가 현지화하지 않는 항목 {#what-locadex-does-not-localize}
...
## `main`에서의 번역 워크플로 {#translation-workflow-on-main}
...
### 영어 PR 병합 후 작성자 체크리스트 {#writer-checklist-after-your-english-pr-merges}
...
## Locadex 콘솔과 wandb/docs 리포지토리 비교 {#locadex-console-versus-wandbdocs-repo}
...
### Glossary 및 AI Context 가져오기와 내보내기 {#importing-and-exporting-glossary-and-ai-context}
...
## LLM을 사용해 번역 라운드 평가하기 {#using-an-llm-to-evaluate-a-translation-round}
...
### 2. 프롬프트 형태 (예시) {#2-prompt-shape-example}
...
### 3. 출력 결과 활용 방법 {#3-how-to-use-the-output}
...
## 자동 현지화된 콘텐츠의 수동 수정 및 업데이트 {#manual-corrections-and-updates-to-auto-localized-content}

### 병합 후 일회성 수정 {#one-off-correction-after-merge}
...
### 전반적인 용어 또는 스타일 수정 {#systemic-terminology-or-style-fix}
...
### English가 다시 변경되는 경우 {#when-english-changes-again}
...
## 체크리스트 (빠른 레퍼런스) {#checklist-quick-reference}
