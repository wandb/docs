...
| \*\*kwargs_wandb_init  | [`wandb.init()`](/ko/models/ref/python/init)에 직접 전달되는 추가 인수입니다.                                                                                                                                                                                                             |
...
이 Model (메타데이터) 아티팩트는 [W&B Registry](/ko/models/core/registry/)의 Model에 추가로 연결될 수 있습니다.
