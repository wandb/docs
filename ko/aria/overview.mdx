...
1. ARIA 채팅 창에서 **<Icon icon="sidebar-reveal" iconType="solid" />**를 클릭합니다.
2. **Customization** 섹션에서 **Project memory**를 클릭합니다. ARIA가 프로젝트에 대해 보유한 모든 메모리가 표시됩니다.
3. 메모리를 수정하려면 **<Icon icon="pencil" iconType="solid" />**를 클릭합니다. 메모리의 **Name**, **Description** 또는 **Memory**를 업데이트한 후 **Save**를 클릭합니다.
