...
<Tip>
[Weave에서의 Tracing](/ko/weave/guides/tracking/tracing)에 대해 더 자세히 알아보세요.
</Tip>
...
- **Traces** 탭을 선택하여 [Trace 확인](/ko/weave/guides/tracking/tracing)
- **Evals** 탭을 선택하여 [모델 평가 확인](/ko/weave/guides/core-types/evaluations)
- **Leaders** 탭을 선택하여 [생성된 Leaderboard 확인](/ko/weave/guides/core-types/leaderboards)
...
- 사용 가능한 모든 메소드에 대해 [API 레퍼런스](/ko/inference/api-reference/)를 살펴보세요.
- [UI](/ko/inference/ui-guide/)에서 모델을 직접 시도해 보세요.