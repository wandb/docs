...
{/* takeru inference-models-deprecated - 이 표는 자동 생성되므로 수동으로 수정하지 마세요. */}

| 모델                           | API 사용을 위한 모델 ID                               | 유형  | 컨텍스트 윈도우 | 파라미터             | 설명                                                                      |
| ---------------------------- | ---------------------------------------------- | --- | -------- | ---------------- | ----------------------------------------------------------------------- |
| MiniMax M2.5                 | `MiniMaxAI/MiniMax-M2.5`                       | 텍스트 | 197k     | 10B-230B (활성-전체) | 뛰어난 코딩 기능을 갖추고 높은 처리량과 짧은 지연 시간을 제공하도록 설계된 고희소성 아키텍처의 MoE 모델입니다.        |
| NVIDIA Nemotron 3 Super 120B | `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-FP8` | 텍스트 | 262k     | 12B-120B (활성-전체) | Nemotron 3는 강력한 에이전트형, 추론 및 대화 기능을 제공하도록 설계된 LatentMoE 모델입니다.           |
| Qwen3 Coder 480B A35B        | `Qwen/Qwen3-Coder-480B-A35B-Instruct`          | 텍스트 | 262k     | 35B-480B (활성-전체) | 함수 호출, 도구 사용, 긴 컨텍스트 추론과 같은 에이전트형 코딩 작업에 최적화된 Mixture-of-Experts 모델입니다. |
| Z.AI GLM 5.1                 | `zai-org/GLM-5.1`                              | 텍스트 | 203k     | 40B-744B (활성-전체) | 장기적인 에이전트형 엔지니어링 및 고급 추론을 위한 강력한 MoE 모델입니다.                             |
