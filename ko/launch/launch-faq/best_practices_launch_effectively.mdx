...
3. `wandb.config`를 사용하여 하이퍼파라미터 를 관리하고 작업 재실행 중에 덮어쓸 수 있습니다. argparse 사용에 대한 자세한 내용은 [이 가이드](/ko/models/track/config/#set-the-configuration-with-argparse) 를 참조하세요.
