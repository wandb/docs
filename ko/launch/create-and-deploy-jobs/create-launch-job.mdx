...
<Note>
실행을 위해 제출하지 않고 작업을 생성하려면 `wandb job create` 코맨드를 사용하세요. 자세한 내용은 [코맨드 참조 문서](/ko/models/ref/cli/wandb-job/wandb-job-create)를 참조하세요.
</Note>
...
- run이 코드 Artifact를 기록했습니다(자세한 내용은 [`Run.log_code`](/ko/models/ref/python/run#log_code) 참조).
