...
* **[GET `/v1/preview/base-models`](https://docs.wandb.ai/serverless-training/api-reference/models/list-base-models)** - 기본 모델 목록
...
* **[GET `/v1/preview/models/{model_id}/checkpoints`](https://docs.wandb.ai/serverless-training/api-reference/models/list-model-checkpoints)** - 모델 체크포인트 목록
* **[POST `/v1/preview/models/{model_id}/log`](https://docs.wandb.ai/serverless-training/api-reference/models/log)** - 로그

### 트레이닝 작업 {#training-jobs}
