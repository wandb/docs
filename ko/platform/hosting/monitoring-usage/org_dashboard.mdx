...
<Warning>
Organization dashboard는 [전용 클라우드](/ko/platform/hosting/hosting-options/dedicated_cloud) 및 [자체 관리 인스턴스](/ko/platform/hosting/hosting-options/self-managed)에서만 사용할 수 있습니다.
</Warning>
