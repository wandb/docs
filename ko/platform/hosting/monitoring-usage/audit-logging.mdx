...
### 개인 식별 정보 (PII) {#personally-identifiable-information-pii}
...
### audit log을 가져올 때 PII 제외하기 <a id="exclude-pii" /> {#exclude-pii-when-fetching-audit-logs}
...
### 기본 인증 사용 {#use-basic-authentication}
