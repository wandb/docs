...
* 조직 범위 내에서 그리고 팀 내에서 [적절한 user 역할을 구성합니다](/ko/platform/hosting/iam/access-management/manage-organization#assign-or-update-a-users-role).
* W&B project의 범위를 정의하여 누가 W&B runs를 보고, 편집하고, 제출할 수 있는지 [제한된 projects](/ko/platform/hosting/iam/access-management/restricted-projects)으로 제한합니다.
