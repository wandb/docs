...
| `GORILLA_DISABLE_PERSONAL_ENTITY`      | true로 설정하면 [personal entities](/ko/models/support/difference_team_entity_user_entity_mean_me/)를 비활성화합니다. 개인 entity에서 새 개인 프로젝트를 만드는 것을 막고, 기존 개인 프로젝트에 쓰는 것도 막습니다.                                                                                                                                                                                                                          |
