...
System Settings 관리자 UI를 통해 인스턴스 수준 설정을 구성하는 것 외에도, W&B는 환경 변수를 사용하여 코드를 통해 이러한 값들을 구성하는 방법을 제공합니다. 또한, [IAM 고급 설정](/ko/platform/hosting/iam/advanced_env_vars/)을 참조하세요.
