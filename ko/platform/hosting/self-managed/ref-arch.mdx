...
W&amp;B Server 애플리케이션은 여러 파드를 배포하는 [Kubernetes Operator](/ko/platform/hosting/self-managed/operator) 형태로 배포됩니다. 따라서 W&amp;B를 사용하려면 다음 요건을 갖춘 Kubernetes 클러스터가 필요합니다.
