...
keywords: ["인프라 사이징", "MySQL 요구 사항", "Redis 설정", "프로덕션 아키텍처", "하드웨어 사양"]
---
...
#### MySQL 데이터베이스 생성 {#mysql-database-creation}
...
### 로드 밸런서 및 인그레스 {#load-balancer-and-ingress}
...
#### 인그레스 컨트롤러 요구 사항 {#ingress-controller-requirements}
...
#### W&amp;B 서비스 라우팅 {#wb-service-routing}
...
### Kubernetes 사이징 {#kubernetes-sizing}
...
## 클라우드 제공업체 인스턴스 권장 사항 {#cloud-provider-instance-recommendations}
