...
keywords: ["버전 고정", "업그레이드 동결", "버전 잠금", "수동 업그레이드"]
---
...
## 자동 업데이트 비활성화 {#disable-automatic-updates}
...
6. **Save**를 클릭합니다.
   ...
   <Frame>
     <img src="/images/hosting/disable_automatic_updates_saved_and_enabled.png" alt="선택한 W&B Server 버전에서 Pin specific version이 켜져 있는 System Console" />
   </Frame>
