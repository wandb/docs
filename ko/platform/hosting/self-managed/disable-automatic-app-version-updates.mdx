...
이 페이지에서는 W&B Server 의 자동 버전 업그레이드를 비활성화하고 특정 버전을 고정(pin)하는 방법을 설명합니다. 이 지침은 [W&B Kubernetes Operator](/ko/platform/hosting/operator/)를 통해 관리되는 배포(deployment)에만 적용됩니다.
