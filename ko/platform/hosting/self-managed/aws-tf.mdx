...
<Note>
Weights & Biases는 [W&B Multi-tenant Cloud](/ko/platform/hosting/hosting-options/saas_cloud) 또는 [W&B 전용 클라우드](/ko/platform/hosting/hosting-options/dedicated_cloud/) 배포 유형과 같은 완전 관리형 배포 옵션을 권장합니다. W&B 완전 관리형 서비스는 사용하기 간단하고 안전하며, 필요한 설정이 최소화되거나 전혀 없습니다.
</Note>
