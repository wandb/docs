...
<Note>
W&B에서는 [W&B Multi-tenant Cloud](/ko/platform/hosting/hosting-options/multi_tenant_cloud) 또는 [W&B Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud/) 배포 유형과 같은 완전 관리형 배포 옵션을 권장합니다. W&B 완전 관리형 서비스는 사용하기 간편하고 안전하며, 최소한의 설정 또는 설정이 필요하지 않습니다.
</Note>
...
W&B 배포를 시작하기 전에 [참조 아키텍처](/ko/platform/hosting/Self-Managed/ref-arch/#infrastructure-requirements), 특히 인프라 요구 사항을 참조하십시오.
...
권장되는 설치 방법은 공식 W&B Helm 차트를 사용하는 것입니다. [이 섹션](/ko/platform/hosting/operator/#deploy-wb-with-helm-cli)에 따라 W&B Server 애플리케이션을 배포하십시오.
