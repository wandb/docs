...
<Note>
W&B에서는 [W&B Multi-tenant Cloud](/ko/platform/hosting/hosting-options/saas_cloud) 또는 [W&B Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud/) 배포 유형과 같은 완전 관리형 배포 옵션을 권장합니다. W&B 완전 관리형 서비스는 사용하기 간편하고 안전하며, 최소한의 설정 또는 설정이 필요하지 않습니다.
</Note>
