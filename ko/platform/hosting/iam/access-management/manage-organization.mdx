...
Organization에서 사용자 관리를 간소화하려면 [사용자 및 Team 관리 자동화](/ko/platform/hosting/iam/automate_iam/)를 참조하십시오.
...
Dedicated Cloud 또는 Self-managed 인스턴스로 SSO를 설정하는 방법에 대한 자세한 내용은 [OIDC를 사용한 SSO](/ko/platform/hosting/iam/sso/) 또는 [LDAP를 사용한 SSO](/ko/platform/hosting/iam/ldap/)를 참조하십시오.
</Note>
...
기본적으로 Team 또는 인스턴스 관리자만 Team에 구성원을 초대할 수 있습니다. 이 동작을 변경하려면 [Team 설정](/ko/platform/hosting/iam/access-management/manage-organization/#invite-users-to-a-team)을 참조하십시오.
