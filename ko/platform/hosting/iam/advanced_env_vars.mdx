...
기본적인 [환경 변수](/ko/platform/hosting/env-vars/) 외에도, 환경 변수를 사용하여 [전용 클라우드](/ko/platform/hosting/hosting-options/dedicated_cloud) 또는 [자체 관리](/ko/platform/hosting/hosting-options/self-managed) 인스턴스에 대한 IAM 옵션을 구성할 수 있습니다.
