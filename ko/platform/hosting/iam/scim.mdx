...
<Note>
여러 Enterprise [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud) organization의 관리자인 경우 SCIM API 요청이 전송되는 organization을 구성해야 합니다. 프로필 이미지를 클릭한 다음 **User Settings**를 클릭합니다. 설정 이름은 **Default API organization**입니다. 이는 [Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud), [Self-managed instances](/ko/platform/hosting/hosting-options/self-managed) 및 [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud)를 포함한 모든 호스팅 옵션에 필요합니다. SaaS Cloud에서 organization 관리자는 SCIM API 요청이 올바른 organization으로 이동하도록 사용자 설정에서 기본 organization을 구성해야 합니다.
...
-   **메서드**: GET
-   **설명**: 사용자 고유 ID를 제공하여 [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud) organization 또는 [Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud) 또는 [Self-managed](/ko/platform/hosting/hosting-options/self-managed) 인스턴스에서 특정 사용자에 대한 정보를 검색합니다.
-   **요청 예시**:
...
-   **메서드**: GET
-   **설명**: [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud) organization 또는 [Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud) 또는 [Self-managed](/ko/platform/hosting/hosting-options/self-managed) 인스턴스에서 모든 사용자 목록을 검색합니다.
-   **요청 예시**:
...
-   **엔드포인트**: **`<host-url>/scim/Users/{id}`**
-   **메서드**: DELETE
-   **설명**: 사용자 고유 ID를 제공하여 [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud) organization 또는 [Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud) 또는 [Self-managed](/ko/platform/hosting/hosting-options/self-managed) 인스턴스에서 사용자를 완전히 삭제합니다. 필요한 경우 [사용자 생성](#create-user) API를 사용하여 사용자를 organization 또는 인스턴스에 다시 추가합니다.
-   **요청 예시**:
...
<Note>
사용자 비활성화 및 재활성화 작업은 [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud)에서 지원되지 않습니다.
</Note>
...
-   **엔드포인트**: **`<host-url>/scim/Users/{id}`**
-   **메서드**: PATCH
-   **설명**: 사용자에게 organization 수준 역할을 할당합니다. 역할은 [여기](/ko/platform/hosting/iam/access-management/manage-organization/#invite-a-user)에 설명된 대로 `admin`, `viewer` 또는 `member` 중 하나일 수 있습니다. [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud)의 경우 사용자 설정에서 SCIM API에 대한 올바른 organization을 구성했는지 확인합니다.
-   **지원되는 필드**:
...
-   **엔드포인트**: **`<host-url>/scim/Users/{id}`**
-   **메서드**: PATCH
-   **설명**: 사용자에게 팀 수준 역할을 할당합니다. 역할은 [여기](/ko/platform/hosting/iam/access-management/manage-organization/#invite-a-user)에 설명된 대로 `admin`, `viewer`, `member` 또는 사용자 지정 역할 중 하나일 수 있습니다. [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud)의 경우 사용자 설정에서 SCIM API에 대한 올바른 organization을 구성했는지 확인합니다.
-   **지원되는 필드**:
