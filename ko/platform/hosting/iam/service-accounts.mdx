...
<Note>
서비스 계정은 [전용 클라우드](/ko/platform/hosting/hosting-options/dedicated_cloud), 엔터프라이즈 라이선스가 있는 [자체 관리 인스턴스](/ko/platform/hosting/hosting-options/self-managed) 및 [SaaS 클라우드](/ko/platform/hosting/hosting-options/saas_cloud)의 엔터프라이즈 계정에서 사용할 수 있습니다.
</Note>
