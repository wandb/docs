...
keywords: ["JWT 인증", "RFC 7523", "페더레이션 로그인", "키 없는 인증", "토큰 기반 인증"]
---
...
## JWT 발급자 설정 {#set-up-the-jwt-issuer}
...
## JWT를 사용하여 W&amp;B에 액세스하기 {#use-the-jwt-to-access-wb}
...
### ID 공급자의 Subject 값 확인 {#determine-the-subject-value-for-your-identity-provider}
