...
## Terraform으로 업데이트 {#update-with-terraform}
...
### spec을 사용해 W&amp;B 업데이트 {#update-wb-with-spec}
...
### 라이선스 및 버전을 직접 업데이트 {#update-license-and-version-directly}
...
## admin UI에서 업데이트 {#update-with-admin-ui}
