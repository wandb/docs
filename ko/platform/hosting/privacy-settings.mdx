...
* 조직 이메일 도메인이 일치하는 사용자가 이 팀에 참여하도록 허용합니다.
    * 이 설정은 [SaaS Cloud](/ko/platform/hosting/hosting-options/saas_cloud/)에만 적용됩니다. [Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud/) 또는 [Self-managed](/ko/platform/hosting/hosting-options/self-managed/) 인스턴스에서는 사용할 수 없습니다.
* 코드 저장을 기본적으로 활성화합니다.
