...
description: "Helm 차트, Kaniko 이미지 빌드, job spec을 사용해 Kubernetes 클러스터에 W&B Launch를 설정합니다."
keywords: ["Kubernetes Launch", "EKS Launch", "GKE Launch", "K8s 워크로드"]
---
...
## Kubernetes용 큐 설정 {#configure-a-queue-for-kubernetes}
...
## Helm으로 Launch 에이전트 구성하기 {#configure-a-launch-agent-with-helm}
