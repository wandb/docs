---
title: Launch 작업 만들기
description: "wandb launch 명령을 사용하여 Git 저장소, 코드 아티팩트 또는 도커 이미지에서 W&B Launch 작업을 만드세요."
keywords: ["wandb job create", "Git 작업", "코드 아티팩트 작업", "이미지 작업", "작업 청사진"]
---
...
## 자동 작업 생성 {#automatic-job-creation}
...
### Requirements 파일 {#requirements-file}
