...
keywords: ["Kaniko builder", "ECR push", "GCR 레지스트리", "에이전트 빌더", "이미지 레지스트리"]
---

# 고급 에이전트 설정 {#advanced-agent-setup}
...
## 컨테이너 레지스트리로 푸시하기 {#push-to-a-container-registry}
...
### Kaniko용 저장소 권한 {#storage-permissions-for-kaniko}
...
## Kaniko 빌드 맞춤 설정 {#customize-the-kaniko-build}
...
## CoreWeave에 Launch 에이전트 배포 {#deploy-launch-agent-into-coreweave}
