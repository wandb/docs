...
<Card title="소스 보기" href="https://www.github.com/wandb/wandb/tree/v0.20.1/wandb/sdk/launch/agent/agent.py#L164-L924" icon="github" />

지정된 run 큐를 폴링하여 wandb Launch용 run을 실행하는 Launch 에이전트 클래스입니다.
...
runqueue에서 작업으로 실행할 항목을 하나 꺼냅니다.
