...
keywords: ["Claude Code skills", "Codex skills", "에이전트 지침", "코딩 에이전트", "Skills 설치"]
---
...
## W&amp;B Skills 기능 {#wb-skills-capabilities}
...
## W&amp;B Skills 설치 {#install-wb-skills}
