...
W&B Platform은 [Core](/ko/models/core), [Models](/ko/models/) 및 [Weave](/ko/guides/weave/)와 같은 W&B 제품을 지원하는 기본적인 인프라, 툴링 및 거버넌스 스캐폴딩입니다.
...
| 오브젝트 스토리지 (S3/GCS/Blob storage) | **옵션 1**: W&B에서 완전 호스팅<br />**옵션 2**: 고객은 [Secure Storage Connector](/ko/platform/hosting/data-security/secure-storage-connector)를 사용하여 팀별로 자체 버킷을 구성할 수 있습니다.  | **옵션 1**: W&B에서 완전 호스팅<br />**옵션 2**: 고객은 [Secure Storage Connector](/ko/platform/hosting/data-security/secure-storage-connector)를 사용하여 인스턴스 또는 팀별로 자체 버킷을 구성할 수 있습니다. | 고객이 완전 호스팅 및 관리 |
...
자세한 내용은 [W&B Multi-tenant Cloud](/ko/platform/hosting/#wb-multi-tenant-cloud)를 참조하십시오.
...
자세한 내용은 [W&B Dedicated Cloud](/ko/platform/hosting/hosting-options/dedicated_cloud/)를 참조하십시오.
...
자세한 내용은 [W&B Self-Managed](/ko/platform/hosting/hosting-options/Self-Managed/)를 참조하십시오.
