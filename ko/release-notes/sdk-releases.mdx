...
<Update label="0.28.0" description="2026년 6월 22일">
  ...
  * 다음 페이지네이션된 아티팩트 및 레지스트리 API 메서드는 이제 선택적 `order` string을 키워드 인수로 받을 수 있습니다: `Api.artifacts()`, `Api.artifact_collections()`, `Api.registries()`, `Api.registries().collections()`, `Registry.collections()`.
