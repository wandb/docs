...
[Models and Weave Integration Demo](/ko/weave/cookbooks/Models_and_Weave_Integration_Demo)는 다음을 위한 전체 워크플로우를 보여줍니다:
...
* [전체 Weave 평가 튜토리얼](/ko/weave/tutorial-eval/)
* [Models 및 Weave 통합 예시](/ko/weave/cookbooks/Models_and_Weave_Integration_Demo)
