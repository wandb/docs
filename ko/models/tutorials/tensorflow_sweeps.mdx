...
더 자세한 정보는 [Sweeps 개요](/ko/models/sweeps/)를 참조하세요.
...
자세한 내용은 [스윕 구성 가이드](/ko/models/sweeps/define-sweep-configuration/)를 참조하세요.
...
## 고급 설정
1. [환경 변수](/ko/platform/hosting/env-vars/): 관리형 클러스터에서의 트레이닝을 위해 API 키를 설정하세요.
2. [오프라인 모드](/ko/models/support/run_wandb_offline/)
3. [온프레미스](/ko/platform/hosting/hosting-options/self-managed): 사용자의 인프라 내 프라이빗 클라우드나 에어갭 서버에 W&B를 설치하세요. 로컬 설치는 학계 및 기업 팀에 적합합니다.