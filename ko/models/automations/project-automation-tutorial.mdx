...
keywords: ["run 상태 변경", "Slack 알림", "run 실패 알림", "프로젝트 범위 자동화", "OnRunState"]
---
...
<div id="create-a-project-automation">
  ## 프로젝트 자동화 만들기 {#create-a-project-automation}
</div>
...
이제 프로젝트에는 run이 실패하면 선택한 Slack 채널에 게시하는 활성 자동화가 설정됩니다. 자세한 내용은 [Slack 자동화 만들기](/ko/models/automations/create-automations/slack#create-an-automation) (Project 탭)을 참조하세요.
