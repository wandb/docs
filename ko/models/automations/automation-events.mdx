...
description: "artifact 변경, run 상태, 메트릭 조건 등 W&B Automations를 트리거하는 이벤트와 범위를 알아보세요."
keywords: ["자동화 트리거", "아티팩트 별칭", "run 상태", "메트릭 임곗값", "z-score"]
---

import MultiTenantAndDedicatedCloudOnly from "/snippets/ko/_includes/multi-tenant-and-dedicated-cloud-only.mdx";
