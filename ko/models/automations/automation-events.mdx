---
title: 자동화 이벤트 및 범위
description: "아티팩트 변경, run 상태, 메트릭 조건을 포함해 W&B 자동화를 트리거하는 이벤트와 범위에 대해 알아보세요."
---
...
자동화는 프로젝트 또는 레지스트리 내에서 특정 이벤트가 발생하면 시작될 수 있습니다. 이 페이지에서는 각 범위 내에서 자동화를 트리거할 수 있는 이벤트를 설명합니다. 자동화에 대해 자세히 알아보려면 [Automations overview](/ko/models/automations) 또는 [자동화 생성](/ko/models/automations/create-automations)을 참고하세요.
