...
## 레지스트리 항목 검색 {#search-for-registry-items}
...
## 레지스트리 항목 쿼리 {#query-registry-items}
...
### 지원되는 Operator {#supported-operators}

W&amp;B는 레지스트리 항목을 필터링할 때 다음 비교 및 논리 Operator를 지원합니다:

#### 비교 Operator {#comparison-operators}
