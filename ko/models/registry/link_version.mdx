...
<Tabs>
  <Tab title="Python SDK">
    ...
    Programmatically link an artifact version to a collection with [`wandb.Run.link_artifact()`](/ko/models/ref/python/experiments/run#link_artifact) or
    [`wandb.Artifact.link()`](/ko/models/ref/python/experiments/artifact#method-artifactlink).
