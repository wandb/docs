...
예를 들어, 다음 코드 조각은 재할당을 통해 리스트를 업데이트하는 일반적인 방법을 보여줍니다. 간결함을 위해 [컬렉션에 태그 추가하기](#컬렉션에-태그-추가하기) 섹션의 코드 예시를 이어서 사용합니다:
...
예를 들어, 다음 코드 조각은 재할당을 통해 리스트를 업데이트하는 일반적인 방법을 보여줍니다. 간결함을 위해 [artifact 버전에 태그 추가하기](#artifact-버전에-태그-추가하기) 섹션의 코드 예시를 이어서 사용합니다:
