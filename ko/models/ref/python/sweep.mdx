...
| 인수 |  |
| :--- | :--- |
|  `sweep` | 하이퍼파라미터 검색의 구성입니다 (또는 구성 생성기). 스윕 정의 방법에 대한 자세한 내용은 [스윕 구성 구조](https://docs.wandb.ai/models/sweeps/define-sweep-configuration) 를 참조하십시오. 호출 가능한 항목을 제공하는 경우 호출 가능한 항목이 인수를 사용하지 않고 W&B 스윕 구성 사양을 준수하는 사전을 반환하는지 확인하십시오. |
