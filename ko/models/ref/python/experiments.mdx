...
| Class | Description |
|-------|-------------|
| [`Run`](/ko/models/ref/python/experiments/run/) | 메트릭, 구성, 출력이 포함된 단일 ML 실험을 나타내는 W&amp;B에 기록되는 기본 계산 단위입니다. |
| [`Artifact`](/ko/models/ref/python/experiments/artifact/) | 자동 중복 제거 및 리니지 추적 기능을 갖춘 데이터셋과 모델 버전 관리를 위한 유연하고 경량의 구성 요소입니다. |
| [`Settings`](/ko/models/ref/python/experiments/settings/) | 로깅부터 API 상호작용까지의 동작을 제어하는 W&amp;B SDK의 구성 관리입니다. |
