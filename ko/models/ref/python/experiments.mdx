...
### 모델 artifact 버전 지정 {#version-a-model-artifact}
...
### SDK 설정하기 {#configure-sdk-settings}
...
### 리니지 추적을 위해 artifact 연결하기 {#link-artifacts-for-lineage-tracking}
