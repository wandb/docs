...
히스토그램을 위한 W&amp;B class입니다.

이 객체는 numpy의 histogram 함수와 https://docs.scipy.org/doc/numpy/reference/generated/numpy.histogram.html 과 동일하게 작동합니다.
...
**매개변수:**
sequence: 히스토그램의 입력 데이터입니다. np&#95;histogram: 미리 계산된 히스토그램을 대체 입력으로 사용합니다. num&#95;bins: 히스토그램의 bin 수입니다. 기본 bin 수는 64입니다. 최대 bin 수는 512입니다.
