...
이 객체는 NumPy의 `histogram` 함수와 동일한 방식으로 동작합니다: https://numpy.org/doc/stable/reference/generated/numpy.histogram.html 

**속성:**

- `bins` ([float]):  구간의 경계값 
 - `histogram` ([int]):  각 구간에 속하는 원소의 개수 
...
**Args:**
sequence: 히스토그램에 사용할 입력 데이터입니다. np&#95;histogram: 미리 계산된 히스토그램을 대체 입력으로 사용합니다. num&#95;bins: 히스토그램의 빈 개수입니다. 기본 빈 개수는 64이며, 최대 빈 개수는 512입니다.
