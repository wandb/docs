...
WANDB&#95;IDENTITY&#95;TOKEN&#95;FILE 환경 변수 등을 통해 ID 토큰 파일이 구성되어 있으면, 해당 파일을 세션(연합 ID)에 사용하며 API 키를 읽거나 저장하지 않습니다.
...
* `verify`: W&amp;B 서버로 자격 증명을 확인하고, 실패하면 AuthenticationError를 발생시킵니다. 이는 API 키와 ID 토큰 모두에 적용됩니다.
