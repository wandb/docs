...
### <kbd>메서드</kbd> `RunStateFilter.__init__`
...
* `run` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트를 트리거할 run과 일치해야 하는 필터입니다.
