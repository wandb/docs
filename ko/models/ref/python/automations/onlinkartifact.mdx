...
새 아티팩트가 컬렉션에 연결될 때 발생하는 이벤트입니다.

예시:
별칭 &quot;prod&quot;로 컬렉션 &quot;my-collection&quot;에 아티팩트가 연결될 때 트리거되는 이벤트를 정의합니다:
...
* `scope` (Union[&#95;ArtifactSequenceScope, &#95;ArtifactPortfolioScope, ProjectScope]): 이벤트의 스코프입니다.
* `filter` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트가 트리거되기 위해 필요한 추가 조건(있는 경우)입니다.
