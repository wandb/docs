...
예제:
프로젝트 &quot;my-project&quot; 내의 모든 런에 대해
상태가 &quot;finished&quot; (즉, 성공) 또는 &quot;failed&quot;로 변경될 때 트리거되는 이벤트를 정의합니다:
...
* `scope` (ProjectScope): 이벤트의 스코프: 프로젝트여야 합니다.
* `filter` (RunStateFilter): 이 이벤트가 트리거되기 위해 만족해야 하는 Run 상태 조건입니다.
