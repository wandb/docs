...
## <Badge color="yellow" size="lg" shape="rounded">클래스</Badge> wandb.automations.SendNotification {#class-wandbautomationssendnotification}
...
### <Badge color="blue" size="lg" shape="rounded">방법</Badge> SendNotification.from_integration() {#method-sendnotificationfrom_integration}
