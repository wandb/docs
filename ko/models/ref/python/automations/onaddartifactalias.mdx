...
예시:
컬렉션 &quot;my-collection&quot; 내의 임의의 아티팩트에 별칭 &quot;prod&quot;가
할당될 때마다 트리거되는 이벤트를 정의합니다:
...
* `filter` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트가 트리거되도록 필요한 추가 조건(있다면)입니다.
