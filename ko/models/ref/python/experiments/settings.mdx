...
1. Public settings: 사용자가 자신의 필요에 맞게 W&amp;B의 동작을 안전하게 변경할 수 있는
   핵심 설정 옵션입니다.
...
3. Computed settings: 다른 설정이나 환경으로부터 자동으로 계산되는 읽기 전용 설정입니다.
...
__init__(
    ...
    anonymous: 'object' = <object object at 0x109045240>,
