...
## <Badge color="yellow" size="lg" shape="rounded">Class</Badge> wandb.Settings {#class-wandbsettings}
...
### <Badge color="blue" size="lg" shape="rounded">메서드</Badge> Settings.validate_anonymous() {#method-settingsvalidate_anonymous}
...
### <Badge color="blue" size="lg" shape="rounded">메서드</Badge> Settings.validate_x_extra_http_headers() {#method-settingsvalidate_x_extra_http_headers}
...
### <Badge color="blue" size="lg" shape="rounded">메서드</Badge> Settings.validate_x_stats_coreweave_metadata_base_url() {#method-settingsvalidate_x_stats_coreweave_metadata_base_url}
