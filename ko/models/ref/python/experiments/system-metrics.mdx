...
각 TPU 코어의 현재 High Bandwidth Memory 사용량(바이트 단위)입니다.
...
TPU 장치별 TensorCore 듀티 사이클 백분율입니다. 샘플링 기간 동안 가속기 TensorCore가 실제로 처리 작업을 수행한 시간의 비율을 나타냅니다. 값이 클수록 TensorCore 사용량이 더 높습니다.
