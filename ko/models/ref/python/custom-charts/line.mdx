...
<div id="function-wandbplotline">
  ## <Badge color="blue" size="lg" shape="rounded">함수</Badge> wandb.plot.line()
</div>
...
<ResponseField name="split_table" type="bool">
  테이블을 W&amp;B UI의 별도 섹션으로 분리할지 여부입니다. `True`이면 테이블이 &quot;맞춤형 차트 Tables&quot;라는 이름의 섹션에 표시됩니다. 기본값은 `False`입니다.
</ResponseField>
