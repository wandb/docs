...
유형별 단일 artifact collection을 반환합니다.

반환된 `ArtifactCollection` 객체를 사용해 해당 collection의 특정 artifact에 대한 정보를 조회하는 등 추가 작업을 수행할 수 있습니다.

**인수:**

* `type_name`: 가져올 artifact collection의 유형입니다.
* `name`: artifact collection 이름입니다. 필요에 따라 artifact를 로깅한 entity를 접두사로 추가한 뒤 슬래시(`/`)를 붙일 수 있습니다.

**반환값:**
`ArtifactCollection` 객체입니다.

**예시:**
다음 코드 스니펫에서 &quot;type&quot;, &quot;entity&quot;, &quot;project&quot;, &quot;artifact&#95;name&quot;는 각각 collection 유형, 사용자의 W&amp;B entity, artifact가 속한 프로젝트 이름, artifact 이름을 나타내는 플레이스홀더입니다.
...
조건에 맞는 artifact collection 목록을 반환합니다.
...
* `access`: 차트의 액세스 수준: - &quot;private&quot;: 차트를 만든 entity만 차트에 액세스할 수 있습니다 - &quot;public&quot;: 누구나 차트에 액세스할 수 있습니다
...
**반환값:**
`Run` 객체를 순회할 수 있는 collection인 `Runs` 객체입니다.
