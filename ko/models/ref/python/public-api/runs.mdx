...
## <Badge color="yellow" size="lg" shape="rounded">클래스</Badge> wandb.apis.public.Runs {#class-wandbapispublicruns}
...
### <Badge color="blue" size="lg" shape="rounded">방법</Badge> Runs.histories() {#method-runshistories}
...
### <Badge color="blue" size="lg" shape="rounded">방법</Badge> Runs.upgrade_to_full() {#method-runsupgrade_to_full}
