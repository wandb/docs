...
<Note>W&amp;B Report and Workspace API는 Public Preview 상태입니다.</Note>
...
* `filters` (Union[str, LList[expr.FilterExpr]]):  runset에 적용할 필터 목록 또는 문자열 표현식입니다. - 목록인 경우: 필터는 AND로 결합됩니다. 필터 생성에 대한 자세한 내용은 FilterExpr를 참조하세요. - 문자열인 경우: Python 스타일 표현식을 사용합니다. 예: &quot;Config(&#39;lr&#39;) = 0.001 and State = &#39;finished&#39;&quot;
