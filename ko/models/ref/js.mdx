...
현재 Python SDK에서 제공되는 많은 기능이 누락되었지만 기본 로깅 기능은 사용할 수 있습니다. 곧 [Tables](/ko/models/tables/?utm_source=github&utm_medium=code&utm_campaign=wandb&utm_content=readme) 와 같은 추가 기능을 추가할 예정입니다.
