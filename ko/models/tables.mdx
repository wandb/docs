...
cascade:
- slug: /ko/guides/models/tables/:filename
menu:
  default:
    identifier: ko-guides-models-tables-_index
    parent: models
slug: /ko/guides/models/tables
weight: 2
---
...
- [`wandb.init()`](/ko/models/ref/python/init): 결과를 추적하기 위해 [run](/ko/models/runs/)을 생성합니다.
- [`wandb.Table()`](/ko/models/ref/python/data-types/table): 새 table 오브젝트를 생성합니다.
  - `columns`: 열 이름을 설정합니다.
  - `data`: table의 내용을 설정합니다.
- [`run.log()`](/ko/models/ref/python/log): table을 기록하여 W&B에 저장합니다.
...
## 시작 방법
* [퀵스타트](/ko/models/tables/tables-walkthrough/): 데이터 table 기록, 데이터 시각화 및 데이터 쿼리에 대해 알아봅니다.
* [Tables Gallery](/ko/models/tables/tables-gallery/): Tables의 유스 케이스 예시를 확인하세요.
