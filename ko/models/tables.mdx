...
- [`wandb.Table()`](/ko/models/ref/python/data-types/table): 새로운 테이블 오브젝트를 생성합니다.
  ...
  - `data`: 테이블의 내용을 설정합니다.
- [`run.log()`](/ko/models/ref/python/experiments/run.md/#method-runlog): 테이블을 W&B에 저장하기 위해 로그합니다.
...
## 시작 방법
* [퀵스타트](/ko/models/tables/tables-walkthrough/): 데이터 테이블 로그, 데이터 시각화 및 데이터 쿼리 방법을 배웁니다.
* [Tables 갤러리](/ko/models/tables/tables-gallery/): Tables의 다양한 유스 케이스 예시를 확인합니다.