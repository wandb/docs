...
([`wandb.init.log_artifact`](/ko/models/ref/python/run#log_artifact))를 사용하여 아티팩트를 run의 출력으로 선언합니다.
...
아티팩트 생성에 대한 자세한 내용은 [아티팩트 생성](/ko/models/artifacts/construct-an-artifact/)을 참조하십시오.
