...
[`wandb.Api().artifact_collection()`](/ko/models/ref/python/public-api/api#artifact_collection) 메서드를 사용하여 컬렉션의 설명에 엑세스합니다. 반환된 오브젝트의 `description` 속성을 사용하여 컬렉션에 대한 설명을 추가하거나 업데이트합니다.
