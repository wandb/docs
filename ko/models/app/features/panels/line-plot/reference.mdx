---
title: 선형 플롯 참조
description: "x축, y축, 스무딩, 집계, 그룹화 옵션을 포함한 선형 플롯 패널 설정에 대한 참조입니다."
---

import LinePlotCaptureGroups from "/snippets/ko/_includes/line-plot-capture-groups.mdx";

이 페이지에서는 선형 플롯 설정을 자세히 설명합니다. 선형 플롯을 사용하는 방법에 대한 더 자세한 내용은 [선형 플롯 개요](/ko/models/app/features/panels/line-plot)를 참고하세요.
...
[스무딩 계수](/ko/support/models/articles/what-formula-do-you-use-for-your-smoothi)를 0과 1 사이의 값으로 설정합니다. 0은 스무딩 없음, 1은 최대 스무딩을 의미합니다.
