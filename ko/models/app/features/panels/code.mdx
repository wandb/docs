...
이 방식은 현재 디렉토리와 모든 하위 디렉토리에 있는 모든 파이썬 소스 코드 파일을 [아티팩트](/ko/models/ref/python/experiments/artifact)로 캡처합니다. 저장되는 소스 코드 파일의 유형과 위치를 더 자세히 제어하려면 [레퍼런스 문서](/ko/models/ref/python/experiments/run#log_code)를 참조하세요.
