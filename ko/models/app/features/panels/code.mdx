---
title: 코드 저장 및 비교
description: "코드 저장을 활성화하고, 코드 비교 도구를 사용해 W&B Runs 간 코드를 비교하며, Jupyter 세션 이력을 캡처합니다."
---
...
W&amp;B는 Jupyter 노트북 세션에서 실행된 코드의 이력을 저장합니다. Jupyter 노트북에서 **wandb.init()** 을 호출하면, W&amp;B는 현재 세션에서 실행된 코드 이력을 포함하는 Jupyter 노트북을 자동으로 저장하기 위한 훅을 추가합니다.
