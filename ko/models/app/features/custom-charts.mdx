...
title: Custom charts
cascade:
- slug: /ko/guides/app/features/custom-charts/:filename
menu:
  default:
    identifier: ko-guides-models-app-features-custom-charts-_index
    parent: w-b-app-ui-reference
slug: /ko/guides/app/features/custom-charts
weight: 2
---
...
1. **데이터 기록**: 스크립트에서 [config](/ko/models/track/config/) 및 요약 데이터를 기록합니다.
