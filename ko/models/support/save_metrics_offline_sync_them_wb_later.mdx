---
title: 메트릭을 오프라인으로 저장하고 나중에 W&B에 동기화할 수 있나요?
---

기본적으로 `wandb.init`은 메트릭을 클라우드에 실시간으로 동기화하는 프로세스를 시작합니다. 오프라인에서 사용하려면 두 개의 환경 변수를 설정하여 오프라인 모드를 활성화하고 나중에 동기화할 수 있습니다.
