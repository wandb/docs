...
이 예제들은 [`wandb.Run.log()`](/ko/models/ref/python/experiments/run/#method-runlog/)를 사용하여 여러 가지 방식으로 loss를 로그하는 방법을 보여줍니다.
...
더 자세한 내용은 [로그 관련 문서](/ko/models/track/log/)를 참조하세요.