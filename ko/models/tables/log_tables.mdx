...
## 테이블 생성 및 로깅 {#create-and-log-a-table}
...
### INCREMENTAL 모드 {#incremental-mode}
...
### MUTABLE로 평가 결과 보강하기 {#enriching-evaluation-results-with-mutable}
...
### INCREMENTAL 테이블로 run 재개하기 {#resuming-runs-with-incremental-tables}
...
### INCREMENTAL 배치 트레이닝을 사용해 트레이닝하기 {#training-with-incremental-batch-training}
