...
### 데이터를 대화형으로 탐색하세요 {#interactively-explore-your-data}
...
### 모델 버전 비교 {#compare-model-versions}
...
### 모든 세부 정보를 추적하고 큰 그림을 확인하세요 {#track-every-detail-and-see-the-bigger-picture}
...
## W&amp;B 테이블를 사용하는 예시 프로젝트 {#example-projects-with-wb-tables}
...
### 모델 변형 비교(시맨틱 세그멘테이션) {#comparing-model-variants-semantic-segmentation}
...
### 트레이닝 시간 경과에 따른 개선 분석 {#analyzing-improvement-over-training-time}
