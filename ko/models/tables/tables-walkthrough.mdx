---
description: 5분 퀵스타트에서 W&B Tables 사용 방법을 알아보세요.
title: '튜토리얼: 테이블 로깅, 시각화, 데이터 쿼리'
---
...
## 2. 프로젝트 워크스페이스에서 테이블 시각화하기 {#2-visualize-tables-in-your-project-workspace}
...
## 3. 여러 모델 버전 비교하기 {#3-compare-across-model-versions}
