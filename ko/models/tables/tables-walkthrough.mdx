...
- [`wandb.Table()`](/ko/models/ref/python/data-types/table): 새로운 테이블 오브젝트를 생성합니다.
  - `columns`: 열 이름을 설정합니다.
  - `data`: 각 행의 내용을 설정합니다.
- [`run.log()`](/ko/models/ref/python/log): 테이블을 기록하여 W&B에 저장합니다.
...
지원되는 데이터 유형에 대한 자세한 내용은 W&B API Reference Guide의 [`wandb.Table`](/ko/models/ref/python/data-types/table)을 참조하세요.
</Tab>
</Tabs>
