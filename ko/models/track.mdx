...
W&B SDK의 내부 동작에 대해 더 알아보려면 다음 페이지를 참조하세요.

- [SDK Architecture](/models/track/sdk-architecture/) — 이벤트 기반 아키텍처와 데이터 흐름
- [SDK Performance](/models/track/sdk-performance/) — 성능 가이드라인, GPU/CPU 동기화, 모범 사례