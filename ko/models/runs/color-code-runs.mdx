...
<Note>
키 기반 색상을 사용하면 [Run 색상 커스텀하기](/ko/models/runs/run-colors) 옵션을 사용할 수 없습니다.
</Note>
...
**Key** 드롭다운의 메트릭 옵션은 [사용자가 W&B에 로그한](/ko/models/runs/color-code-runs/#custom-metrics) 키-값 쌍과 W&B 에서 정의한 [기본 메트릭](/ko/models/runs/color-code-runs/#default-metrics)에서 파생됩니다.
