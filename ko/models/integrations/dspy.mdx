---
description: "프롬프트, 평가, 컴파일된 모듈 성능을 로깅하기 위해 W&B로 DSPy 프로그램을 추적하고 최적화합니다."
title: DSPy
---

W&amp;B를 DSPy와 함께 사용하여 언어 모델 프로그램을 추적하고 최적화하세요. W&amp;B는 [Weave DSPy 통합](/ko/weave/guides/integrations/dspy)을 보완하여 다음을 제공합니다:

* 시간에 따른 평가 메트릭 추적
* 프로그램 시그니처 진화를 위한 W&amp;B Tables
* MIPROv2와 같은 DSPy 옵티마이저와의 통합

DSPy 모듈을 최적화할 때 포괄적인 관측 기능을 확보하려면 W&amp;B와 Weave 모두에서 통합을 활성화하세요.
