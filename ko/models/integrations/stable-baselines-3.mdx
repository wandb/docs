...
[Stable Baselines 3](https://github.com/DLR-RM/stable-baselines3) (SB3)는 PyTorch로 구현된 신뢰할 수 있는 강화 학습 알고리즘 모음입니다. W&amp;B SB3 인테그레이션은 다음을 지원합니다:
...
SB3 트레이닝을 W&amp;B에 로깅하려면 모델의 `learn` 메서드에 `WandbCallback`을 전달하세요:
...
다음 표에서는 `WandbCallback`에 전달할 수 있는 인수를 설명합니다:
