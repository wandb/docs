---
title: Hugging Face
description: "W&B로 Hugging Face 모델의 성능을 시각화하고 추적하세요. 하이퍼파라미터, 메트릭, GPU 사용량도 함께 로깅할 수 있습니다."
---
...
원활한 [W&amp;B](https://wandb.ai/site) 통합을 통해 [Hugging Face](https://github.com/huggingface/transformers) 모델의 성능을 빠르게 시각화하세요.
