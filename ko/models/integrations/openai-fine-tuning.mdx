...
## OpenAI Python API 설치 또는 업데이트 {#install-or-update-openai-python-api}
...
## OpenAI 파인튜닝 결과 동기화하기 {#sync-your-openai-fine-tuning-results}
...
### 파인튜닝 결과 동기화하기 {#sync-your-fine-tunes}
...
## 데이터셋 버전 관리 및 시각화 {#dataset-versioning-and-visualization}
...
## 파인튜닝된 모델과 모델 버전 관리 {#the-fine-tuned-model-and-model-versioning}
...
### 파인튜닝 결과를 팀과 공유하세요 {#share-fine-tune-results-with-your-team}
...
### 파인튜닝된 모델에 액세스하기 {#access-your-fine-tuned-model}
...
### 동기화되지 않은 파인튜닝 복구 {#recover-a-fine-tune-that-didnt-sync}
...
### W&amp;B로 데이터셋과 모델 추적 {#track-datasets-and-models-with-wb}
