...
1. `WANDB_API_KEY` [환경 변수](/ko/models/track/environment-variables/)를 본인의 API 키로 설정합니다.
...
[`wandb.init()`](/ko/models/ref/python/functions/init)에 전달하고 싶은 추가 선택적 인수는 yaml 파일의 `wandb` 헤더 아래에 추가할 수 있습니다:
