...
2. [User Settings](https://wandb.ai/settings)에서 API 키를 생성합니다. 프로덕션 환경에서는 해당 키를 [service account](/ko/models/support/service_account_useful)에서 소유하도록 설정하는 것을 권장합니다.
