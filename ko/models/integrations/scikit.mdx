---
title: Scikit-Learn
description: "W&B를 사용해 실험 추적과 자동 플롯 로깅으로 scikit-learn 모델 성능을 시각화하고 비교하세요."
---

import ApiKeyCreateStreamlined from "/snippets/ko/_includes/api-key-create-streamlined.mdx";

wandb를 사용하면 간단한 코드 몇 줄만으로 scikit-learn 모델의 성능을 시각화하고 비교할 수 있습니다. [예시 보기 →](https://wandb.me/scikit-colab)
