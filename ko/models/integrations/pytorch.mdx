---
title: PyTorch
description: "실험 추적, 데이터셋 버전 관리, 메트릭, 그래디언트, 모델 로깅을 위해 W&B를 PyTorch와 통합하세요."
---
...
2. [Offline mode](/ko/support/models/articles/can-i-run-wandb-offline): `dryrun` 모드를 사용해 오프라인으로 트레이닝하고, 나중에 결과를 동기화하세요.
