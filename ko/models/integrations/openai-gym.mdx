...
이 페이지에서는 [OpenAI Gym](https://github.com/openai/gym)과 함께 W&amp;B를 사용하여 강화 학습 환경의 비디오를 자동으로 캡처하는 방법을 설명합니다. 그런 다음 W&amp;B에서 실험 메트릭과 함께 에이전트 동작을 검토할 수 있습니다.
...
[CleanRL](https://github.com/vwxyzjn/cleanrl)의 [OpenRL Benchmark](https://wandb.me/openrl-benchmark-report)는 OpenAI Gym 예제에 이 인테그레이션을 사용합니다. gym을 W&amp;B와 함께 사용하는 방법을 보여 주는 소스 코드([특정 run에 사용된 코드](https://wandb.ai/cleanrl/cleanrl.benchmark/runs/2jrqfugg/code?workspace=user-costa-huang) 포함)는 다음에서 확인할 수 있습니다.
