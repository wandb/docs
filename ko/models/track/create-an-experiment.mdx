...
W&amp;B 대시보드를 머신러닝 모델의 결과를 정리하고 시각화하는 중심 공간으로 활용하세요. 몇 번의 클릭만으로 [평행좌표 플롯](/ko/models/app/features/panels/parallel-coordinates/), [파라미터 중요도 분석](/ko/models/app/features/panels/parameter-importance/), [추가 차트 유형](/ko/models/app/features/panels/)과 같은 풍부하고 대화형 차트를 구성할 수 있습니다.

<Frame>
  <img src="/images/sweeps/quickstart_dashboard_example.png" alt="Quickstart Sweeps Dashboard example" />
</Frame>

실험과 특정 run을 보는 방법에 대한 자세한 내용은 [실험 결과 시각화](/ko/models/track/workspaces/)를 참조하세요.
