...
## W&amp;B 실험을 생성하는 방법 {#how-to-create-a-wb-experiment}
...
### W&amp;B run 초기화 {#initialize-a-wb-run}
...
### 하이퍼파라미터 딕셔너리 기록하기 {#capture-a-dictionary-of-hyperparameters}
...
### 트레이닝 루프 내에서 메트릭 로깅하기 {#log-metrics-inside-your-training-loop}
...
### W&amp;B에 Artifact 로깅하기 {#log-an-artifact-to-wb}
...
## 다음 단계: 실험 시각화 {#next-steps-visualize-your-experiment}
