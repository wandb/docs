...
### 모델 평가 차트 {#model-evaluation-charts}
...
### 대화형 맞춤형 차트 {#interactive-custom-charts}
...
### Matplotlib 및 Plotly 플롯 {#matplotlib-and-plotly-plots}
...
### W&amp;B Tables에 맞춤형 HTML 로깅하기 {#log-custom-html-to-wb-tables}

W&amp;B에서는 Plotly와 Bokeh의 대화형 차트를 HTML로 로깅해 Tables에 추가할 수 있습니다.

#### Plotly figure를 HTML로 변환해 Tables에 로깅하기 {#log-plotly-figures-to-tables-as-html}
...
#### Bokeh figure를 HTML로 변환해 Tables에 로깅하기 {#log-bokeh-figures-to-tables-as-html}
