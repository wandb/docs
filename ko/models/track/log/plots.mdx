...
전체적으로 맞춤 설정하려면 기본 제공 [맞춤형 차트 프리셋](/ko/models/app/features/custom-charts/walkthrough/)을 조정하거나 새 프리셋을 만든 다음 차트를 저장하세요. 차트 ID를 사용해 스크립트에서 바로 해당 맞춤형 프리셋에 데이터를 로깅할 수 있습니다.
