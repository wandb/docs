...
[위에서 정의한 것과 동일한 배열 형식](#numpy-array-formats)을 사용하여 [`numpy` 배열을 [`the `from_numpy` method](/ko/models/ref/python/data-types/object3d/#from_numpy)와 함께 직접 사용하여 포인트 클라우드를 정의할 수 있습니다.
