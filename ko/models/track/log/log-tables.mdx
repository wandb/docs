...
1. [Tables 생성](./log-tables#tables-생성)
2. [데이터 추가](./log-tables#데이터-추가)
3. [데이터 검색](./log-tables#데이터-검색)
4. [Tables 저장](./log-tables#tables-저장)
...
Artifacts에 대한 자세한 내용은 개발자 가이드의 [Artifacts 챕터](/ko/models/artifacts/)를 참조하세요.

### Tables 시각화

이러한 방식으로 로그된 모든 테이블은 Run 페이지와 Project 페이지 모두의 Workspace에 표시됩니다. 자세한 내용은 [Tables 시각화 및 분석](/ko/models/tables/visualize-tables/)을 참조하세요.
