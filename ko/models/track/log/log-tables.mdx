...
1. [테이블 만들기](/ko/models/track/log/log-tables/#%ED%85%8C%EC%9D%B4%EB%B8%94-%EB%A7%8C%EB%93%A4%EA%B8%B0)
2. [데이터 추가](/ko/models/track/log/log-tables/#%EB%8D%B0%EC%9D%B4%ED%84%B0-%EC%B6%94%EA%B0%80)
3. [데이터 검색](/ko/models/track/log/log-tables/#%EB%8D%B0%EC%9D%B4%ED%84%B0-%EA%B2%80%EC%83%89)
4. [테이블 저장](/ko/models/track/log/log-tables/#%ED%85%8C%EC%9D%B4%EB%B8%94-%EC%A0%80%EC%9E%A5)
...
Artifacts에 대한 자세한 내용은 개발자 가이드의 [Artifacts 챕터](/ko/models/artifacts/)를 참조하십시오.

### 테이블 시각화

이러한 방식으로 기록된 테이블은 Run 페이지와 Project 페이지 모두의 Workspace에 표시됩니다. 자세한 내용은 [테이블 시각화 및 분석](/ko/models/tables/visualize-tables/)을 참조하십시오.
