...
2.  **코드 저장**: 모델을 재현할 때 노트북의 어떤 셀이 어떤 순서로 실행되었는지 파악하기 어려울 수 있습니다. [설정 페이지](/ko/platform/app/settings-page/)에서 코드 저장을 활성화하여 각 실험에 대한 셀 실행 기록을 저장하세요.
...
<Note>
W&B로 무엇을 더 할 수 있는지 알고 싶으신가요? [데이터 및 미디어 로깅 가이드](/ko/models/track/log/)를 확인하거나, [선호하는 ML 툴킷과의 인테그레이션 방법](/ko/models/integrations)을 알아보세요. 또는 [레퍼런스 문서](/ko/models/ref/python/)나 [예제 레포지토리](https://github.com/wandb/examples)를 바로 살펴보실 수 있습니다.
</Note>
