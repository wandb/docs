...
## API를 사용하여 계보 추적
[W&B API](/ko/models/ref/python/public-api/api)를 사용하여 그래프를 탐색할 수도 있습니다.
...
Artifact 오브젝트의 [`logged_by`](/ko/models/ref/python/artifact#logged_by) 및 [`used_by`](/ko/models/ref/python/artifact#used_by) 메서드를 사용하여 Artifact에서 그래프를 탐색합니다.
...
```
## 다음 단계
- [Artifacts를 더 자세히 살펴보기](/ko/models/artifacts/artifacts-walkthrough/)
- [Artifact 스토리지 관리](/ko/models/artifacts/delete-artifacts/)
