...
특정 artifact 버전에 설정된 TTL 정책을 비활성화하려면 W&amp;B Python SDK 또는 W&amp;B App UI를 사용하세요.

{/* <Note>
  TTL이 비활성화된 artifact는 artifact 컬렉션의 TTL을 상속하지 않습니다. artifact TTL을 삭제하고 컬렉션 수준의 TTL을 상속하는 방법은 ## Inherit TTL Policy를 참고하세요.
  </Note> */}
...
<Tabs>
  ...
  <Tab title="W&B App">
    ...
    5. Version 탭을 클릭합니다.
    6. **Link to registry** 버튼 옆의 점 세 개 UI 아이콘을 클릭합니다.
