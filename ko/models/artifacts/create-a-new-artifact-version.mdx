...
## 처음부터 새 아티팩트 버전 만들기 {#create-new-artifact-versions-from-scratch}
...
## 기존 버전에서 새 아티팩트 버전 만들기 {#create-a-new-artifact-version-from-an-existing-version}
