...
W&B 앱 내에서 파일 브라우저를 사용하여 reference artifact의 콘텐츠를 살펴보고, [전체 종속성 그래프를 탐색](/ko/models/artifacts/explore-and-traverse-an-artifact-graph/)하며, 아티팩트의 버전 관리 히스토리를 스캔할 수 있습니다. 데이터 자체가 아티팩트 내에 포함되어 있지 않기 때문에 W&B 앱은 이미지, 오디오 등의 리치 미디어를 렌더링하지 않습니다.
