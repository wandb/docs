...
## Artifact 가비지 컬렉션 워크플로 {#artifact-garbage-collection-workflow}
...
## artifact 버전 삭제 {#delete-an-artifact-version}
...
## 여러 artifact 버전 삭제 {#delete-multiple-artifact-versions}
...
## 특정 alias가 있는 여러 artifact 버전 삭제 {#delete-multiple-artifact-versions-with-a-specific-alias}
...
## artifact 컬렉션 삭제 {#delete-an-artifact-collection}
...
## 보호된 별칭 및 삭제 권한 {#protected-aliases-and-deletion-permissions}
...
## W&amp;B 호스팅 방식에 따라 가비지 컬렉션 활성화 {#enable-garbage-collection-based-on-how-wb-is-hosted}
