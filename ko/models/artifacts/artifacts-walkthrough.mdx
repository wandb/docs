...
## 3. 아티팩트 객체 만들기 {#3-create-an-artifact-object}
...
## 4. 데이터셋을 아티팩트에 추가 {#4-add-the-dataset-to-the-artifact}
...
## 6. 아티팩트 다운로드 및 사용 {#6-download-and-use-the-artifact}
