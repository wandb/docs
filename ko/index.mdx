...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    >
        ...
        <br/>
        <br/>
        • <a href="/ko/models">Introduction</a><br/>
        • <a href="/ko/models/quickstart">Quickstart</a><br/>
    ...
    >   
        ...
        <br/>
        <br/>
        • <a href="/ko/weave">Introduction</a><br/>
        • <a href="/ko/weave/quickstart">Quickstart</a><br/>
    ...
    >
        ...
        <br/>
        <br/>
        • <a href="/ko/inference">Introduction</a><br/>
    ...
    >
        ...
        <br/>
        <br/>
        • <a href="/ko/training">Introduction</a><br/>
        • <a href="/ko/training/prerequisites">Quickstart</a><br/>
    </ProductCard>
</div>
</HomeWrapper>