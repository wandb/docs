...
description: "W&B Weave로 Leaderboard 퀵스타트를 사용하는 방법을 알아보세요"
---
...
<div id="step-1-generate-a-dataset-of-fake-zip-code-data">
  ## Step 1: 가짜 우편번호 데이터셋 생성하기
</div>

먼저 가짜 우편번호 데이터로 이루어진 목록을 생성하는 `generate_dataset_rows` 함수를 만듭니다.
...
이제 모델과 평가의 조합으로 구성된 매트릭스를 평가합니다.
...
<div id="step-7-review-the-leaderboard">
  ## step 7: Leaderboard 검토
</div>

UI에서 Leaderboard 탭으로 이동한 다음 &quot;Create Leaderboard&quot;를 클릭하면 새 Leaderboard를 만들 수 있습니다.
