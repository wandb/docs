...
# 리더보드 퀵스타트 {#leaderboard-quickstart}
...
## Step 1: 가짜 우편번호 데이터셋 생성 {#step-1-generate-a-dataset-of-fake-zip-code-data}
...
## Step 2: 점수화 함수 작성 {#step-2-author-scoring-functions}
...
## Step 3: Evaluation 만들기 {#step-3-create-an-evaluation}
...
## Step 4: 기준선 모델 Evaluate {#step-4-evaluate-a-baseline-model}
...
## Step 5: 모델 더 만들기 {#step-5-create-more-models}
...
## Step 6: 더 많은 Evaluation 만들기 {#step-6-create-more-evaluations}
...
## 7단계: 리더보드 검토 {#step-7-review-the-leaderboard}
