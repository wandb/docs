...
## Weave로 통합: 프로덕션 대시보드 {#integrate-with-weave-production-dashboard}
...
### Weave 클라이언트 초기화 및 비용 정의 {#initialize-the-weave-client-and-define-costs}
...
### Weave에서 Call 데이터 가져오기 {#fetch-calls-data-from-weave}
...
#### Call 단위로 데이터 가져오기 {#fetch-data-call-by-call}
...
#### 고수준 API 사용 {#use-high-level-apis}
...
### 입력 데이터 수집 및 시각화 생성 {#gather-inputs-and-generate-visualizations}
