...
description: "W&B Weave에서 Service API를 통해 Weave tracing을 사용하는 방법을 알아보세요"
...
## 사전 요구 사항: 변수 및 엔드포인트 설정 {#prerequisites-set-variables-and-endpoints}
...
### 단순한 트레이스 시작하기 {#start-a-simple-trace}
...
### 단순한 트레이스 종료 {#end-a-simple-trace}
...
### 복잡한 트레이스 시작 {#start-a-complex-trace}
...
### RAG 문서 조회용 하위 span 추가 {#add-a-child-span-for-a-rag-document-lookup}
...
### LLM completion call에 대한 하위 span 추가 {#add-a-child-span-for-an-llm-completion-call}
...
### 복잡한 트레이스 종료 {#end-a-complex-trace}
...
## lookup 쿼리 실행 {#run-a-lookup-query}
