---
title: "DSPy 프롬프트 최적화"
description: "W&B Weave를 사용해 dspy 프롬프트 최적화를 수행하는 방법을 알아보세요"
...
## Weave를 사용해 추적 활성화 {#enable-tracking-using-weave}
...
## BIG-Bench Hard 데이터셋 불러오기 {#load-the-big-bench-hard-dataset}
...
### 인과 추론 시그니처 작성하기 {#write-the-causal-reasoning-signature}
...
## DSPy 프로그램 평가하기 {#evaluate-the-dspy-program}
...
## DSPy 프로그램 최적화하기 {#optimize-the-dspy-program}
