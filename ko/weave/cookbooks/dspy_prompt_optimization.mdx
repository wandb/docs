...
<Frame>![데이터셋 준비 step과 데이터 구조를 보여주는 DSPy 데이터셋 로딩 인터페이스](/media/dspy_optimization/1.png)</Frame>
...
<Frame>![성능 메트릭과 출력 예시가 포함된 베이스라인 DSPy 프로그램 평가 결과](/media/dspy_optimization/2.png) ## DSPy 프로그램 평가하기</Frame>
...
<Frame>![DSPy 프로그램의 성능 메트릭, 트레이스, 비교 결과를 보여주는 Weave 평가 대시보드](/media/dspy_optimization/3.png)</Frame>
...
<Warning>인과 추론 데이터셋으로 평가를 실행하면 OpenAI 크레딧이 약 $0.24 소요됩니다.</Warning>
