...
<img src="https://i.imgur.com/OUfsZ2x.png" alt="GPT 4o Audio Preview 인테그레이션과 오디오 응답 생성 워크플로우가 포함된 OpenAI Chat Completions API 인터페이스" />
...
<img src="https://i.imgur.com/ZiW3IVu.png" alt="Weave와 Realtime Audio API 인테그레이션 및 스트리밍 오디오 대화 인터페이스" />
