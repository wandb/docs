...
## HuggingFace 데이터셋 로드 및 준비 {#load-and-prepare-huggingface-dataset}
...
## 처리 및 평가 함수 정의 {#define-processing-and-evaluation-functions}
...
## 평가 생성 및 실행 {#create-and-run-the-evaluation}
