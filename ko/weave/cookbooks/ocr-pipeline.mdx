...
## Weave로 프롬프트를 만들고 반복적으로 개선하기 {#create-and-iterate-on-prompts-with-weave}
...
## NER 파이프라인 구축하기 {#build-the-ner-pipeline}
...
## Weave를 사용해 파이프라인 평가하기 {#evaluate-the-pipeline-using-weave}
...
### 프로그램 방식 Scorer {#programatic-scorer}
...
### LLM-as-a-judge scorer {#llm-as-a-judge-scorer}
