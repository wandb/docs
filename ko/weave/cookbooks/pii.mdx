...
<Frame>
  ![파악된 PII entity와 마스킹된 텍스트 출력이 포함된 Presidio PII 마스킹 프로세스](/media/pii/redact.png)
</Frame>
...
<Frame>
  ![원본 텍스트, 파악된 PII, 익명화된 대체 값으로 구성된 Faker 및 Presidio PII 대체 프로세스](/media/pii/replace.png)
</Frame>
