...
## 서드파티 시스템에서 트레이스 가져오기 {#import-traces-from-third-party-systems}
...
## 트레이스를 Weave에 기록하기 {#log-the-traces-to-weave}
...
## 결과: Weave에 로깅된 트레이스 {#result-traces-logged-to-weave}
...
## 선택 사항: 평가 실행을 위해 트레이스 내보내기 {#optional-export-your-traces-to-run-evaluations}
