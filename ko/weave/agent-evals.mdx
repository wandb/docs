...
## 에이전트 구축 및 트레이싱 {#build-and-trace-the-agent}
...
## LLM 평가자로 에이전트 점수 매기기 {#score-the-agent-with-an-llm-judge}
...
## 평가 구성 및 비교 {#organize-and-compare-evaluations}
...
## 여러 턴으로 이루어진 대화 점수 매기기 {#score-a-multi-turn-conversation}
