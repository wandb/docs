...
<div id="build-a-knowledge-base">
  ## 지식 베이스 구축하기 {#build-a-knowledge-base}
</div>
...
<div id="evaluate-with-an-llm-judge">
  ## LLM 기반 평가자로 평가하기 {#evaluate-with-an-llm-judge}
</div>
...
<div id="define-a-scoring-function">
  ### 점수 함수 정의하기 {#define-a-scoring-function}
</div>
...
<div id="optional-define-a-scorer-class">
  ### 선택 사항: `Scorer` 클래스 정의하기 {#optional-define-a-scorer-class}
</div>
...
<div id="put-it-all-together">
  ## 전체를 한데 모아보기 {#put-it-all-together}
</div>
