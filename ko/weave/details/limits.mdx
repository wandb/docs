...
keywords: ["재시도", "시간 초과", "트레이스 잘림", "OpenTelemetry", "예외"]
---

이 페이지에는 Weave의 제한 사항, 알려진 문제, 예상 동작이 나와 있습니다. 예상치 못한 결과가 발생했을 때 또는 Weave가 edge cases를 어떻게 처리하는지 이해하고 싶을 때 레퍼런스로 활용하세요.
...
* Dedicated Weave 인스턴스는 다른 OpenTelemetry 인그레스 URL을 사용합니다. 공식 엔드포인트에 대한 자세한 내용은 [OpenTelemetry Traces 보내기](/ko/weave/guides/tracking/otel)를 참조하세요.
