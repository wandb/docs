...
`weave.init()`를 호출할 때 W&amp;B team을 지정하지 않으면 기본 entity가 사용됩니다. 기본 entity를 찾거나 업데이트하려면 W&amp;B Models 문서의 [User Settings](/ko/platform/app/settings-page/user-settings/#default-team)를 참조하세요.
