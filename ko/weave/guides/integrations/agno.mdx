...
[사전 요구 사항](#prerequisites)을 완료한 후에는 Agno에서 Weave로 OTEL 트레이스를 보낼 수 있습니다. 다음 코드 스니펫은 Agno 애플리케이션에서 Weave로 OTEL 트레이스를 보내도록 OTLP span exporter와 tracer provider를 설정하는 방법을 보여줍니다.
...
<Frame>
  ![Agno 도구 호출에 대한 트레이스 시각화](/weave/guides/integrations/imgs/agno/agno_tool_calls.png)
</Frame>
...
<Frame>
  ![Agno 메모리 사용에 대한 트레이스 시각화](/weave/guides/integrations/imgs/agno/agno_memory_use.png)
</Frame>
