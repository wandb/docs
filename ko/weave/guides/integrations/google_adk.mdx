...
<Frame>
![ADK 에이전트의 트레이스 시각화](./imgs/google_adk/adk_agent_trace.png)
</Frame>
...
<Frame>
![ADK 툴 호출의 트레이스 시각화](./imgs/google_adk/adk_tool_calls.png)
</Frame>
...
<Frame>
![Sequential 워크플로우 에이전트의 트레이스 시각화](./imgs/google_adk/adk_workflow_trace.png)
</Frame>
