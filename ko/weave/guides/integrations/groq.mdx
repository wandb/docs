...
| ![모델 버전, 트레이스 이력 및 성능 메트릭이 표시된 Groq Weave Model 트레이스 및 버전 관리 인터페이스](/weave/guides/integrations/imgs/groq/groq_weave_model.png) |
| ------------------------------------------------------------------------------------------------------------------------------ |
| [`Model`](../core-types/models)을 사용해 Call을 트레이스하고 버전 관리하세요.                                                                    |

### Weave Model 서빙 {#serve-a-weave-model}
