---
title: Groq
description: "Weave로 Groq LPU 추론을 추적하고 모니터링하여, LLM 애플리케이션을 위한 모델 호출, 성능 메트릭, 함수 체인을 캡처합니다."
---
...
`weave.Model` 객체에 대한 weave reference가 있으면 FastAPI 서버를 실행해 이를 [서빙](/ko/weave/guides/tools/serve)할 수 있습니다.
