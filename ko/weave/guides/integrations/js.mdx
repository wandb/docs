...
## TypeScript 프로젝트에서 Weave 인테그레이션 사용하기 {#use-weave-integrations-with-your-typescript-project}
...
### 어떤 유형의 프로젝트인지 잘 모르겠다면 {#if-youre-unsure-which-type-of-project-you-have}
...
### CommonJS 프로젝트 설정 {#set-up-a-commonjs-project}
...
### ESM 프로젝트 설정 {#set-up-an-esm-project}
...
## 고급 활용 및 문제 해결 {#advanced-usage-and-troubleshooting}
...
### `NODE_OPTIONS` 사용하기(ESM 전용) {#use-node_options-only-for-esm}
...
### 수동 패치(대체 옵션) {#manual-patching-fallback-option}
