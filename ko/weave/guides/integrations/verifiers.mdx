---
title: Verifiers
description: "Weave를 사용해 Verifiers RL 환경과 LLM 에이전트 트레이닝을 추적하고, 여러 라운드의 대화와 평가 롤아웃을 캡처합니다."
---
...
`verifiers` 리포지토리에는 바로 실행해 볼 수 있는 [예제](https://github.com/PrimeIntellect-ai/verifiers)가 포함되어 있어 시작하는 데 도움이 됩니다.
...
Verifiers는 W&amp;B Models와 일급 인테그레이션을 제공합니다. 자세한 내용은 [Verifiers 리포지터리](https://github.com/PrimeIntellect-ai/verifiers)를 참고하세요.