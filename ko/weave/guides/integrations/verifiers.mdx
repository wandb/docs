...
`verifiers` 리포지토리에는 바로 실행해 볼 수 있는 [예제](https://github.com/willccbb/verifiers)가 포함되어 있어 시작하는 데 도움이 됩니다.
...
Verifiers는 W&amp;B Models와 일급 인테그레이션을 제공합니다. 자세한 내용은 [Verifiers 리포지토리](https://github.com/willccbb/verifiers)을 참고하세요.