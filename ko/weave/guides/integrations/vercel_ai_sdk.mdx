...
## Next.js용 OTel 트레이싱 설정 {#configure-otel-tracing-for-nextjs}
...
### 계측 설정 {#configure-instrumentation}
...
### 함수에서 telemetry 설정하기 {#configure-telemetry-on-a-function}
...
## Node.js용 OTel 트레이싱 구성 {#configure-otel-tracing-for-nodejs}
