---
title: MistralAI
description: "Weave의 자동 Tracing으로 채팅 completion, 함수 호출, 모델 상호작용 전반에서 MistralAI 모델 Call을 추적하고 모니터링하세요."
keywords: ["mistralai", "mistral-large", "Chat Completion", "LLM Tracing", "함수 호출"]
---
...
## 직접 만든 ops로 Call 감싸기 {#wrap-calls-with-your-own-ops}
