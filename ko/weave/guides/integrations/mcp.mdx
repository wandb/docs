...
## 인테그레이션 사용하기 {#use-the-integration}
...
### 서버 측 인테그레이션 {#server-side-integration}
...
### 클라이언트 측 인테그레이션 {#client-side-integration}
...
## 튜토리얼: `mcp_demo` 예시 {#tutorial-mcp_demo-example}
...
### 클라이언트 CLI 명령어 {#client-cli-commands}
...
### 왜 MCP 트레이싱이 필요한가요? {#why-mcp-tracing-is-needed}
