...
keywords: [PydanticAI, OTEL, OpenTelemetry, 에이전트 트레이싱, 도구 call]
---
...
### Weave에서 OTEL 트레이싱 구성하기 {#configure-otel-tracing-in-weave}
...
## OTEL로 PydanticAI 에이전트 트레이스하기 {#trace-pydanticai-agents-with-otel}
...
<Frame>
  ![기본 PydanticAI 에이전트의 트레이스 시각화](/weave/guides/integrations/imgs/pydantic_ai/pydanticai_agent_trace.png)
</Frame>

## OTEL로 PydanticAI 도구 트레이스하기 {#trace-pydanticai-tools-with-otel}
...
## 기본적으로 모든 에이전트 계측 {#instrument-all-agents-by-default}
