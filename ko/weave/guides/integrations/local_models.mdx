...
`weave.init('<your-project-name>')`으로 Weave를 초기화한 다음, LLM 호출 부분을 `weave.op()`로 래핑하면 어떤 LLM이든 Weave와 쉽게 통합할 수 있습니다. 자세한 내용은 [tracing](/ko/weave/guides/tracking/tracing) 가이드를 참조하세요.
