...
### Weave로 Azure AI Model Inference API 사용하기 {#use-the-azure-ai-model-inference-api-with-weave}
...
### Weave로 Azure OpenAI 모델 트레이스하기 {#trace-azure-openai-models-with-weave}
