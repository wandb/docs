...
이것은 시작을 위한 간단한 예시입니다. 더 복잡한 use case를 위해 Weave를 사용자 정의 함수와 통합하는 방법에 대한 자세한 내용은 [OpenAI](/ko/weave/guides/integrations/openai#track-your-own-ops) 가이드를 참조하세요.