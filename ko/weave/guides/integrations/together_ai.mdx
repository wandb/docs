---
title: "Together AI"
description: "OpenAI SDK 호환성을 사용해 Weave로 Together AI의 오픈 소스 LLM을 추적하여 모델 호출을 원활하게 트레이싱하고 평가할 수 있습니다."
---
...
Together API를 사용하도록 전환하려면, [Together API](https://docs.together.ai/docs/quickstart)용 API 키로 교체하고 `base_url`을 `https://api.together.xyz/v1`로 설정한 다음, `model`을 해당 서비스의 [chat models](https://docs.together.ai/docs/inference-models#chat-models) 중 하나로 변경하면 됩니다.
