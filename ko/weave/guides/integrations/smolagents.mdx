---
title: Smolagents
description: "Weave의 자동 트레이싱으로 Smolagents 애플리케이션을 추적하고, 도구 call, 모델 추론, 여러 step의 에이전트 워크플로를 캡처하세요."
keywords: ["Smolagents", "에이전트", "도구 호출", "Hugging Face", "트레이싱"]
---
...
<Frame>
  ![Weave는 각 추론 call을 기록하고 입력, 출력, 메타데이터에 대한 세부 정보를 제공합니다.](/weave/guides/integrations/imgs/smolagents-trace.png)
</Frame>

## 맞춤형 도구 트레이싱 {#tracing-custom-tools}
