...
<Frame>
  ![Weave는 각 Inference call을 기록하고 입력, 출력, 메타데이터에 대한 세부 정보를 제공합니다.](/weave/guides/integrations/imgs/smolagents-trace.png)
</Frame>
...
Weave는 Smolagents 워크플로의 맞춤형 도구 호출을 자동으로 추적합니다. 다음 예제에서는 Weave로 맞춤형 Smolagents 도구 호출을 로깅하는 방법을 보여줍니다.
...
<Frame>
  ![Weave는 각 맞춤형 도구 call을 기록합니다.](/weave/guides/integrations/imgs/smolagents-custom-tool.png)
</Frame>