---
title: Instructor
description: "Weave의 Instructor 인테그레이션을 통해 LLM에서 구조화된 데이터를 추적하며, Pydantic 검증과 재시도 로직을 캡처합니다."
---
...
`weave.Model` 객체에 대한 Weave reference가 있으면, FastAPI 서버를 띄우고 이를 [`serve`](/ko/weave/guides/tools/serve) 할 수 있습니다.
