...
| ![구조화된 객체, 함수 inputs, outputs, 그리고 Pydantic 모델 검증이 포함된 Instructor op 트레이스](/weave/guides/integrations/imgs/instructor/instructor_op_trace.png)           |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ![모델 버전 및 트레이스 이력이 있는 Instructor Weave Model 트레이싱 및 버전 관리 인터페이스](/weave/guides/integrations/imgs/instructor/instructor_weave_model.png) |
| --------------------------------------------------------------------------------------------------------------------------------------- |
