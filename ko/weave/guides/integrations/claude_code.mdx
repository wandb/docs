---
title: "Claude Code"
description: "W&B Weave를 사용해 모든 대화 턴, 도구 Call, 서브에이전트 상호작용을 포함한 Claude Code 세션을 자동으로 트레이스하고 확인하세요."
keywords: ["weave-claude-plugin", "Claude Code 트레이싱", "에이전트 트레이싱", "서브에이전트", "데몬"]
---
