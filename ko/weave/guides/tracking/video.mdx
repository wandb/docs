...
## 사용을 위한 사전 요구 사항 {#usage-prerequisites}
...
## 지원되는 비디오 유형 {#supported-video-types}
...
### 파일 기반 클립 직접 업로드 {#direct-upload-of-file-based-clips}
...
### 메모리 내 클립 지원 {#in-memory-clip-support}
...
## 예시: 비디오 함수를 트레이스하기 {#example-trace-a-video-function}
