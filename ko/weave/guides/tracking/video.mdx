...
<Frame>
  ![Traces 테이블에 표시된 비디오 처리 함수의 트레이스.](/weave/guides/tracking/imgs/video-trace.png)
</Frame>

<Frame>
  ![Weave에 업로드된 MP4 비디오를 Traces 팝아웃에서 보는 모습.](/weave/guides/tracking/imgs/video-trace-popout.png)
</Frame>