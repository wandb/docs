...
<Tabs>
  <Tab title="Python">
    [`add_cost`](/ko/weave/reference/python-sdk/trace/weave_client#method-add-cost) 메소드를 사용하여 사용자 정의 비용을 추가할 수 있습니다.
...
<Tabs>
  <Tab title="Python">
    [`query_costs`](/ko/weave/reference/python-sdk/trace/weave_client#method-query-costs) 메소드를 사용하여 비용을 조회할 수 있습니다.
...
<Tabs>
  <Tab title="Python">
    [`purge_costs`](/ko/weave/reference/python-sdk/trace/weave_client#method-purge-costs) 메소드를 사용하여 사용자 정의 비용을 삭제할 수 있습니다. 비용 ID 리스트를 전달하면 해당 ID를 가진 비용들이 삭제됩니다.
...
사용자 정의 모델의 비용을 설정하는 방법에 대한 쿡북 [Setting up costs with a custom model](/ko/weave/cookbooks/custom_model_cost)을 확인해 보세요.
