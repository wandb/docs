...
## span에 속성 설정하기 {#set-attributes-on-a-span}
...
## 대화의 모든 span에 속성 설정하기 {#set-attributes-on-every-span-in-a-conversation}
...
## 속성을 설정할 수 있는 시점 {#when-you-can-set-attributes}
...
## UI에서 속성 보기 및 필터링 {#view-and-filter-attributes-in-the-ui}
