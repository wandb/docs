...
- **중앙 패널**: 선택한 trace에 대한 대화형 trace 뷰입니다. Trace 트리는 trace 내에서 추적된 모든 메소드의 계층 구조를 보여줍니다.
  - Trace 트리는 trace 도중 호출된 `@weave.op()` 데코레이터가 적용된 함수인 [ops](/ko/weave/guides/tracking/ops#automatically-track-function-calls-using-ops) 를 표시합니다.
...
- **Feedback**: 해당 op에 대해 사용 가능한 모든 [feedback](/ko/weave/guides/tracking/feedback) 입니다. Weave 내에서 직접 또는 API를 통해 피드백을 제공할 수 있습니다.
- **Scores**: 해당 op에 대해 사용 가능한 모든 [scores](/ko/weave/guides/evaluation/scorers) 입니다. 호출은 Evaluations 를 실행하여 점수가 매겨집니다.
