...
## Weave UI에서 Calls 내보내기 {#export-calls-from-the-weave-ui}
...
## 프로그래밍 방식으로 call 조회하기 {#fetch-calls-programmatically}
...
<Tabs>
  ...
  <Tab title="TypeScript">
    TypeScript API를 사용해 Call를 조회하려면 [`client.getCalls`](/ko/weave/reference/typescript-sdk/interfaces/weaveclient#getcalls) 메서드를 사용하세요:
...
## Call 메트릭 내보내기 {#export-call-metrics}
