...
특정 span 속성을 추가하여 OpenTelemetry trace를 [Weave threads](/ko/weave/guides/tracking/threads)로 구성한 다음, Weave의 Thread UI를 사용하여 멀티-턴 대화 또는 사용자 세션과 같은 관련 작업을 분석할 수 있습니다.
