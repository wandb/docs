...
## LLM 라이브러리 Call 자동 추적 {#automatic-tracking-of-llm-library-calls}
...
## 맞춤형 함수 추적 {#track-custom-functions}
...
### 클래스 및 객체 메서드 추적 {#track-class-and-object-methods}
...
### 병렬(멀티스레드) 함수 call 트레이스 {#trace-parallel-multi-threaded-function-calls}
...
## 수동 Call 추적 {#manual-call-tracking}
