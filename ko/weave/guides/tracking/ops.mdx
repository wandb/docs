...
## 표시 이름 사용자 지정 {#customize-display-names}
...
## kind 및 색상 적용 {#apply-kinds-and-colors}
...
## 로깅된 입력과 출력을 사용자 지정하기 {#customize-logged-inputs-and-outputs}
...
## 샘플링 비율 제어 {#control-sampling-rate}
...
## Call 링크 출력 제어 {#control-call-link-output}
