...
### Call details 패널 사용 {#use-the-call-details-panel}
...
### 피드백 아이콘 사용 {#use-the-feedback-icons}
...
## SDK를 통해 피드백 제공 {#provide-feedback-through-the-sdk}
...
### 프로젝트 feedback 쿼리하기 {#query-a-projects-feedback}
...
### Call에 피드백 추가 {#add-feedback-to-a-call}
...
### Call에서 피드백 삭제 {#delete-feedback-from-a-call}
...
### UI에서 휴먼 어노테이션 Scorer 만들기 {#create-a-human-annotation-scorer-in-the-ui}
...
### UI에서 휴먼 어노테이션 Scorer 사용하기 {#use-the-human-annotation-scorer-in-the-ui}
...
### API를 사용하여 휴먼 어노테이션 Scorer 생성하기 {#create-a-human-annotation-scorer-using-the-api}
...
### API를 사용해 휴먼 어노테이션 Scorer 수정하기 {#modify-a-human-annotation-scorer-using-the-api}
...
### API를 사용해 휴먼 어노테이션 Scorer 사용하기 {#use-a-human-annotation-scorer-using-the-api}

피드백 API를 사용하면 특별한 형식의 name과 `annotation_ref` 필드를 지정해 휴먼 어노테이션 Scorer를 사용할 수 있습니다. `annotation_spec_ref`는 UI에서 적절한 탭을 선택해 획득하거나, `AnnotationSpec`를 생성하는 동안 획득할 수 있습니다.
