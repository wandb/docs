...
## 객체 ref 만들기 {#construct-object-refs}
...
## 태그와 별칭으로 객체 버전 정리하기 {#organize-object-versions-with-tags-and-aliases}
