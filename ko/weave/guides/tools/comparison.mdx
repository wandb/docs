...
keywords: [비교, diff, 베이스라인, 나란히, 트레이스]
---
...
## 뷰 열기 {#access-the-comparison-view}
...
## 뷰 사용자 지정 {#customize-the-comparison-view}
...
기본적으로 뷰의 각 객체는 바로 왼쪽에 있는 객체와 비교됩니다. 하지만 객체를 &#95;기준선&#95;으로 설정할 수 있으며, 이렇게 설정하면 모든 객체가 뷰의 가장 왼쪽 객체를 기준으로 비교됩니다. 알려진 정상 run처럼 모든 객체를 하나의 기준점에 대해 비교하려는 경우 기준선을 사용하세요.
...
### 다중 객체 비교에서 객체 한 쌍 비교 {#compare-a-pair-from-a-multi-object-comparison}
