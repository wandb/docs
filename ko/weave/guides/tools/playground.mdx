...
<Frame>
![Playground 메시지 버튼 스크린샷](/weave/guides/tools/imgs/playground_message_buttons.png)
</Frame>
<Frame>
![Playground 편집 스크린샷](/weave/guides/tools/imgs/playground_message_editor.png)
</Frame>
...
<Frame>
![Playground에서 모델 저장하기](/weave/guides/tools/imgs/saved-model.png)
</Frame>
...
<Frame>
![Saved Models가 선택된 LLM 드롭다운](/weave/guides/tools/imgs/saved-models-dropdown.png)
</Frame>
