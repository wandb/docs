---
title: "Evaluation Playground를 사용해 모델 성능 비교"
description: "맞춤형 데이터셋과 LLM judge를 사용하는 Weave의 Evaluation Playground에서 코드 없이 모델 성능을 비교하고 평가하세요."
keywords: ["Evaluation Playground", "LLM judge", "모델 비교", "코드 없는 평가", "Scorer"]
---
...
## 플레이그라운드에서 평가 설정 {#set-up-an-evaluation-in-the-playground}
