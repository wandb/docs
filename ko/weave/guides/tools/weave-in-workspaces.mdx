...
# 모델 트레이닝 run 중 트레이스 로깅하기 {#log-traces-during-model-training-runs}
...
## 특정 W&amp;B run에 트레이스 연결 {#associate-traces-with-a-specific-wb-run}
...
## Weave 트레이스에서 W&amp;B 아티팩트 레퍼런스하기 {#reference-wb-artifacts-in-a-weave-trace}
...
### 트레이스의 속성으로 아티팩트 추가하기 {#add-an-artifact-as-an-attribute-of-a-trace}
...
### 아티팩트를 `Model`의 속성으로 추가하기 {#add-an-artifact-as-an-attribute-of-a-model}
