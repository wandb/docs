...
## ingest 샘플링을 사용하는 이유 {#why-use-ingest-sampling}
...
## 수집 샘플링이 적용되는 대상 {#what-ingest-sampling-applies-to}
...
## ingest 샘플링 설정 {#configure-ingest-sampling}
...
### 선택 사항: 드라이 런으로 미리 보기 {#optional-preview-with-a-dry-run}
