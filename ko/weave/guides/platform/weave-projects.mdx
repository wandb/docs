...
keywords: ["entity", "팀", "워크스페이스", "weave.init", "프로젝트 경로"]
---
...
<Tabs>
  <Tab title="W&B UI">
    ...
    새로 만든 프로젝트를 찾으려면 왼쪽 상단의 **Weights &amp; Biases logo**를 선택해 **Global navigation** 메뉴를 엽니다. 이 메뉴에는 최근 프로젝트와 자신이 속한 팀가 표시되므로 컨텍스트를 전환할 수 있습니다. 프로젝트를 선택하면 해당 프로젝트의 워크스페이스가 열립니다.
