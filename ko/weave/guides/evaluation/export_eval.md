...
## 사용되는 API 엔드포인트 {#api-endpoints-used}
...
## evaluation run 목록 {#list-evaluation-runs}
...
## 단일 Evaluation run 조회 {#read-a-single-evaluation-run}
...
## 예측 및 점수 조회 {#get-predictions-and-scores}
...
## 집계된 점수 조회 {#get-aggregated-scores}
...
## 단일 예측 조회 {#read-a-single-prediction}
