...
3. 드로어(drawer)에서 모니터를 설정합니다:
   ...
   - **LLM-as-a-Judge configuration**: 
        ...
        - **Judge model**: ops의 점수를 매길 모델을 선택합니다. 세 가지 유형의 모델을 사용할 수 있습니다:
            - [Saved models](../tools/playground#메시지-재시도-편집-및-삭제)
...
호출 및 Scorer 결과를 쿼리하는 방법에 대한 자세한 내용은 [점수 분석 가이드](./scorers#점수-분석)와 [데이터 엑세스 가이드](/ko/weave/guides/tracking/tracing#querying--exporting-calls)를 참조하세요.
...
- [Weave Ops](/ko/weave/guides/tracking/ops)에 대해 알아보기