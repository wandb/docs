...
LLM 평가자 대신 직접 호스팅하는 HTTP 엔드포인트로 Call을 점수화하려면 [원격 Scorer로 Call 점수화](/ko/weave/guides/evaluation/remote-scorers)를 참조하세요.

## 시그널과 맞춤형 모니터 {#signals-and-custom-monitors}
...
## Weave에서 모니터 만들기 {#create-a-monitor-in-weave}
...
### 예시: 진실성 모니터 만들기 {#example-create-a-truthfulness-monitor}
