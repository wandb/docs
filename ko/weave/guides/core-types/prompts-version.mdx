...
keywords: ["프롬프트", "프롬프트 버전", "프롬프트 태그", "프롬프트 별칭", "태그", "별칭","프롬프트 버전 관리"]
---
...
## 프롬프트 버전이 생성되는 방법 {#how-prompt-versions-are-created}
...
## 전체 ref URI 구성 {#construct-a-fully-qualified-ref-uri}
...
## 코드에서 프롬프트 버전 조회 {#retrieve-a-prompt-version-in-code}
...
## 프로덕션에서 프롬프트 사용 {#use-prompts-in-production}
...
## <a id="view-prompts" aria-label="프롬프트 버전 보기 및 비교" />프롬프트 버전 보기 및 비교 {#view-and-compare-prompt-versions}
...
## 프롬프트 태그 및 별칭 추가 {#add-prompt-tags-and-aliases}
...
### 코드에서 태그와 별칭 수정 {#modify-tags-and-aliases-in-code}
