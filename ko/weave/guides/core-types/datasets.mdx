...
## 다른 객체에서 dataset 만들기 {#create-a-dataset-from-other-objects}
...
## UI에서 데이터셋 생성, 수정 및 삭제 {#create-edit-and-delete-a-dataset-in-the-ui}
...
### 새 데이터셋 만들기 {#create-a-new-dataset}
...
### 데이터셋에 새 에이전트 트레이스 추가 {#add-a-new-agent-trace-to-a-dataset}
...
### 데이터셋에 새 트레이스 추가 {#add-a-new-trace-to-a-dataset}
...
## 기타 데이터셋 오퍼레이션 {#other-dataset-operations}
