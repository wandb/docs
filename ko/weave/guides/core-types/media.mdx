...
<Frame>
  ![호박을 쓴 고양이 트레이스 뷰 스크린샷](/weave/guides/core-types/imgs/cat-pumpkin-trace.png)
</Frame>
...
<Frame>
  ![Weave의 비디오 로깅](/images/weave/video.png)
</Frame>
...
다음 예제에서는 Weave에 오디오를 로깅하는 방법을 보여줍니다.
...
<Tabs>
  <Tab title="Python">
    ...
    이 예제에서는 `Content` annotation을 사용해 AI가 생성한 오디오를 만들고 로깅합니다:
...
<Tip>
  [Audio Logging](/ko/weave/cookbooks/audio_with_weave) 쿡북도 사용해 보세요. 이 쿡북에는 Weave로 통합된 Real Time Audio API 기반 어시스턴트의 고급 예제도 포함되어 있습니다.
</Tip>
