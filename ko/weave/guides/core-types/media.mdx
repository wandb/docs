...
<Tabs>
  <Tab title="Python">
    ...
    <div id="advanced-example-generate-an-image-with-dall-e-and-log-it-to-weave">
    ...
    <div id="advanced-example-resize-large-images-before-logging">
  ...
  <Tab title="TypeScript">
    ...
    <div id="advanced-example-log-an-image-generated-with-the-openai-dall-e-api">
...
<Tabs>
  <Tab title="Python">
    ...
    <div id="advanced-example-log-a-video-within-a-video-analysis-project">
      ### 고급 예시: 비디오 분석 프로젝트 내에서 비디오 로깅
    </div>
...
<Tabs>
  <Tab title="Python">
    ...
    <div id="advanced-example-log-documents-within-a-rag-system">
      ### 고급 예시: RAG 시스템 내 문서 로깅
    </div>
...
<Tabs>
  <Tab title="Python">
    ...
    <div id="advanced-example-generate-and-log-ai-created-audio">
  ...
  <Tab title="TypeScript">
    ...
    <div id="advanced-example-generate-audio-using-openais-tts-api-and-log-it-to-weave">
...
<Tabs>
  <Tab title="Python">
    ...
    <div id="advanced-example-generate-self-contained-html-pages-using-serverless-inference-and-log-them-to-weave">
      ### 고급 예시: Serverless Inference를 사용해 독립형 HTML 페이지를 생성하고 Weave에 로깅하기
    </div>
