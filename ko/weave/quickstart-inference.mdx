...
이 가이드는 W&B Weave를 [W&B Inference](/ko/inference/)와 함께 사용하는 방법을 설명합니다. W&B Inference를 사용하면 자체 인프라를 구축하거나 여러 제공업체의 API 키를 관리할 필요 없이 실시간 오픈 소스 모델을 사용하여 LLM 애플리케이션을 구축하고 추적(trace)할 수 있습니다. W&B API 키만 있으면 [W&B Inference에서 호스팅하는 모든 모델](/ko/inference/models/)과 상호 작용할 수 있습니다.
...
사용 가능한 전체 모델 목록은 W&B Inference 문서의 [사용 가능한 모델 섹션](/ko/inference/models/)을 참조하세요.

## 다음 단계

- **Playground 사용**: Weave Playground에서 [대화식으로 모델을 시도](/ko/weave/guides/tools/playground#access-the-playground)해 보세요.
- **평가 구축**: LLM 애플리케이션의 [체계적인 평가](/ko/weave/guides/core-types/evaluations)에 대해 알아보세요.
- **다른 인테그레이션 시도**: Weave는 [OpenAI, Anthropic 및 기타 여러 모델](/ko/weave/guides/integrations)과 함께 작동합니다.
...
자세한 내용은 [W&B Inference 사용 제한 문서](/ko/inference/usage-limits/)를 참조하세요.
...
무료 티어에는 제한된 크레딧이 포함되어 있습니다. 자세한 내용은 [사용량 및 제한 문서](/ko/inference/usage-limits/)를 참조하세요.
