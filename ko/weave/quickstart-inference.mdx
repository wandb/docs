...
description: "W&B Inference를 사용해 모델 호출을 트레이스하고, 출력을 비교하고, 평가를 실행하면서 Weave의 기본 사항을 배워보세요."
---
...
이 가이드는 W&amp;B Weave를 [W&amp;B Inference](/ko/inference/)와 함께 사용하는 방법을 보여줍니다. W&amp;B Inference를 사용하면 별도의 인프라를 구축하거나 여러 제공업체의 API 키를 관리할 필요 없이 실시간 오픈소스 모델을 활용해 LLM 애플리케이션을 구축하고 트레이싱할 수 있습니다. W&amp;B API 키만 있으면 [W&amp;B Inference에서 호스팅하는 모든 모델](/ko/inference/models/)과 상호작용할 수 있습니다.
...
사용 가능한 모델의 전체 목록은 W&amp;B Inference 문서의 [Available Models 섹션](/ko/inference/models/)을 참조하세요.
...
<details>
  ...
  * 더 높은 한도가 필요하다면 요금제 업그레이드를 고려하세요.
  ...
  자세한 내용은 [W&amp;B Inference 한도 관련 문서](/ko/inference/usage-limits/)를 참조하세요.
</details>

<details>
  <summary>크레딧 부족</summary>

  무료 요금제에는 제한된 크레딧이 포함되어 있습니다. 자세한 내용은 [사용량 및 한도 관련 문서](/ko/inference/usage-limits/)를 참조하세요.
</details>