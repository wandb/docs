...
<div id="how-the-weave-sdk-works-with-agents">
  ## Weave SDK가 에이전트와 작동하는 방식 {#how-the-weave-sdk-works-with-agents}
</div>
...
<div id="run-a-traced-multi-turn-agent">
  ## 트레이스된 멀티턴 에이전트 실행 {#run-a-traced-multi-turn-agent}
</div>
...
<div id="record-token-usage-and-cost">
  ## 토큰 사용량 및 비용 기록 {#record-token-usage-and-cost}
</div>
...
<div id="see-your-agent-traces-in-the-agents-view">
  ## Agents 뷰에서 에이전트 트레이스 확인하기 {#see-your-agent-traces-in-the-agents-view}
</div>
...
<div id="link-to-a-conversation-from-your-app">
  ## 앱에서 대화로 연결하기 {#link-to-a-conversation-from-your-app}
</div>
