...
`weave.op`을 추가하고 함수를 호출한 뒤, W&amp;B 대시보드를 방문하여 해당 함수가 프로젝트 내에서 추적되는 것을 확인하세요.
...
다음 예제는 기본 함수 추적이 어떻게 동작하는지 보여줍니다.
...
Weave는 다음을 포함한 모든 OpenAI Call을 자동으로 추적합니다.
...
* 애플리케이션 로직 흐름에 대한 전체 가시성 확보
* 복잡한 오퍼레이션 체인의 디버깅 용이
* 성능 최적화 기회 포착
