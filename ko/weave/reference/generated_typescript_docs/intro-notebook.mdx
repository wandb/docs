...
[`weave.Dataset`](/ko/weave/guides/core-types/datasets) 클래스를 사용하여 Weave 에서 Datasets 을 생성하고 관리할 수 있습니다. [Weave `Models`](/ko/weave/guides/core-types/models) 와 마찬가지로 `weave.Dataset` 은 다음과 같은 도움을 줍니다:
...
Weave 는 [`Evaluation` 클래스](/ko/weave/guides/core-types/evaluations)를 통해 evaluation 중심 개발을 지원합니다. Evaluations 를 통해 GenAI 애플리케이션을 안정적으로 반복 개선할 수 있습니다. `Evaluation` 클래스는 다음을 수행합니다:
