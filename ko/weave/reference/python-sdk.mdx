...
## <kbd>class</kbd> `Agent` {#class-agent}
...
## <kbd>class</kbd> `AgentState` {#class-agentstate}
...
## <kbd>class</kbd> `AnnotationSpec` {#class-annotationspec}
...
### <kbd>클래스 메서드</kbd> `preprocess_field_schema` {#classmethod-preprocess_field_schema}
...
### <kbd>클래스 메서드</kbd> `validate_field_schema` {#classmethod-validate_field_schema}
...
### <kbd>방법</kbd> `value_is_valid` {#method-value_is_valid}
...
## <kbd>class</kbd> `Audio` {#class-audio}
...
### <kbd>방법</kbd> `__init__` {#method-__init__}
...
### <kbd>방법</kbd> `export` {#method-export}
...
### <kbd>클래스 메서드</kbd> `from_data` {#classmethod-from_data}
...
### <kbd>클래스 메서드</kbd> `from_path` {#classmethod-from_path}
...
## <kbd>class</kbd> `ClassifierMonitor` {#class-classifiermonitor}
...
### <kbd>방법</kbd> `activate` {#method-activate}
...
### <kbd>방법</kbd> `deactivate` {#method-deactivate}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj}
...
### <kbd>방법</kbd> `get_prompt_footer` {#method-get_prompt_footer}
...
### <kbd>방법</kbd> `get_prompt_header` {#method-get_prompt_header}
...
## <kbd>class</kbd> `Content` {#class-content}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-2}
...
### <kbd>클래스 메서드</kbd> `from_base64` {#classmethod-from_base64}
...
### <kbd>클래스 메서드</kbd> `from_bytes` {#classmethod-from_bytes}
...
### <kbd>클래스 메서드</kbd> `from_data_url` {#classmethod-from_data_url}
...
### <kbd>클래스 메서드</kbd> `from_path` {#classmethod-from_path-2}
...
### <kbd>클래스 메서드</kbd> `from_text` {#classmethod-from_text}
...
### <kbd>클래스 메서드</kbd> `from_url` {#classmethod-from_url}
...
### <kbd>클래스 메서드</kbd> `model_validate` {#classmethod-model_validate}
...
### <kbd>클래스 메서드</kbd> `model_validate_json` {#classmethod-model_validate_json}
...
### <kbd>방법</kbd> `serialize_data` {#method-serialize_data}
...
### <kbd>방법</kbd> `to_data_url` {#method-to_data_url}
...
## <kbd>class</kbd> `Conversation` {#class-conversation}
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-2}
...
### <kbd>방법</kbd> `start_turn` {#method-start_turn}
...
컨텍스트 관리자 사용 여부와 관계없이 `get_current_turn()`를 통해 turn이 표시되도록 `_current_turn` contextvar를 설정합니다. `agent_name` / `model` / `agent_id` / `agent_description` / `agent_version`는 비워 두면 각각 대화의 기본값을 사용하며, `continue_parent_trace`는 상속됩니다. 이들 값은 나중에 `turn.record(...)`를 통해 재정의할 수 있습니다.
...
## <kbd>class</kbd> `Dataset` {#class-dataset}
...
### <kbd>방법</kbd> `add_rows` {#method-add_rows}
...
### <kbd>클래스 메서드</kbd> `convert_to_table` {#classmethod-convert_to_table}
...
### <kbd>클래스 메서드</kbd> `from_calls` {#classmethod-from_calls}
...
### <kbd>클래스 메서드</kbd> `from_hf` {#classmethod-from_hf}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-2}
...
### <kbd>클래스 메서드</kbd> `from_pandas` {#classmethod-from_pandas}
...
### <kbd>방법</kbd> `select` {#method-select}
...
### <kbd>방법</kbd> `to_pandas` {#method-to_pandas}
...
#### <kbd>속성</kbd> as_str {#property-as_str}

모든 메시지를 하나의 문자열로 합쳐 반환합니다.

***

#### <kbd>속성</kbd> is_bound {#property-is_bound}

***

#### <kbd>속성</kbd> 메시지 {#property-messages}

#### <kbd>속성</kbd> 플레이스홀더 {#property-placeholders}

***

#### <kbd>속성</kbd> system_message {#property-system_message}

모든 메시지를 합쳐 하나의 system prompt 메시지로 만듭니다.

***

#### <kbd>속성</kbd> system_prompt {#property-system_prompt}

모든 메시지를 시스템 프롬프트 객체로 합칩니다.

***

#### <kbd>속성</kbd> unbound_placeholders {#property-unbound_placeholders}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/prompt/prompt.py#L230" />

### <kbd>방법</kbd> `append` {#method-append}
...
### <kbd>방법</kbd> `as_dict` {#method-as_dict}
...
### <kbd>방법</kbd> `as_pydantic_dict` {#method-as_pydantic_dict}
...
### <kbd>방법</kbd> `bind_rows` {#method-bind_rows}
...
### <kbd>방법</kbd> `config_table` {#method-config_table}
...
### <kbd>방법</kbd> `configure` {#method-configure}
...
### <kbd>방법</kbd> `dump_file` {#method-dump_file}
...
### <kbd>방법</kbd> `format` {#method-format}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-3}
...
### <kbd>클래스 메서드</kbd> `load` {#classmethod-load}
...
### <kbd>클래스 방법</kbd> `load_file` {#classmethod-load_file}
...
### <kbd>방법</kbd> `messages_table` {#method-messages_table}
...
### <kbd>방법</kbd> `publish` {#method-publish}
...
### <kbd>방법</kbd> `require` {#method-require}
...
### <kbd>방법</kbd> `validate_requirement` {#method-validate_requirement}
...
### <kbd>방법</kbd> `validate_requirements` {#method-validate_requirements}
...
### <kbd>방법</kbd> `values_table` {#method-values_table}
...
### <kbd>방법</kbd> `evaluate` {#method-evaluate}
...
### <kbd>클래스 방법</kbd> `from_obj` {#classmethod-from_obj-4}
...
### <kbd>방법</kbd> `get_eval_results` {#method-get_eval_results}
...
### <kbd>방법</kbd> `get_evaluate_calls` {#method-get_evaluate_calls}
...
### <kbd>방법</kbd> `get_score_calls` {#method-get_score_calls}
...
### <kbd>방법</kbd> `get_scores` {#method-get_scores}
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-3}
...
### <kbd>방법</kbd> `predict_and_score` {#method-predict_and_score}
...
### <kbd>방법</kbd> `summarize` {#method-summarize}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-4}
...
#### <kbd>속성</kbd> attributes {#property-attributes}

***

#### <kbd>속성</kbd> ui_url {#property-ui_url}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/evaluation/eval_imperative.py#L1106" />

### <kbd>방법</kbd> `fail` {#method-fail}
...
### <kbd>방법</kbd> `finish` {#method-finish}
...
### <kbd>방법</kbd> `log_example` {#method-log_example}
...
### <kbd>방법</kbd> `log_prediction` {#method-log_prediction}
...
### <kbd>방법</kbd> `log_summary` {#method-log_summary}
...
### <kbd>방법</kbd> `set_view` {#method-set_view}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-5}
...
#### <kbd>속성</kbd> filename {#property-filename}
...
### <kbd>방법</kbd> `add_event` {#method-add_event}
...
이 span 내 특정 시점에 OTel span 이벤트를 기록합니다.

.. deprecated:
&#96;&#96;&#96;      대신 `set_attributes`로 이 데이터를 기록하세요. OpenTelemetry는 Span Event API(`Span.add_event`)를 단계적으로 사용 중단하고 있습니다.      `add_event`는 계속 작동하며 기존 span 이벤트 데이터도 계속 유효합니다.      자세한 내용은 [https://opentelemetry.io/blog/2026/deprecating-span-events/](https://opentelemetry.io/blog/2026/deprecating-span-events/)를 참조하세요.

````
마커/라이프사이클 데이터에 사용합니다 — 권한 프롬프트(예: ``weave.permission_request``), 라이프사이클 전환(예: ``spawned`` / ``streaming`` / ``finished``), 또는 span의 수명 내 특정 시점에 발생하는 맞춤형 마일스톤(span 전체의 속성인 attribute와 구별됩니다).

span 시작과 span 종료 사이(``with`` 내부)에서 호출해야 합니다. 해당 범위 밖에서의 call은 no-op이며 경고를 기록합니다. 
...
### <kbd>방법</kbd> `attach_media_url` {#method-attach_media_url}
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-4}
...
### <kbd>방법</kbd> `output` {#method-output}
...
### <kbd>방법</kbd> `record` {#method-record}
...
한 번의 Call로 여러 LLM Call 필드를 설정합니다.
...
### <kbd>방법</kbd> `set_attributes` {#method-set_attributes}
...
## <kbd>class</kbd> `LogResult` {#class-logresult}
...
## <kbd>class</kbd> `Markdown` {#class-markdown}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-6}
...
## <kbd>class</kbd> `MediaAttachment` {#class-mediaattachment}
...
### <kbd>클래스 메서드</kbd> `assistant` {#classmethod-assistant}
...
### <kbd>클래스 메서드</kbd> `system` {#classmethod-system}
...
### <kbd>클래스 메서드</kbd> `tool_result` {#classmethod-tool_result}
...
### <kbd>클래스 메서드</kbd> `user` {#classmethod-user}
...
## <kbd>class</kbd> `MessagesPrompt` {#class-messagesprompt}

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/prompt/prompt.py#L168" />

### <kbd>방법</kbd> `__init__` {#method-__init__-7}
...
### <kbd>방법</kbd> `format` {#method-format-2}
...
### <kbd>방법</kbd> `format_message` {#method-format_message}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-5}
...
## <kbd>class</kbd> `Model` {#class-model}
...
### <kbd>방법</kbd> `get_infer_method` {#method-get_infer_method}
...
## <kbd>class</kbd> `Monitor` {#class-monitor}
...
### <kbd>방법</kbd> `activate` {#method-activate-2}
...
### <kbd>방법</kbd> `deactivate` {#method-deactivate-2}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-6}
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-5}
...
## <kbd>class</kbd> `Object` {#class-object}
...
### <kbd>클래스 메서드</kbd> `from_uri` {#classmethod-from_uri}
...
### <kbd>클래스 메서드</kbd> `handle_relocatable_object` {#classmethod-handle_relocatable_object}
...
# ObjectRef를 전달하는 경우 {#when-an-objectref-is-passed}

obj = MyObject(some&#95;object&#95;ref)

# WeaveObject가 전달된 경우 {#when-a-weaveobject-is-passed}
...
## <kbd>class</kbd> `ObjectRef` {#class-objectref}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-8}
...
#### <kbd>속성</kbd> digest {#property-digest}

***

#### <kbd>속성</kbd> extra {#property-extra}

***

#### <kbd>속성</kbd> is_digest_resolved {#property-is_digest_resolved}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/refs.py#L191" />

### <kbd>방법</kbd> `as_param_dict` {#method-as_param_dict}
...
### <kbd>방법</kbd> `delete` {#method-delete}
...
### <kbd>방법</kbd> `is_descended_from` {#method-is_descended_from}
...
### <kbd>방법</kbd> `maybe_parse_uri` {#method-maybe_parse_uri}
...
### <kbd>방법</kbd> `parse_uri` {#method-parse_uri}
...
### <kbd>방법</kbd> `with_attr` {#method-with_attr}
...
### <kbd>방법</kbd> `with_extra` {#method-with_extra}
...
### <kbd>방법</kbd> `with_index` {#method-with_index}
...
### <kbd>방법</kbd> `with_item` {#method-with_item}
...
### <kbd>방법</kbd> `with_key` {#method-with_key}
...
## <kbd>클래스</kbd> `Prompt` {#class-prompt}
...
### <kbd>방법</kbd> `format` {#method-format-3}
...
## <kbd>클래스</kbd> `SavedView` {#class-savedview}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-9}
...
#### <kbd>속성</kbd> entity {#property-entity}

***

#### <kbd>속성</kbd> 레이블 {#property-label}

***

#### <kbd>속성</kbd> 프로젝트 {#property-project}

***

#### <kbd>속성</kbd> view_type {#property-view_type}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/flow/saved_view.py#L624" />

### <kbd>방법</kbd> `add_column` {#method-add_column}
...
### <kbd>방법</kbd> `add_columns` {#method-add_columns}
...
### <kbd>방법</kbd> `add_filter` {#method-add_filter}
...
### <kbd>방법</kbd> `add_sort` {#method-add_sort}
...
### <kbd>방법</kbd> `column_index` {#method-column_index}
...
### <kbd>방법</kbd> `filter_op` {#method-filter_op}
...
### <kbd>방법</kbd> `get_calls` {#method-get_calls}
...
### <kbd>방법</kbd> `get_known_columns` {#method-get_known_columns}
...
### <kbd>방법</kbd> `get_table_columns` {#method-get_table_columns}
...
### <kbd>방법</kbd> `hide_column` {#method-hide_column}
...
### <kbd>방법</kbd> `insert_column` {#method-insert_column}
...
### <kbd>클래스 메서드</kbd> `load` {#classmethod-load-2}
...
### <kbd>방법</kbd> `page_size` {#method-page_size}
...
### <kbd>방법</kbd> `pin_column_left` {#method-pin_column_left}
...
### <kbd>방법</kbd> `pin_column_right` {#method-pin_column_right}
...
### <kbd>방법</kbd> `remove_column` {#method-remove_column}
...
### <kbd>방법</kbd> `remove_columns` {#method-remove_columns}
...
### <kbd>방법</kbd> `remove_filter` {#method-remove_filter}
...
### <kbd>방법</kbd> `remove_filters` {#method-remove_filters}
...
### <kbd>방법</kbd> `rename` {#method-rename}
...
### <kbd>방법</kbd> `rename_column` {#method-rename_column}
...
### <kbd>방법</kbd> `set_columns` {#method-set_columns}
...
### <kbd>방법</kbd> `show_column` {#method-show_column}
...
### <kbd>방법</kbd> `sort_by` {#method-sort_by}
...
### <kbd>방법</kbd> `to_grid` {#method-to_grid}
...
### <kbd>방법</kbd> `to_rich_table_str` {#method-to_rich_table_str}
...
### <kbd>방법</kbd> `ui_url` {#method-ui_url}
...
### <kbd>방법</kbd> `unpin_column` {#method-unpin_column}
...
## <kbd>class</kbd> `Scorer` {#class-scorer}
...
#### <kbd>속성</kbd> display_name {#property-display_name}

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/flow/scorer.py#L57" />

### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-7}
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-6}
...
### <kbd>방법</kbd> `summarize` {#method-summarize-2}
...
## <kbd>클래스</kbd> `Session` {#class-session}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-10}
...
#### <kbd>속성</kbd> session_id {#property-session_id}

:attr:`conversation_id`의 사용 중단된 별칭입니다.

***

#### <kbd>속성</kbd> session_name {#property-session_name}
...
### <kbd>방법</kbd> `format` {#method-format-4}
...
### <kbd>클래스 메서드</kbd> `from_obj` {#classmethod-from_obj-8}
...
## <kbd>클래스</kbd> `SubAgent` {#class-subagent}
...
### <kbd>방법</kbd> `add_event` {#method-add_event-2}
...
.. deprecated:
&#96;&#96;&#96;      대신 이 데이터는 `set_attributes`로 기록하세요. OpenTelemetry는 Span Event API(`Span.add_event`)를 단계적으로 사용 중단하고 있습니다.      `add_event`는 계속 작동하며 기존 span event 데이터도 여전히 유효합니다.      [https://opentelemetry.io/blog/2026/deprecating-span-events/](https://opentelemetry.io/blog/2026/deprecating-span-events/)를 참조하세요.
...
### <kbd>방법</kbd> `record` {#method-record-2}
...
### <kbd>방법</kbd> `set_attributes` {#method-set_attributes-2}
...
## <kbd>class</kbd> `ContextAwareThread` {#class-contextawarethread}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-13}
...
#### <kbd>속성</kbd> daemon {#property-daemon}
...
#### <kbd>속성</kbd> ident {#property-ident}
...
#### <kbd>속성</kbd> native_id {#property-native_id}
...
#### <kbd>속성</kbd> thread_id {#property-thread_id}
...
#### <kbd>속성</kbd> turn_id {#property-turn_id}
...
## <kbd>class</kbd> `ContextAwareThreadPoolExecutor` {#class-contextawarethreadpoolexecutor}
...
### <kbd>방법</kbd> `__init__` {#method-__init__-15}
...
### <kbd>방법</kbd> `submit` {#method-submit}
...
### <kbd>방법</kbd> `add_event` {#method-add_event-3}
...
.. 사용 중단:
&#96;&#96;&#96;      이 데이터는 대신 `set_attributes`로 기록하세요. OpenTelemetry는      Span Event API(`Span.add_event`)를 단계적으로 폐지하고 있습니다.      `add_event`는 여전히 작동하며 기존 span-event 데이터도 계속 유효합니다.      자세한 내용은 [https://opentelemetry.io/blog/2026/deprecating-span-events/](https://opentelemetry.io/blog/2026/deprecating-span-events/)를 참조하세요.

````
Use for marker / lifecycle data — 권한 프롬프트 (e.g. ``weave.permission_request``), lifecycle transitions (e.g. ``spawned`` / ``streaming`` / ``finished``), or any custom milestone that happens at a point in time within the span's lifetime (vs an attribute, which is a property of the span as a whole). 
...
### <kbd>방법</kbd> `set_attributes` {#method-set_attributes-3}
...
### <kbd>방법</kbd> `add_event` {#method-add_event-4}
...
.. 사용 중단:
&#96;&#96;&#96;      이 데이터는 대신 `set_attributes`로 기록하세요. OpenTelemetry는      Span Event API(`Span.add_event`)를 단계적으로 사용 중단하고 있습니다.      `add_event`는 계속 작동하며 기존 span-event 데이터도 계속 유효합니다.      자세한 내용은 [https://opentelemetry.io/blog/2026/deprecating-span-events/](https://opentelemetry.io/blog/2026/deprecating-span-events/)를 확인하세요.
...
### <kbd>방법</kbd> `model_post_init` {#method-model_post_init-7}
...
### <kbd>방법</kbd> `record` {#method-record-3}
...
### <kbd>방법</kbd> `set_attributes` {#method-set_attributes-4}
...
### <kbd>방법</kbd> `subagent` {#method-subagent}
...
## <kbd>class</kbd> `Usage` {#class-usage}
...
### <kbd>함수</kbd> `add_tags` {#function-add_tags}
...
### <kbd>함수</kbd> `as_op` {#function-as_op}
...
### <kbd>함수</kbd> `attributes` {#function-attributes}
...
### <kbd>함수</kbd> `end_conversation` {#function-end_conversation}
...
### <kbd>함수</kbd> `end_llm` {#function-end_llm}
...
### <kbd>함수</kbd> `end_session` {#function-end_session}
...
### <kbd>함수</kbd> `end_turn` {#function-end_turn}
...
### <kbd>함수</kbd> `finish` {#function-finish}
...
### <kbd>함수</kbd> `get_aliases` {#function-get_aliases}
...
### <kbd>함수</kbd> `get_client` {#function-get_client}
...
### <kbd>함수</kbd> `get_current_call` {#function-get_current_call}
...
### <kbd>함수</kbd> `get_current_conversation` {#function-get_current_conversation}
...
### <kbd>함수</kbd> `get_current_llm` {#function-get_current_llm}
...
### <kbd>함수</kbd> `get_current_session` {#function-get_current_session}
...
### <kbd>함수</kbd> `get_current_turn` {#function-get_current_turn}
...
### <kbd>함수</kbd> `get_tags` {#function-get_tags}
...
### <kbd>함수</kbd> `get_tags_and_aliases` {#function-get_tags_and_aliases}
...
### <kbd>함수</kbd> `link_prompt_to_registry` {#function-link_prompt_to_registry}
...
* <b>`prompt`</b>: 게시된 prompt, `ObjectRef`, 또는 완전 수식된 weave ///... URI string입니다.
...
### <kbd>함수</kbd> `list_aliases` {#function-list_aliases}
...
### <kbd>함수</kbd> `list_tags` {#function-list_tags}
...
### <kbd>함수</kbd> `log_call` {#function-log_call}
...
각 Turn의 `.spans` 속성은 해당 Turn의 하위 항목을 제공합니다. `conversation_id`가 비어 있으면 자동으로 생성됩니다. 기본적으로 각 턴에는 자체 OTel 트레이스가 할당됩니다. `agent_name` / `model` / `agent_id` / `agent_description` / `agent_version`은 대화 수준 기본값입니다. Turn 자체 값이 우선하며, Turn에서 해당 값을 비워 둔 경우에만 대화 값이 채워집니다. 대화의 `continue_parent_trace`는 모든 턴에 적용됩니다(개별 Turn의 `continue_parent_trace`는 여기서 의도적으로 우선순위가 낮아집니다).

`attributes`는 내보내는 모든 span에 적용됩니다. 맞춤형 비-semconv 키를 사용하세요. span 자체의 `gen_ai.*` / `weave.*` 속성과 충돌하는 키는 지원되지 않습니다(어느 값이 우선하는지는 경로에 따라 달라집니다).

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/conversation/_deprecated.py#L78" />

### <kbd>function</kbd> `log_session` {#function-log_session}
...
### <kbd>함수</kbd> `log_turn` {#function-log_turn}
...
컨텍스트 관리자를 사용할 수 없는 경우(상태를 유지하지 않는 컨테이너, callback, 큐 워커)에 사용하세요. 전달되는 각 하위 span에는 `started_at` / `ended_at`가 설정되어 있어야 하며, 내보내는 OTel span의 타임스탬프는 이 필드에서 가져옵니다. 턴이 자체 값을 제공하지 않으면 가장 이른/가장 늦은 하위 span의 타임스탬프를 사용하고, 그것도 없으면 `now()`를 사용합니다. `agent_id` / `agent_description` / `agent_version`은 스트리밍 경로와 동일하게 동작합니다.
...
### <kbd>함수</kbd> `otel_traces_endpoint` {#function-otel_traces_endpoint}
...
### <kbd>함수</kbd> `publish` {#function-publish}
...
### <kbd>함수</kbd> `remove_aliases` {#function-remove_aliases}
...
### <kbd>함수</kbd> `remove_tags` {#function-remove_tags}
...
### <kbd>함수</kbd> `require_current_call` {#function-require_current_call}
...
### <kbd>함수</kbd> `set_aliases` {#function-set_aliases}
...
### <kbd>함수</kbd> `set_view` {#function-set_view}
...
### <kbd>함수</kbd> `start_conversation` {#function-start_conversation}
...
### <kbd>함수</kbd> `start_llm` {#function-start_llm}
...
### <kbd>함수</kbd> `start_session` {#function-start_session}
...
### <kbd>함수</kbd> `start_subagent` {#function-start_subagent}
...
SubAgent의 OTel span은 OTel 컨텍스트에서 현재 활성 span의 자식으로 자동 설정됩니다. 일반적으로 활성화된 턴 span이 있으면 그 자식 span이 됩니다. 형태는 `start_tool`과 같으며, 부모-자식 전파는 OTel 컨텍스트가 처리하므로 명시적으로 위임할 필요가 없습니다.

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/conversation/conversation.py#L1291" />

### <kbd>함수</kbd> `start_tool` {#function-start_tool}
...
### <kbd>함수</kbd> `start_turn` {#function-start_turn}
...
### <kbd>함수</kbd> `thread` {#function-thread}
...
### <kbd>함수</kbd> `wandb_init_hook` {#function-wandb_init_hook}
