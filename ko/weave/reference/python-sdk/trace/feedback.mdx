...
### <kbd>방법</kbd> `execute` {#method-execute}
...
### <kbd>방법</kbd> `refresh` {#method-refresh}
...
### <kbd>방법</kbd> `add_note` {#method-add_note}
...
### <kbd>방법</kbd> `add_reaction` {#method-add_reaction}
...
### <kbd>방법</kbd> `execute` {#method-execute-2}
...
### <kbd>방법</kbd> `refresh` {#method-refresh-2}
