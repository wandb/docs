---
title: "retour"
description: "weave.trace.feedback에 대한 Python SDK 레퍼런스"
---
...
서버에서 retour를 가져오기 위한 지연 로딩 객체입니다.
...
다양한 유틸리티를 제공하는 retour 객체 컬렉션입니다.
...
특정 ref에 연결된 retour와 상호 작용하기 위한 객체입니다.
...
feedback&#95;type: retour의 유형을 파악하는 문자열입니다. &quot;wandb.&quot; 접두사는 예약되어 있습니다. creator: retour 작성자의 표시 이름입니다.
