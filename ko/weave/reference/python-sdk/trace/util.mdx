...
### <kbd>함수</kbd> `deprecated` {#function-deprecated}
...
### <kbd>함수</kbd> `is_colab` {#function-is_colab}
...
### <kbd>함수</kbd> `is_notebook` {#function-is_notebook}
...
### <kbd>함수</kbd> `log_once` {#function-log_once}
