...
이 클래스는 executor 내부에서 Weave Call이 예상대로 동작하도록 보장하는 concurrent.futures.ThreadPoolExecutor의 드롭인 대체 구현입니다. Weave는 특정 contextvars가 설정되어 있어야 하지만(`call&#95;context.py` 참조), 새 스레드는 부모의 컨텍스트를 자동으로 복사하지 않기 때문에 call 컨텍스트가 손실될 수 있습니다 -- 이는 바람직하지 않습니다! 이 클래스는 contextvar 복사를 자동화하므로, 이 executor를 사용하면 사용자가 기대하는 대로 &quot;그냥 작동&quot;합니다.
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.0/weave/trace/util.py#L164" />
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.0/weave/trace/util.py#L137" />
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.0/weave/trace/util.py#L146" />
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.0/weave/trace/util.py#L21" />
