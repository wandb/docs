...
## <kbd>class</kbd> `RemoteHTTPTraceServer` {#class-remotehttptraceserver}
...
### <kbd>방법</kbd> `ensure_project_exists` {#method-ensure_project_exists}
...
### <kbd>classmethod</kbd> `from_env` {#classmethod-from_env}
...
### <kbd>방법</kbd> `get_call_processor` {#method-get_call_processor}
...
### <kbd>방법</kbd> `get_feedback_processor` {#method-get_feedback_processor}
...
### <kbd>방법</kbd> `projects_info` {#method-projects_info}
...
### <kbd>방법</kbd> `server_info` {#method-server_info}
...
### <kbd>방법</kbd> `set_auth` {#method-set_auth}
