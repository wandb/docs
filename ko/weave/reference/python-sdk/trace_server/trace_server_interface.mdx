...
annotation 큐에 call을 일괄 추가하는 요청입니다.
...
annotation 큐의 항목을 쿼리하기 위한 요청입니다.
...
프로젝트의 annotation 큐를 쿼리하는 요청입니다.
...
여러 annotation 큐의 통계를 쿼리하는 요청입니다.
