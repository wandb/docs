...
| 이름 | 타입 | 설명 |
| :------ | :------ | :------ |
| `uri` | `string` | 형식이 `weave:///entity/project/object/name:digest` 인 Weave URI |
...
URI 형식이 올바르지 않거나 객체 참조가 아닌 경우 Error
