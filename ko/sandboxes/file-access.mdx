---
title: 파일 작업
description: Serverless Sandboxes에서 파일을 조회하고, 쓰고, 마운트하는 방법을 알아보세요.
keywords: ["Sandbox.write_file", "Sandbox.read_file", "파일 마운트", "샌드박스에 업로드"]
---
...
## 샌드박스에 파일 쓰기 {#write-a-file-to-the-sandbox}
...
## 샌드박스에서 파일 조회 {#read-a-file-from-the-sandbox}
...
## 파일 또는 디렉터리 마운트 {#mount-a-file-or-directory}
