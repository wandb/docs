---
title: "튜토리얼: PyTorch 모델 트레이닝"
description: "이 단계별 튜토리얼을 통해 Serverless Sandbox 환경에서 PyTorch 모델을 트레이닝하는 방법을 알아보세요."
keywords: ["W&B experiment tracking", "UCI Zoo 데이터셋", "신경망", "격리된 ML 트레이닝", "wandb logging"]
---
...
### W&amp;B Python SDK 설치 {#install-the-wb-python-sdk}
...
### W&amp;B에 로그인하고 인증하세요 {#log-in-and-authenticate-with-wb}
...
## 트레이닝 스크립트와 의존성 복사하기 {#copy-the-training-script-and-dependencies}
...
## 샌드박스를 생성하고 트레이닝 스크립트를 실행하세요 {#create-the-sandbox-and-run-the-training-script}
