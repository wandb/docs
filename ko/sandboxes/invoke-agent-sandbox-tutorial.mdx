...
description: "Serverless Sandbox 환경에서 OpenAI 에이전트를 호출하는 방법을 알아보세요"
keywords: ["튜토리얼", "샌드박스에서 에이전트 호출"]
---
...
### W&amp;B Python SDK 설치 {#install-wb-python-sdk}
...
### Secret Manager에 API 키 저장 {#store-api-keys-in-secret-manager}
