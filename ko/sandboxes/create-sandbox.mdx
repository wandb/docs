---
title: 샌드박스 만들기
description: W&B Sandboxes를 만드는 방법을 알아보세요.
---

<Warning>W&amp;B Sandboxes는 비공개 프리뷰 상태이며 초대를 받은 경우에만 사용할 수 있습니다. 등록을 요청하려면 [지원팀](mailto:support@wandb.com) 또는 AISE에 문의하세요.</Warning>
