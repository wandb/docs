...
본문 텍스트는 각 플랫폼에서 최적의 가독성을 제공하기 위해 시스템 폰트 스택을 사용합니다.
...
링크에는 일관성을 위해 <a href="#">청록색 계열 색상</a>을 사용합니다.
...
<div className="help-banner custom-banner">
  <h2>도움말 &amp; 지원 배너</h2>
  <p>이 배너는 텍스트 그림자 효과가 적용된 지원용 배경 이미지를 사용합니다.</p>
</div>

<div className="card-banner custom-banner">
  <h3>카드 배너</h3>
  <p>안내용 콘텐츠를 위한 은은한 회색 배경의 배너입니다.</p>
</div>

<div className="gradient-banner custom-banner">
  <h3>그라디언트 배너</h3>
  <p>눈에 띄는 공지를 위해 노을 그라디언트를 사용합니다.</p>
</div>
...
<div className="hero-gradient">
  ...
  <p>히어로 섹션과 중요한 공지를 위해 sunset 그라디언트를 사용합니다.</p>
</div>

<div className="card-gradient">
  <h3>은은한 그라디언트가 적용된 카드</h3>
  <p>카드 컴포넌트에 은은한 그라디언트 오버레이를 적용해, 과하지 않으면서도 시각적 관심을 더합니다.</p>
</div>
...
- 모든 스타일은 자동으로 다크 모드에 맞게 표시됩니다
- 색상은 관리가 쉽도록 CSS 변수로 정의되어 있습니다
- 그라데이션은 브랜드 색상을 일관되게 사용합니다
