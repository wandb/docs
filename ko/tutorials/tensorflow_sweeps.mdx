...
자세한 내용은 [Sweep documentation](/ko/models/sweeps/)을 참조하십시오.
...
자세한 내용은 [W&B Sweeps documentation](/ko/models/sweeps/define-sweep-configuration/)을 참조하십시오.
...
## 고급 설정
1. [환경 변수](/ko/platform/hosting/env-vars/): 관리형 클러스터에서 트레이닝하기 위한 API 키를 설정합니다.
2. [오프라인 모드](/ko/models/support/run_wandb_offline/)
3. [On-prem](/ko/platform/hosting/hosting-options/self-managed): 인프라의 프라이빗 클라우드 또는 에어 갭 서버에 W&B를 설치합니다. 로컬 설치는 학계 및 엔터프라이즈 팀에 적합합니다.
