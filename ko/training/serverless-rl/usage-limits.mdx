...
Serverless RL 인퍼런스 요청에 대한 가격은 W&B Inference 가격 정책과 동일합니다. 자세한 내용은 [모델별 비용](https://site.wandb.ai/pricing/reinforcement-learning)을 참조하세요. 크레딧 구매, 계정 등급 및 사용량 제한에 대한 자세한 내용은 [W&B Inference 문서](/ko/inference/usage-limits#purchase-more-credits)에서 확인할 수 있습니다.
