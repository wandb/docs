...
## API를 사용해 프로그래밍 방식으로 {#programmatically-via-the-api}
...
## run이 아직 실행 중일 때 {#while-the-run-is-still-running}
...
## run이 충돌한 경우 {#if-the-run-crashed}
...
## Logs 탭에 표시되는 줄 수보다 더 많은 줄 {#more-lines-than-the-logs-tab-shows}
