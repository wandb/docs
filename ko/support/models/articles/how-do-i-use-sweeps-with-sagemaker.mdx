...
Amazon SageMaker와 함께 W&amp;B Sweeps를 사용해 SageMaker 트레이닝 작업에서 하이퍼파라미터 검색을 실행할 수 있습니다. 기본 제공 Amazon SageMaker estimator를 사용할 때 W&amp;B를 인증하려면 `requirements.txt` 파일을 만드세요.
