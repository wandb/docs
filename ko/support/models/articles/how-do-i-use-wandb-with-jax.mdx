...
## JAX 트레이닝 루프에서 메트릭 로깅하기 {#log-metrics-from-a-jax-training-loop}
...
## 검증 메트릭 로깅 {#log-validation-metrics}
...
## 체크포인트를 아티팩트로 저장 {#save-checkpoints-as-artifacts}
