...
## 단일 프로세스 또는 단일 GPU 작업 {#single-process-or-single-gpu-jobs}
...
## 분산 트레이닝을 사용하는 멀티 GPU 작업 {#multi-gpu-jobs-with-distributed-training}
...
### `SLURM_PROCID`와 `SLURM_LOCALID` 중에서 선택하기 {#choose-between-slurm_procid-and-slurm_localid}
...
### rank-0이 아닌 rank에서 로그 기록 {#log-from-non-rank-0-ranks}
