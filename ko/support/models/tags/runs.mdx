...
<Card title="system 메트릭 로깅 빈도를 변경하려면 어떻게 해야 하나요?" href="/ko/support/models/articles/how-can-i-change-how-frequently-to-log-s" arrow="true" horizontal>
  system 메트릭 로깅 빈도를 설정하려면 &#95;stats&#95;sampling&#95;interval을 초 단위 숫자(float)로 설정하 ...
</Card>
...
<Card title="W&B에 system 메트릭 로깅을 비활성화하려면 어떻게 해야 하나요?" href="/ko/support/models/articles/how-can-i-disable-logging-of-system-metr" arrow="true" horizontal>
  system 메트릭 로깅을 비활성화하려면 &#95;disable&#95;stats를 True로 설정하세요:
</Card>
...
<Card title="임시 환경에서 run 데이터를 어떻게 보존하나요?" href="/ko/support/models/articles/how-do-i-preserve-run-data-from-ephemeral-env" arrow="true" horizontal>
