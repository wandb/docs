...
## `TS1295` 및 `TS1287`: ECMAScript import 및 export는 CommonJS 파일에 작성할 수 없습니다 {#ts1295-and-ts1287-ecmascript-imports-and-exports-cannot-be-written-in-a-commonjs-file}
