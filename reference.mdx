...
<CardGroup cols={2}>
  <Card title="W&B Agent Reference" href="/aria/overview">
    Reference for ARIA, is your personalized research assistant that analyzes and runs experiments, explains results, finds patterns across runs, recommends next steps, builds visualizations, reports and more in W&B.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="API Reference" href="/serverless-training/api-reference">
    REST API reference for Serverless Training (RL and SFT) endpoints.
  </Card>
</CardGroup>
