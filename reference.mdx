...
<CardGroup cols={2}>
  <Card title="W&B Agent Reference" href="/aria/overview">
    Reference for ARIA, your personalized research assistant that analyzes and runs experiments, explains results, finds patterns across runs, recommends next steps, builds visualizations, reports and more in W&B.
  </Card>
</CardGroup>
