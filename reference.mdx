...
<CardGroup cols={2}>
  <Card title="W&B Agent Reference" href="/agent/agent_overview">
    Reference for W&B Agent, your personalized AI research assistant that helps you analyze experiments and understand results.
  </Card>
</CardGroup>
