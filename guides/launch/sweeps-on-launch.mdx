...
slug: guides/launch/sweeps-on-launch
---
...
<Note>
Before you create a sweep with W&B Launch, ensure that you first create a job to sweep over. See the [Create a Job](/guides/launch/create-launch-job/) page for more information.
</Note>
...
For information on how to create a sweep configuration, see the [Define sweep configuration](/guides/launch/sweeps-on-launch/) page.
