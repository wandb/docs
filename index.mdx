...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    >
        Use Serverless Inference to access leading open-source foundation models through an OpenAI-compatible API. Features include multiple model options, usage tracking, and integration with Weave for tracing and evaluation.
        <br/>
        <br/>
    ...
    >
        Now in private preview by invitation, use Serverless Sandboxes to run code in on-demand, isolated compute environments. Features include lifecycle management, secrets handling, file access, and a Python SDK built on the CoreWeave Sandbox library.
        <br/>
        <br/>
