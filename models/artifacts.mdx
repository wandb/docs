...
<Frame>
    <img src="/images/artifacts/artifacts_landing_page2.png" alt="Artifacts workflow diagram with inputs and outputs for model training, data processing, and model evaluation" />
</Frame>
