...
You must provide the API with your entity, project name and the run's ID. You can find these details in the Run object or in [W&B](/models/track/workspaces/):
...
# current script or notebook, or you can copy them from W&B.
username = run.entity
project = run.project
run_id = run.id
