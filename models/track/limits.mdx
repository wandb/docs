...
<Warning>
The guidance described in this section only applies to W&B Multi-tenant Cloud. If you use a different W&B deployment type, check with your administrator for deployment-specific guidance or limits.
</Warning>
