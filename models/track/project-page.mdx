...
Starred projects are grouped at the top of the **Projects** page. Quickly access up to 10 recent projects in the **Projects** list in the left navigation, with starred projects listed first.
...
To confirm that your project is available, open your organization from the upper left of the app. Open **Projects** in the left navigation (or use **View all** under **Projects**) and find your project in the list. Starred projects appear at the top of the Projects page.
