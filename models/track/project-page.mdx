...
All panels maintain the same size, and there are pages of panels. Resize the section by clicking and dragging the lower right corner of the section.
...
<Frame>
    <img src="/images/data_vis/data_vis_sort_kebob.png" alt="Configuring a table sort"  />
</Frame>
...
[Tables](/models/tables/tables-walkthrough/) associated with artifacts are particularly rich and interactive in this context. Learn more about using Tables with Artifacts [here](/models/tables/visualize-tables/).
