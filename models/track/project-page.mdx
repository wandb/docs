...
## Create a project
You can create a project in W&B or programmatically by specifying a project in a call to `wandb.init()`.
...
1. Navigate to your W&B project on W&B at `https://wandb.ai/<team>/<project-name>`.
