...
In Multi-tenant Cloud organizations, client connections for distributed training are subject to the same [rate limits](/models/track/limits#rate-limits) as regular training runs. On [Teams and Enterprise plans](https://wandb.ai/site/pricing), you receive higher rate limits than on the Free plan.
</Tip>
