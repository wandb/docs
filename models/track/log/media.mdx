...
Logged point clouds are fully interactive in the W&B app. The [LIDAR Point Clouds of Driving Scenes report](https://wandb.ai/stacey/lyft/reports/LIDAR-Point-Clouds-of-Driving-Scenes--Vmlldzo2MzA5Mg) embedded below shows scenes from the Lyft dataset with 3D bounding boxes — drag to rotate and zoom within the viewer.
