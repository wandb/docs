...
title: Log tables
keywords: [wandb.Table, JoinedTable, add_data, log table, artifact tables]
---
...
For more information about artifacts, see the [Artifacts chapter](/models/artifacts/) in the Developer Guide.

### Visualize tables

Any table logged this way appears in your workspace on both the run page and the project page. For more information, see [Visualize and Analyze Tables](/models/tables/visualize-tables/).
