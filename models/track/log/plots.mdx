...
This page shows you how to create and log plots from your machine learning experiments so that you can visualize metrics, evaluate models, and share interactive charts in W&B. This page assumes you already log runs with the W&B Python SDK (`wandb`) and want to add custom or built-in visualizations to your experiments.

Use functions from W&B's `wandb.plot` namespace to track charts. To learn more about the custom charting framework, see the [custom charts walkthrough](/models/app/features/custom-charts/walkthrough/).
