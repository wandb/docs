...
You can also ask W&B ARIA to save your current workspace layout as a new view. The following compares the current code-block style with a chat-bubble prototype:
