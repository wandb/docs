...
1. Configure the workspace's [line plot settings](/models/app/features/panels/line-plot/#all-line-plots-in-a-workspace) according to your preferences.
