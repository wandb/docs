...
The following sections describe how to visualize and analyze W&B Tables.
...
The following section describes two common use cases for comparing W&B Tables: [comparing tables across time](#compare-tables-across-time) and [comparing tables across model variants](#compare-tables-across-model-variants).
