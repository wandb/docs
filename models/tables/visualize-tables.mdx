...
Customize your W&B Tables to answer questions about your machine learning model's performance, analyze your data, and more. This page is for machine learning practitioners who want to inspect logged data interactively in W&B.

Interactively explore your data to:

* [Compare two Tables](#table-comparison-options) logged as artifact versions to analyze changes in your data or model performance.
* Understand higher-level patterns in your data.
* [View how values you log to a table change throughout your runs](#visualize-how-values-change-throughout-your-runs).

Tables have the following behaviors:
...
For information on how to save your current Table view, see [Save your view](#save-your-view).
...
In W&B, you may notice duplicate values for multiple steps. This duplication can occur if multiple runs log the same value at different steps, or if a run doesn't log values at every step. If a value is missing for a given step, W&B uses the last logged value as the slider key.
