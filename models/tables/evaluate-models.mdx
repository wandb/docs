...
Download a model from Registry and evaluate it using Weave:
...
# Define a ChatModel that loads from Registry
...
### Integrate Weave evaluations with Models
...
1. **Load models from Registry**: Download fine-tuned models stored in Registry.
...
W&B Tables let you log structured predictions and inspect them interactively in the UI. Use Tables to:
