...
### Evaluate a model from Registry

Download a model from W&B Registry and evaluate it using Weave:
...
1. **Load models from Registry**: Download fine-tuned models stored in W&B Registry.
...
Log evaluation results to both Weave and Models:
...
## Evaluate models with W&B Tables

W&B Tables let you log structured predictions and inspect them interactively in the W&B UI. Use Tables to:
...
After you log a table, you can use the W&B UI to explore the results. You can:
