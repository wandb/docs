...
- [Track experiments](/models/track/) using runs or sweeps.
- [Configure deployment settings](/platform/app/settings-page/) and [defaults](/models/app/features/cascade-settings/).
- [Add panels](/models/app/features/panels/) to visualize your experiments, such as line plots, bar plots, media panels, query panels, and tables.
- [Add custom charts](/models/app/features/custom-charts/).
- [Create and share reports](/models/reports/).
