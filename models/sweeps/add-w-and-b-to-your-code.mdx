...
This guide provides recommendations on how to integrate W&B into your Python training script or notebook for hyperparameter serach optimization.
...
3. Use [`wandb.init()`](/models/ref/python/functions/init) to generate a background process to sync and log data as a [W&B Run](/models/ref/python/experiments/run). Pass the config object to the config parameter.
