...
If you want to use the W&B Python SDK to start, stop, and manage sweeps, follow the instructions in the **Python script or notebook** tab. If you want to use the W&B CLI to start, stop, and manage sweeps, follow the instructions in the **CLI** tab.
...
3. Use the [`wandb.init()`](/models/ref/python/functions/init) API to generate a background process to sync and log data as a [W&B Run](/models/ref/python/experiments/run). Pass the config object to the config parameter.
...
4. Within your `main` function, use the [`wandb.init()`](/models/ref/python/functions/init) API to generate a background process to sync and log data as a [W&B Run](/models/ref/python/experiments/run). Pass the project name as a parameter to the `wandb.init()` method. If you do not pass a project name, W&B uses the default project name.
