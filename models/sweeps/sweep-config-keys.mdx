...
Random search chooses a random, uninformed set of hyperparameter values on each iteration based on a distribution. Random search runs forever unless you stop the process from the command line, within your Python script, or from [the W&B UI](/models/sweeps/visualize-sweep-results).
...
Bayesian search runs forever unless you stop the process from the command line, within your Python script, or from [the W&B UI](/models/sweeps/visualize-sweep-results).
