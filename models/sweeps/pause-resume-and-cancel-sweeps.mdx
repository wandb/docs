...
The previous sections show how to manage the sweep. In the W&B App, a sweep's runs appear together with other runs in your project. See [View runs in a project](/models/runs/customize-run-display) for details.
