---
description: Start or stop a sweep agent on one or more machines.
...
These examples show how to start a sweep agent with the W&B CLI or from Python. You need the sweep ID that W&B returns when you initialize the sweep. The sweep ID has the form:
