...
Once the sweep is running, you can explore how different hyperparameter combinations affect your metric in W&B.

Open your project to see your live results in the W&B dashboard. In a few clicks, build interactive charts such as [parallel coordinates plots](/models/app/features/panels/parallel-coordinates), [parameter importance analyses](/models/app/features/panels/parameter-importance), and [other chart types](/models/app/features/panels).
