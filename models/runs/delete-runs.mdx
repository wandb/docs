---
title: Delete runs
description: Delete runs from a W&B project using W&B or the Public API, and learn how deleted run data is removed from storage.
---

## Delete runs
Delete runs from a project with W&B or the Python API.
...
<Note>
If deletions do not appear as expected in W&B when using the Public API, upgrade the W&B Python SDK to a current release and retry.
</Note>
