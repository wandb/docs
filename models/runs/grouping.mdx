...
<Note>
W&B stores group names as a run [`wandb.Run.group`](/models/ref/python/experiments/run#property-group) property.
</Note>
...
<Note>
View a run's job type by accessing the run's [`wandb.Run.job_type`](/models/ref/python/experiments/run#property-job_type) property.
</Note>
