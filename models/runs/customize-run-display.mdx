...
To view a specific run's details, click the run's name in the **Name** column. For more information, refer to [View a specific run logged to a project](/models/runs/view-logged-runs/).
...
<Note>
W&B persists customizations you make in the Runs table in the Runs selector of the Workspace tab.
</Note>
