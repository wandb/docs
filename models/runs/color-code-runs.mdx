...
4. In the **Colors** tab, confirm that **Key-based colors** is selected.
5. From the **Key** dropdown, select a metric or configuration key. After you select a key, the **Y value** dropdown and the **Buckets** section appear below it.
