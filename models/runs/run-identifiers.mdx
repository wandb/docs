...
```text title="W&B App URL of a specific run"
...
1. Search or scroll to the run you want to find the run path for.
1. Click on the run to open the run's **Overview** page.
1. Copy and paste the run path from the **Run path** field.
