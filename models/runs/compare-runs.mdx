---
description: Learn how to use pinned and baseline runs to keep track of important runs and set a baseline reference run to efficiently evaluate model experiments.
