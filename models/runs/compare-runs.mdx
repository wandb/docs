...
---
Use W&B to organize, identify, and compare important runs, such as top performers, production models, failed experiments, and reference runs. To accomplish this, you can organize and compare runs with:
...
After the runs complete, navigate to W&B to view the runs in your workspace. You can pin promising experiments and set the baseline run to compare the performance of new runs against it:
