...
- Hover over the baseline run's legend label to see the line in detail.
- Hover over the baseline run's line to see details about a point. Hover over another run's line to visually compare it with the baseline. When you hover over the plot, the baseline line is a heavy dashed line, and the other run's line is also displayed prominently. Other pinned and visible runs appear with reduced saturation.
...
- Hover over the baseline run's legend to display the line prominently. It appears as a heavy dashed line. Lines for other visible runs appear with reduced saturation.
