...
2. Click on the **Select runs from another project** button (small square box with rounded corners and a diagonal arrow).
...
W&B shows pinned runs in your project's run selector and runs table. Hover your mouse over the pinned run's name to see the project the run is from. Runs from other projects have an open circle icon next to their name.
