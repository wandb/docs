---
title: Stop runs
description: Stop runs programmatically using the W&B Python SDK or manually from the W&B UI.
---

Stop a run programmatically with the W&B Python SDK or interactively in the W&B UI.
