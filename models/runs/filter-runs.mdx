...
Filter runs based on their name, state, [tags](#filter-runs-with-tags), or other properties with the expression editor in the Runs table. Filtering helps you narrow a large set of runs down to the subset you want to compare, analyze, or act on.
