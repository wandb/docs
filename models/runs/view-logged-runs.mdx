---
title: View info about a specific run
...
After you select a run, explore its properties by navigating through the tabs: Overview, Logs, Files, Code, and Artifacts.
