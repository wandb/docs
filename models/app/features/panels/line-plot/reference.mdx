...
Use a regular expression to create a single line plot that shows multiple metrics together (including matching metrics logged in the future). W&B supports [RE2](https://github.com/google/re2/wiki/Syntax).
