...
Set the x-axis to any value logged with `wandb.Run.log()` as a number.
...
Set the y-axis variables to any value logged with `wandb.Run.log()` as a number, array of numbers, or histogram of numbers. If you logged more than 1500 points for a variable, W&B samples down to 1500 points.
