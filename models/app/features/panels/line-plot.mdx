...
1. To add a custom line plot instead, click **Line plot**.
    ...
    1. To add calculated expressions to the x-axis or y-axis, click **Expressions**. Specify a regular expression. Use Google's [RE2 syntax](https://github.com/google/re2/wiki/Syntax).
