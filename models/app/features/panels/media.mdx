...
- **Sync video playback**: Configure whether videos in the section play in sync. Not customizable at the section level. Appears only if the workspace has video media panels.
