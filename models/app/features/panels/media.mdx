...
1. Switch to **Compare mode** using the panel controls.
1. Select the runs, steps, or indices to show in the grid. Up to 4 items can appear in the comparison.

![Media panel showing two images in compare mode](/images/models/media_compare_mode.png)
