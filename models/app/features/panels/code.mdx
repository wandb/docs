...
1. In the run selector, select the run whose diff you want to view.
1. On the run **Overview** page, select the **Files** tab.
1. From the list of files, select the `diff.patch` or `diff_<sha>.patch` file.
1. Select a file from the list to expand the diff for that file.
