...
View local changes in your project workspace. W&B generates diff files when you log code with staged or unstaged changes in your Git repository.
...
2. On the run **Overview** page, select the **Files** tab.
3. From the list of files, select the `diff.patch` or `diff_<sha>.patch` file.
4. Select a file from the list to expand the diff for that file.
