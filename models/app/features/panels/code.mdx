...
View local changes in your project workspace. W&B saves the diff of unstaged changes across runs in a `diff.patch` or `diff_<sha>.patch` file in the **Files** tab of your project workspace. The diff files are generated when you log code with W&B and have unstaged changes in your git repository. To view the diff of unstaged changes across runs:
