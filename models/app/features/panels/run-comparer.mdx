...
Reports capture a run comparison so you can share the conclusion alongside the supporting charts. The [When Inception-ResNet-V2 Is Too Slow report](https://wandb.ai/stacey/estuary/reports/When-Inception-ResNet-V2-is-too-slow--Vmlldzo3MDcxMA) embedded below compares model variants to show which architectures train faster; scroll within it to read the analysis and inspect the panels.

<WandbReport
  src="https://wandb.ai/stacey/estuary/reports/When-Inception-ResNet-V2-is-too-slow--Vmlldzo3MDcxMA"
  title="Model speed comparison report: when Inception-ResNet-V2 is too slow"
  height={720}
/>
