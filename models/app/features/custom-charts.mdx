...
import {
  AriaChatBubbles,
  AriaChatCodeBlocks,
} from '/snippets/_includes/aria-chat-example.mdx';
import { AriaChatComparisonLayout } from '/snippets/_includes/aria-chat-comparison-layout.mdx';
...
You can also ask W&B ARIA to create a custom chart from a description. Open ARIA from your project workspace and describe the chart you want. The following compares the current code-block style with a chat-bubble prototype:

<AriaChatComparisonLayout
  codeColumn={
    <AriaChatCodeBlocks
