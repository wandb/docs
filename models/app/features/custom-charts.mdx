...
For detailed query examples and patterns, see the [Query syntax guide](/models/app/features/custom-charts/query-syntax).
...
For more examples, including how to import existing charts to reports, see the [Query syntax guide](/models/app/features/custom-charts/query-syntax).

## Articles and guides

1. [Query syntax for custom charts](/models/app/features/custom-charts/query-syntax)
