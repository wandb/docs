...
| ----- | ----- |
| **X axis** | The scale of the x-axis in line plots. The x-axis is set to **Step** by default. See the following tables for the list of x-axis and y-axis options. |
...
In addition to **Step**, W&B supports the following x-axis options:
...
W&B supports the following y-axis options:

| Y axis option | Description |
| ------------- | ----------- |
| **Range** | Minimum and maximum settings to display for the y-axis. |
