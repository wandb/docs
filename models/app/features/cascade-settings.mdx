...
In addition to the **Step** option, W&B supports the following x-axis options:
...
W&B supports the following y-axis:
...
W&B constrains all line plots in your workspace if you define a manual y-axis range. For highly variable metrics, consider setting the range at the section level.
