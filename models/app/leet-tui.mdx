...
Available color schemes: `wandb-vibe-10`, `wandb-vibe-20`, `sunset-glow`, `blush-tide`, `gilded-lagoon`, `bootstrap-vibe`, `dusk-shore`, `clear-signal`, `traffic-light`, `viridis`, `plasma`, `inferno`, `magma`, and `cividis`.
...
The following table summarizes LEET changes by version. For more details, see the [SDK release notes](/release-notes/sdk-releases).
...
- [`wandb beta leet`](/models/ref/cli/wandb-beta/wandb-beta-leet) — launch syntax and subcommands.
