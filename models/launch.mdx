...
![Example leaderboard](/images/models/llm-evaluation-jobs/example-leaderboard.png)
...
- Certain benchmarks use OpenAI for scoring or access datasets in Hugging Face. To run these benchmarks, the relevant API keys must be available as team secrets.

For more details about a given requirement, see:
