...
<Frame>
    <img src="/images/evaltables/overview_basic_compare_two_runs_landing_page_notlabled.png" alt="Eval Table view"/>
</Frame>
...
<Frame>
    <img src="/images/evaltables/overview_basic_compare_two_runs_landing_page.png" alt="Eval Table view" />
</Frame>

[Create an Eval Table with the `EvalTable` class from the W&B Python SDK](/models/evaltables/create-an-evaluation-table). 

Existing [W&B Tables](/models/tables) can also be converted to Eval Tables with ARIA. For more information, see [Convert a W&B Table to an Eval Table](/models/evaltables/create-an-evaluation-table#convert-a-wb-table-to-an-eval-table).
