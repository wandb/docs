...
* Each individual argument must contain the prefix `"wandb-"` . For example any argument to be passed to [`wandb.init()`](/models/ref/python/functions/init) would get the `wandb-` prefix
