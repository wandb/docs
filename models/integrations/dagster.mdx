...
Find your W&B entity by checking your team's profile page in the W&B App. You can use a pre-existing W&B project or create a new one. Create new projects on the W&B App homepage or on your team's profile page. If a project doesn't exist, W&B creates it automatically when you first use it.
