...
This section explains how to authenticate to W&B, install the client library, name your project, and turn on logging in your `Trainer` so that your first training run shows up in the W&B Dashboard.
