...
- Whether you can run your library without saving or uploading W&B data.
...
Log configuration values and metrics to W&B so you, and members of your team, can compare, filter, group, and reproduce runs.
...
Configuration values help you [compare](/models/runs/compare-runs), [filter](/models/runs/filter-runs), [group](/models/runs/grouping), and [reproduce](/models/track/reproduce_experiments) runs.
...
Download artifacts that your library produces or consumes so that you can reproduce and compare runs. Use the [W&B Public API](/models/ref/python/public-api) to download an artifact without creating a run or recording a run input relationship.
