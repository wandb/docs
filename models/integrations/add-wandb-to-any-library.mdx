...
See the [Log models and datasets with artifacts](#track-models-and-datasets-with-artifacts) section for guidance on logging models and datasets as artifacts.
...
Check that the destination registry exists. If the specified collection does not exist, W&B creates it when you link the artifact version.
