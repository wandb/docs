...
<Tabs>
<Tab title="PyTorch Logger">
To log your metrics to W&B when using the `WandbLogger`, call `self.log('my_metric_name', metric_value)` within your `LightningModule`, such as in your `training_step` or `validation_step` methods.
