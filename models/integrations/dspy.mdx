...
title: DSPy
keywords: ["BootstrapFewShot", "MIPRO optimizer", "teleprompter", "signature tuning"]
---
...
1. Set the `WANDB_API_KEY` [environment variable](/models/track/environment-variables/) and log in. Replace `[YOUR-API-KEY]` with your W&B API key:
