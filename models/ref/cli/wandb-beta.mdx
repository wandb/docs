---
title: "wandb beta"
description: "CLI reference for the `wandb beta` command, which provides beta versions of wandb CLI commands."
---
...
| Command | Description |
| :--- | :--- |
| [core](/models/ref/cli/wandb-beta/wandb-beta-core) | Manage a shared local wandb-core service for multi-process workloads. |
