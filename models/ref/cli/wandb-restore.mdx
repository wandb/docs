...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/cli/cli.py#L3189" />
...
Usage: restore [OPTIONS] RUN
  ...
  Restore a run from the "foobar" project and "team-awesome" entity with run
  ID "abcd1234"

  ```bash wandb restore team-awesome/foobar-project:abcd1234 ```

  Restore run "abcd1234" without restoring git state. Only restore config and
  Docker state.
