...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/cli/cli.py#L562" />
...
| `--clean` | BOOL Flag | (legacy only) Delete local data for runs that are already synced. **Default**: False |
