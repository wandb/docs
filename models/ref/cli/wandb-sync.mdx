...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/cli/cli.py#L552" />
...
Usage: sync [OPTIONS] [PATH]...
  ...
  Sync a run in the "foobar-project" project and "team-awesome" entity by its
  `.wandb` filepath

  ```bash wandb sync --project foobar-project --entity team-awesome
