...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/cli/cli.py#L543" />
...
```
    ...
    Sync a run in the "foobar-project" project and "team-awesome"
    entity by its .wandb filepath
