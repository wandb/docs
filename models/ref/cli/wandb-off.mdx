---
title: "wandb off"
description: "CLI reference for the `wandb off` command, which disables W&B functionality as an alias for wandb disabled."
---
{/*
  To add introductory content for this command:
  1. Create the snippet file: /snippets/en/_includes/cli/wandb-off.mdx
