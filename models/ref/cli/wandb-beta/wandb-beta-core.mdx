...
| Command | Description |
|---------|-------------|
| [`wandb beta core start`](wandb-beta-core/wandb-beta-core-start) | Start a detached wandb-core service. |
| [`wandb beta core stop`](wandb-beta-core/wandb-beta-core-stop) | Stop a detached wandb-core service. |
