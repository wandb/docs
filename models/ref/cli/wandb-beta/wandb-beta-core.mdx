...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/cli/beta.py#L251" />
...
| Command | Description |
|---------|-------------|
| [`wandb beta core start`](/models/ref/cli/wandb-beta/wandb-beta-core/wandb-beta-core-start) | Start a detached wandb-core service. |
| [`wandb beta core stop`](/models/ref/cli/wandb-beta/wandb-beta-core/wandb-beta-core-stop) | Stop a detached wandb-core service. |
