...
| `--verify` | BOOL Flag | Verify the API key with W&B after storing it. If verification is successful, display the source of the credentials and the default team. **Default**: True |
