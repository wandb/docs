...
Specify aggregate metrics added to summary. Supported aggregations include "min", "max", "mean", "last", "first", "copy" and "none". "none" prevents a summary from being generated. "copy" is deprecated and should not be used.
</ResponseField>
