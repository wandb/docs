...
Note that you must call wandb.Run.finish()_artifact() to finalize the artifact. This is useful when distributed jobs need to all contribute to the same artifact. 
