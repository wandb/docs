...
### <kbd>method</kbd> finish_artifact
...
### <kbd>method</kbd> log_code

```python
self,
root: 'str | None' = '.',
name: 'str | None' = None,
include_fn: 'Callable[[str, str], bool] | Callable[[str], bool]' = <function _is_py_requirements_or_dockerfile at 0x106c1b060>,
exclude_fn: 'Callable[[str, str], bool] | Callable[[str], bool]' = <function exclude_wandb_fn at 0x1082c93a0>
```
...
### <kbd>method</kbd> mark_preempting
...
### <kbd>method</kbd> pin_config_keys
...
### <kbd>method</kbd> upsert_artifact
