---
description: Reference for CPU, GPU, memory, disk, and network system metrics that the W&B SDK automatically logs during runs.
...
## View system metrics
You can view and monitor system metrics using the W&B UI or the `wandb beta leet` terminal UI.

<Tabs>
<Tab title="App">

To view system metrics in W&B:
