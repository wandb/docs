...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L322" />



## <Badge color="yellow" size="lg" shape="rounded">Class</Badge> wandb.automations.OnAddCollectionTag
...
<ResponseField name="event_type" type="Literal[ADD_COLLECTION_TAG]">
