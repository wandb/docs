...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L358" />
...
filter: typing.Annotated[wandb.automations.events.RunStateFilter, Json, BeforeValidator(func=<function ensure_json at 0x108cdcae0>, json_schema_input_type=PydanticUndefined), PlainSerializer(func=<function to_json at 0x106c66a20>, return_type=PydanticUndefined, when_used='always')]
```
