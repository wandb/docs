...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L355" />
...
filter: typing.Annotated[wandb.automations.events.RunStateFilter, Json, BeforeValidator(func=<function ensure_json at 0x10894b100>, json_schema_input_type=PydanticUndefined), PlainSerializer(func=<function to_json at 0x106b4ee80>, return_type=PydanticUndefined, when_used='always')]
```
