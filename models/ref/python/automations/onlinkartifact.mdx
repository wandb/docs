...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L238" />
...
<ResponseField name="event_type" type="Literal[LINK_ARTIFACT]">
