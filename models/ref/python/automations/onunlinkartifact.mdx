...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L262" />



## <Badge color="yellow" size="lg" shape="rounded">Class</Badge> wandb.automations.OnUnlinkArtifact
```python
*,
...
<ResponseField name="event_type" type="Literal[UNLINK_ARTIFACT]">
