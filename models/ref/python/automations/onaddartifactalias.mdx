...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L268" />
...
<ResponseField name="event_type" type="Literal[ADD_ARTIFACT_ALIAS]">
