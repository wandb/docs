...
action: Optional[Annotated[Union[wandb.automations.actions.SendNotification, wandb.automations.actions.SendWebhook, wandb.automations.actions.DoNothing], BeforeValidator(func=<function parse_input_action at 0x108b82840>, json_schema_input_type=PydanticUndefined), FieldInfo(annotation=NoneType, required=True, discriminator='action_type')]] = None
```
