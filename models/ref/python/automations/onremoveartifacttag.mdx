...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L316" />



## <Badge color="yellow" size="lg" shape="rounded">Class</Badge> wandb.automations.OnRemoveArtifactTag
```python
*,
...
<ResponseField name="event_type" type="Literal[REMOVE_ARTIFACT_TAG]">
