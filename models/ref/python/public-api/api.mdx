...
For more complex filtering, you can use MongoDB query operators. For details, see: https://www.mongodb.com/docs/manual/reference/mql/query-predicates/ The following operations are supported: 
- `$and` 
- `$or` 
- `$nor` 
- `$eq` 
