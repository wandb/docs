...
| [`Team`](./Team) | Query team information and manage team-level resources. |
| [`User`](./User) | Access user profiles and user-specific data. |
...
For more information on how to query a registry, collection, or artifact, see the [Search registry](/models/registry/search_registry).