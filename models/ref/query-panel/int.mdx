...
[number](number.md)를 다른 숫자로 나누고 나머지를 반환합니다.
...
[number](number.md)를 다른 숫자로 나눕니다.
...
[number](number.md)가 다른 숫자보다 작은지 확인합니다.

| ARG |  |
| :--- | :--- |
| `lhs` | 비교할 [number](number.md) |
| `rhs` | 비교할 [number](number.md) |

#### Return Value
첫 번째 [number](number.md)가 두 번째 숫자보다 작은지 여부

<h3 id="number-lessEqual"><code>number-lessEqual</code></h3>

[number](number.md)가 다른 숫자보다 작거나 같은지 확인합니다.
...
#### Return Value
첫 번째 [number](number.md)가 두 번째 숫자보다 작거나 같은지 여부
...
[number](number.md)가 다른 숫자보다 큰지 확인합니다.
...
#### Return Value
첫 번째 [number](number.md)가 두 번째 숫자보다 큰지 여부

<h3 id="number-greaterEqual"><code>number-greaterEqual</code></h3>

[number](number.md)가 다른 숫자보다 크거나 같은지 확인합니다.
...
#### Return Value
첫 번째 [number](number.md)가 두 번째 숫자보다 크거나 같은지 여부
...
[number](number.md)를 _timestamp_ 로 변환합니다. 31536000000보다 작은 값은 초로 변환되고, 31536000000000보다 작은 값은 밀리초로 변환되고, 31536000000000000보다 작은 값은 마이크로초로 변환되고, 31536000000000000000보다 작은 값은 나노초로 변환됩니다.
