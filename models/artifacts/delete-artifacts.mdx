...
Artifacts with protected aliases have special deletion restrictions. [Protected aliases](/models/registry/model_registry/access_controls/) are aliases in the Model Registry that registry admins can set to prevent unauthorized deletion.
