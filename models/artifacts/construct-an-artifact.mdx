...
keywords: ["wandb.Artifact", "add_file", "add_dir", "add_reference", "log_artifact"]
---
...
2. [Add one or more files to the artifact](/models/artifacts/construct-an-artifact#2-add-one-or-more-files-to-the-artifact)
3. [Save your artifact to the W&B server](/models/artifacts/construct-an-artifact#3-save-your-artifact-to-the-wb-server)
