...
<Note>
W&B uses the "name" and "type" you provide to create a directed acyclic graph that you can explore in the W&B UI. See the [Explore and traverse artifact graphs](./explore-and-traverse-an-artifact-graph) for more information.
</Note>
