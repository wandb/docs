...
keywords: ["incremental artifact", "distributed_id", "upsert_artifact", "new_draft", "artifact version"]
---
...
W&B retrieves an existing artifact if you pass a name and artifact type to the `wandb.Artifact` API that matches an existing artifact in your project. The retrieved artifact has a version greater than 1. 
