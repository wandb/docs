...
keywords: ["reference artifact", "add_reference", "S3 bucket", "NFS mount", "object versioning"]
---
...
<Note>
W&B Artifacts support any Amazon S3 compatible interface, including CoreWeave Storage and MinIO. The following scripts work without modification with both providers, when you set the `AWS_S3_ENDPOINT_URL` environment variable to point at your CoreWeave Storage or MinIO server.
</Note>
