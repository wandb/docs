...
1. Navigate to your project's workspaces in the W&B App.
2. Click on the **Artifacts** tab in the project sidebar.
3. Select the artifact whose lineage graph you want to view.
...
Use the W&B App UI to explore and traverse an artifact's lineage graph. The lineage graph is a visual representation of the relationships between artifacts and runs in an ML experiment.
...
<Note>
You can view the type and the name of artifact in both the left sidebar and in the a lineage graph node.
</Note>
