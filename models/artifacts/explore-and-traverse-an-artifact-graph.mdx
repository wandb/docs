...
keywords: ["DAG", "lineage tracking", "artifact graph", "use_artifact", "log_artifact"]
---
...
To enable lineage graph tracking, you must mark artifacts as [inputs](/models/artifacts/explore-and-traverse-an-artifact-graph) or
