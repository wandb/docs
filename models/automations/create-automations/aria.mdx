...
The automation creates the ARIA conversation under the account of the user who created the automation. The conversation appears in that person's ARIA chat history sidebar, alongside conversations they started themselves. To identify the user that caused the event, include `${event_author}` in the prompt.
