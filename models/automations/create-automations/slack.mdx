...
<Note>
To apply an automation more broadly, create it from the global **Automations** hub and select the **Team** or **Organization** scope. The steps are the same as those that follow. At these scopes, the W&B App supports artifact and collection events only. See [Automations hub](/models/automations#automations-hub).
</Note>
