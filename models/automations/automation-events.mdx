...
| Scope | What the automation watches | Events available in W&B |
|-------|-----------------------------|---------------------------------|
...
Run-based events (the [run status change](#run-status-change) and [run metric](#run-metrics-change) events) aren't available at the Organization scope in W&B.

## Team

Use the Team scope to apply a policy to everything one Team owns. A Team-scoped automation watches for the same artifact and collection events as the Organization scope. Run-based events aren't available at the Team scope in W&B.
