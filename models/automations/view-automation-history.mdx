...
<Tip>If a collection has associated automation executions, the icon ![Collection automation execution symbol, a circle with a right-pointing arrow](/images/automations/collection-automation-execution-icon) displays, along with the number of associated executions.</Tip>
</Tab>
<Tab title="Project">
