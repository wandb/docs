...
Use the notebook sidebar to manage files in the notebook sandbox and connect to remote data sources. You can also download [W&B Artifacts](/models/artifacts/download-and-use-an-artifact) into the notebook.

## Notebook storage and persistence

Each notebook runs in a temporary [CoreWeave Sandbox](https://docs.coreweave.com/products/sandboxes). Files that you create, upload, or download appear under **Files** in the notebook sidebar and exist only in the sandbox.
