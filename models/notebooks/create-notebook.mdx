...
Duplicate an existing notebook to create a copy within the same project or a different project. W&B names the duplicate notebook by prepending `Copy` to the original notebook name.
