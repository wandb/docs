...
- **Command mode**: Perform actions on cells, such as adding, deleting, and moving them. Press **Escape** (`Esc`) to enter command mode. 
- **Edit mode**: Modify the contents of a cell. Press **Enter** (`Enter`) to enter edit mode.
...
Press **Escape** (`Esc`) to enter command mode then use one of the following shortcuts:
...
1. Press **Escape** (`Esc`) to enter command mode.
