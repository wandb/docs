---
title: "Available Evaluation Benchmarks"
description: >
  Browse the evaluation benchmarks available through W&B LLM Evaluation Jobs
---

[W&B LLM Evaluation Jobs](/models/launch) provides access to a comprehensive suite of standardized evaluation benchmarks to test different capabilities of language models, from reasoning and knowledge to safety and specialized benchmarks.

## Available benchmarks

{/* Src: https://github.com/wandb/launch-jobs/blob/main/jobs/inspect_ai_evals/api_model/sample-schema.json */}

These sections list the available benchmarks in each category.
...
| HLE | `hle` | Human-level evaluation benchmark |
| Lingoly | `lingoly` | Linguistics olympiad problems |
| Lingoly Too | `lingoly_too` | Extended linguistics challenge problems |
...
| [SimpleQA](https://openai.com/index/introducing-simpleqa/) | `simpleqa` | Straightforward factual question answering |
...
| Evaluation | Task ID | Description |
|------------|---------|-------------|
| [AgentHarm](https://arxiv.org/abs/2410.09024) | `agentharm` | Tests model resistance to harmful agent behavior and misuse scenarios |
| [AgentHarm Benign](https://arxiv.org/abs/2410.09024) | `agentharm_benign` | Benign baseline for AgentHarm to measure false positive rates |
...
| MASK | `mask` | Tests model's handling of sensitive information |
| Personality BFI | `personality_BFI` | Big Five personality trait assessment |
| Personality TRAIT | `personality_TRAIT` | Comprehensive personality trait evaluation |
| SOSBench | `sosbench` | Safety and oversight stress test |
| [StereoSet](https://stereoset.mit.edu/) | `stereoset` | Measures stereotypical biases in language models |
...
| [XSTest](https://arxiv.org/abs/2308.01263) | `xstest` | Exaggerated safety test for over-refusal detection |
...
| [HealthBench](https://arxiv.org/abs/2406.09746) | `healthbench` | Healthcare and medical knowledge evaluation |
| [HealthBench Consensus](https://arxiv.org/abs/2406.09746) | `healthbench_consensus` | Healthcare questions with expert consensus |
| [HealthBench Hard](https://arxiv.org/abs/2406.09746) | `healthbench_hard` | Challenging healthcare scenarios |
...
## Specifying evaluation tasks

When configuring an evaluation job programmatically, specify tasks by Task ID. You can select multiple evaluations to run in a single job. For example:

```json
{
  "tasks": ["gsm8k", "mmlu_5_shot", "hellaswag"],
  "limit": 100,
  "model": {
...
- View details about specific LLM evaluation benchmarks at [AISI Inspect Evals](https://inspect.aisi.org.uk/evals/)
