...
1. Click **Launch** to run the evaluation.
1. Track the status recent evaluations by clicking the circular arrows at the top of the page. Click the name of a **Running** run to view results as they come in, or a **Finished** run to view the full results.
