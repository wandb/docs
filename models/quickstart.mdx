...
import { MolabLink } from '/snippets/_includes/molab-link.mdx';

<div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
<MolabLink url="https://molab.marimo.io/github/wandb/examples/blob/marimo-migration/colabs/intro/run_quickstart.py" />
<GitHubLink url="https://github.com/wandb/examples/blob/marimo-migration/colabs/intro/run_quickstart.py" />
</div>
...
1. Learn about and create your first [run](/models/runs).
2. Track models, datasets, and other files with [W&B Artifacts](/models/artifacts).
3. Automate hyperparameter searches and optimize models with [W&B Sweeps](/models/sweeps).
4. Share models, prompts, and datasets with [W&B Registry](/models/registry).
