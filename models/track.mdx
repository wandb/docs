...
- [SDK Architecture](/models/track/sdk-architecture/) — Event-driven architecture and data flow
- [SDK Performance](/models/track/sdk-performance/) — Performance guidelines, GPU/CPU synchronization, and best practices