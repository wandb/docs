...
The report below was created from metrics logged to W&B over the course of training. Scroll within it to explore the benchmark runs, panels, and commentary, or [open the full report](https://wandb.ai/stacey/saferlife/reports/SafeLife-Benchmark-Experiments--Vmlldzo0NjE4MzM) in the W&B app.

<WandbReport
  src="https://wandb.ai/stacey/saferlife/reports/SafeLife-Benchmark-Experiments--Vmlldzo0NjE4MzM"
  title="SafeLife benchmark experiments report"
  height={720}
/>
...
1. Navigate to your W&B project workspace.
