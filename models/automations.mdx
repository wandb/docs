...
- At the **Team** and **Organization** scopes, W&B supports only artifact and collection events. Run-based events aren't available at these scopes. See [Automation events and scopes](/models/automations/automation-events).

## Next steps
- [Automations tutorial](/models/automations/tutorial): Guides you to create a project automation to alert on run failures and a Registry automation to run a webhook when an alias is added. The tutorial uses W&B.
