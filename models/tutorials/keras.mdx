...
This Colab notebook introduces the `WandbMetricsLogger` callback. Use this callback for [Experiment Tracking](/models/track/). It will log your training and validation metrics along with system metrics to W&B.
