...
1. Initialize a [run](/models/runs/) and pass in the hyperparameters you want to track.
...
W&B runs automatically log [metrics](/models/runs/#workspace-tab),
system information,
[hyperparameters](/models/runs/#overview-tab),
[terminal output](/models/runs/#logs-tab) and
you'll see an [interactive table](/models/tables/)
...
W&B also makes it easy to share your saved models and model checkpoints with other members of your team or organization. To learn how to share your model and model checkpoints with members outside of your team, see [W&B Registry](/models/registry/).
...
Create a [W&B Alerts](/models/runs/alert/) to send alerts to your Slack or email from your Python code. 
...
For more details, see the [W&B Alerts overview](/models/runs/alert/).
