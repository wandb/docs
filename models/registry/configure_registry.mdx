...
Registry admins can control access to a W&B Registry by managing members and permissions. Use the registry settings to [configure registry roles](/models/registry/configure_registry/#configure-registry-roles), [add users](/models/registry/configure_registry/#add-a-user-or-a-team-to-a-registry) or teams, and [remove users or teams](/models/registry/configure_registry/#remove-a-user-or-team-from-a-registry).
...
<a id="service_account_footnote">1</a>: Service accounts can't have **Viewer** or **Restricted Viewer** roles. See [Service account access](#service-account-access) for how a service account's access is determined.
...
| Usage: Consume an artifact in a registry with `wandb.Run.use_artifact()`                                             | Read             |                                                            |   ✓    |   ✓    |   ✓   |
