...
- **Restricted Viewer**: Provides read-only access to registry artifacts without the ability to create, update, or delete collections, automations, or other registry resources. This role is available for Dedicated Cloud and Self-Managed Server v0.75.0 or newer.
