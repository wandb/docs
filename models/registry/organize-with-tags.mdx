...
description: Use tags to organize collections or artifact versions within collections.
  You can add, remove, edit tags with the Python SDK or the W&B UI.
title: Organize versions with tags
---

Create and add tags to organize your collections or artifact versions within your registry. Add, modify, view, or remove tags to a collection  or artifact version with the W&B UI or the W&B Python SDK.
...
Add a tag to an artifact version linked to a collection with the W&B UI or with the Python SDK.
...
View tags that belong to an artifact version that is linked to a registry with the W&B UI or with the Python SDK. 
