...
You can link an artifact version programmatically with the W&B Python SDK or interactively in the W&B UI. Based on your use case, follow the instructions described in the following tabs to link an artifact version.
...
Copy and paste the following code snippet. Replace the bracketed placeholders with your own:
