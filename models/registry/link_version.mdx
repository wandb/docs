...
keywords: ["link artifact", "link_artifact", "registry collection", "target_path", "publish model"]
---
...
If you're unsure of the exact path to use as your `target_path`, you can confirm it from the W&B App UI in two ways: create an empty collection and view the collection details, or copy and paste the autogenerated code on the collection's homepage.
...
3. At the top of the page, you see an autogenerated code block.
4. Copy and paste this into your code, and replace the last part of the path with the name of your collection.
