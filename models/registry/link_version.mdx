...
can link an artifact version [programmatically by using the W&B Python SDK or interactively in W&B](/models/registry/link_version#link-an-artifact-to-a-collection).
...
1. Navigate to your project's artifact browser on W&B at: `https://wandb.ai/<entity>/<project>/artifacts`
