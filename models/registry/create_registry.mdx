...
keywords: ["registry visibility", "restricted registry", "artifact types", "artifact registry"]
---
...
5. Select who can view the registry from the **Registry visibility** dropdown. See [Registry visibility types](./configure_registry#registry-visibility-types) for more information about registry visibility options.
...
For more information about assigning visibility when a team admin creates a registry, see [Create a registry](./create_registry#create-a-custom-registry).
