...
description: "Learn how to search for registries, collections, and artifact versions in the W&B Registry using the global search bar or MongoDB-style queries."
---
