...
keywords: ["lineage graph", "artifact history", "collection audit", "action history"]
---
...
The following image shows the expanded view of a run (`rural-feather-20`) when you select a node in the lineage graph:
...
The following image shows the expanded view of an artifact (`zoo-ylbchv20:v0`) when you select an artifact node in the lineage graph:
