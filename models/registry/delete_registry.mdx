...
This page shows how a Team admin or Registry admin can delete a custom registry.  A [core registry](/models/registry/registry_types/#core-registry) cannot be deleted.
