...
description: "Delete a W&B Registry as a Team admin or Registry admin using the Python SDK or the W&B App."
---

This page shows how a Team admin or Registry admin can delete a registry. Admins can programmatically or interactively delete a registry with the W&B Python SDK or the W&B App.
