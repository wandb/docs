...
See [`use_model`](/models/ref/python/experiments/run#use_model) in the API Reference guide for more information on possible parameters and return type.
...
Use the W&B Registry to track, organize and consume model artifacts. For more information see the [Registry docs](/models/registry/).
</Note>
...
See [`use_model`](/models/ref/python/experiments/run#use_model) in the API Reference guide for parameters and return type.
</Tab>
<Tab title="W&B App">
