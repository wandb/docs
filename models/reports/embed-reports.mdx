...
<Note>
You can only embed and render reports from public projects or reports that you've shared using [view-only links](/models/reports/cross-project-reports#view-only-report-links) (the link's access token is part of the URL).
</Note>
