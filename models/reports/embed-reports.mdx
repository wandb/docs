...
<Note>
Only reports that anonymous viewers can open render when embedded: reports in *public* projects, or reports shared with a [view-only link](/models/reports/cross-project-reports#view-only-report-links) (the link's access token is part of the URL).
</Note>
