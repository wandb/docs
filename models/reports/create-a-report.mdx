---
description: Create a W&B Report with W&B or programmatically.
...
Select a tab to learn how to create a report in W&B or programmatically with the Report and Workspace API.
...
<Tabs>
<Tab title="W&B">
1. Navigate to your project workspace in W&B.
