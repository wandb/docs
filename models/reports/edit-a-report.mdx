...
<Tip>
To have [ARIA](/aria/overview) revise a report you own, open the report and click **Edit with ARIA**, then describe the changes you want. ARIA saves its changes to the existing report.
</Tip>
