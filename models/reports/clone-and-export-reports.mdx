---
description: "Export W&B Reports as PDF or LaTeX files, and clone reports using the W&B UI or the Report and Workspace API."
...
Clone a report to reuse an existing project's template and formatting as the basis for a new report. You can clone reports in the W&B UI or programmatically with the Report and Workspace API.
...
<Frame>
    <img src="/images/reports/clone_reports.gif" alt="Cloning a report in W&B"  />
</Frame>
