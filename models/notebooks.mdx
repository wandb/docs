...
Use W&B Notebooks to create interactive, reactive Python notebooks inside W&B. Notebooks are useful for exploring data, prototyping model workflows, analyzing W&B runs and artifacts, and sharing reproducible work with collaborators.

Each notebook runs in a temporary [CoreWeave Sandbox](https://docs.coreweave.com/products/sandboxes), which provides isolated compute for notebook cells, packages, files, and terminal commands.
