...
<Note>
To compare runs with workspace-level summary metrics, line plots, pinned runs, or a baseline run, see [Pin and compare runs](/models/runs/compare-runs). Eval Tables compare aligned examples and eval-specific scores within a logged table.
</Note>
