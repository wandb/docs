...
| Moonshot AI Kimi K2.7 Code   | `moonshotai/Kimi-K2.7-Code`                    | Text         | 262k           | 32B-1T (Active-Total)     | Kimi K2.7 Code is a 1T-parameter MoE model with 32B active parameters purpose-built for long-horizon agentic coding and software engineering.     |
...
| Z.AI GLM 5.2                 | `zai-org/GLM-5.2`                              | Text         | 262k           | 40B-744B (Active-Total)   | GLM-5.2 is a Mixture-of-Experts language model featuring 40 billion activated parameters and a total of 744 billion parameters.                   |
