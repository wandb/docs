...
4. **Inference gateway access**  
   Your organization must have the inference gateway enabled. If you receive an error message stating "the inference gateway is not enabled for your organization", contact your W&B administrator or [W&B support](mailto:support@wandb.com) to enable access.
