...
<Tab title="Standalone binary (macOS or Linux)">
 you'd rather not use Homebrew or `uv`, 
...
<Tip>For details about distributing and installing the standalone binary with fleet rollout tools like JAMF, Intune, Mosyle, Kandji, or Workspace ONE, see [MDM](https://hivemind.wandb.tools/docs/mdm) in the HiveMind documentation.
</Tab>
