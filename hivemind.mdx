...
These screenshots show example pages in the HiveMind dashboard: an adoption leaderboard, a usage and cost report, and the detailed view of a session. Click a screenshot to view details.

<Columns cols={2}>
<Frame>![HiveMind Adoption Leaderboard showing the top users](/images/hivemind/hivemind-dashboard-leaderboard.png)</Frame>
<Frame>![HiveMind Usage dashboard with charts](/images/hivemind/hivemind-dashboard-usage.png)</Frame>
</Columns>
<Columns cols={1}>
