...
1. In the ARIA chat window, click **<Icon icon="bars" iconType="solid" />**.
...
ARIA uses W&B Launch to run experiments in a sandbox environment. See [Enable ARIA to run experiments](/aria/autoresearch#set-up-wb-launch-with-aria) for more information.
</Accordion>
