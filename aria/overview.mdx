...
Besides **Ask ARIA** at the top of the page, you can start ARIA from buttons throughout W&B. Most of them open a new chat with a hint in the message box, and you describe what you want before sending.

| Where | Button | What ARIA helps with |
|---|---|---|
| Crashed or failed run's page | **Debug with ARIA** | Explain why the run crashed or failed. This button starts a new chat and asks ARIA right away. |
...
| **Manage columns** dialog in the **Runs** table | **Manage columns with ARIA** | Same as the previous row. |
...
To give ARIA context about a specific run, workspace panel, or Weave trace or evaluation, see [Add context to a conversation](/aria/chat#add-context-to-a-conversation).
