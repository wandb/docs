...
To help you stay in context, ARIA renders line plots and bar charts directly in the chat, with support for full-screen view, hovering, and more. Hovering on a run in the workspace's **Runs** tab highlights the run's plots in ARIA, and hovering over a panel in ARIA highlights the run in the **Runs** tab.
