...
|---|---|---|
| Crashed or failed run's page | **Debug with ARIA** | Starts a new chat and immediately asks ARIA to explain why the run crashed or failed. |
...
| **Filter** menu in the **Runs** table | **Describe the filters you want ARIA to create** text field | Type a description of the runs you want and press **Enter**. ARIA proposes a **Run Filter**. Click it in the chat to apply it to your workspace. |
