...
The following page describes how to specify a run in your prompt, add an image to a conversation, start a new chat, view your chat history, delete previous conversations, undock the chat window, and provide feedback on ARIA's responses. 
