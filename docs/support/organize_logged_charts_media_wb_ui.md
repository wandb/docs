...
In the [Workspace](../guides/track/project-page.md#workspace-tab) settings, adjust the grouping of panels based on either the first segment or all segments separated by `/`.