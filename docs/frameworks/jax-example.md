...
This is a complete example of jax code that trains a MLP and saves to W&B.  You can find the code at (https://github.com/wandb/examples/blob/master/jax-mnist/train.py) and the results of running at (https://app.wandb.ai/l2k2/examples-jax-mnist/runs/g0vgca81).
