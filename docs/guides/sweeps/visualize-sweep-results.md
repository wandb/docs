...
![Animation that shows how to navigate to the Sweep UI interface and view autogenerated plots.](<@site/static/images/sweeps/navigation_sweeps_ui.gif>)
...
![Example parallel coordinates plot.](<@site/static/images/sweeps/example_parallel_coordiantes_plot.png>)
...
![Example scatter plot (left) and parameter importance plot (right).](<@site/static/images/sweeps/scatter_and_parameter_importance.png>)
