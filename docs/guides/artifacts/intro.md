...
![Artifact overview](<@site/static/images/artifacts/artifacts_overview.png>)Artifacts can be an input or an output of a given run.
...
![Example artifact DAG](<@site/static/images/artifacts/example_dag_view.gif>)
