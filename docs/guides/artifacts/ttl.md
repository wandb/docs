...
## Determine if your Artifact is affected by TTL policies
Only user-generated artifacts can use TTL policies. Artifacts auto-generated by W&B cannot have TTL policies set for them.

The following Artifact naming schemes indicate an auto-generated Artifact:
- The Artifact name starts with: `run-*`
- The Artifact name starts with: `source-*`
- The Artifact name starts with: `job`
- The Artifact name starts with: `wandb-*`
