...
![Share panel creates a new report, Add to report lets you append to an existing report.](<pathname:///images/data_vis/share_your_view.png>)
...
![7s confused for 2s are the most frequent error in this view.](<pathname:///images/data_vis/tables_persistent_view.png>)
...
![See the digits for which the model most confidently guessed "0".](<pathname:///images/data_vis/sort.png>)
...
![See only examples which the model gets wrong.](<pathname:///images/data_vis/filter.png>)
...
![The truth distribution shows small errors: 8s and 2s are confused for 7s and 9s for 2s.](<pathname:///images/data_vis/group.png>)
...
![The closed\_loop\_score column sums the confidence scores for digits with typical loops (0, 6, 8, 9).](<pathname:///images/data_vis/add_columns.png>)
...
![Left: mistakes after 1 training epochs, Right: mistakes after 5 epochs](<pathname:///images/data_vistable_comparison.png>)
...
![Click on "predictions" to view the Table](pathname:///images/data_vis/preds_mnist.png)
...
![Preparing to compare model predictions after training for 1 epoch (v0, shown here) vs 5 epochs (v4)](pathname:///images/data_vis/preds_2.png)
...
![In the merged view, numerical columns will appear as histograms by default](pathname:///images/data_vis/merged_view.png)
...
![In the side-by-side view, Table rows are independent of each other.](<pathname:///images/data_vis/side_by_side.png>)
...
![For each label, the model makes fewer mistakes after 5 training epochs (R) than after 1 (L)](<pathname:///images/data_vis/compare_across_time.png>)
...
![After 1 epoch, performance is mixed: precision improves for some classes and worsens for others.](<pathname:///images/data_vis/compare_across_variants.png>)
  </TabItem>
  <TabItem value="five_epochs">

![After 5 epochs, the "double" variant is catching up to the baseline.](<pathname:///images/data_vis/compare_across_variants_after_5_epochs.png>)
  </TabItem>
</Tabs>