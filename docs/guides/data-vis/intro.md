...
![](<pathname:///images/data_vis/wandb - iris table (1).png>)
...
![](<pathname:///images/data_vis/tablesquickstart (1).png>)
...
![Browse actual examples and verify the counts & distribution of your data](<pathname:///images/data_vis/tables_see_data.png>)
...
![Listen to original songs and their synthesized versions (with timbre transfer)](<pathname:///images/data_vis/explore_data.png>)
...
![See granular differences: the left model detects some red sidewalk, the right does not.](<pathname:///images/data_vis/compare_model_versions.png>)
...
![](<pathname:///images/data_vis/track_details.png>)
...
![Compare the distribution of true labels across two different models' predictions.](<pathname:///images/data_vis/image_classification.png>)
...
![](<pathname:///images/data_vis/audio.png>)
...
![Doubling the size of the hidden layer yields some more creative prompt completions.](pathname:///images/data_vis/shakesamples.png)
...
![Browse easily through the few successful agents](<pathname:///images/data_vis/video.png>)
...
![Tables and Artifacts work together to version control, label, and deduplicate your dataset iterations](pathname:///images/data_vis/tabs.png)
...
![Find the best predictions across two models on the same test set](<pathname:///images/data_vis/comparing_model_variants.png>)
