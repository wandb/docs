...
![](<@site/static/images/data_vis/wandb_iris_table.png>)
...
![](<@site/static/images/data_vis/tablesquickstart.png>)
...
![Browse actual examples and verify the counts & distribution of your data](<@site/static/images/data_vis/tables_see_data.png>)
...
![Listen to original songs and their synthesized versions (with timbre transfer)](<@site/static/images/data_vis/explore_data.png>)
...
![See granular differences: the left model detects some red sidewalk, the right does not.](<@site/static/images/data_vis/compare_model_versions.png>)
...
![](<@site/static/images/data_vis/track_details.png>)
...
![Compare the distribution of true labels across two different models' predictions.](<@site/static/images/data_vis/image_classification.png>)
...
![](<@site/static/images/data_vis/audio.png>)
...
![Browse easily through the few successful agents](<@site/static/images/data_vis/video.png>)
...
![Find the best predictions across two models on the same test set](<@site/static/images/data_vis/comparing_model_variants.png>)
