...
![](<@site/static/images/models/walkthrough.png>)
...
![](<@site/static/images/models/workflow_dag.png>)
...
![](<@site/static/images/models/create_registered_model_1.png>)

![](<@site/static/images/models/create_registered_model_2.png>)

2. Click the `Create Registered Model` button at the top of the Model Registry.

![](<@site/static/images/models/create_registered_model_3.png>)
...
![](<@site/static/images/models/create_registered_model_4.png>)
  </TabItem>
...
![](<@site/static/images/models/browser.gif>)
  </TabItem>
</Tabs>
...
![](<@site/static/images/models/train_log_model_version_browser.png>)

If you are following along the example notebook, you should see a Run Workspace with charts similar to the image below

![](<@site/static/images/models/train_log_model_version_notebook.png>)
...
![](<@site/static/images/models/link_model_versions.gif>)
  </TabItem>
...
![](<@site/static/images/models/evaluate_model_performance.png>)
...
![](<@site/static/images/models/promote_version_to_prod_1.png>)
  </TabItem>
  <TabItem value="api">
...
![](<@site/static/images/models/promote_version_to_prod_2.png>)
...
![](<@site/static/images/models/build_reporting_dashboard.png>)
