...
:::tip
**A** [**companion colab notebook**](http://wandb.me/models_quickstart) **is provided which covers step 2-3 in the first code block and steps 4-6 in the second code block.**
:::
