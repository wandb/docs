...
If you're using [W&B Server](../hosting/intro.md) in your Private Cloud or on W&B Dedicated Cloud, then please refer to [this documentation](../hosting/configure/slack-alerts.md) to setup Slack alerts.
:::
