...
![](<@site/static/images/track/distributed_training_method1.png>)

However, the loss values as a function epoch and batch size were only logged from a single GPU.

![](<@site/static/images/experiments/loss_function_single_gpu.png>)
...
![](<@site/static/images/experiments/dashboard_grouped_runs.png>)
