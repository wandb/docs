...
:::note
Only W&B [instance admins](../iam/access-management-intro.md) can fetch audit logs using the API. If you are not an instance admin or not logged into your organization, you get a `HTTP 403 Forbidden` error.
:::
