...
![Because we're only using OIDC for authentication and not authorization, public clients simplify setup](<@site/static/images/hosting/setup_aws_cognito.png>)
...
![If your instance is accessible from multiple hosts, be sure to include all of them here.](<@site/static/images/hosting/setup_aws_cognito_ui_settings.png>)
...
![openid, profile, and email are required](<@site/static/images/hosting/setup_aws_required_fields.png>)
...
![The issuer URL would be https://cognito-idp.us-east-1.amazonaws.com/us-east-1\_uiIFNdacd](<@site/static/images/hosting/setup_aws_cognito_issuer_url.png>)
...
![](<@site/static/images/hosting/pkce.png>)
...
the redirect URI would look like `https://localhost:8080/oidc/callback`![](<@site/static/images/hosting/redirect_uri.png>)

Set the sign-out redirect to `http(s)://YOUR-W&B-HOST/logout`

![](<@site/static/images/hosting/signout_redirect.png>)
...
![](<@site/static/images/hosting/system_settings.png>)

Next, select **System Settings**

![](<@site/static/images/hosting/system_settings_select_settings.png>)

Enter your Issuer, Client ID, and Authentication Method. Select **Update settings**.

![](<@site/static/images/hosting/system_settings_select_update.png>)
...
![](<@site/static/images/hosting/configure_file_store.png>)
...
![Azure storage account setup](<@site/static/images/hosting/azure_create_storage_account.png>)

Click Review and Create, and then, on the summary screen, click Create:

![Azure storage account details review](<@site/static/images/hosting/azure_create_storage_account_click_create.png>)
...
![](<@site/static/images/hosting/create_blob_container_1.png>)

Create a new container, and set it to Private:

![](<@site/static/images/hosting/create_blob_container_2.png>)
...
![](<@site/static/images/hosting/create_blob_container_3.png>)

#### Creating the Queue

Go to Queue service > Queues in your storage account, and create a new Queue:

![](<@site/static/images/hosting/create_blob_container_4.png>)

Go to Events in your storage account, and create an event subscription:

![](<@site/static/images/hosting/create_blob_container_5.png>)
...
![](<@site/static/images/hosting/create_blob_container_6.png>)
...
![](<@site/static/images/hosting/create_blob_container_7.png>)
...
![](<@site/static/images/hosting/create_blob_container_8.png>)
...
![](<@site/static/images/hosting/create_blob_container_9.png>)
...
![Configuring REDIS in W&B](<@site/static/images/hosting/configure_redis.png>)
...
![](<@site/static/images/hosting/create_slack_ap_1.png>)
...
![](<@site/static/images/hosting/create_slack_ap_2.png>)
...
![](<@site/static/images/hosting/create_slack_ap_3.png>)

Under **Scopes**, supply the bot with the **incoming\_webhook** scope.

![](<@site/static/images/hosting/create_slack_ap_4.png>)
...
![](<@site/static/images/hosting/create_slack_ap_5.png>)
