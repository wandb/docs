...
Every project is comprised of [Workspaces](../../app/pages/workspaces.md) and [Reports](../../reports/intro.md), and is linked to relevant [Artifacts](../../artifacts/intro.md), [Sweeps](../../sweeps/intro.md), and [Automations](../../artifacts/project-scoped-automations.md).