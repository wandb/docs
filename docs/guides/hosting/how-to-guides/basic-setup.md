...
- This solution is not meant for [production](/guides/hosting/hosting-options/intro) workloads.
...
To enjoy the powerful collaborative features of W&B, you will need a shared instance on a central server, which you can [set up on AWS, GCP, Azure, Kubernetes, or Docker](/guides/hosting/hosting-options/intro).
