...
6. Choose whether to allow **Prioritization** for this queue.  When prioritization is enabled, users may specify a priority for jobs when they enqueue them.  Higher priority jobs are executed before lower priority jobs.
