...
### Launch job
A job is a specific type of [W&B Artifact](../artifacts/intro.md) that represents work to be done--most commonly, training a model or triggering a model evaluation. Job definitions include:
