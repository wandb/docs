...
![All these charts and more!](<@site/static/images/integrations/yolov5_experiment_tracking.png>)
...
![Model Versioning: the latest and the best versions of the model are identified.](<@site/static/images/integrations/yolov5_model_versioning.png>)

![Data Visualization: compare the input image to the model's outputs and example-wise metrics.](<@site/static/images/integrations/yolov5_data_visualization.png>)
