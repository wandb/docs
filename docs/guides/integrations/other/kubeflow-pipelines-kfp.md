...
| ------------------ | --- | --------------- |
| Input Scalar | [`config`](/guides/track/config) | [Overview tab](../../runs/run-page#overview-tab) |
| Output Scalar | [`summary`](/guides/track/log) | [Overview tab](../../runs/run-page#overview-tab) |
| Input Artifact | Input Artifact | [Artifacts tab](../../runs/run-page#artifacts-tab) |
| Output Artifact | Output Artifact | [Artifacts tab](../../runs/run-page#artifacts-tab) |
