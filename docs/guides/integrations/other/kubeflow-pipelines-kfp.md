...
| ------------------ | --- | --------------- |
| Input Scalar | [`config`](/guides/track/config) | [Overview tab](../../runs/run-page.md#overview-tab) |
| Output Scalar | [`summary`](/guides/track/log) | [Overview tab](../../runs/run-page.md#overview-tab) |
| Input Artifact | Input Artifact | [Artifacts tab](../../runs/run-page.md#artifacts-tab) |
| Output Artifact | Output Artifact | [Artifacts tab](../../runs/run-page.md#artifacts-tab) |
