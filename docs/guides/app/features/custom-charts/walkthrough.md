...
![A new, blank custom chart ready to be configured](<pathname:///images/app_ui/create_a_query.png>)
...
![Pulling in columns from the query results to set Vega fields](<pathname:///images/app_ui/set_vega_fields.png>)
...
![](<pathname:///images/app_ui/customize_vega_spec_for_pr_curve.png>)
...
![](<pathname:///images/app_ui/composite_histograms.png>)
