...
![](<pathname:///images/app_ui/demo_precision_lines.png>)
...
![](<pathname:///images/app_ui/visualize_nan.png>)
...
![](pathname:///images/app_ui/visualization_add.png)
...
![Random colors given to runs](<pathname:///images/app_ui/line_plots_run_table_random_colors.png>)

Upon clicking any of the colors, a color palette appears from which we can manually choose the color we want.

![The color palette](<pathname:///images/app_ui/line_plots_run_table_color_palette.png>)
...
![](<pathname:///images/app_ui/plot_style_line_plot_legend.png>)
...
![](<pathname:///images/app_ui/howto_use_relative_time_or_wall_time.gif>)
