...
![](<pathname:///images/weave/weave_panel_components.png>)
...
![](<pathname:///images/weave/basic_weave_expression.png>)
...
![](<pathname:///images/weave/merge_query_plot_example.png>)
...
![](<pathname:///images/weave/panel_selector.png>)
...
2.  `Merge Tables: <Panel>` is a special case where the incoming datatype is a List of Tables. In such cases, the "Merge Tables" portion of the panel allows users to either concatenate all the rows, or join the tables on a particular column. This setting is configured in the Weave Configuration (discussed below) and shown in the following screen shots
    ...
    ![](<pathname:///images/weave/merge_tables_concate.png>) ![](<pathname:///images/weave/merge_tables_join.png>)
...
![](<pathname:///images/weave/list_of_panels_plot.png>)
...
![](<pathname:///images/weave/config_box_plot.png>)result_
...
![](<pathname:///images/weave/result_panel.png>)

![](<pathname:///images/weave/result_panel_merge_table_plot.png>)
...
![](<pathname:///images/weave/create_weave_panel.png>)
