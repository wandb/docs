...
Yes, you can [privately host W&B](guides/hosting) locally on your own machines or in a private cloud, try [this quick tutorial notebook](http://wandb.me/intro) to see how. Note, to login to wandb local server you can [set the host flag](guides/hosting/installation/dev-setup) to the address of the local instance.  
