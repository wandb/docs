...
* L’étape d’entraînement du modèle que vous souhaitez déployer (il s’agit généralement de l’étape où le modèle a donné les meilleurs résultats dans vos évaluations)
