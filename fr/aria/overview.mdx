...
* Les étapes **shell** indiquent quand ARIA effectue une action, par exemple la création d’un panneau, le filtrage de runs, ou la création et l’exécution de scripts Python.
...
{/*
  ...
  1. Dans la fenêtre de chat ARIA, cliquez sur **<Icon icon="bars" iconType="solid" />**.
  1. Dans la section **Customization**, cliquez sur **Project memory**. Toutes les mémoires qu’ARIA possède sur le projet s’affichent.
  1. Pour modifier une mémoire, cliquez sur **<Icon icon="pencil" iconType="solid" />**. Mettez à jour le **Nom**, la **Description** ou la **Mémoire**, puis cliquez sur **enregistrer**.
  1. Pour supprimer une mémoire, cliquez sur **<Icon icon="trash" iconType="solid" />**.
  ...
  <AriaChatBubbles
  prompt="N’oublie pas que nous préférons une coloration sémantique pour les graphiques."
  response="Je vais d’abord vérifier les mémoires de projet existantes afin que cette préférence soit enregistrée sous le bon sujet plutôt que dupliquée… Nouvelle mémoire de projet enregistrée : chart-coloring. Elle indique que les graphiques doivent utiliser des couleurs cohérentes et sémantiques basées sur la signification ou le statut des séries/catégories, plutôt que sur un ordre arbitraire de la palette. "
  />
