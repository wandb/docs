...
1. Dans la fenêtre de chat ARIA, cliquez sur **<Icon icon="sidebar-reveal" iconType="solid" />**.
2. Dans la section **Customization**, cliquez sur **Project memory**. Toutes les mémoires qu’ARIA possède sur le projet s’affichent.
