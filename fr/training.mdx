...
Utilisez W&amp;B Training pour le post-entraînement serverless des grands modèles de langage (LLM), y compris l’apprentissage par renforcement (RL) et le Fine-tuning supervisé (SFT). W&amp;B Training est désormais en préversion publique.
