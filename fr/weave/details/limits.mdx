...
keywords: ["nouvelles tentatives", "expirations", "troncature de trace", "OpenTelemetry", "exceptions"]
---
...
* Les instances Dedicated Weave utilisent une URL d’ingress OpenTelemetry différente. Pour plus d’informations sur les points de terminaison officiels, voir [Envoyer des traces OpenTelemetry](/fr/weave/guides/tracking/otel).
