...
* Les instances Dedicated Weave utilisent une URL d’ingress OpenTelemetry différente. Voir [Envoyer des traces OpenTelemetry](/fr/weave/guides/tracking/otel) pour obtenir les informations officielles sur le point de terminaison.
