...
## Installation des dépendances {#install-the-dependencies}
...
## Configurer les agents {#set-up-the-agents}
...
## Activer le suivi multi-agent avec Weave {#enable-multi-agent-tracking-with-weave}
...
## Exécutez le système multi-agent et visualisez-le dans Weave {#execute-the-multi-agent-system-and-visualize-in-weave}
