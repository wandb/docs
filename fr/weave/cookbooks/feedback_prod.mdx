...
description: "Collectez et analysez les retours utilisateur sur les sorties de LLM en production à l’aide des fonctionnalités de suivi des retours de W&B Weave."
---
...
Après avoir effectué l’appel, le résultat de l’opération est disponible via `result` ci-dessus.
