...
Les évaluateurs Weave sont des classes spéciales dotées d&#39;une méthode `score` permettant d&#39;évaluer les performances d&#39;un appel. Ils peuvent aller de règles assez simples à des LLM complexes faisant office de juges.
