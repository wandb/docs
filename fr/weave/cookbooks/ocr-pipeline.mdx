...
## Créez des prompts et itérez dessus avec Weave {#create-and-iterate-on-prompts-with-weave}
...
## Obtenir le jeu de données {#get-the-dataset}
...
## Créer le pipeline NER {#build-the-ner-pipeline}
...
## Évaluer le pipeline avec Weave {#evaluate-the-pipeline-using-weave}
...
### Évaluateur programmatique {#programatic-scorer}
...
### Évaluateur LLM-as-a-judge {#llm-as-a-judge-scorer}
