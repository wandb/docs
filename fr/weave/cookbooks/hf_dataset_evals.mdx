...
## Configuration et imports {#setup-and-imports}
...
## Charger et préparer le jeu de données HuggingFace {#load-and-prepare-huggingface-dataset}
...
## Définissez les fonctions de traitement et d’évaluation {#define-processing-and-evaluation-functions}
...
## Créez et exécutez l’évaluation {#create-and-run-the-evaluation}
