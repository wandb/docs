...
## Intégrer Weave : tableau de bord de production {#integrate-with-weave-production-dashboard}
...
### Initialiser le client Weave et définir les coûts {#initialize-the-weave-client-and-define-costs}
...
### Récupérer les données d&#39;appels dans Weave {#fetch-calls-data-from-weave}
...
#### Récupérer les données par appel {#fetch-data-call-by-call}
...
#### Utilisez des API de haut niveau {#use-high-level-apis}
...
### Rassemblez les données d’entrée et générez des visualisations {#gather-inputs-and-generate-visualizations}
