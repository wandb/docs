...
## Pourquoi utiliser Weave {#why-use-weave}
...
## Configurez l’environnement {#set-up-the-environment}
...
## Sorties structurées et modèles Pydantic {#structured-outputs-and-pydantic-models}
...
## Implémenter un formateur de code {#implement-a-code-formatter}
...
## Définir le `CodeGenerationPipeline` {#define-the-codegenerationpipeline}
...
## Implémenter des métriques d’évaluation {#implement-evaluation-metrics}
...
## Créer un jeu de données Weave et effectuer une évaluation {#create-a-weave-dataset-and-run-evaluation}
