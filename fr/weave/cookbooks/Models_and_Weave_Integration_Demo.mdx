...
## Télécharger `ChatModel` depuis W&amp;B Registry et implémenter `UnslothLoRAChatModel` {#download-chatmodel-from-wb-registry-and-implement-unslothlorachatmodel}
...
## Intégrer la nouvelle version de `ChatModel` dans `RagModel` {#integrate-the-new-chatmodel-version-into-ragmodel}
...
## Exécuter une `weave.Evaluation` {#run-a-weaveevaluation}
...
## Enregistrer le nouveau modèle RAG dans le registre {#save-the-new-rag-model-to-the-registry}
