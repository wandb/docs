...
keywords: ["Modèle Weave", "API d’évaluation", "fonction de score", "évaluation de LLM", "Pydantic"]
---
...
## Lancez votre première évaluation {#run-your-first-evaluation}
...
## Vous cherchez d’autres exemples {#looking-for-more-examples}
