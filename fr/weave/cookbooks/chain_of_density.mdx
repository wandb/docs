...
<Frame>![visualisation de la trace Weave avec l’exécution du pipeline de synthèse Chain of Density](/media/summarization/summarization_trace.png)</Frame>
...
<Frame>![Interface de configuration d’un jeu de données Weave pour l’évaluation, avec sélection du jeu de données et options de configuration](/media/summarization/dataset.png)</Frame>
...
<Frame>![tableau de bord d’évaluation Weave avec les résultats de synthèse Chain of Density, les métriques et les comparaisons de performances](/media/summarization/eval_dash.png)</Frame>
