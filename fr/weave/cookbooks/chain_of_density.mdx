...
description: "Implémentez des techniques de synthèse par Chain of Density avec W&B Weave pour la compression itérative de texte et son évaluation."
---
...
Chain of Density (CoD) est une technique de synthèse itérative qui produit des résumés de plus en plus concis et riches en informations. Son fonctionnement repose sur les étapes suivantes :
...
<Frame>
  ![Visualisation de trace Weave avec exécution du pipeline de synthèse Chain of Density](/media/summarization/summarization_trace.png)
</Frame>
...
<Frame>
  ![Interface de configuration d’un Weave Model pour la synthèse Chain of Density, avec les paramètres et la configuration du modèle](/media/summarization/model.png)
</Frame>
...
<a href="https://wandb.ai/wandb_fc/arxiv-reader/reports/Building-a-bot-to-summarize-arXiv-papers-as-PDFs-using-Anthrophic-and-W-B-Weave--Vmlldzo4Nzg0ODI4" target="_blank" rel="noopener noreferrer" className="button button--primary button--lg">
  Voir le Report complet sur W&amp;B
</a>