---
title: "Utiliser l’API de service de Weave pour le traçage"
description: "Découvrez comment utiliser le traçage Weave via l’API de service avec W&B Weave"
keywords: [API de service Weave, journalisation des traces, traçage RAG, requête de flux, observabilité LLM]
---
...
## Prérequis : définir les variables et les endpoints {#prerequisites-set-variables-and-endpoints}
...
### Démarrer une trace simple {#start-a-simple-trace}
...
### Terminer une trace simple {#end-a-simple-trace}
...
### Démarrer une trace complexe {#start-a-complex-trace}
...
### Ajouter un span enfant pour une recherche de document RAG {#add-a-child-span-for-a-rag-document-lookup}
...
### Ajouter un span enfant pour un appel de complétion LLM {#add-a-child-span-for-an-llm-completion-call}
...
### Terminer une trace complexe {#end-a-complex-trace}
...
## Exécuter une requête de recherche {#run-a-lookup-query}
