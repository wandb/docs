...
<Frame>![Interface de chargement d’un jeu de données DSPy avec les étapes de préparation et la structure des données](/media/dspy_optimization/1.png)</Frame>
...
<Frame>![Résultats de l’évaluation du programme DSPy de référence avec des métriques de performances et des exemples de sortie](/media/dspy_optimization/2.png) ## Évaluation de notre programme DSPy</Frame>
