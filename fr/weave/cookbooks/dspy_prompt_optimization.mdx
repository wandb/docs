...
## Activer le suivi avec Weave {#enable-tracking-using-weave}
...
## Charger le jeu de données BIG-Bench Hard {#load-the-big-bench-hard-dataset}
...
## Le programme DSPy {#the-dspy-program}
...
### Écrire la signature du raisonnement causal {#write-the-causal-reasoning-signature}
...
## Évaluez le programme DSPy {#evaluate-the-dspy-program}
...
## Optimiser le programme DSPy {#optimize-the-dspy-program}
