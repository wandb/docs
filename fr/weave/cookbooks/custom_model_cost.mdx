...
## Configurer un modèle de coût personnalisé {#set-up-a-custom-cost-model}
...
### Configurer un modèle avec Weave {#set-up-a-model-with-weave}
...
### Ajouter un coût personnalisé {#add-a-custom-cost}
