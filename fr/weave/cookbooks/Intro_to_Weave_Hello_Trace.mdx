...
Avant de commencer à utiliser Tracing dans Weave, assurez-vous d’avoir rempli les prérequis suivants.
...
* Découvrez-en plus sur les [rubriques avancées du Tracing](/fr/weave/tutorial-tracing_2).
