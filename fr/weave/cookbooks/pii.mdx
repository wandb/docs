...
### Personnaliser la journalisation des entrées et sorties à l’aide de `weave.op` {#customize-input-and-output-logging-using-weaveop}
...
### Bonnes pratiques pour Weave avec des données PII {#best-practices-for-weave-with-pii-data}
...
#### Conseils en matière de chiffrement {#encryption-tips}
...
## Aperçu des méthodes de masquage {#redaction-methods-overview}
...
### Méthode 1 : Filtrer avec des expressions régulières {#method-1-filter-using-regular-expressions}
...
### Méthode 2 : Masquer à l’aide de Microsoft Presidio {#method-2-redact-using-microsoft-presidio}
...
### Méthode 3 : anonymiser par remplacement à l’aide de Faker et Presidio {#method-3-anonymize-with-replacement-using-faker-and-presidio}
...
### Méthode 4 : Utiliser `autopatch_settings` {#method-4-use-autopatch_settings}
...
## Appliquer les méthodes aux appels Weave {#apply-the-methods-to-weave-calls}
...
### Méthode de masquage avec Presidio {#presidio-redaction-method}
...
### Méthode de remplacement avec Faker et Presidio {#faker-and-presidio-replacement-method}
...
### méthode `autopatch_settings` {#autopatch_settings-method}
...
### Facultatif : Chiffrez vos données {#optional-encrypt-your-data}
