...
<Frame>
  ![Processus de masquage des PII avec Presidio, avec entités PII identifiées et texte de sortie masqué](/media/pii/redact.png)
</Frame>
...
<Frame>
  ![Processus de remplacement des PII avec Faker et Presidio, avec le texte d’origine, les PII identifiées et les valeurs de substitution anonymisées](/media/pii/replace.png)
</Frame>
...
<Frame>
  ![Processus de chiffrement des données PII avec sortie de texte chiffré et gestion des clés de chiffrement](/media/pii/encrypt.png)
</Frame>
