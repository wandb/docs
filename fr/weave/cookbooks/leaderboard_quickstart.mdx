...
description: "Découvrez comment utiliser Démarrage rapide du Leaderboard avec W&B Weave"
keywords: [leaderboard, comparaison de modèles, évaluation Weave, fonctions de score]
---
...
# Démarrage rapide du Leaderboard {#leaderboard-quickstart}
...
## Étape 1 : Générer un jeu de données fictif de codes postaux {#step-1-generate-a-dataset-of-fake-zip-code-data}
...
## Étape 2 : Créez des fonctions de score {#step-2-author-scoring-functions}
...
## Étape 3 : Créer une évaluation {#step-3-create-an-evaluation}
...
## Étape 4 : Évaluer un modèle de référence {#step-4-evaluate-a-baseline-model}
...
## Étape 5 : Créer d’autres modèles {#step-5-create-more-models}
...
## Étape 6 : Créez davantage d’évaluations {#step-6-create-more-evaluations}
...
## Étape 7 : consultez le leaderboard {#step-7-review-the-leaderboard}
