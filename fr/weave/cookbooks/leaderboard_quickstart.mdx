...
<div id="step-1-generate-a-dataset-of-fake-zip-code-data">
  ## Étape 1 : Générer un jeu de données factices sur des codes postaux
</div>

Nous allons d’abord créer une fonction `generate_dataset_rows` qui génère une liste de données factices sur des codes postaux.
...
<div id="step-5-create-more-models">
  ## Étape 5 : Créer davantage de modèles
</div>

Nous allons maintenant créer 2 modèles supplémentaires pour les comparer au modèle de référence.
...
Vous pouvez créer un nouveau leaderboard en accédant à l’onglet du leaderboard dans l’interface utilisateur, puis en cliquant sur &quot;Create Leaderboard&quot;.
