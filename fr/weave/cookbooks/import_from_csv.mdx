...
keywords: ["import CSV", "import de traces", "traces historiques", "appels parent-enfant", "traces de conversation"]
---
...
## Importer des traces depuis des systèmes tiers {#import-traces-from-third-party-systems}
...
## Enregistrer les traces dans Weave {#log-the-traces-to-weave}
...
## Résultat : traces enregistrées dans Weave {#result-traces-logged-to-weave}
...
<Frame>
  ![Traces de conversation importées dans l’interface Weave](/images/screenshots/csv-1.png)
</Frame>

Opérations :

<Frame>
  ![Opérations Conversation et Turn dans l’interface Weave](/images/screenshots/csv-2.png)
</Frame>

## Facultatif : exportez vos traces pour lancer des évaluations {#optional-export-your-traces-to-run-evaluations}
...
<Frame>
  ![Exportation de traces depuis un projet Weave](/images/screenshots/csv-3.png)
</Frame>
...
<Frame>
  ![Jeu de données publié dans l'interface Weave, prêt à être utilisé dans une évaluation](/images/screenshots/csv-4.png)
</Frame>

Pour en savoir plus sur les évaluations, consultez le [Démarrage rapide](/fr/weave/tutorial-rag) pour apprendre à utiliser le jeu de données que vous venez de créer afin d&#39;évaluer votre application RAG.