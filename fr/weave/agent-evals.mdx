...
## Créer et tracer l’agent {#build-and-trace-the-agent}
...
## Évaluez l’agent avec un juge LLM {#score-the-agent-with-an-llm-judge}
...
## Organiser et comparer les évaluations {#organize-and-compare-evaluations}
...
## Évaluer une conversation sur plusieurs tours de conversation {#score-a-multi-turn-conversation}
...
## Étendez vos évaluateurs {#extend-your-scorers}
