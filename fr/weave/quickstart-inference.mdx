...
description: "Découvrez les bases de Weave à l’aide de Serverless Inference pour effectuer le tracing des appels au modèle, comparer les sorties et effectuer des évaluations."
keywords: [tracing LLM, EvaluationLogger, comparaison de modèles, weave.op, Démarrage rapide]
---
...
<div id="trace-your-first-llm-call">
  ## Tracez votre premier appel LLM {#trace-your-first-llm-call}
</div>
...
<div id="build-a-text-summarization-application">
  ## Créer une application de synthèse de texte {#build-a-text-summarization-application}
</div>
...
<div id="evaluate-model-performance">
  ## Évaluer les performances du modèle {#evaluate-model-performance}
</div>
