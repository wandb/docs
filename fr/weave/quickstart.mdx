...
Apprenez à suivre les appels de LLM avec Weave en ajoutant le traçage à votre code. Ce démarrage rapide vous montre comment tracer une requête vers OpenAI et afficher les résultats dans l’interface Weave.
...
[Commencez par évaluer votre application](/fr/weave/tutorial-eval), puis voyez comment [évaluer une application RAG](/fr/weave/tutorial-rag).