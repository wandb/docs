...
* `queue_id`: `<classe 'str'>`
* `call_id`: `<classe 'str'>`
* `call_started_at`: `<classe 'datetime.datetime'>`
* `call_ended_at`: `datetime.datetime | None`
* `call_op_name`: `<classe 'str'>`
* `call_trace_id`: `<classe 'str'>`
...
* `created_at`: `<classe 'datetime.datetime'>`
* `created_by`: `<classe 'str'>`
* `updated_at`: `<classe 'datetime.datetime'>`
...
Étend AnnotationQueueItemsQueryBody en ajoutant `queue_id` pour une utilisation interne de l’API.
...
* `queue_id`: `<classe 'str'>`
* `total_items`: `<classe 'int'>`
* `completed_items`: `<classe 'int'>`
...
Requête permettant de mettre à jour l&#39;état d&#39;annotation d&#39;un élément de file d&#39;attente pour l&#39;annotateur actuel.
...
* `item`: `<classe 'AnnotationQueueItemSchema'>`
...
* `prompt_token_cost`: `<classe 'float'>`
* `completion_token_cost`: `<classe 'float'>`
...
* `project_id` : `<classe 'str'>`
* `query` : `<classe 'weave.trace_server.interface.query.Query'>`
...
* `project_id`: `<classe 'str'>`
* `id`: `<classe 'str'>`
* `ended_at`: `<classe 'datetime.datetime'>`
* `exception`: `str | None`
* `output`: `typing.Any | None`
* `summary`: `<classe 'SummaryInsertMap'>`
* `wb_run_step_end`: `int | None`
...
* `project_id`: `<classe 'str'>`
* `evaluation_ref`: `<classe 'str'>`
* `model_ref`: `<classe 'str'>`
* `wb_user_id`: `str | None`
...
* `digest`: `<classe 'str'>`
* `object_id`: `<classe 'str'>`
* `version_index`: `<classe 'int'>`
* `evaluation_ref`: `<classe 'str'>`
...
Corps de la requête pour finaliser un run d&#39;évaluation via l&#39;API REST.

Ce modèle exclut `project_id` et `evaluation_run_id`, car ils sont fournis par le chemin de l&#39;URL dans les endpoints REST.
...
Ce protocole représente une implémentation de serveur de traces qui prend en charge l’ensemble des API, à savoir les points de terminaison V1 hérités et les points de terminaison Object modernes. Utilisez ce type pour les implémentations devant prendre en charge les deux versions de l’API.
...
Points de terminaison de l’API des objets pour le Trace Server.

Ce protocole inclut des API de gestion d’objets qui offrent des interfaces plus claires et plus conformes aux principes REST. Les implémentations doivent prendre en charge à la fois ce protocole et TraceServerInterface afin de préserver la rétrocompatibilité.
...
* `base_object_classes`: `liste[str] | None`
* `exclude_base_object_classes`: `liste[str] | None`
* `leaf_object_classes`: `liste[str] | None`
* `object_ids`: `liste[str] | None`
* `is_op`: `bool | None`
...
Ce modèle exclut `project_id`, car il est fourni par le chemin d’URL des points de terminaison REST.
...
Étend PredictionCreateBody en y ajoutant `project_id` pour un usage interne de l’API.
...
Étend ScoreCreateBody en y ajoutant `project_id` pour un usage interne de l’API.
...
* `thread_id`: `str | None`
* `turn_id`: `str | None`
* `started_at`: `<classe 'datetime.datetime'>`
* `attributes`: `dict[str, typing.Any]`
* `inputs`: `dict[str, typing.Any]`
...
* `append`: `<classe 'TableAppendSpecPayload'>`
...
* `table`: `<classe 'TableSchemaForInsert'>`
...
* `insert`: `<classe 'TableInsertSpecPayload'>`
...
* `pop`: `<classe 'TablePopSpecPayload'>`
...
* `updates`: `liste[TableAppendSpec | TablePopSpec | TableInsertSpec]`
...
Interrogez les threads avec des statistiques agrégées basées uniquement sur les appels de tour.
