...
### <kbd>fonction</kbd> `obsolète` {#function-deprecated}
...
### <kbd>fonction</kbd> `is_colab` {#function-is_colab}
...
### <kbd>fonction</kbd> `is_notebook` {#function-is_notebook}
...
### <kbd>fonction</kbd> `log_once` {#function-log_once}
