...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L96" />

## <kbd>classe</kbd> `DisplayNameFuncError` {#class-displaynamefuncerror}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L99" />

## <kbd>classe</kbd> `OpCallError` {#class-opcallerror}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L215" />

## <kbd>classe</kbd> `OpKwargs` {#class-opkwargs}

TypedDict des arguments nommés de op().

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L120" />

## <kbd>classe</kbd> `Sentinel` {#class-sentinel}

Sentinel(package: &#39;str&#39;, path: &#39;str&#39;, name: &#39;str&#39;)

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/../../../../weave/trace/op/__init__" />
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L209" />

## <kbd>classe</kbd> `WeaveKwargs` {#class-weavekwargs}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1170" />

### <kbd>fonction</kbd> `call` {#function-call}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1216" />

### <kbd>fonction</kbd> `calls` {#function-calls}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1423" />

### <kbd>fonction</kbd> `get_captured_code` {#function-get_captured_code}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1469" />

### <kbd>fonction</kbd> `is_op` {#function-is_op}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L443" />

### <kbd>fonction</kbd> `is_placeholder_call` {#function-is_placeholder_call}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L411" />

### <kbd>fonction</kbd> `is_tracing_setting_disabled` {#function-is_tracing_setting_disabled}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1440" />

### <kbd>fonction</kbd> `maybe_bind_method` {#function-maybe_bind_method}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L1452" />

### <kbd>fonction</kbd> `maybe_unbind_method` {#function-maybe_unbind_method}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L436" />

### <kbd>fonction</kbd> `placeholder_call` {#function-placeholder_call}
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L231" />

### <kbd>fonction</kbd> `setup_dunder_weave_dict` {#function-setup_dunder_weave_dict}
...
* <b>`attributes`</b> : Attributs par défaut fusionnés dans chaque appel créé par cet op, avec la priorité la plus faible. Un contexte `weave.attributes()` et des attributs par appel explicites les redéfinissent en cas de collision de clé. La clé réservée &quot;weave&quot; ne peut pas être définie ici.
...
<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/op.py#L422" />

### <kbd>fonction</kbd> `should_skip_tracing_for_op` {#function-should_skip_tracing_for_op}
