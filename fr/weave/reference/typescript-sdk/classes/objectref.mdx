...
Représente une référence à un objet Weave sauvegardé.

En règle générale, les utilisateurs finaux n’ont pas besoin d’interagir directement avec cette classe.

Un ObjectRef contient l’ID du projet, l’ID de l’objet et l’empreinte qui permettent d’identifier de manière unique
un objet sauvegardé dans le système de stockage de Weave.
...
| :---- | :------- | :------------------------------------------------------------------ |
| `uri` | `string` | Un URI Weave au format : weave:///entity/project/object/name:digest |
...
Erreur si le format de l’URI est invalide ou ne correspond pas à une réf. d&#39;objet
