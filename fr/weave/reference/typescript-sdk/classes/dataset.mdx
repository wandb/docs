...
Objet Dataset avec enregistrement facile et gestion automatique des versions
...
• `Facultatif` **&#95;&#95;savedRef**: `ObjectRef`([`ObjectRef`](./objectref)) | `Promise`&lt;[`ObjectRef`](./objectref)&gt;
