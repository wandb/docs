...
Défini dans : [src/integrations/openai.agent.ts:169](https://github.com/wandb/weave/blob/8c5f077eb11c42b84000726ff20504abc728d3fb/sdks/node/src/integrations/openai.agent.ts#L169)
...
**Alternative pour une logique de processeur personnalisée** : Si vous avez besoin d’un comportement de tracing personnalisé,
utilisez `createOpenAIAgentsTracingProcessor()` et enregistrez-le manuellement :
