...
| :-------- | :---------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `options` | `WeaveImageInput` | Les options de ce type de média - data : les données d’image brutes sous forme de Buffer - imageType : (Facultatif) le type de fichier d’image, actuellement seul &#39;png&#39; est pris en charge |
