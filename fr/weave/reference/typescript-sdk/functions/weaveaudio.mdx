...
| :-------- | :---------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `options` | `WeaveAudioInput` | Les options pour ce type de média - data : les données audio brutes sous forme de Buffer - audioType : (facultatif) le type de fichier audio ; actuellement, seul &#39;wav&#39; est pris en charge |
