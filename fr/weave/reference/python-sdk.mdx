...
* `scorers`: `list[typing.Annotated[trace.op_protocol.Op | flow.scorer.Scorer, BeforeValidator(func=<function cast_to_scorer at 0x7f6af79307c0>, json_schema_input_type=PydanticUndefined)]] | None`
...
Extrait et organise les résultats des scorers à partir des Runs d’évaluation.
...
Renvoyer la session active stockée dans contextvar, ou None.
...
```python
thread(
    thread_id: 'str | object | None' = <object object at 0x7f6af7dc0980>
