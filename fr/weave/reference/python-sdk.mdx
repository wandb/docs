...
## <kbd>classe</kbd> `Agent` {#class-agent}
...
### <kbd>méthode</kbd> `step` {#method-step}
...
## <kbd>classe</kbd> `AgentState` {#class-agentstate}
...
## <kbd>classe</kbd> `AnnotationSpec` {#class-annotationspec}
...
### <kbd>méthode de classe</kbd> `preprocess_field_schema` {#classmethod-preprocess_field_schema}
...
### <kbd>méthode de classe</kbd> `validate_field_schema` {#classmethod-validate_field_schema}
...
### <kbd>méthode</kbd> `value_is_valid` {#method-value_is_valid}
...
## <kbd>classe</kbd> `Audio` {#class-audio}
...
### <kbd>méthode</kbd> `export` {#method-export}
...
### <kbd>méthode de classe</kbd> `from_data` {#classmethod-from_data}
...
### <kbd>méthode de classe</kbd> `from_path` {#classmethod-from_path}
...
## <kbd>classe</kbd> `ClassifierMonitor` {#class-classifiermonitor}
...
### <kbd>méthode</kbd> `activate` {#method-activate}
...
### <kbd>méthode</kbd> `deactivate` {#method-deactivate}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj}
...
### <kbd>méthode</kbd> `get_prompt_footer` {#method-get_prompt_footer}
...
### <kbd>méthode</kbd> `get_prompt_header` {#method-get_prompt_header}
...
## <kbd>classe</kbd> `Content` {#class-content}
...
#### <kbd>propriété</kbd> art {#property-art}

#### <kbd>propriété</kbd> ref {#property-ref}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/type_wrappers/Content/content.py#L543" />

### <kbd>méthode</kbd> `as_string` {#method-as_string}
...
### <kbd>méthode de classe</kbd> `from_base64` {#classmethod-from_base64}
...
### <kbd>méthode de classe</kbd> `from_bytes` {#classmethod-from_bytes}
...
### <kbd>méthode de classe</kbd> `from_data_url` {#classmethod-from_data_url}
...
### <kbd>méthode de classe</kbd> `from_path` {#classmethod-from_path-2}
...
### <kbd>méthode de classe</kbd> `from_text` {#classmethod-from_text}
...
### <kbd>méthode de classe</kbd> `from_url` {#classmethod-from_url}
...
### <kbd>méthode de classe</kbd> `model_validate` {#classmethod-model_validate}
...
### <kbd>méthode de classe</kbd> `model_validate_json` {#classmethod-model_validate_json}
...
### <kbd>méthode</kbd> `open` {#method-open}
...
### <kbd>méthode</kbd> `save` {#method-save}
...
### <kbd>méthode</kbd> `serialize_data` {#method-serialize_data}
...
### <kbd>méthode</kbd> `to_data_url` {#method-to_data_url}
...
## <kbd>classe</kbd> `Conversation` {#class-conversation}
...
### <kbd>méthode</kbd> `end` {#method-end}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-2}
...
### <kbd>méthode</kbd> `start_turn` {#method-start_turn}
...
## <kbd>classe</kbd> `Dataset` {#class-dataset}
...
### <kbd>méthode</kbd> `add_rows` {#method-add_rows}
...
### <kbd>méthode de classe</kbd> `convert_to_table` {#classmethod-convert_to_table}
...
### <kbd>méthode de classe</kbd> `from_calls` {#classmethod-from_calls}
...
### <kbd>méthode de classe</kbd> `from_hf` {#classmethod-from_hf}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-2}
...
### <kbd>méthode de classe</kbd> `from_pandas` {#classmethod-from_pandas}
...
### <kbd>méthode</kbd> `select` {#method-select}
...
### <kbd>méthode</kbd> `to_hf` {#method-to_hf}
...
### <kbd>méthode</kbd> `to_pandas` {#method-to_pandas}
...
## <kbd>classe</kbd> `EasyPrompt` {#class-easyprompt}
...
#### <kbd>propriété</kbd> as_str {#property-as_str}

Regroupe tous les messages en une seule chaîne.

***

#### <kbd>propriété</kbd> is_bound {#property-is_bound}

***

#### <kbd>propriété</kbd> messages {#property-messages}

#### espaces réservés de <kbd>propriété</kbd> {#property-placeholders}

***

#### <kbd>propriété</kbd> system_message {#property-system_message}

Regroupe tous les messages en un message de prompt système.

***

#### <kbd>propriété</kbd> system_prompt {#property-system_prompt}

Regroupe tous les messages en un objet de prompt système.

***

#### <kbd>propriété</kbd> unbound_placeholders {#property-unbound_placeholders}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/prompt/prompt.py#L230" />

### <kbd>méthode</kbd> `append` {#method-append}
...
### <kbd>méthode</kbd> `as_dict` {#method-as_dict}
...
### <kbd>méthode</kbd> `as_pydantic_dict` {#method-as_pydantic_dict}
...
### <kbd>méthode</kbd> `bind` {#method-bind}
...
### <kbd>méthode</kbd> `bind_rows` {#method-bind_rows}
...
### <kbd>méthode</kbd> `config_table` {#method-config_table}
...
### <kbd>méthode</kbd> `configure` {#method-configure}
...
### <kbd>méthode</kbd> `dump` {#method-dump}
...
### <kbd>méthode</kbd> `dump_file` {#method-dump_file}
...
### <kbd>méthode</kbd> `format` {#method-format}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-3}
...
### <kbd>méthode de classe</kbd> `load` {#classmethod-load}
...
### <kbd>méthode de classe</kbd> `load_file` {#classmethod-load_file}
...
### <kbd>méthode</kbd> `messages_table` {#method-messages_table}
...
### <kbd>méthode</kbd> `print` {#method-print}
...
### <kbd>méthode</kbd> `publish` {#method-publish}
...
### <kbd>méthode</kbd> `require` {#method-require}
...
### <kbd>méthode</kbd> `run` {#method-run}
...
### <kbd>méthode</kbd> `validate_requirement` {#method-validate_requirement}
...
### <kbd>méthode</kbd> `validate_requirements` {#method-validate_requirements}
...
### <kbd>méthode</kbd> `values_table` {#method-values_table}
...
## <kbd>class</kbd> `Evaluation` {#class-evaluation}
...
### <kbd>méthode</kbd> `evaluate` {#method-evaluate}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-4}
...
### <kbd>méthode</kbd> `get_eval_results` {#method-get_eval_results}
...
### <kbd>méthode</kbd> `get_evaluate_calls` {#method-get_evaluate_calls}
...
### <kbd>méthode</kbd> `get_score_calls` {#method-get_score_calls}
...
### <kbd>méthode</kbd> `get_scores` {#method-get_scores}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-3}
...
### <kbd>méthode</kbd> `predict_and_score` {#method-predict_and_score}
...
### <kbd>méthode</kbd> `summarize` {#method-summarize}
...
## <kbd>class</kbd> `EvaluationLogger` {#class-evaluationlogger}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-4}
...
#### attributs de la <kbd>propriété</kbd> {#property-attributes}

***

#### <kbd>propriété</kbd> ui_url {#property-ui_url}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/evaluation/eval_imperative.py#L1106" />

### <kbd>méthode</kbd> `fail` {#method-fail}
...
### <kbd>méthode</kbd> `finish` {#method-finish}
...
### <kbd>méthode</kbd> `log_example` {#method-log_example}
...
### <kbd>méthode</kbd> `log_prediction` {#method-log_prediction}
...
### <kbd>méthode</kbd> `log_summary` {#method-log_summary}
...
### <kbd>méthode</kbd> `set_view` {#method-set_view}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-5}
...
#### <kbd>propriété</kbd> filename {#property-filename}
...
### <kbd>méthode</kbd> `open` {#method-open-2}
...
### <kbd>méthode</kbd> `save` {#method-save-2}
...
### <kbd>méthode</kbd> `add_event` {#method-add_event}
...
### <kbd>méthode</kbd> `attach_media_url` {#method-attach_media_url}
...
### <kbd>méthode</kbd> `end` {#method-end-2}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-4}
...
### <kbd>méthode</kbd> `output` {#method-output}
...
### <kbd>méthode</kbd> `record` {#method-record}
...
### <kbd>méthode</kbd> `set_attributes` {#method-set_attributes}
...
### <kbd>méthode</kbd> `think` {#method-think}
...
## <kbd>classe</kbd> `LogResult` {#class-logresult}
...
## <kbd>classe</kbd> `Markdown` {#class-markdown}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-6}
...
## <kbd>classe</kbd> `MediaAttachment` {#class-mediaattachment}
...
## <kbd>classe</kbd> `Message` {#class-message}
...
### <kbd>méthode de classe</kbd> `assistant` {#classmethod-assistant}
...
### <kbd>méthode de classe</kbd> `system` {#classmethod-system}
...
### <kbd>méthode de classe</kbd> `tool_result` {#classmethod-tool_result}
...
### <kbd>méthode de classe</kbd> `user` {#classmethod-user}
...
## <kbd>classe</kbd> `MessagesPrompt` {#class-messagesprompt}

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/prompt/prompt.py#L168" />

### <kbd>méthode</kbd> `__init__` {#method-__init__-7}
...
### <kbd>méthode</kbd> `format` {#method-format-2}
...
### <kbd>méthode</kbd> `format_message` {#method-format_message}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-5}
...
## <kbd>classe</kbd> `Model` {#class-model}
...
### <kbd>méthode</kbd> `get_infer_method` {#method-get_infer_method}
...
## <kbd>classe</kbd> `Monitor` {#class-monitor}
...
### <kbd>méthode</kbd> `activate` {#method-activate-2}
...
### <kbd>méthode</kbd> `deactivate` {#method-deactivate-2}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-6}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-5}
...
## <kbd>classe</kbd> `Object` {#class-object}
...
### <kbd>méthode de classe</kbd> `from_uri` {#classmethod-from_uri}
...
### <kbd>méthode de classe</kbd> `handle_relocatable_object` {#classmethod-handle_relocatable_object}
...
# Lorsqu’un ObjectRef est passé {#when-an-objectref-is-passed}

obj = MyObject(some&#95;object&#95;ref)

# Lorsqu’un WeaveObject est passé {#when-a-weaveobject-is-passed}
...
## <kbd>classe</kbd> `ObjectRef` {#class-objectref}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-8}
...
#### <kbd>propriété</kbd> digest {#property-digest}

***

#### <kbd>propriété</kbd> extra {#property-extra}

***

#### <kbd>propriété</kbd> is_digest_resolved {#property-is_digest_resolved}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/trace/refs.py#L191" />

### <kbd>méthode</kbd> `as_param_dict` {#method-as_param_dict}
...
### <kbd>méthode</kbd> `delete` {#method-delete}
...
### <kbd>méthode</kbd> `get` {#method-get}
...
### <kbd>méthode</kbd> `is_descended_from` {#method-is_descended_from}
...
### <kbd>méthode</kbd> `maybe_parse_uri` {#method-maybe_parse_uri}
...
### <kbd>méthode</kbd> `parse_uri` {#method-parse_uri}
...
### <kbd>méthode</kbd> `with_attr` {#method-with_attr}
...
### <kbd>méthode</kbd> `with_extra` {#method-with_extra}
...
### <kbd>méthode</kbd> `with_index` {#method-with_index}
...
### <kbd>méthode</kbd> `with_item` {#method-with_item}
...
### <kbd>méthode</kbd> `with_key` {#method-with_key}
...
## <kbd>classe</kbd> `Prompt` {#class-prompt}
...
### <kbd>méthode</kbd> `format` {#method-format-3}
...
## <kbd>classe</kbd> `SavedView` {#class-savedview}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-9}
...
#### <kbd>propriété</kbd> entité {#property-entity}

***

#### <kbd>propriété</kbd> label {#property-label}

***

#### <kbd>propriété</kbd> project {#property-project}

***

#### <kbd>propriété</kbd> view_type {#property-view_type}

***

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/flow/saved_view.py#L624" />

### <kbd>méthode</kbd> `add_column` {#method-add_column}
...
### <kbd>méthode</kbd> `add_columns` {#method-add_columns}
...
### <kbd>méthode</kbd> `add_filter` {#method-add_filter}
...
### <kbd>méthode</kbd> `add_sort` {#method-add_sort}
...
### <kbd>méthode</kbd> `column_index` {#method-column_index}
...
### <kbd>méthode</kbd> `filter_op` {#method-filter_op}
...
### <kbd>méthode</kbd> `get_calls` {#method-get_calls}
...
### <kbd>méthode</kbd> `get_known_columns` {#method-get_known_columns}
...
### <kbd>méthode</kbd> `get_table_columns` {#method-get_table_columns}
...
### <kbd>méthode</kbd> `hide_column` {#method-hide_column}
...
### <kbd>méthode</kbd> `insert_column` {#method-insert_column}
...
### <kbd>méthode de classe</kbd> `load` {#classmethod-load-2}
...
### <kbd>méthode</kbd> `page_size` {#method-page_size}
...
### <kbd>méthode</kbd> `pin_column_left` {#method-pin_column_left}
...
### <kbd>méthode</kbd> `pin_column_right` {#method-pin_column_right}
...
### <kbd>méthode</kbd> `remove_column` {#method-remove_column}
...
### <kbd>méthode</kbd> `remove_columns` {#method-remove_columns}
...
### <kbd>méthode</kbd> `remove_filter` {#method-remove_filter}
...
### <kbd>méthode</kbd> `remove_filters` {#method-remove_filters}
...
### <kbd>méthode</kbd> `rename` {#method-rename}
...
### <kbd>méthode</kbd> `rename_column` {#method-rename_column}
...
### <kbd>méthode</kbd> `save` {#method-save-3}
...
### <kbd>méthode</kbd> `set_columns` {#method-set_columns}
...
### <kbd>méthode</kbd> `show_column` {#method-show_column}
...
### <kbd>méthode</kbd> `sort_by` {#method-sort_by}
...
### <kbd>méthode</kbd> `to_grid` {#method-to_grid}
...
### <kbd>méthode</kbd> `to_rich_table_str` {#method-to_rich_table_str}
...
### <kbd>méthode</kbd> `ui_url` {#method-ui_url}
...
### <kbd>méthode</kbd> `unpin_column` {#method-unpin_column}
...
## <kbd>classe</kbd> `Scorer` {#class-scorer}
...
#### <kbd>propriété</kbd> display_name {#property-display_name}

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/flow/scorer.py#L57" />

### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-7}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-6}
...
### <kbd>méthode</kbd> `score` {#method-score}
...
### <kbd>méthode</kbd> `summarize` {#method-summarize-2}
...
## <kbd>classe</kbd> `Session` {#class-session}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-10}
...
#### <kbd>propriété</kbd> session_id {#property-session_id}

Alias obsolète de :attr:`conversation_id`.

***

#### <kbd>propriété</kbd> session_name {#property-session_name}
...
## <kbd>classe</kbd> `StringPrompt` {#class-stringprompt}

<SourceLink url="https://github.com/wandb/weave/blob/v0.53.1/weave/prompt/prompt.py#L92" />

### <kbd>méthode</kbd> `__init__` {#method-__init__-11}
...
### <kbd>méthode</kbd> `format` {#method-format-4}
...
### <kbd>méthode de classe</kbd> `from_obj` {#classmethod-from_obj-8}
...
## <kbd>classe</kbd> `SubAgent` {#class-subagent}
...
### <kbd>méthode</kbd> `add_event` {#method-add_event-2}
...
### <kbd>méthode</kbd> `llm` {#method-llm}
...
### <kbd>méthode</kbd> `record` {#method-record-2}
...
### <kbd>méthode</kbd> `set_attributes` {#method-set_attributes-2}
...
### <kbd>méthode</kbd> `tool` {#method-tool}
...
### <kbd>méthode</kbd> `pop` {#method-pop}
...
## <kbd>classe</kbd> `ContextAwareThread` {#class-contextawarethread}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-13}
...
#### <kbd>propriété</kbd> daemon {#property-daemon}
...
#### <kbd>propriété</kbd> ident {#property-ident}
...
#### <kbd>propriété</kbd> nom {#property-name}
...
#### <kbd>propriété</kbd> native_id {#property-native_id}
...
### <kbd>méthode</kbd> `run` {#method-run-2}
...
## <kbd>classe</kbd> `ThreadContext` {#class-threadcontext}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-14}
...
#### <kbd>propriété</kbd> thread_id {#property-thread_id}
...
#### <kbd>propriété</kbd> turn_id {#property-turn_id}
...
## <kbd>classe</kbd> `ContextAwareThreadPoolExecutor` {#class-contextawarethreadpoolexecutor}
...
### <kbd>méthode</kbd> `__init__` {#method-__init__-15}
...
### <kbd>méthode</kbd> `map` {#method-map}
...
### <kbd>méthode</kbd> `submit` {#method-submit}
...
## <kbd>classe</kbd> `Tool` {#class-tool}
...
### <kbd>méthode</kbd> `add_event` {#method-add_event-3}
...
### <kbd>méthode</kbd> `set_attributes` {#method-set_attributes-3}
...
## <kbd>classe</kbd> `Turn` {#class-turn}
...
### <kbd>méthode</kbd> `add_event` {#method-add_event-4}
...
### <kbd>méthode</kbd> `llm` {#method-llm-2}
...
### <kbd>méthode</kbd> `model_post_init` {#method-model_post_init-7}
...
### <kbd>méthode</kbd> `record` {#method-record-3}
...
### <kbd>méthode</kbd> `set_attributes` {#method-set_attributes-4}
...
### <kbd>méthode</kbd> `subagent` {#method-subagent}
...
### <kbd>méthode</kbd> `tool` {#method-tool-2}
...
### <kbd>méthode</kbd> `user` {#method-user}
...
## <kbd>classe</kbd> `Utilisation` {#class-usage}
...
### <kbd>fonction</kbd> `add_tags` {#function-add_tags}
...
### <kbd>fonction</kbd> `as_op` {#function-as_op}
...
### <kbd>fonction</kbd> `attributes` {#function-attributes}
...
### <kbd>fonction</kbd> `end_conversation` {#function-end_conversation}
...
### <kbd>fonction</kbd> `end_llm` {#function-end_llm}
...
### <kbd>fonction</kbd> `end_session` {#function-end_session}
...
### <kbd>fonction</kbd> `end_turn` {#function-end_turn}
...
### <kbd>fonction</kbd> `finish` {#function-finish}
...
### <kbd>fonction</kbd> `get` {#function-get}
...
### <kbd>fonction</kbd> `get_aliases` {#function-get_aliases}
...
### <kbd>fonction</kbd> `get_client` {#function-get_client}
...
### <kbd>fonction</kbd> `get_current_call` {#function-get_current_call}
...
### <kbd>fonction</kbd> `get_current_conversation` {#function-get_current_conversation}
...
### <kbd>fonction</kbd> `get_current_llm` {#function-get_current_llm}
...
### <kbd>fonction</kbd> `get_current_session` {#function-get_current_session}
...
### <kbd>fonction</kbd> `get_current_turn` {#function-get_current_turn}
...
### <kbd>fonction</kbd> `get_tags` {#function-get_tags}
...
### <kbd>fonction</kbd> `get_tags_and_aliases` {#function-get_tags_and_aliases}
...
### <kbd>fonction</kbd> `init` {#function-init}
...
### <kbd>fonction</kbd> `link_prompt_to_registry` {#function-link_prompt_to_registry}
...
### <kbd>fonction</kbd> `list_aliases` {#function-list_aliases}
...
### <kbd>fonction</kbd> `list_tags` {#function-list_tags}
...
### <kbd>fonction</kbd> `log_call` {#function-log_call}
...
### <kbd>fonction</kbd> `log_session` {#function-log_session}
...
### <kbd>fonction</kbd> `log_turn` {#function-log_turn}
...
### <kbd>fonction</kbd> `op` {#function-op}
...
### <kbd>fonction</kbd> `otel_traces_endpoint` {#function-otel_traces_endpoint}
...
### <kbd>fonction</kbd> `publish` {#function-publish}
...
### <kbd>fonction</kbd> `ref` {#function-ref}
...
### <kbd>fonction</kbd> `remove_aliases` {#function-remove_aliases}
...
### <kbd>fonction</kbd> `remove_tags` {#function-remove_tags}
...
### <kbd>fonction</kbd> `require_current_call` {#function-require_current_call}
...
### <kbd>fonction</kbd> `set_aliases` {#function-set_aliases}
...
### <kbd>fonction</kbd> `set_view` {#function-set_view}
...
### <kbd>fonction</kbd> `start_conversation` {#function-start_conversation}
...
### <kbd>fonction</kbd> `start_llm` {#function-start_llm}
...
### <kbd>fonction</kbd> `start_session` {#function-start_session}
...
### <kbd>fonction</kbd> `start_subagent` {#function-start_subagent}
...
### <kbd>fonction</kbd> `start_tool` {#function-start_tool}
...
### <kbd>fonction</kbd> `start_turn` {#function-start_turn}
...
### <kbd>fonction</kbd> `thread` {#function-thread}
...
### <kbd>fonction</kbd> `wandb_init_hook` {#function-wandb_init_hook}
