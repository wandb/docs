...
keywords: [génération augmentée par récupération, juge LLM, précision du contexte, scorer, embeddings]
---
...
<div id="build-a-knowledge-base">
  ## Créer une base de connaissances {#build-a-knowledge-base}
</div>
...
<div id="create-a-rag-app">
  ## Créer une application RAG {#create-a-rag-app}
</div>
...
<div id="evaluate-with-an-llm-judge">
  ## Évaluer avec un juge LLM {#evaluate-with-an-llm-judge}
</div>
...
<div id="define-a-scoring-function">
  ### Définir une fonction de score {#define-a-scoring-function}
</div>
...
<div id="optional-define-a-scorer-class">
  ### Facultatif : définir une classe `Scorer` {#optional-define-a-scorer-class}
</div>
...
<div id="put-it-all-together">
  ## Assemblez le tout {#put-it-all-together}
</div>
