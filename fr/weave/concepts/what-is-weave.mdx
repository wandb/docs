...
Si vous souhaitez tracer des appels de fonction individuels, le code de l&#39;application ou une logique personnalisée, utilisez Weave Ops and Calls. Ajoutez une ligne à n&#39;importe quelle fonction pour suivre les entrées, les sorties, le coût, le nombre de jetons et la latence.
...
Pour tracer des fonctions individuelles, suivez le [démarrage rapide du traçage des Ops](/fr/weave/quickstart) de Weave ou apprenez à utiliser les [Ops and Calls](/fr/weave/guides/tracking/tracing) de Weave.
...
Évaluez et surveillez systématiquement les performances de votre application LLM à l’aide d’évaluations afin d’améliorer de manière itérative la qualité et la fiabilité.
