...
<Tabs>
  ...
  <Tab title="TypeScript">
    L’exemple de code suivant montre un run d’évaluation complet, du début à la fin. Les lignes du jeu de données sont utilisées par la fonction de scoring `matchScore` pour évaluer `myModel`.
  </Tab>
</Tabs>

<Frame>![Visuel des évaluations](/images/evals-hero.png)</Frame>
