...
## Créer un objet `Evaluation` {#create-an-evaluation-object}
...
### Facultatif : nommage personnalisé {#optional-custom-naming}
...
#### Nommer l’objet `Evaluation` {#name-the-evaluation-object}
...
#### Nommer des runs d’évaluation individuels {#name-individual-evaluation-runs}
...
## Définir un jeu de données d&#39;exemples de test {#define-a-dataset-of-test-examples}
...
## Définir des fonctions de score {#define-scoring-functions}
...
### Facultatif : Définir une classe `Scorer` personnalisée {#optional-define-a-custom-scorer-class}
...
## Définissez un modèle ou une fonction à évaluer {#define-a-model-or-function-to-evaluate}
...
### Facultatif : Définissez une fonction à évaluer {#optional-define-a-function-to-evaluate}
...
## Lancez l’évaluation {#run-the-evaluation}
...
### Facultatif : Exécuter plusieurs essais {#optional-run-multiple-trials}
...
### Facultatif : Exécuter plusieurs essais {#optional-run-multiple-trials-2}
...
## Exemple complet de code d’évaluation {#full-evaluation-code-example}
...
## Utilisation avancée de l’évaluation {#advanced-evaluation-usage}
...
### Formater les lignes du jeu de données avant d’évaluer {#format-dataset-rows-before-evaluating}
...
### Utiliser des jeux de données HuggingFace avec les évaluations {#use-huggingface-datasets-with-evaluations}
...
### Évaluations impératives (`EvaluationLogger`) {#imperative-evaluations-evaluationlogger}
