...
<Tabs>
  <Tab title="Python">
    Journalisez des vidéos en annotant les fonctions avec le type `Annotated[bytes, Content]`. Weave gère automatiquement les vidéos `mp4`. Voici un exemple simple :
