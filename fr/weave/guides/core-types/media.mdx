...
<Frame>![Capture d’écran de la Vue de trace du chat à la citrouille](/weave/guides/core-types/imgs/cat-pumpkin-trace.png)</Frame>
...
<Tabs>
  <Tab title="Python">
    ...
    Il peut être utile de redimensionner les images avant de les journaliser afin de réduire le coût de rendu de l’UI et l’impact sur le stockage. Vous pouvez utiliser `postprocess_output` dans votre `@weave.op` pour redimensionner une image.
...
<Frame>![Journalisation de vidéos dans Weave](/images/weave/video.png)</Frame>
...
<Frame>![Journalisation de documents PDF dans Weave](/images/weave/pdf.png)</Frame>
...
<Frame>![Capture d’écran de la vue de trace audio](/weave/guides/core-types/imgs/audio-trace.png)</Frame>
...
<Tabs>
  <Tab title="Python">
    ...
    <Frame>![Enregistrement audio dans Weave](/images/weave/audio.png)</Frame>
