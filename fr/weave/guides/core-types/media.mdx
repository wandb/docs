...
<Note>
  Pour afficher des médias déjà stockés dans votre propre bucket cloud sans téléverser les octets vers Weave, voir [Référencer des médias dans votre propre bucket (BYOB)](/fr/weave/guides/tracking/byob-references).
</Note>

## Journaliser des images {#log-images}

Les exemples suivants montrent comment générer et journaliser des images dans l’interface utilisateur de Weave.

<Frame>
  ![Vue de trace Weave montrant une image générée d’un chat portant un chapeau en forme de citrouille](/weave/guides/core-types/imgs/cat-pumpkin-trace.png)
</Frame>
...
### Exemple avancé : générer une image avec DALL-E et la journaliser dans Weave {#advanced-example-generate-an-image-with-dall-e-and-log-it-to-weave}
...
### Exemple avancé : redimensionner les grandes images avant de les journaliser {#advanced-example-resize-large-images-before-logging}
...
### Exemple avancé : journaliser une image générée avec l’API DALL-E d’OpenAI {#advanced-example-log-an-image-generated-with-the-openai-dall-e-api}
...
### Exemple avancé : journaliser une vidéo dans un projet d’analyse vidéo {#advanced-example-log-a-video-within-a-video-analysis-project}
...
## Journaliser des documents {#log-documents}
...
### Exemple avancé : journaliser des documents dans un système RAG {#advanced-example-log-documents-within-a-rag-system}
...
## Journaliser l’audio {#log-audio}

Les exemples suivants montrent comment journaliser de l’audio vers Weave.

<Frame>
  ![Vue de trace Weave montrant un fichier audio enregistré avec un lecteur audio intégré](/weave/guides/core-types/imgs/audio-trace.png)
</Frame>
...
### Exemple avancé : générer et journaliser de l’audio généré par l’IA {#advanced-example-generate-and-log-ai-created-audio}
...
### Exemple avancé : générer de l’audio avec l’API TTS d’OpenAI et le journaliser dans Weave {#advanced-example-generate-audio-using-openais-tts-api-and-log-it-to-weave}
...
### Exemple avancé : générer des pages HTML autonomes avec Serverless Inference et les journaliser dans Weave {#advanced-example-generate-self-contained-html-pages-using-serverless-inference-and-log-them-to-weave}
...
### Initialisation directe {#direct-initialization}
...
### Types MIME personnalisés {#custom-mimetypes}
...
#### Types MIME personnalisés avec annotations de type {#custom-mimetypes-with-type-annotations}
...
#### Types MIME personnalisés avec initialisation directe {#custom-mimetypes-with-direct-initialization}
...
### Propriétés de Content {#content-properties}
...
#### Méthodes d’initialisation {#initialization-methods}
