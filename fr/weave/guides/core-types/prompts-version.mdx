...
## Versions de prompt {#prompt-versions}
...
## Comment les versions de prompts sont créées {#how-prompt-versions-are-created}
...
## Construire une URI de référence pleinement qualifiée {#construct-a-fully-qualified-ref-uri}
...
## Récupérer une version de prompt dans le code {#retrieve-a-prompt-version-in-code}
...
## Utiliser des prompts en production {#use-prompts-in-production}
...
## <a id="view-prompts" aria-label="Afficher et comparer les versions de prompt" />Afficher et comparer les versions de prompt {#view-and-compare-prompt-versions}
...
## Ajouter des tags et des alias aux prompts {#add-prompt-tags-and-aliases}
...
### Modifier les tags et les alias dans le code {#modify-tags-and-aliases-in-code}
