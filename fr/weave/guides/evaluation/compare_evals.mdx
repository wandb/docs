...
## Accéder à la vue Compare evaluations {#access-the-compare-evaluations-view}
...
## Examiner la comparaison {#review-the-comparison}
...
### Onglet Dataset results {#dataset-results-tab}
...
## Personnaliser la vue Compare evaluations {#customize-the-compare-evaluations-view}
...
### Supprimer de la comparaison {#remove-from-comparison}
