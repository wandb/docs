...
<div id="simplified-logging-with-log_example">
  ## Journalisation simplifiée avec `log_example()` {#simplified-logging-with-log_example}
</div>
...
<div id="use-context-managers">
  ### Utiliser des gestionnaires de contexte {#use-context-managers}
</div>
...
<div id="link-agent-traces-to-evaluations">
  ### Lier les traces d’agent aux évaluations {#link-agent-traces-to-evaluations}
</div>
...
<div id="link-spans-you-instrument-yourself">
  #### Lier les spans que vous instrumentez vous-même {#link-spans-you-instrument-yourself}
</div>
...
<div id="link-an-agent-that-runs-in-a-separate-service">
  #### Lier un agent exécuté dans un service distinct {#link-an-agent-that-runs-in-a-separate-service}
</div>
...
<div id="view-linked-agent-spans-from-your-evaluations">
  #### Afficher les spans d’agent liés à vos évaluations {#view-linked-agent-spans-from-your-evaluations}
</div>
...
<div id="link-to-an-existing-dataset">
  ### Lier à un jeu de données existant {#link-to-an-existing-dataset}
</div>
...
<div id="get-outputs-before-logging">
  ### Obtenir les sorties avant la journalisation {#get-outputs-before-logging}
</div>
...
<div id="log-rich-media">
  ### Journaliser des médias enrichis {#log-rich-media}
</div>
...
<div id="log-and-compare-multiple-evaluations">
  ### Journaliser et comparer plusieurs évaluations {#log-and-compare-multiple-evaluations}
</div>
