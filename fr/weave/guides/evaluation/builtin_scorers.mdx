...
Les évaluateurs prédéfinis qui utilisent des LLM s’intègrent automatiquement à litellm. Vous n’avez pas besoin de passer un client LLM ; définissez simplement `model_id`. Voir les [modèles pris en charge](https://docs.litellm.ai/docs/providers).
