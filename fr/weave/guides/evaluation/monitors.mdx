...
## Signaux disponibles {#available-signals}
...
### Signaux de qualité {#quality-signals}
...
### Signaux d’erreur {#error-signals}
...
### Comment fonctionnent les signaux {#how-signals-work}
...
## Ajoutez un signal depuis la page Monitors {#add-a-signal-from-the-monitors-page}
...
3. Pour ajouter un signal à un projet sans Monitors activés, cliquez sur la carte correspondante pour activer sa case à cocher, puis cliquez sur **Setup monitors**.
...
## Gérer les signaux actifs {#manage-active-signals}
...
## Utiliser les signaux intégrés {#use-built-in-signals}
...
### Voir les traces d’Appel taguées sur la page Traces {#see-tagged-call-traces-on-the-traces-page}
...
### Voir les signaux dans le tableau de bord du projet {#see-signals-in-the-project-dashboard}
...
### Recevoir des alertes sur les signaux {#alert-on-signals}
