...
## Comment fonctionnent les garde-fous Weave {#how-weave-guardrails-work}
...
### Optimisez les performances de vos garde-fous Weave {#optimize-your-weave-guardrail-performance}
...
## Exemple : Créer un guardrail à l’aide d’un évaluateur de modération intégré {#example-create-a-guardrail-using-a-built-in-moderation-scorer}
...
## Exemple : créer un guardrail à l’aide d’un évaluateur personnalisé {#example-create-a-guardrail-using-a-custom-scorer}
...
## Intégrer Weave avec AWS Bedrock garde-fous {#integrate-weave-with-aws-bedrock-guardrails}
