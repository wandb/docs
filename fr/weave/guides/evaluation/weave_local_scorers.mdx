...
keywords: ["évaluateurs locaux", "évaluation RAG", "détection des PII", "hallucination", "toxicité"]
---
...
## Sélectionner un évaluateur {#select-a-scorer}
...
## `WeaveBiasScorerV1` {#weavebiasscorerv1}
...
## `WeaveToxicityScorerV1` {#weavetoxicityscorerv1}
...
### Notes d’utilisation {#usage-notes-2}
...
### Exemple d’utilisation {#usage-example-2}
...
## `WeaveHallucinationScorerV1` {#weavehallucinationscorerv1}
...
### Notes d’utilisation {#usage-notes-3}
...
### Exemple d’utilisation {#usage-example-3}
...
## `WeaveContextRelevanceScorerV1` {#weavecontextrelevancescorerv1}
...
### Notes d’utilisation {#usage-notes-4}
...
### Exemple d’utilisation {#usage-example-4}
...
## `WeaveCoherenceScorerV1` {#weavecoherencescorerv1}
...
### Notes d’utilisation {#usage-notes-5}
...
### Exemple d’utilisation {#usage-example-5}
...
## `WeaveFluencyScorerV1` {#weavefluencyscorerv1}
...
### Notes d’utilisation {#usage-notes-6}
...
### Exemple d’utilisation {#usage-example-6}
...
## `WeaveTrustScorerV1` {#weavetrustscorerv1}
...
### Notes d’utilisation {#usage-notes-7}
...
### Exemple d’utilisation {#usage-example-7}
...
### Notes d’utilisation {#usage-notes-8}
...
### Exemple d’utilisation {#usage-example-8}
