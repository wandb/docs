...
keywords: ["déploiement", "IAM", "SSO", "Cloud dédié", "sécurité des données"]
---
...
* **[Instances autogérées](/fr/weave/guides/platform/weave-self-managed) :** Pour les équipes qui préfèrent héberger Weave de manière autonome, votre équipe W&amp;B peut vous accompagner dans l’évaluation des options de déploiement. Les instances autogérées peuvent utiliser [l’échantillonnage à l’ingestion](/fr/weave/guides/platform/ingest-sampling) pour contrôler les coûts lorsque le volume de traces est élevé.
