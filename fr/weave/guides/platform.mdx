...
* **[Instances autogérées](/fr/weave/guides/platform/weave-self-managed) :** Configurez une instance W&amp;B autogérée et activez Weave sur votre propre infrastructure. Pour les équipes qui préfèrent héberger Weave de manière autonome, votre équipe W&amp;B peut vous accompagner dans l’évaluation des options de déploiement.
