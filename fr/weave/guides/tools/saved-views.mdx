...
Vous pouvez créer, modifier et enregistrer des vues directement dans le SDK Python de Weave ou via l&#39;interface utilisateur. Le SDK Python offre un contrôle précis du filtrage et des requêtes par programmation, tandis que l&#39;interface utilisateur permet d&#39;explorer et d&#39;enregistrer facilement différentes configurations de tableau dans les onglets **Traces** et **Evals**.

Ce guide couvre :

* [Comment créer et modifier des vues enregistrées dans le SDK Python](#saved-views-in-the-python-sdk).
* [Comment créer des vues enregistrées et interagir avec elles dans l&#39;interface utilisateur de Weave](#saved-views-in-the-ui).
...
Utilisez `.add_column()` pour ajouter une ou plusieurs colonnes à la vue. Indiquez la ou les colonnes à ajouter.
...
5. Dans la fenêtre modale, confirmez en cliquant sur **Supprimer la vue**. Vous pouvez également cliquer sur **Annuler** pour interrompre la suppression.
