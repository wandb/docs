...
## Attributs par appel {#per-call-attributes}
...
## Attributs globaux {#global-attributes}
...
### Combiner les attributs globaux et les attributs par appel {#combine-global-and-per-call-attributes}
...
## Obtenir les attributs pendant l&#39;exécution {#get-attributes-during-execution}
