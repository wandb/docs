...
Au moment de l&#39;exécution, vous pouvez inspecter les attributs actuellement en vigueur pour un Appel. Cela est utile lorsque vous souhaitez déboguer les métadonnées que Weave associe, ou lorsque votre code doit se brancher en fonction d&#39;informations contextuelles définies par un appelant externe.
