...
1. Ouvrez la W&amp;B UI et cliquez sur l’onglet **Projects**. Cela ouvre la liste de vos projets.
...
<Note>La classe `Model` n’est actuellement prise en charge que dans le SDK Python de Weave.</Note>