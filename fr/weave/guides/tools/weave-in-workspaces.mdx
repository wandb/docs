...
# Enregistrer des traces pendant les runs d&#39;entraînement de modèle {#log-traces-during-model-training-runs}
...
## Utiliser les panneaux Weave {#use-weave-panels}
...
## Associer des traces à un run W&amp;B spécifique {#associate-traces-with-a-specific-wb-run}
...
## Référencer des artefacts W&amp;B dans une trace Weave {#reference-wb-artifacts-in-a-weave-trace}
...
### Ajouter un artefact comme attribut d’une trace {#add-an-artifact-as-an-attribute-of-a-trace}
...
### Ajouter un artefact comme attribut d’un `Model` {#add-an-artifact-as-an-attribute-of-a-model}
