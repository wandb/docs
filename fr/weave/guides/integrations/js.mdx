...
## Utilisez les intégrations Weave avec votre projet TypeScript {#use-weave-integrations-with-your-typescript-project}
...
### Si vous ne savez pas quel type de projet vous avez {#if-youre-unsure-which-type-of-project-you-have}
...
### Configurer un projet CommonJS {#set-up-a-commonjs-project}
...
### Configurer un projet ESM {#set-up-an-esm-project}
...
## Utilisation avancée et dépannage {#advanced-usage-and-troubleshooting}
...
### Utiliser `NODE_OPTIONS` (uniquement pour ESM) {#use-node_options-only-for-esm}
...
### Compatibilité des bundlers {#bundler-compatibility}
...
### Patching manuel (option de repli) {#manual-patching-fallback-option}
