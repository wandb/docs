---
title: Agno
description: "Tracez les systèmes multi-agents Agno avec Weave à l’aide d’OpenTelemetry pour capturer les interactions entre agents, les appel d’outil et les flux de travail multimodaux."
keywords: ["OTEL", "OpenInference", "multi-agent", "AgnoInstrumentor", "appel d’outil"]
---
...
## Envoyer des traces OTEL d’Agno vers Weave {#send-otel-traces-from-agno-to-weave}
...
## Tracez les agents Agno avec OTEL {#trace-agno-agents-with-otel}
...
## Tracez les outils Agno avec OTEL {#trace-agno-tools-with-otel}
...
## Tracez les équipes multi-agents avec OTEL {#trace-multi-agent-teams-with-otel}
...
## Utiliser des agents de raisonnement {#work-with-reasoning-agents}
...
## Utiliser la mémoire et les connaissances {#work-with-memory-and-knowledge}
