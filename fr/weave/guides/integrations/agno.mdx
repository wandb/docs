...
Toutes les opérations de l’agent font automatiquement l’objet d’un traçage et sont envoyées à Weave, ce qui vous permet de visualiser le flux d’exécution, les appels au modèle, les étapes de raisonnement et les appels d’outil.
...
Lorsque vous définissez et utilisez des outils avec Agno, les appels d’outil sont également capturés dans la trace. L’intégration OTEL instrumente automatiquement à la fois le processus de raisonnement de l’agent et l’exécution de chaque outil, offrant une vue complète du comportement de votre agent.
...
# Utiliser l'agent - les appels d’outil seront tracés
...
<Frame>
  ![Une visualisation de la trace des appels d’outil Agno](/weave/guides/integrations/imgs/agno/agno_tool_calls.png)
</Frame>
...
La puissante architecture multi-agent d&#39;Agno vous permet de créer des équipes d&#39;agents capables de collaborer et de partager un contexte commun. Ces interactions au sein de l&#39;équipe sont également entièrement tracées :
...
Cette trace multi-agents montrera comment les différents agents se coordonnent dans Weave, en vous offrant une visibilité sur la façon dont les tâches sont réparties et exécutées au sein de votre équipe d&#39;agents.

<Frame>
  ![Une visualisation de la trace de l'équipe multi-agents Agno](/weave/guides/integrations/imgs/agno/agno_team_trace.png)
</Frame>
...
Agno fournit des capacités de raisonnement intégrées qui aident les agents à analyser les problèmes étape par étape. Ces processus de raisonnement sont également capturés dans les traces :
...
Les étapes du raisonnement seront visibles dans la trace, qui montre comment l’agent décompose des problèmes complexes et prend des décisions.
...
Les opérations en mémoire, notamment l’enregistrement et la récupération de l’historique des conversations, apparaîtront dans la trace.
