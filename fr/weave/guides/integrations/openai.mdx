...
### Patching automatique {#automatic-patching}
...
### Facultatif : patching explicite {#optional-explicit-patching}
...
## Prise en charge de l’asynchrone {#async-support}
...
## Prise en charge du streaming {#streaming-support}
...
## Tracing des appels de fonction {#tracing-function-calls}
...
## Tracing des fonctions personnalisées {#tracing-custom-functions}
