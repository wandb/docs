...
<Warning>
  ...
  Le nettoyage des PII et le masquage des données sensibles ne sont pas implémentés. Si vous ne pouvez pas envoyer ces données à Weave au regard de vos exigences de sécurité ou de conformité, n’activez pas le tracing Weave dans votre application Pi.
</Warning>
