...
## Tracez les agents du Claude Agent SDK avec Weave {#trace-claude-agent-sdk-agents-with-weave}
...
### Initialisez Weave dans votre code {#initialize-weave-in-your-code}
