...
<Steps>
  ...
  <Step title="Démarrez Claude Code :">
    ...
    Les sessions sont automatiquement tracées à partir de ce point. Exécutez un ou deux prompts, puis ouvrez votre projet Weave pour voir les traces apparaître.
  </Step>
</Steps>
...
Les conversations comportant plusieurs tours de conversation sont associées côté serveur via l&#39;ID de session, afin que vous puissiez suivre une conversation complète à travers plusieurs traces. Chaque span inclut l&#39;utilisation des jetons, le nom du modèle, les entrées et sorties des outils, les informations de temporisation, ainsi que le contenu textuel des prompts et des réponses. Pour plus de détails, voir [Ce qui est tracé](https://github.com/wandb/weave-claude-code/blob/main/README.md#what-gets-traced) sur GitHub.
...
| ------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Installation  | `/weave:weave-install` | Vous guide de manière interactive tout au long du processus complet d&#39;installation et de configuration. À utiliser sur une nouvelle machine ou pour diagnostiquer une installation défectueuse.              |
...
3. Relancez Claude Code. Le démon redémarre automatiquement et prend en compte l’URL correcte.
