...
<div id="install-the-plugin">
  ## Installez le plugin {#install-the-plugin}
</div>
...
<div id="view-claude-code-traces-in-weave">
  ## Afficher les traces de Claude Code dans Weave {#view-claude-code-traces-in-weave}
</div>
...
<div id="weave-skills">
  ## Compétences Weave {#weave-skills}
</div>
...
<div id="check-plugin-status">
  ## Vérifier le statut du plugin {#check-plugin-status}
</div>
...
<div id="wb-dedicated-cloud-or-self-hosted-instances">
  ### W&amp;B Cloud dédié ou instances auto-hébergées {#wb-dedicated-cloud-or-self-hosted-instances}
</div>
