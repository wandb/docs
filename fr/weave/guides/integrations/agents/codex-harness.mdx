...
keywords: ["OpenAI Codex", "OTEL", "traçage des agents", "hook Stop", "rollout"]
---
...
<div id="view-codex-traces-in-weave">
  ## Voir les traces Codex dans Weave {#view-codex-traces-in-weave}
</div>
...
<div id="credential-resolution-order">
  ### Ordre de résolution des identifiants d’authentification {#credential-resolution-order}
</div>
...
<div id="wb-dedicated-cloud-or-self-hosted-instances">
  ### W&amp;B Cloud dédié ou instances autohébergées {#wb-dedicated-cloud-or-self-hosted-instances}
</div>
...
<div id="no-traces-appear-after-running-codex">
  ### Aucune trace n’apparaît après l’exécution de Codex {#no-traces-appear-after-running-codex}
</div>
...
<div id="turns-appear-but-inputoutput-text-is-empty">
  ### Les tours de conversation apparaissent, mais le texte d’entrée et de sortie est vide {#turns-appear-but-inputoutput-text-is-empty}
</div>
...
<div id="hook-locked-environments">
  ### Environnements avec hooks verrouillés {#hook-locked-environments}
</div>
