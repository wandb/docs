---
title: "NVIDIA NIM"
description: "Utilisez Weave pour capturer les traces et journaliser les appels LLM effectués via la bibliothèque ChatNVIDIA"
...
## Créer un `Model` pour expérimenter plus facilement {#create-a-model-for-easier-experimentation}
...
## Informations d’utilisation {#usage-info}
