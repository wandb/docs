...
keywords: ["AutoGen", "multi-agent", "traçage des agents", "GroupChat", "RAG"]
---
...
## Traces d’un client de modèle {#traces-for-a-model-client}
...
### Traces d’un appel à la méthode `create` du client {#traces-for-a-client-create-call}
...
### Traces pour un appel `create` du client avec streaming {#traces-for-a-client-create-call-with-streaming}
...
### Traces pour les appels client mis en cache {#traces-for-cached-client-calls}
...
## Traces pour un agent avec des appels d’outils {#traces-for-an-agent-with-tool-calls}
...
## Traces pour un GroupChat round robin {#traces-for-a-round-robin-groupchat}
...
## Traces pour la mémoire {#traces-for-memory}
...
## Traces pour les flux de travail RAG {#traces-for-rag-workflows}
...
## Traces pour les runtimes d’agent {#traces-for-agent-runtimes}
...
## Traces pour les flux de travail séquentiels {#traces-for-sequential-workflows}
...
## Traces pour les exécuteurs de code {#traces-for-code-executors}
