...
## Encapsuler les appels dans vos propres ops {#wrap-calls-with-your-own-ops}
...
### Essayez Bedrock dans le playground Weave {#try-bedrock-in-the-weave-playground}

Pour tester des modèles Amazon Bedrock dans Weave UI sans rien configurer, essayez le [LLM Playground](../tools/playground).

### Rapport : comparer des LLM sur Bedrock pour le résumé de texte avec Weave {#report-compare-llms-on-bedrock-for-text-summarization-with-weave}
