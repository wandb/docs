...
## Configurer le traçage OTel pour Next.js {#configure-otel-tracing-for-nextjs}
...
### Configurer l’instrumentation {#configure-instrumentation}
...
### Configurer la télémétrie sur une fonction {#configure-telemetry-on-a-function}
...
## Configurer le traçage OTel pour Node.js {#configure-otel-tracing-for-nodejs}
