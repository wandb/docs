---
title: MistralAI
description: "Suivez et surveillez les appels au modèle MistralAI grâce au Tracing automatique de Weave pour les complétions de chat, les appels de fonction et les interactions avec le modèle."
---
...
Les ops Weave rendent les résultats *reproductibles* en assurant automatiquement la gestion des versions du code au fil de vos expérimentations, et en capturant leurs entrées et sorties. Créez simplement une fonction décorée avec [`@weave.op()`](/fr/weave/guides/tracking/ops) qui appelle [`mistralai.client.MistralClient.chat()`](https://docs.mistral.ai/capabilities/completion), et Weave en assurera le suivi pour vous. Voyons comment faire pour notre recommandateur de fromages :
