...
<Tabs>
  <Tab title="Python">
    Le [SDK Python d’OpenAI Agents](https://github.com/openai/openai-agents-python) est un framework léger et puissant pour créer des flux de travail multi-agents.
  ...
  <Tab title="TypeScript">
    ...
    Installez les dépendances requises à l’aide de `npm` :
