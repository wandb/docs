...
## Suivi des métadonnées des appels {#tracking-call-metadata}
...
## Exemple de traçage de pipeline {#pipeline-tracing-example}
...
## Traceurs personnalisés et Weave {#custom-tracers-and-weave}
