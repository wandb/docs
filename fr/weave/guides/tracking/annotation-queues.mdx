...
* **Queue ID** : l’identifiant unique de la file d’annotation.

Pour trouver l’ID de la file d’annotation :

1. Dans le tableau **Annotation Queues**, sélectionnez le nom de la file d’annotation pour ouvrir ses éléments.
...
Dans cet exemple, l’ID de la file d’annotation est :

019c0f63-7acb-7497-8f87-08873368fcd4

Vous pouvez parcourir les traces (appels) de votre file d’annotation à l’aide du code suivant.
