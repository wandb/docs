...
description: "Filtrez, triez et exportez les données d’appels Weave à l’aide du SDK Python, de l’API REST ou de l’interface Weave pour une analyse personnalisée."
keywords: ["exporter des traces", "stream_query", "métriques d’appels", "statistiques d’appels", "export de traces"]
---
...
## Exporter des appels depuis l’interface Weave {#export-calls-from-the-weave-ui}
...
## Récupérer les appels par programmation {#fetch-calls-programmatically}
...
<Tabs>
  ...
  <Tab title="TypeScript">
    Pour récupérer des appels avec l’API TypeScript, utilisez la méthode [`client.getCalls`](/fr/weave/reference/typescript-sdk/interfaces/weaveclient#getcalls) :
...
## Exporter les métriques d’appel {#export-call-metrics}
