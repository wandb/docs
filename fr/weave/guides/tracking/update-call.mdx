...
<Tabs>
  ...
  <Tab title="TypeScript">
    Pour définir le nom d’affichage d’un Appel, utilisez [`client.updateCall`](/fr/weave/reference/typescript-sdk/interfaces/weaveclient#updatecall) pour le mettre à jour directement à partir de l’ID de l’appel :
...
## Supprimer plusieurs appels {#delete-multiple-calls}
