...
## Suivi automatique des Appels aux bibliothèques LLM {#automatic-tracking-of-llm-library-calls}
...
## Suivi des fonctions personnalisées {#track-custom-functions}
...
### Suivre les méthodes de classe et d’instance {#track-class-and-object-methods}
...
### Tracer des appels de fonction parallèles (multithread) {#trace-parallel-multi-threaded-function-calls}
...
## Suivi manuel des appels {#manual-call-tracking}
