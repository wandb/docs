...
<Tip>
  Si vous cherchez à intégrer Weave à des SDK ou harnesses populaires, comme le Claude Agent SDK ou Codex, voir [Intégrations de traçage des agents](/fr/weave/guides/tracking/trace-agent-integrations). Weave applique automatiquement des patchs à plusieurs SDK populaires de création d’agents et harnesses d’agents pour une intégration rapide.
</Tip>
