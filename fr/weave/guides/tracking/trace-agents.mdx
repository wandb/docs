...
keywords: ["sur plusieurs tours de conversation", "conversations", "OTel", "invoke_agent", "conversation_id"]
---
...
<div id="how-data-appears-in-the-weave-ui">
  ## Comment les données s’affichent dans l’interface Weave
</div>
...
* La **vue détaillée de la conversation** s’ouvre lorsque vous cliquez sur une conversation et affiche tous les tours de conversation, ses appels LLM, ses exécutions d’outils, le nombre de jetons et le feedback associé.
