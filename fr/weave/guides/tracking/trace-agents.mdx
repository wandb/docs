...
## Le modèle de données des agents {#the-agent-data-model}
...
| Conversation         | `Conversation`      | *(aucun span, les tours de conversation sont regroupés par l’attribut `conversation_id`)* | Une conversation ou une exécution qui contient un ou plusieurs tours de conversation.       | [Python](/fr/weave/reference/python-sdk#class-conversation) <br /> [TypeScript](/fr/weave/reference/typescript-sdk/interfaces/conversation) |
| Tour de conversation | `Turn`              | `invoke_agent`                                                                            | Un message utilisateur et la réponse complète de l’agent.                                   | [Python](/fr/weave/reference/python-sdk#class-turn) <br /> [TypeScript](/fr/weave/reference/typescript-sdk/interfaces/turn)                 |
| appel LLM            | `LLM`               | `chat`                                                                                    | Un appel à une API de modèle de langage.                                                    | [Python](/fr/weave/reference/python-sdk#class-llm) <br /> [TypeScript](/fr/weave/reference/typescript-sdk/interfaces/llm)                   |
| appel d’outil        | `Tool`              | `execute_tool`                                                                            | Un appel d’outil déclenché par une réponse LLM.                                             | [Python](/fr/weave/reference/python-sdk#class-tool) <br /> [TypeScript](/fr/weave/reference/typescript-sdk/interfaces/tool)                 |
| appel de sous-agent  | `SubAgent`          | `invoke_agent`                                                                            | Un appel d’agent imbriqué, généralement lorsqu’un agent délègue à un autre.                 | [Python](/fr/weave/reference/python-sdk#class-subagent) <br /> [TypeScript](/fr/weave/reference/typescript-sdk/interfaces/subagent)         |
...
<div id="agent-tracing-apis">
  ## API de traçage des agents {#agent-tracing-apis}
</div>
...
<div id="start-a-turn">
  ### Démarrer un tour de conversation {#start-a-turn}
</div>
...
<div id="start-an-llm-call">
  ### Démarrer un appel LLM {#start-an-llm-call}
</div>
...
<div id="start-a-tool-call">
  ### Démarrer un appel d’outil {#start-a-tool-call}
</div>
...
<div id="usage-patterns-for-agent-tracing">
  ## Schémas d’utilisation pour le traçage des agents {#usage-patterns-for-agent-tracing}
</div>
...
<div id="context-manager-or-try-finally-pattern">
  ### Gestionnaire de contexte ou schéma try-finally {#context-manager-or-try-finally-pattern}
</div>
...
<div id="manual-start-and-end-pattern">
  ### Démarrage et arrêt manuels {#manual-start-and-end-pattern}
</div>
...
## Comment les données apparaissent dans l’interface Weave {#how-data-appears-in-the-weave-ui}
