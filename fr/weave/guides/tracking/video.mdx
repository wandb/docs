...
## Prérequis d’utilisation {#usage-prerequisites}
...
## Types de vidéos pris en charge {#supported-video-types}
...
### Téléversement direct de clips sous forme de fichiers {#direct-upload-of-file-based-clips}
...
### Prise en charge des clips en mémoire {#in-memory-clip-support}
...
## Exemple : tracer une fonction vidéo {#example-trace-a-video-function}
