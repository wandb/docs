...
<Tabs>
  <Tab title="Python">
    ...
    Notez que Weave applique les taux d’échantillonnage uniquement aux appels racines. Si un Op a un taux d’échantillonnage, mais qu’il est d’abord appelé par un autre Op, ce taux d’échantillonnage est ignoré.
