...
## Personnaliser les noms d’affichage {#customize-display-names}
...
## Appliquer des types et des couleurs {#apply-kinds-and-colors}
...
## Personnaliser les entrées et sorties enregistrées {#customize-logged-inputs-and-outputs}
...
## Contrôler le taux d’échantillonnage {#control-sampling-rate}
...
## Contrôler l’affichage des liens d’appel {#control-call-link-output}
