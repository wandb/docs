...
keywords: ["coût LLM", "coût des jetons", "add_cost", "query_costs", "purge_costs"]
---
...
## Utiliser le suivi automatique des coûts {#use-automatic-cost-tracking}
...
## Ajout d’un coût personnalisé {#add-a-custom-cost}
...
### Interroger les coûts personnalisés {#query-custom-costs}
...
### Purger un coût personnalisé {#purge-a-custom-cost}
...
### Calcul des coûts personnalisés d’un projet {#calculate-custom-costs-for-a-project}
...
### Configurer un modèle personnalisé avec des coûts personnalisés {#set-up-a-custom-model-with-custom-costs}
