...
## Publier un objet {#publish-an-object}
...
## Récupérer un objet {#get-an-object-back}
...
## Supprimer un objet {#delete-an-object}
...
## Construire des réf. d&#39;objet {#construct-object-refs}
...
## Organiser les versions d’objets avec des tags et des alias {#organize-object-versions-with-tags-and-aliases}
