...
### Utiliser le panneau des détails de l’appel {#use-the-call-details-panel}
...
### Utilisez les icônes de feedback {#use-the-feedback-icons}
...
## Fournir des feedbacks via le SDK {#provide-feedback-through-the-sdk}
...
### Interroger le feedback d’un projet {#query-a-projects-feedback}
...
### Ajouter du feedback à un Appel {#add-feedback-to-a-call}
...
#### Récupérer l’UUID de l’Appel {#retrieve-the-call-uuid}
...
##### Lors de l’exécution de l’Appel {#during-call-execution}
...
##### Après l’exécution de l’Appel {#after-call-execution}
...
### Supprimer le feedback d’un Appel {#delete-feedback-from-a-call}
...
### Créer un évaluateur d’annotation humaine dans l’interface utilisateur {#create-a-human-annotation-scorer-in-the-ui}
...
### Utiliser l’évaluateur d’annotation humaine dans l’interface utilisateur {#use-the-human-annotation-scorer-in-the-ui}
...
### Créer un évaluateur d’annotation humaine à l’aide de l’API {#create-a-human-annotation-scorer-using-the-api}
...
### Modifier un évaluateur d’annotation humaine via l’API {#modify-a-human-annotation-scorer-using-the-api}
...
### Utiliser un évaluateur d’annotation humaine avec l’API {#use-a-human-annotation-scorer-using-the-api}
