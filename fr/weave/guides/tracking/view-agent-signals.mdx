...
keywords: ["signaux", "surveillance des agents", "scorers", "scores", "tags"]
---
...
Pour évaluer les tours de conversation à l’aide d’un point de terminaison HTTP que vous hébergez plutôt qu’avec un juge LLM, consultez [Évaluer les tours de conversation des agents avec un scorer distant](/fr/weave/guides/tracking/remote-scorer-signals).
...
<div id="signals-table">
  ## Tableau des signaux {#signals-table}
</div>
...
## Comment Weave normalise les scores {#how-weave-normalizes-scores}

Avant de stocker le résultat d&#39;un signal, Weave normalise les tags, les scores et les justifications renvoyés par le scorer :

* Les tags sont convertis en minuscules. Les caractères autres que `0-9`, `a-z`, `A-Z`, l&#39;espace et `. , ; - & ! @ # $ % ?` sont supprimés. Toute suite d&#39;espaces, de caractères de soulignement et de tirets est remplacée par un seul tiret.
* Au maximum 10 tags sont conservés par résultat. Les tags en double sont supprimés.
* Les mêmes caractères sont supprimés des justifications, qui sont ensuite tronquées à 256 caractères.
* Si un tag dépasse 36 caractères ou si un résultat comporte plus d&#39;un score, le résultat est rejeté dans son intégralité et Weave n&#39;écrit aucun feedback pour celui-ci.

Ces règles s&#39;appliquent à tous les signaux, que le résultat provienne d&#39;un juge LLM ou d&#39;un [scorer distant](/fr/weave/guides/tracking/remote-scorer-signals).

<div id="create-a-new-signal">
  ## Créer un nouveau signal {#create-a-new-signal}
</div>
...
<div id="preset-signals">
  ### Signaux prédéfinis {#preset-signals}
</div>
...
<div id="tags-presets">
  #### Préréglages de tags {#tags-presets}
</div>
...
<div id="ratings-presets">
  #### Préréglages de score {#ratings-presets}
</div>
...
### Signals personnalisés {#custom-signals}
...
<div id="manage-and-edit-signals">
  ## Gérer et modifier les signaux {#manage-and-edit-signals}
</div>
...
<div id="troubleshoot-signals">
  ## Résoudre les problèmes liés aux signaux {#troubleshoot-signals}
</div>
