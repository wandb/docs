---
title: "Référence du schéma de Appel"
description: "Référence sur la structure et les propriétés de l'objet Appel"
keywords: ["CallSchema", "synthèse", "trace", "latency_ms", "utilisation"]
---
...
## Propriétés de l’Appel {#call-properties}
...
## Utiliser la synthèse d’un Appel {#use-call-summary}
...
### Ajouter des données pendant un Appel {#write-during-a-call}
...
### Lire les données de synthèse {#read-summary-data}
