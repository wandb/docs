...
<div id="sub-agent-data-model">
  ## Modèle de données du sous-agent {#sub-agent-data-model}
</div>
...
<div id="trace-a-single-sub-agent">
  ## Tracer un seul sous-agent {#trace-a-single-sub-agent}
</div>
...
<div id="trace-multiple-sub-agents">
  ## Tracer plusieurs sous-agents {#trace-multiple-sub-agents}
</div>
...
<div id="trace-nested-sub-agents">
  ## Tracer des sous-agents imbriqués {#trace-nested-sub-agents}
</div>
