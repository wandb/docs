...
keywords: ["fonctions générateur", "générateurs asynchrones", "traces en streaming", "accumulateur", "weave.op"]
---
...
## Consommer des générateurs {#consume-generators}
...
## Accumuler les valeurs produites par `yield` dans une seule trace {#accumulate-yielded-values-into-a-single-trace}
