...
## Définir des attributs sur un span {#set-attributes-on-a-span}
...
## Définir des attributs sur chaque span d’une conversation {#set-attributes-on-every-span-in-a-conversation}
...
## Quand vous pouvez définir des attributs {#when-you-can-set-attributes}
...
## Afficher et filtrer les attributs dans l’interface utilisateur {#view-and-filter-attributes-in-the-ui}
