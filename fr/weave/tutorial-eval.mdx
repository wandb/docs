...
<div id="import-the-necessary-libraries-and-functions">
  ## Importez les bibliothèques et les fonctions nécessaires {#import-the-necessary-libraries-and-functions}
</div>
...
<div id="define-custom-scoring-functions">
  ## Définir des fonctions de score personnalisées {#define-custom-scoring-functions}
</div>
...
<div id="use-a-built-in-scorer-and-run-the-evaluation">
  ## Utiliser un évaluateur intégré et exécuter l’évaluation {#use-a-built-in-scorer-and-run-the-evaluation}
</div>
...
<div id="view-your-evaluation-results">
  ## Consultez les résultats de votre évaluation {#view-your-evaluation-results}
</div>
...
<div id="learn-more-about-weave-evaluations">
  ## En savoir plus sur les évaluations Weave {#learn-more-about-weave-evaluations}
</div>
