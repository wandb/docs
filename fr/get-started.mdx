...
## Comparaison des produits {#product-comparison}
...
<Columns cols={2}>
  ...
  <Card title="Cours W&B 101" href="https://www.youtube.com/watch?v=UHYU2OZKGJI&list=PLD80i8An1OEEgxMpH-SOdBCjWpT5Io5rJ">
    Un cours vidéo axé sur le suivi des expériences, avec des quiz pour valider votre compréhension.
  </Card>

  <Card title="Tutoriels YouTube" href="https://www.youtube.com/@WeightsBiases/courses">
    Découvrez comment utiliser W&amp;B Models pour suivre les expériences, gérer les artifacts et optimiser les modèles grâce à des tutoriels pratiques.
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="Playlist YouTube" href="https://www.youtube.com/playlist?list=PLD80i8An1OEFWB5JYk1bnWVPhLRzvNkVx">
    Découvrez comment utiliser Weave pour tracer, évaluer et déboguer des applications LLM, et comment vous en servir pour créer des applications LLM prêtes pour la production.
  </Card>
</Columns>
