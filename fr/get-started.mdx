...
| **[Serverless RL](#serverless-rl)**               | Fine-tuning de modèles                       | Créer et déployer des LoRAs et des adaptations de modèles personnalisées à l’aide de l’apprentissage par renforcement                       |
...
<Columns cols={2}>
  ...
  <Card title="Utiliser vos modèles entraînés" href="/fr/serverless-rl/use-trained-models">
