...
keywords: ["wandb-artifact", "point de terminaison de modèle", "SDK d’OpenAI", "cURL", "étape du point de contrôle"]
---
...
Une fois votre point de terminaison obtenu, vous pouvez l’intégrer à vos flux de travail d’inférence habituels. Les exemples suivants montrent comment effectuer des requêtes d’inférence vers votre modèle déjà entraîné à l’aide d’une requête cURL ou du [SDK d’OpenAI pour Python](https://github.com/openai/openai-python). Choisissez l’exemple correspondant à votre environnement.
