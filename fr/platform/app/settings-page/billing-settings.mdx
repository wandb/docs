...
Pour configurer les alertes d’utilisation pour votre organisation, vous devez être **Administrateur de l’organisation** ou **administrateur de la facturation** :
...
5. Activez ou désactivez l’**alerte d’utilisation à 85 %** ou l’**alerte d’utilisation à 100 %** pour cette catégorie. <Warning>Si vous désactivez les deux alertes d’utilisation, aucune alerte n’est envoyée pour cette catégorie d’utilisation.</Warning>
...
4. Pour ajouter une alerte, cliquez sur **Add alert**.
   a. Saisissez un seuil en USD.
   a. Cliquez sur **Create alert**.
