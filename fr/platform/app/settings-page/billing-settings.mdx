...
## Détails du forfait {#plan-details}
...
## Utilisation du plan {#plan-usage}
...
### Voir l’utilisation au fil du temps {#view-usage-over-time}
...
#### Cycle actuel comparé aux vues historiques {#current-cycle-compared-to-historical-views}
...
#### Barre de statistiques et lignes de seuil {#stats-bar-and-threshold-lines}
...
<a id="usage-alerts">
  ### Afficher et gérer les alertes d’utilisation {#view-and-manage-usage-alerts}
</a>
...
<a id="spending-alerts">
  ### Afficher et gérer les alertes de dépenses {#view-and-manage-spending-alerts}
</a>
...
## Administrateur de la facturation {#billing-admin}
