---
description: Gérez les membres, l’avatar, les alertes et les paramètres de confidentialité d’une équipe dans la page
  Team Settings.
title: Gérer les paramètres de l’équipe
keywords: ["confidentialité de l’équipe", "alertes de l’équipe", "avatar de l’équipe", "administrateur de l’équipe"]
---
...
Pour les étapes de navigation et le contrôle **Disable default code saving** au niveau de l’organisation, voir [Configurer les paramètres de confidentialité](/fr/platform/hosting/privacy-settings).
