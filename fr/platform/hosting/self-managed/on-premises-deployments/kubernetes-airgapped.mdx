...
2. Transférez les fichiers de chart `.tgz` vers votre environnement isolé du réseau et importez-les dans votre dépôt Helm interne conformément aux procédures de votre dépôt.
...
<Note>
  Contactez [l’assistance W&amp;B](mailto:support@wandb.com) ou votre ingénieur d’assistance W&amp;B attitré pour obtenir des exemples complets de configuration d’OpenShift adaptés à vos exigences de sécurité.
</Note>
