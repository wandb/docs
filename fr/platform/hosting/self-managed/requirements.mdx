...
## Exigences relatives aux versions logicielles {#software-version-requirements}
...
### Paramètres de configuration MySQL {#mysql-configuration-parameters}
...
### Création de la base de données {#database-creation}
...
W&amp;B Weave dans les déploiements autogérés utilise ClickHouse. ClickHouse n&#39;est pas requis pour chaque installation autogérée.
...
### Configurer W&amp;B pour utiliser votre bucket {#configure-wb-to-use-your-bucket}
...
### Équilibreur de charge et ingress {#load-balancer-and-ingress}
