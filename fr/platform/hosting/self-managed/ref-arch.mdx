...
keywords: ["dimensionnement de l’infrastructure", "exigences MySQL", "configuration de Redis", "architecture de production", "spécifications matérielles"]
---
...
## Exigences d’infrastructure {#infrastructure-requirements}
...
#### Topologie MySQL {#mysql-topology}
...
#### Création de la base de données MySQL {#mysql-database-creation}
...
#### Paramètres de configuration de MySQL {#mysql-configuration-parameters}
...
#### Exigences du contrôleur d’ingress {#ingress-controller-requirements}
...
#### Routage du service W&amp;B {#wb-service-routing}
...
#### Exemple de configuration d’ingress {#example-ingress-configuration}
...
### Architectures de CPU prises en charge {#supported-cpu-architectures}

W&amp;B fonctionne sur les architectures 64 bits d’Intel et d’AMD. ARM n’est pas pris en charge.

## Méthode de déploiement {#deployment-method}
...
### opérateur Kubernetes W&amp;B avec Helm {#wb-kubernetes-operator-with-helm}
...
### Provisionnement de l’infrastructure {#infrastructure-provisioning}
...
### Dimensionnement Kubernetes {#kubernetes-sizing}
...
### Dimensionnement MySQL {#mysql-sizing}
...
## Recommandations d’instances par fournisseur de cloud {#cloud-provider-instance-recommendations}
