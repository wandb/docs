...
## Schéma du journal d’audit {#audit-log-schema}
...
### Informations personnelles identifiables (PII) {#personally-identifiable-information-pii}
...
## Récupérer les journaux d’audit {#fetch-audit-logs}
...
### Exclure les informations personnelles (PII) lors de la récupération des journaux d’audit <a id="exclude-pii" /> {#exclude-pii-when-fetching-audit-logs}
...
### Utiliser l’authentification de base {#use-basic-authentication}
