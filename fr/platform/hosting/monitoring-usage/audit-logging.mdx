...
1. Déterminez l’API endpoint approprié pour votre instance :
   ...
   * [Cloud mutualisé (Enterprise requis)](/fr/platform/hosting/hosting-options/multi_tenant_cloud): `https://api.wandb.ai/audit_logs`
   ...
   Dans les étapes suivantes, remplacez `<API-endpoint>` par votre API endpoint.
...
4. Exécutez une requête HTTP `GET` sur l’API endpoint complète à l’aide d’un navigateur web ou d’un outil comme [Postman](https://www.postman.com/downloads/), [HTTPie](https://httpie.io/), ou cURL.
