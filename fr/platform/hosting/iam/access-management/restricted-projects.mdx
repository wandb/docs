...
## Portées de visibilité {#visibility-scopes}
...
<div id="set-visibility-scope-on-a-new-or-existing-project">
  ### Définir la portée de visibilité d’un projet nouveau ou existant {#set-visibility-scope-on-a-new-or-existing-project}
</div>
...
#### Définir la portée de visibilité lorsque vous créez un projet {#set-visibility-scope-when-you-create-a-project}
...
#### Modifier la portée de visibilité d’un projet existant {#edit-visibility-scope-of-an-existing-project}
...
<div id="other-key-things-to-note-for-restricted-scope">
  ### Autres points clés à noter concernant la portée restreinte {#other-key-things-to-note-for-restricted-scope}
</div>
...
<div id="project-level-roles">
  ## Rôles au niveau du projet {#project-level-roles}
</div>
...
### Attribuer un rôle au niveau du projet à un utilisateur {#assign-a-project-level-role-to-a-user}
...
### Autres points importants à noter concernant les rôles au niveau du projet {#other-key-things-to-note-for-project-level-roles}
