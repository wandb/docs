...
| ------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Models  | Paiement à la licence | Le coût total de votre abonnement dépend du nombre de licences Models payantes dont vous disposez et du volume d’utilisation accumulé. Vous pouvez attribuer à chaque utilisateur l’un des trois types de licence disponibles : Full, Viewer ou No-Access. |
...
<Tabs>
  <Tab title="Cloud mutualisé">
    ...
    5. Facultatif : ajoutez l’utilisateur à une équipe à l’aide du menu déroulant **Choose teams**.
    6. Dans le menu déroulant **Select role**, sélectionnez le rôle à attribuer à l’utilisateur. Vous pourrez modifier le rôle de l’utilisateur plus tard. Voir le tableau indiqué dans [Attribuer un rôle](#assign-or-update-a-team-members-role) pour plus d’informations sur les rôles possibles.
  ...
  <Tab title="Cloud dédié ou Autogéré">
    ...
    4. Sélectionnez, dans le menu déroulant **Role**, le rôle à attribuer à l’utilisateur. Vous pourrez modifier le rôle de l’utilisateur plus tard. Voir le tableau indiqué dans [Attribuer un rôle](#assign-or-update-a-team-members-role) pour plus d’informations sur les rôles possibles.
    5. Pour que W&amp;B envoie un lien d’invitation à l’adresse e-mail de l’utilisateur via un serveur de messagerie tiers, cochez la case **Send invite email to user**.
...
| Rôle                                                | Descriptions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Admin                                               | Un administrateur d’instance qui peut ajouter ou supprimer d’autres utilisateurs de l’organisation, modifier les rôles des utilisateurs, gérer les rôles personnalisés, ajouter des équipes, etc. W&amp;B recommande d’avoir plus d’un administrateur au cas où l’un d’eux ne serait pas disponible.                                                                                                                                                                                                                      |
...
| Viewer (fonctionnalité Enterprise uniquement)       | Un utilisateur en lecture seule de votre organisation, invité par un administrateur d’instance. Un viewer dispose uniquement d’un accès en lecture à l’organisation et aux équipes dont il est membre.                                                                                                                                                                                                                                                                                                                    |
| Custom Roles (fonctionnalité Enterprise uniquement) | Les rôles personnalisés permettent aux administrateurs de l’organisation de créer de nouveaux rôles en héritant des rôles de base lecture seule ou membre, puis en ajoutant des autorisations supplémentaires pour obtenir un contrôle d’accès granulaire. Les administrateurs d’équipe peuvent ensuite attribuer n’importe lequel de ces rôles personnalisés aux utilisateurs de leurs équipes respectives. Pour plus d&#39;informations, voir [Ajouter et gérer des rôles personnalisés](#add-and-manage-custom-roles). |
...
Bien que le rôle au niveau de l&#39;organisation contrôle les actions administratives, le type de licence contrôle ce qu&#39;un utilisateur peut faire dans Models et Weave. Utilisez cette procédure lorsque vous devez modifier les autorisations d&#39;un utilisateur au niveau du produit indépendamment de son rôle dans l&#39;organisation.
...
Le type de licence Models et le type d&#39;accès Weave sont définis au niveau de l&#39;organisation, puis hérités par l&#39;équipe. Pour modifier le type de licence d&#39;un utilisateur, accédez aux paramètres de l&#39;organisation et suivez les étapes suivantes :
...
Les rôles personnalisés vous permettent d’adapter les autorisations au-delà des rôles intégrés lorsque les rôles standard View-Only, Member et Admin ne correspondent pas aux exigences d’accès de votre organisation. Utilisez des rôles personnalisés pour accorder des autorisations spécifiques tout en vous appuyant sur un rôle de base familier.
