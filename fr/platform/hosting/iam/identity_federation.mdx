...
<Note>Dans ce document, les termes `fournisseur d’identité` et `émetteur JWT` sont utilisés de manière interchangeable. Ils désignent tous deux une seule et même chose dans le contexte de cette fonctionnalité.</Note>
...
* En règle générale, le claim `aud` du JWT doit être égal au nom de l&#39;organisation W&amp;B qui héberge le projet auquel vous accédez dans le cadre de votre flux de travail d&#39;IA.
