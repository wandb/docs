...
## Mettre à jour avec Terraform {#update-with-terraform}
...
## Mise à jour avec Helm {#update-with-helm}
...
### Mettre à jour W&amp;B avec le fichier de spécification {#update-wb-with-spec}
...
### Mettre à jour directement la licence et la version {#update-license-and-version-directly}
...
## Mettre à jour via l’interface d’administration {#update-with-admin-ui}
