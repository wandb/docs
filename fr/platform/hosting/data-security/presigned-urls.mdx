...
## Contrôle d’accès au niveau de l’équipe {#team-level-access-control}
...
## Restriction réseau {#network-restriction}
...
## Déterminer l’utilisateur ayant demandé une URL pré-signée {#determine-the-user-that-requested-a-pre-signed-url}
...
### Mettre en corrélation l’activité Azure Blob Storage avec un utilisateur {#correlate-azure-blob-storage-activity-with-a-user}
