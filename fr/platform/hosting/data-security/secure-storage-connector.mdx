  ...
  <Tab title="Azure">
    ...
    **BYOB au niveau de l’instance**:
    ...
    1. Provisionnez le conteneur Azure Blob Storage.
       ...
       1. Créez un conteneur avec le nom de votre choix. Vous pouvez également créer un dossier que vous configururez comme sous-chemin pour stocker tous les fichiers W&amp;B.
