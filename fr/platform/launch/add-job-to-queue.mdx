...
keywords: ["mettre un job en file d'attente", "soumettre un job", "CLI Launch", "file d'attente prioritaire", "priorité du job"]
---
...
## Ajouter des jobs à votre file d’attente {#add-jobs-to-your-queue}
