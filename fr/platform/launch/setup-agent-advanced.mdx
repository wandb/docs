...
# Configuration avancée de l’agent {#advanced-agent-setup}
...
## Téléverser vers un registre de conteneurs {#push-to-a-container-registry}
...
## Autorisations de l’agent {#agent-permissions}
...
### Autorisations des registres cloud {#cloud-registry-permissions}
...
### Autorisations de stockage pour Kaniko {#storage-permissions-for-kaniko}
...
## Personnaliser le build Kaniko {#customize-the-kaniko-build}
...
## Déployer l’agent Launch sur CoreWeave {#deploy-launch-agent-into-coreweave}
