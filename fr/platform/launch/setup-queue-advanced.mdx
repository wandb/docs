...
keywords: ["modèle de file d'attente", "garde-fous de ressources", "macros dynamiques", "ressources min/max"]
---
...
## Configurer les modèles de configuration de file d&#39;attente {#set-up-queue-config-templates}
...
### Configurer un modèle de file d’attente {#configure-queue-template}
...
## Configurer dynamiquement les jobs Launch {#dynamically-configure-launch-jobs}
...
## Utilisez l’agent Launch pour créer des images qui s’exécutent sur des accélérateurs ou des GPU {#use-the-launch-agent-to-build-images-that-execute-on-accelerators-or-gpus}
...
### Utiliser des GPU avec TensorFlow {#use-gpus-with-tensorflow}
