...
keywords: ["ordonnanceur de balayage", "optimisation d’hyperparamètres", "balayage distribué", "automatisation des balayages"]
---
...
## Créer un balayage avec l’ordonnanceur standard de W&amp;B {#create-a-sweep-with-a-wb-standard-scheduler}
...
## Créer un ordonnanceur de balayage personnalisé {#create-a-custom-sweep-scheduler}
...
## Reprendre des balayages dans Launch {#resume-sweeps-on-launch}
