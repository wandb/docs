...
keywords: ["wandb job create", "job Git", "job d’artefact de code", "job d’image", "modèle de job"]
---
...
### Format des URL distantes {#remote-url-format}
...
## Jobs d’artefact de code {#code-artifact-jobs}
...
## Création automatique de jobs {#automatic-job-creation}
...
### Noms des jobs Launch {#launch-job-names}
...
### Contexte de build {#build-context}
...
### Fichier `requirements` {#requirements-file}
