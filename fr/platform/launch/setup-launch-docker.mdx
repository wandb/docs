...
description: "Configurez W&B Launch pour exécuter des jobs de ML avec Docker sur une machine locale, à la fois comme environnement d’agent et comme cible de calcul."
keywords: ["file d’attente Docker", "Docker local", "agent Docker", "lancement sur machine locale"]
---
...
## Configurer une file d’attente Docker {#configure-a-docker-queue}
...
## Configurer un agent Launch sur une machine locale {#configure-a-launch-agent-on-a-local-machine}
...
### Principales options de configuration de l&#39;agent {#core-agent-config-options}
...
### Outils de création d’images Docker {#docker-image-builders}
