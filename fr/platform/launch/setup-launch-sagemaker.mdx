...
### Décidez si vous voulez que l’agent Launch crée une image Docker {#decide-if-you-want-the-launch-agent-to-build-a-docker-image}
...
### Configurer les ressources AWS {#set-up-aws-resources}
...
### Créer une stratégie IAM pour l&#39;agent Launch {#create-an-iam-policy-for-the-launch-agent}
...
### Créer un rôle IAM pour l&#39;agent Launch {#create-an-iam-role-for-the-launch-agent}
...
## Configurer la file d’attente Launch pour SageMaker {#configure-the-launch-queue-for-sagemaker}
...
## Configurer l’agent Launch {#set-up-the-launch-agent}
...
### Décidez où exécuter l’agent Launch {#decide-where-to-run-the-launch-agent}
...
### Configurer un agent Launch {#configure-a-launch-agent}
...
## Facultatif : Téléversez l’image Docker de votre job Launch vers Amazon ECR {#optional-push-your-launch-job-docker-image-to-amazon-ecr}
