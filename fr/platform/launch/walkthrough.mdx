...
keywords: ["démarrage rapide Launch", "guide pas à pas Launch", "exemple de wandb launch", "Launch de bout en bout"]
---

## Qu’est-ce que Launch {#what-is-launch}
...
## Créer un job Launch {#create-a-launch-job}
...
## Connecter un agent à la file d&#39;attente {#connect-an-agent-to-the-queue}
...
## Soumettre un job dans la file d&#39;attente {#submit-a-job-to-the-queue}
