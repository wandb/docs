...
Retrouvez les jobs que vous avez créés dans la W&amp;B App, sous l&#39;onglet `Jobs` de l&#39;espace de travail du projet. À partir de là, les jobs peuvent être configurés et envoyés vers une [launch queue](#launch-queue) pour être exécutés sur diverses [ressources cibles](#target-resources).
