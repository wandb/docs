...
keywords: ["glossaire Launch", "concepts Launch", "définition de la file d'attente", "concepts d'agent", "ressource cible"]
---
...
## Environnement de l&#39;agent Launch {#launch-agent-environment}
