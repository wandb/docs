...
keywords: ["entraînement Vertex AI", "CustomJob", "lancement Google Cloud", "lancement GCP", "Artifact Registry"]
---
...
## Configurer une file d&#39;attente pour Vertex AI {#configure-a-queue-for-vertex-ai}
...
## Configurer les autorisations de l&#39;agent {#set-up-agent-permissions}
