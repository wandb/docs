...
### <kbd>méthode de classe</kbd> `from_table` {#classmethod-from_table}
...
### <kbd>propriété</kbd> url {#property-url}
...
### <kbd>méthode</kbd> `disable_share_link` {#method-disable_share_link}
...
### <kbd>méthode</kbd> `enable_share_link` {#method-enable_share_link}
...
### <kbd>méthode</kbd> `get_share_url` {#method-get_share_url}
...
### <kbd>méthode</kbd> `to_html` {#method-to_html}
...
### <kbd>méthode</kbd> `convert_filterexpr_list_to_string` {#method-convert_filterexpr_list_to_string}
...
### <kbd>méthode</kbd> `merge_custom_run_colors_into_run_settings` {#method-merge_custom_run_colors_into_run_settings}
