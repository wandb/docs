...
### <kbd>méthode</kbd> `ensure_baseline_pinned` {#method-ensure_baseline_pinned}
...
### <kbd>méthode</kbd> `validate_and_setup_columns` {#method-validate_and_setup_columns}
...
### <kbd>propriété</kbd> auto_generate_panels {#property-auto_generate_panels}
...
### <kbd>méthode</kbd> `save_as_new_view` {#method-save_as_new_view}
