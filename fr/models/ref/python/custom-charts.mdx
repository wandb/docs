...
## Fonctions de graphique disponibles {#available-chart-functions}
...
### Suivi de l’entraînement {#training-monitoring}
...
### Journaliser une matrice de confusion {#log-a-confusion-matrix}
...
### Créer un nuage de points pour l’analyse des variables {#build-a-scatter-plot-for-feature-analysis}
