...
## <Badge color="yellow" size="lg" shape="rounded">Classe</Badge> wandb.Molecule {#class-wandbmolecule}
...
### <Badge color="blue" size="lg" shape="rounded">méthode</Badge> Molecule.from_rdkit() {#method-moleculefrom_rdkit}
...
### <Badge color="blue" size="lg" shape="rounded">méthode</Badge> Molecule.from_smiles() {#method-moleculefrom_smiles}
