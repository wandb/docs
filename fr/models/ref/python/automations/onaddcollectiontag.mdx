...
## <kbd>classe</kbd> wandb.automations.OnAddCollectionTag
...
Un nouveau tag est attribué à une collection d’artefacts.
...
* `filter`: Condition(s) supplémentaire(s), le cas échéant, nécessaire(s) pour que cet événement se déclenche.