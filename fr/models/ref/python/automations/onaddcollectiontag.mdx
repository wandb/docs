...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L324" />

<div id="class-wandbautomationsonaddcollectiontag">
  ## <Badge color="yellow" size="lg" shape="rounded">Classe</Badge> wandb.automations.OnAddCollectionTag
</div>
...
<ResponseField name="filter" type="Annotated">
  Condition(s) supplémentaire(s), le cas échéant, nécessaire(s) pour que cet événement se déclenche.
</ResponseField>