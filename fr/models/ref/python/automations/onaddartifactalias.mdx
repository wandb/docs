...
n&#39;importe quel artefact de la collection &quot;my-collection&quot; :
...
* `scope` (Union[&#95;ArtifactSequenceScope, &#95;ArtifactPortfolioScope, ProjectScope]) : La portée de l’événement.
* `filter` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]) : Conditions supplémentaires, le cas échéant, qui doivent être remplies pour que cet événement se déclenche.
