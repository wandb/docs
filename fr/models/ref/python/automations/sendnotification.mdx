...
## <Badge color="yellow" size="lg" shape="rounded">Classe</Badge> wandb.automations.SendNotification {#class-wandbautomationssendnotification}
...
### <Badge color="blue" size="lg" shape="rounded">méthode</Badge> SendNotification.from_integration() {#method-sendnotificationfrom_integration}
