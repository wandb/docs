...
## <kbd>classe</kbd> wandb.automations.OnRemoveCollectionTag
...
Un tag est supprimé d’une collection d’artefacts.
...
* `filter`: Conditions supplémentaires, le cas échéant, requises pour déclencher cet événement.