...
<div id="class-wandbautomationsonremovecollectiontag">
  ## <Badge color="yellow" size="lg" shape="rounded">Classe</Badge> wandb.automations.OnRemoveCollectionTag
</div>
...
<ResponseField name="filter" type="Annotated">
  Conditions supplémentaires, le cas échéant, requises pour déclencher cet événement.
</ResponseField>