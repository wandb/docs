...
## <kbd>classe</kbd> wandb.automations.OnLinkArtifact
...
Un nouvel artefact est lié à une collection.
...
Définissez un événement qui se déclenche lorsqu’un artefact est associé à la
