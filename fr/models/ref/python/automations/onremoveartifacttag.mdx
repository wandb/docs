...
<GitHubLink compact url="https://github.com/wandb/wandb/blob/main/wandb/automations/events.py#L318" />

<div id="class-wandbautomationsonremoveartifacttag">
  ## <Badge color="yellow" size="lg" shape="rounded">Classe</Badge> wandb.automations.OnRemoveArtifactTag
</div>
