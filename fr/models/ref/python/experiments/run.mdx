...
<GitHubLink url="https://github.com/wandb/wandb/blob/main/wandb/sdk/wandb_run.py#L406" />
...
Le répertoire dans lequel sont enregistrés les fichiers d’un run.

Il s’agit des fichiers enregistrés avec `run.save()`, y compris ceux créés automatiquement pour certains types de données transmis à `run.log()`. Pour le répertoire contenant toutes les données d’un run, voir `run.sync_dir`.
...
Le répertoire contenant toutes les données d’un run.

Vous pouvez le transmettre à `wandb sync` pour téléverser ou téléverser à nouveau le run.
...
* `summary`: Spécifie les métriques agrégées ajoutées à summary. Les agrégations prises en charge incluent &quot;min&quot;, &quot;max&quot;, &quot;mean&quot;, &quot;last&quot;, &quot;first&quot;, &quot;copy&quot; et &quot;none&quot;. &quot;none&quot; empêche la génération d&#39;un summary. &quot;copy&quot; est obsolète et ne doit pas être utilisé.
