...
L’extrait de code précédent enregistre la perte et la précision dans l’historique du run, et met à jour les valeurs de la synthèse pour ces métriques.
...
**Exemples :**
Pour davantage d’exemples, plus détaillés, voir [nos guides sur la journalisation](https://docs.wandb.com/guides/track/log).
