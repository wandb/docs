...
Les alias sont des références modifiables que vous pouvez utiliser par programmation.
Modifiez l&#39;alias d&#39;un artifact dans l&#39;interface de l’application W&amp;B ou par programmation.
Voir [Create new artifact versions](https://docs.wandb.ai/models/artifacts/create-a-new-artifact-version)
pour plus d&#39;informations.

### <kbd>propriété</kbd> collection
...
Le digest correspond à la somme de contrôle du contenu de l&#39;artifact. Si un artifact a le
même digest que la version `latest` actuelle, alors `log_artifact` est sans effet.

### <kbd>propriété</kbd> digest_algorithm

L’algorithme de digest utilisé pour calculer le digest de l’artifact.
...
### <kbd>propriété</kbd> file_count

Le nombre de fichiers (références comprises).

### <kbd>propriété</kbd> history_step
...
### <kbd>propriété</kbd> is_link

Indicateur booléen indiquant si l&#39;artifact est un artifact de lien.

True : l&#39;artifact est un artifact de lien vers un artifact source.
False : l&#39;artifact est un artifact source.

### <kbd>propriété</kbd> linked_artifacts
...
### <kbd>propriété</kbd> linked_at

Date et heure auxquelles cet artifact a été lié à sa collection actuelle.

Valide uniquement pour les artifacts liés ; renvoie `None` sinon.

### <kbd>propriété</kbd> manifest
...
### <kbd>propriété</kbd> qualified_name
...
### <kbd>propriété</kbd> source_artifact

Renvoie l&#39;artifact source, c&#39;est-à-dire l&#39;artifact original enregistré.

Si cet artifact est un artifact source (`artifact.is_link == False`),
il se renvoie lui-même.

### <kbd>propriété</kbd> source_collection
...
### <kbd>propriété</kbd> source_entity

Le nom de l’entité de l’Artifact source.

### <kbd>propriété</kbd> source_name
...
### <kbd>propriété</kbd> use_as

Obsolète.

### <kbd>propriété</kbd> version

La version de l&#39;artifact.

Une chaîne au format `v{number}`.
S&#39;il s&#39;agit d&#39;un artifact de type lien, la version proviendra de la collection liée.
...
- `policy`: Par défaut, défini sur « mutable ». S&#39;il est défini sur « mutable », créez une copie temporaire du fichier afin d&#39;éviter toute corruption lors du téléversement. S&#39;il est défini sur « immutable », désactivez la protection et comptez sur l&#39;utilisateur pour ne pas supprimer ni modifier le fichier.
