...
Voir la [structure de configuration d&#39;un balayage](https://docs.wandb.ai/models/sweeps/define-sweep-configuration) pour savoir comment définir votre balayage.
