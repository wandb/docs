...
Initialisez un balayage d&#39;hyperparamètres.

Recherchez les hyperparamètres qui optimisent une fonction de coût d&#39;un modèle d&#39;apprentissage automatique en testant différentes combinaisons.

Notez bien l&#39;identifiant unique `sweep_id` renvoyé. Lors d&#39;une étape ultérieure, fournissez le `sweep_id` à un agent de balayage.
