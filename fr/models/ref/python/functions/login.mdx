...
* `verify`: Vérifie les identifiants auprès du serveur W&amp;B et lève une `AuthenticationError` en cas d&#39;échec. Cela fonctionne aussi bien pour les clés API que pour les jetons d’identité.
