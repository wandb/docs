...
### <kbd>propriété</kbd> internal_id

L’`internalId` GraphQL du projet associé à ce registre, s’il a été récupéré.

Il s’agit d’un ID global encodé en base64. Une fois décodé, il se présente ainsi :
...
* `order`: Chaîne facultative permettant de spécifier l&#39;ordre des résultats. L&#39;ordre peut être `created_at`, `artifact_size` ou `linked_at`. Préfixé par &#39;+&#39;, le tri est croissant (par défaut). Préfixé par &#39;-&#39;, le tri est décroissant.
