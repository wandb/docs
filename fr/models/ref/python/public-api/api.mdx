...
* `access` : Niveau d’accès au graphique : - &quot;private&quot; : Le graphique est accessible uniquement à l’entité qui l’a créé - &quot;public&quot; : Le graphique est accessible publiquement
...
* `include_sweeps` : (bool) Indique s’il faut inclure les runs de Sweeps dans les résultats.
