...
5. Analysez les runs, visualisez les prédictions des modèles et consultez les artifacts dans le [tableau de bord](/fr/models/track/workspaces) de votre projet.
