...
## Créer de nouvelles versions d’artefact à partir de zéro {#create-new-artifact-versions-from-scratch}
...
### Runs distribués {#distributed-runs}
...
## Créer une nouvelle version d’artefact à partir d’une version existante {#create-a-new-artifact-version-from-an-existing-version}
...
### Runs distribués {#distributed-runs-2}
