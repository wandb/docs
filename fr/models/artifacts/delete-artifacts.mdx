...
## Flux de travail de garbage collection des artefacts {#artifact-garbage-collection-workflow}
...
## Supprimer une version d&#39;artefact {#delete-an-artifact-version}
...
## Supprimer plusieurs versions d&#39;artefact {#delete-multiple-artifact-versions}
...
## Supprimer plusieurs versions d’artefact avec un alias spécifique {#delete-multiple-artifact-versions-with-a-specific-alias}
...
## Supprimer une collection d&#39;artefact {#delete-an-artifact-collection}
...
## Alias protégés et autorisations de suppression {#protected-aliases-and-deletion-permissions}
...
## Activer le garbage collection selon le mode d’hébergement de W&amp;B {#enable-garbage-collection-based-on-how-wb-is-hosted}
