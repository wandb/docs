...
{/* <Note>
  Les Artifacts dont la TTL est désactivée n’hériteront pas de la TTL d’une collection d'artifacts. Se référer à (## Inherit TTL Policy) pour savoir comment supprimer la TTL d’un artifact et hériter de celle définie au niveau de la collection.
  </Note> */}
...
<Tabs>
  ...
  <Tab title="W&B App">
    ...
    5. Cliquez sur l’onglet Version.
    6. Cliquez sur l’icône UI à trois points à côté du bouton **Link to registry**.
