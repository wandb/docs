---
description: "Définissez des politiques TTL sur les Artifacts W&B afin de planifier leur suppression automatique et de gérer la consommation de stockage."
...
Regardez le tutoriel vidéo [Managing data retention with Artifacts TTL](https://www.youtube.com/watch?v=hQ9J6BoVmnc) pour apprendre à gérer la rétention des données avec Artifacts TTL dans W&amp;B App.
...
## Artifacts générés automatiquement {#auto-generated-artifacts}
...
## Définir qui peut modifier et définir des politiques TTL {#define-who-can-edit-and-set-ttl-policies}
...
## Créer une politique TTL {#create-a-ttl-policy}
...
### Définir une politique TTL lors de la création d’un artifact {#set-a-ttl-policy-when-you-create-an-artifact}
...
### Définir ou modifier une politique TTL après la création d’un artifact {#set-or-edit-a-ttl-policy-after-you-create-an-artifact}
...
### Définir des politiques TTL par défaut pour une équipe {#set-default-ttl-policies-for-a-team}
...
### Définir une politique TTL en dehors d’un run {#set-a-ttl-policy-outside-of-a-run}
...
## Désactiver une politique TTL {#deactivate-a-ttl-policy}
...
## Consulter les politiques TTL {#view-ttl-policies}
...
## Politiques TTL pour les versions d&#39;artifacts liées {#ttl-policies-for-linked-artifact-versions}

W&amp;B désactive les politiques TTL des versions d&#39;artifacts liées afin d&#39;éviter l&#39;expiration des artifacts utilisés dans les flux de travail de production.

Lorsque vous liez une version d&#39;artifact à une collection du Registry, W&amp;B désactive sa politique TTL et définit sa valeur TTL sur `None`. Si vous dissociez ultérieurement la version d&#39;artifact, W&amp;B ne restaure ni la politique TTL précédente ni sa durée. Définissez une nouvelle politique TTL après l&#39;avoir dissociée si la version d&#39;artifact en nécessite toujours une.