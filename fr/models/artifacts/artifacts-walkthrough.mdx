...
## 1. Connectez-vous à W&amp;B {#1-log-into-wb}
...
## 2. Initialiser un run {#2-initialize-a-run}
...
## 3. Créer un objet artifact {#3-create-an-artifact-object}
...
## 4. Ajoutez le jeu de données à l&#39;artifact {#4-add-the-dataset-to-the-artifact}
...
## 5. Journaliser le jeu de données {#5-log-the-dataset}
...
## 6. Télécharger et utiliser l&#39;artifact {#6-download-and-use-the-artifact}
