...
## Ajouter un tag à une collection {#add-a-tag-to-a-collection}
...
<div id="update-tags-that-belong-to-a-collection">
  ## Mettre à jour les tags appartenant à une collection {#update-tags-that-belong-to-a-collection}
</div>
...
## Afficher les tags d’une collection {#view-tags-that-belong-to-a-collection}
...
<div id="remove-a-tag-from-a-collection">
  ## Supprimer un tag d’une collection {#remove-a-tag-from-a-collection}
</div>
...
## Ajouter un tag à une version d&#39;artifact {#add-a-tag-to-an-artifact-version}
...
<div id="update-tags-that-belong-to-an-artifact-version">
  ## Mettre à jour les tags d&#39;une version d&#39;artifact {#update-tags-that-belong-to-an-artifact-version}
</div>
...
<div id="view-tags-that-belong-to-an-artifact-version">
  ## Afficher les tags associés à une version d&#39;artifact {#view-tags-that-belong-to-an-artifact-version}
</div>
...
## Supprimer un tag d’une version d’artifact {#remove-a-tag-from-an-artifact-version}
...
{/* ## Rechercher des tags existants
  ...
  Utilisez l’interface de l’application W&B pour rechercher des tags existants dans les collections et les versions d’artifact :
...
<div id="find-artifact-versions-with-a-specific-tag">
  ## Trouver des versions d&#39;artifact avec un tag spécifique {#find-artifact-versions-with-a-specific-tag}
</div>
