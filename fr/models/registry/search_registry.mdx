...
description: "Découvrez comment rechercher des registres, des collections et des versions d'artifact de manière interactive via l'interface utilisateur ou par programmation à l'aide de requêtes."
---

Trouvez des registres, des collections et des versions d&#39;artifact [de manière interactive dans W&amp;B Registry](/fr/models/registry/search_registry#search-for-registry-items) ou par programmation avec le [SDK Python W&amp;B](/fr/models/registry/search_registry#query-registry-items).
...
## Rechercher des éléments du registre {#search-for-registry-items}

Utilisez la [barre de recherche de la page d’accueil du W&amp;B Registry](/fr/models/registry/search_registry#basic-search) pour trouver des collections et des registres par nom. Utilisez la [recherche avancée](/fr/models/registry/search_registry#advanced-search) pour trouver des registres, des collections ou des versions d&#39;artifact selon des attributs spécifiques tels que le nom, le tag, la description, la date de création, etc.

### Recherche de base {#basic-search}

Recherchez des registres et des collections sur la page d’accueil du W&amp;B Registry :

1. Accédez au W&amp;B Registry.
2. Saisissez un terme à rechercher dans la barre de recherche en haut de la page.
3. Appuyez sur Entrée pour lancer la recherche.

### Recherche avancée {#advanced-search}

Utilisez la recherche avancée pour trouver des registres, des collections ou des versions d&#39;artifact. Utilisez des filtres pour rechercher des éléments du registre spécifiques en fonction d&#39;attributs tels que le nom, le tag, la description, la date de création, etc.

1. Accédez à W&amp;B Registry.
2. Cliquez sur **Advanced** en haut de la page d’accueil.
3. Sélectionnez **Registries**, **Collections** ou **Versions**.
4. Cliquez sur **Filters**.
5. De gauche à droite, sélectionnez l’attribut selon lequel vous souhaitez filtrer, l’opérateur, puis la valeur. Vous pouvez ajouter plusieurs filtres pour affiner vos résultats de recherche.
6. Appuyez sur Entrée pour appliquer le filtre.

## Interroger les éléments du registre {#query-registry-items}
...
### Champs pouvant être filtrés {#filterable-fields}
