...
<Tabs>
  <Tab title="SDK pour Python">
    ...
    <div id="link-an-artifact-from-a-run">
    ...
    <div id="create-and-link-an-artifact">
    ...
    <div id="link-an-existing-artifact">
...
<div id="unlink-an-artifact-version-from-a-collection">
  ## Dissocier une version d’artifact d’une collection
</div>
