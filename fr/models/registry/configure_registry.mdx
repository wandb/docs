...
<div id="manage-users">
  ## Gérer les Users {#manage-users}
</div>

### Ajouter un User ou une Team {#add-a-user-or-a-team}
...
<div id="remove-a-user-or-team">
  ### Supprimer un User ou une Team {#remove-a-user-or-team}
</div>
...
<div id="change-the-owner-of-a-registry">
  ### Changer le propriétaire d’un registre {#change-the-owner-of-a-registry}
</div>
...
<div id="configure-registry-roles">
  ## Configurer les rôles du registre {#configure-registry-roles}
</div>
...
<div id="details-about-registry-roles">
  ## Détails sur les rôles du registre {#details-about-registry-roles}
</div>
...
<div id="role-permissions">
  ### Autorisations par rôle {#role-permissions}
</div>
...
### Rôles de registre effectifs et hérités {#effective-and-inherited-registry-roles}
...
### Accès des comptes de service {#service-account-access}
...
<div id="restricted-viewer-role-details">
  ### Détails du rôle Restricted Viewer {#restricted-viewer-role-details}
</div>
...
### Autorisations entre registres {#cross-registry-permissions}
