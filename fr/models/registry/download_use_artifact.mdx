...
<div id="construct-path-to-linked-artifact">
  ## Construire le chemin vers l&#39;artifact lié {#construct-path-to-linked-artifact}
</div>
...
## Copier-coller l’extrait de code pré-généré {#copy-and-paste-pre-generated-code-snippet}
