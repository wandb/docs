...
<div id="check-the-types-of-artifact-that-a-collection-accepts">
  ### Vérifier les types d’artifact qu’une collection accepte {#check-the-types-of-artifact-that-a-collection-accepts}
</div>
...
<div id="programmatically-create-a-collection">
  ### Créer une collection par programmation {#programmatically-create-a-collection}
</div>
...
### Créer une collection de manière interactive {#interactively-create-a-collection}
