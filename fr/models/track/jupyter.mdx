...
## Cas d’usage de W&amp;B avec les notebooks Jupyter {#use-cases-for-wb-with-jupyter-notebooks}
...
## Prise en main dans un notebook {#getting-started-in-a-notebook}
...
### Afficher des interfaces W&amp;B en direct dans vos notebooks {#rendering-live-wb-interfaces-directly-in-your-notebooks}
...
## Fonctionnalités Jupyter supplémentaires dans W&amp;B {#additional-jupyter-features-in-wb}
