...
### Cardinalité des métriques {#metric-cardinality}
...
### Points enregistrés {#logged-points}
...
### Fréquence de journalisation {#log-frequency}
...
## Recommandations pour le passage à l’échelle {#recommendations-at-scale}
...
## Exemples de débit {#throughput-examples}

Différents modes de journalisation peuvent produire le même débit.

### Exemples de journalisation de scalaires {#scalar-logging-examples}
...
### Exemples de journalisation vidéo {#video-logging-examples}
...
## Considérations sur la journalisation {#logging-considerations}

Utilisez `wandb.Run.log()` pour suivre les métriques de l&#39;expérience.

### Cardinalité des métriques {#metric-cardinality-2}
...
### Taille de la valeur {#value-size}
...
### Fréquence de journalisation et débit {#log-frequency-and-throughput}
...
### Taille de la configuration {#config-size}
...
## Performances de l’espace de travail {#workspace-performance}
...
### Runs par projet {#runs-per-project}
...
### Nombre de panneaux {#panel-count}
...
### Nombre de sections {#section-count}
...
### De nombreuses métriques par run {#many-metrics-per-run}
...
### Reports et espaces de travail {#reports-and-workspaces}
...
## Performances du script Python {#python-script-performance}
...
### En-têtes HTTP de limitation de débit {#rate-limit-http-headers}
...
### Limites de débit de l’API de journalisation des métriques {#metric-logging-api-rate-limits}
...
### Limites de débit de l’API GraphQL {#graphql-api-rate-limits}
...
## Dépannage des projets lents {#troubleshooting-slow-projects}
...
## Considérations sur le navigateur {#browser-considerations}
...
## Signaler des problèmes de performances à W&amp;B {#reporting-performance-issues-to-wb}
