...
Pour réinitialiser un Workspace en mode manuel, cliquez sur le menu d’action `...` du Workspace, puis sur **Réinitialiser le Workspace**. La réinitialisation d’un Workspace n’a aucun impact sur les métriques stockées pour les Runs. Voir [la gestion des panneaux du Workspace](/fr/models/app/features/panels/).
