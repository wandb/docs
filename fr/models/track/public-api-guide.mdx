...
Pour utiliser l’API publique, vous aurez souvent besoin du chemin du run, au format `<entity>/<project>/<run_id>`. Dans l’interface de l’application, ouvrez la Page du run et cliquez sur l’[onglet Vue d’ensemble](/fr/models/track/public-api-guide/#overview-tab) pour obtenir le chemin du run.
