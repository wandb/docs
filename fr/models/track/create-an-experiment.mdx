...
## Comment créer une expérience W&amp;B {#how-to-create-a-wb-experiment}
...
### Initialiser un run W&amp;B {#initialize-a-wb-run}
...
### Enregistrez un dictionnaire d’hyperparamètres {#capture-a-dictionary-of-hyperparameters}
...
### Consigner des métriques dans votre boucle d’entraînement {#log-metrics-inside-your-training-loop}
...
### Journaliser un Artifact dans W&amp;B {#log-an-artifact-to-wb}
...
### Tout réunir {#putting-it-all-together}
...
## Étapes suivantes : visualisez votre expérience {#next-steps-visualize-your-experiment}
