...
## Importez et journalisez votre fichier CSV de jeu de données {#import-and-log-your-dataset-csv-file}
...
## Importez et consignez votre fichier CSV d&#39;Experiments {#import-and-log-your-csv-of-experiments}

{/* {% embed url="https://drive.google.com/file/d/1PL4RSdopHEptDR5Gi0DEzECXuoW_5B0f/view?usp=sharing" %}
  Le tableau ci-dessous est converti en ce tableau de bord W&B
  {% endembed %} */}
