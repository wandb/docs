...
### Graphiques de base {#basic-charts}
...
### Graphiques d’évaluation du modèle {#model-evaluation-charts}
...
### Graphiques personnalisés interactifs {#interactive-custom-charts}
...
### Graphiques Matplotlib et Plotly {#matplotlib-and-plotly-plots}
...
### Journaliser du HTML personnalisé dans W&amp;B Tables {#log-custom-html-to-wb-tables}
...
#### Journaliser des figures Plotly dans W&amp;B Tables au format HTML {#log-plotly-figures-to-tables-as-html}
...
#### Journaliser des figures Bokeh dans Tables au format HTML {#log-bokeh-figures-to-tables-as-html}
