...
<div id="image-overlays">
  ## Superpositions d’image {#image-overlays}
</div>
...
<div id="image-overlays-in-tables">
  ## Superpositions d’images dans Tables {#image-overlays-in-tables}
</div>
...
## Visualisations 3D {#3d-visualizations}
...
Les nuages de points enregistrés sont entièrement interactifs dans l’application W&amp;B. Par exemple, le [rapport LIDAR Point Clouds of Driving Scenes](https://wandb.ai/stacey/lyft/reports/LIDAR-Point-Clouds-of-Driving-Scenes--Vmlldzo2MzA5Mg) intégré ci-dessous montre des scènes du jeu de données Lyft avec des boîtes englobantes 3D. Faites glisser pour faire pivoter la vue et zoomer dans le visualiseur.

{/* <WandbReport
  src="https://wandb.ai/stacey/lyft/reports/LIDAR-Point-Clouds-of-Driving-Scenes--Vmlldzo2MzA5Mg"
  title="rapport LIDAR point clouds of driving scenes"
  height={720}
  /> */}
...
<div id="numpy-array-formats">
  #### Formats de tableaux NumPy {#numpy-array-formats}
</div>
...
<div id="point-cloud-files">
  #### Fichiers de nuages de points {#point-cloud-files}
</div>
...
Une fois votre run terminé, vous pourrez interagir avec les visualisations 3D de vos molécules dans l’interface utilisateur.
...
<div id="2d-view-of-a-molecule">
  ## Vue 2D d&#39;une molécule {#2d-view-of-a-molecule}
</div>
