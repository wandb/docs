...
description: Utilisez W&B Registry pour gérer et partager les versions d'artifacts dans votre organisation
---
...
{{/* - Repérez rapidement des artifacts importants ou faites-y référence à l’aide d’un identifiant unique appelé alias. */}}

L’image suivante montre la page d’accueil de W&amp;B Registry.

De haut en bas, l’image présente les registres marqués d’une étoile, puis les registres et les collections mis à jour le plus récemment.

<Frame>
  <img src="/images/registry/registry_landing_page.png" alt="W&B Registry" />
</Frame>

## Découvrez les bases {#learn-the-basics}
...
3. Vérifiez que le registre existe.
4. Indiquez le nom de la collection et du registre auxquels lier votre version d&#39;artifact.
5. Liez l&#39;artifact à la collection à l&#39;aide de `wandb.Run.link_artifact()`.
...
## Activer W&amp;B Registry {#enable-wb-registry}
...
## Ressources pour bien démarrer {#resources-to-get-started}
...
* Suivez le cours W&amp;B [Model CI/CD](https://www.youtube.com/watch?v=VWdRQL0CsAk\&list=PLD80i8An1OEGECFPgY-HPCNjXgGu-qGO6) et découvrez comment :
