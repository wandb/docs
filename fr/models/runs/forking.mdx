...
<Note>
  Le fork d’un run est en préversion publique pour le Cloud mutualisé et le Cloud dédié. Il n’est pas actuellement disponible pour les déploiements autogérés.

  Les fonctionnalités en préversion publique sont disponibles pour une évaluation en production, mais les fonctionnalités, les API et le comportement sont en cours de développement actif et peuvent changer avant la disponibilité générale.
</Note>
