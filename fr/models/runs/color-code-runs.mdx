...
### Activez les couleurs basées sur une clé {#turn-on-key-based-colors}
...
### Exemple : coloration basée sur des clés avec la métrique de perte {#example-key-based-coloring-with-loss-metric}
...
## Définir une métrique {#set-a-metric}
...
## Définir une clé de configuration {#set-a-configuration-key}
...
## Définir une valeur Y {#set-a-y-value}
...
## Personnaliser les buckets {#customize-buckets}
