...
graph TB
    ...
    RegistryWarning --> ConfirmRegistry{Confirmer la suppression du<br/>modèle du Registry ?}
    ConfirmRegistry -->|Non| DeleteRunOnly
    ConfirmRegistry -->|Oui| DirectDelete[Supprimer le run et les artefacts<br/><br/>- Métadonnées du run supprimées<br/>- Artefacts supprimés définitivement<br/>- Liens vers le Registry supprimés<br/>- Récupération impossible]
