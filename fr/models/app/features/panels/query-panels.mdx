...
Pour des exemples interactifs à essayer et un guide pas à pas sur la syntaxe des requêtes, consultez le [rapport d’exemples du panneau de requête](https://wandb.ai/luis_team_test/weave_example_queries/reports/Weave-queries---Vmlldzo1NzIxOTY2?accessToken=bvzq5hwooare9zy790yfl3oitutbvno2i6c2s81gk91750m53m2hdclj0jvryhcr) public. Les types et opérations générés sont répertoriés dans l’[aperçu du langage d’expression des requêtes](/fr/models/ref/query-panel).
...
## Créer un panneau de requête {#create-a-query-panel}
...
## Composants de requête {#query-components}
...
#### Exemple : Interroger un tableau {#example-query-a-table}
...
#### Options du panneau {#panel-options}
...
### Panneaux de résultats {#result-panels}
...
### Parcourir l’historique des exécutions {#step-through-run-history}
...
### Combiner des tableaux dans les expressions {#combine-tables-in-expressions}
