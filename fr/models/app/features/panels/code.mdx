...
## Activer l’enregistrement du code {#enable-code-saving}
...
<Info>
  Par défaut, W&amp;B désactive l’enregistrement du code pour toutes les équipes. Avant de pouvoir l’activer pour une équipe, un administrateur de l’organisation doit laisser l’option **Disable default code saving** désactivée pour l’organisation. Voir la section [Organisation](#organization).
</Info>

### Équipe {#team}

Pour activer l’enregistrement du code pour une équipe en tant qu’administrateur de l’équipe, accédez à la page **Settings**, puis à la section **Confidentialité**, et configurez **Enable code saving by default** pour les runs de l’équipe. Cette option n’est disponible que si un administrateur de l’organisation n’a pas activé **Disable default code saving** pour toute l’organisation. Pour les étapes de navigation, voir [Configurer les paramètres de confidentialité d’une équipe](/fr/platform/hosting/privacy-settings#configure-privacy-settings-for-a-team).

### Organisation {#organization}

En tant qu’administrateur de l’organisation, accédez à **Settings**, sélectionnez **Confidentialité**, puis utilisez **Disable default code saving** dans la section **Project and content security** pour contrôler si l’enregistrement du code est désactivé par défaut pour chaque équipe. Tant que ce paramètre est activé, les administrateurs d’équipe ne peuvent pas activer **Enable code saving by default** pour leur équipe. Pour la liste complète des contrôles au niveau de l’organisation, voir [Enforce privacy settings for all teams](/fr/platform/hosting/privacy-settings#enforce-privacy-settings-for-all-teams).
...
### Contrôle fin {#fine-grain-control}
...
### Capturer automatiquement le code {#automatically-capture-code}
...
## Voir les modifications locales {#view-local-changes}
...
## Historique de session Jupyter {#jupyter-session-history}
...
## Comparer le code entre les runs {#compare-code-across-runs}
