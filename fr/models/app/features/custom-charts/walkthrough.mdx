...
<div id="log-data-to-wb">
  ## Journalisez des données dans W&amp;B {#log-data-to-wb}
</div>
...
<div id="add-a-query">
  ### Ajouter une requête {#add-a-query}
</div>
...
<div id="set-vega-fields">
  ### Définir les champs Vega {#set-vega-fields}
</div>
...
## Bonus : histogrammes composites {#bonus-composite-histograms}
