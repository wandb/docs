...
keywords: ["changement d’état du run", "notification Slack", "alerte d’échec de run", "automatisation au niveau du projet", "OnRunState"]
---
...
<div id="create-a-project-automation">
  ## Créer une automatisation de projet {#create-a-project-automation}
</div>
...
Votre projet dispose maintenant d’une automatisation active qui publie dans le canal Slack que vous avez sélectionné lorsqu’un run échoue. Pour plus de détails, voir [Créer une automatisation Slack](/fr/models/automations/create-automations/slack#create-an-automation) (onglet Project).
