...
<Note>
  Pour appliquer une automatisation à une portée plus large, créez-la depuis le hub global **Automations** et sélectionnez la portée **Team** ou **Organization**. Les étapes sont les mêmes que celles qui suivent. À ces portées, W&amp;B App prend uniquement en charge les événements d&#39;artifact et de collection. Voir le [hub Automations](/fr/models/automations#automations-hub).
</Note>
...
## Référence de la charge utile {#payload-reference}
...
### Variables de charge utile {#payload-variables}
...
### Exemples de charges utiles {#payload-examples}
...
## Dépanner votre webhook {#troubleshoot-your-webhook}
