...
<Tabs>
  <Tab title="Registry">
    ...
    * Pour supprimer une automatisation, cliquez sur son menu **action (<Icon icon="ellipsis" iconType="solid" />)**, puis sur **Delete automation**. Une confirmation est requise.
  </Tab>
