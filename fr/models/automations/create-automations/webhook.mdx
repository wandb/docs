...
Après avoir [configuré un webhook](#create-a-webhook), sélectionnez **Registry** ou **projet**, puis suivez ces étapes pour créer une automatisation qui déclenche le webhook.
