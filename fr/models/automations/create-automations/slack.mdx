...
keywords: ["intégration Slack", "notifications", "événements d’automatisation", "automatisation registre", "automatisation de projet"]
---
...
## Ajouter une intégration Slack {#add-a-slack-integration}
...
2. Dans la section **Slack channel integrations**, cliquez sur **Connect Slack** pour ajouter une nouvelle instance Slack. Pour ajouter un canal à une instance Slack existante, cliquez sur **New integration**.
   ...
   ![Deux intégrations Slack dans une Team](/images/automations/slack_integrations.png)
...
## Afficher et gérer les intégrations Slack {#view-and-manage-slack-integrations}
...
Après avoir [ajouté une intégration Slack](#add-a-slack-integration), vous pouvez créer une automatisation qui l’utilise pour envoyer des notifications. Sélectionnez **Registre** ou **Projet** selon la portée à laquelle vous voulez que l’automatisation s’applique. Puis suivez ces étapes pour créer une automatisation qui envoie une notification au canal Slack.

<Note>
  Pour appliquer une automatisation plus largement, créez-la depuis le hub **Automations** global et sélectionnez la portée **Équipe** ou **Organisation**. Les étapes sont les mêmes que celles qui suivent. À ces portées, W&amp;B App ne prend en charge que les événements d&#39;artifact et de collection. Voir [Hub Automations](/fr/models/automations#automations-hub).
</Note>
...
<Tabs>
  <Tab title="Registre">
    ...
    3. Pour créer une automatisation portée au registre, cliquez sur l&#39;onglet **Automations**, puis sur **Créer une automatisation**. Une automatisation portée à un registre s&#39;applique automatiquement à toutes ses collections (y compris celles qui seront créées ultérieurement).
