...
Cette page explique comment créer une [automatisation](/fr/models/automations) Slack. Pour créer une automatisation webhook, consultez plutôt [Créer une automatisation webhook](/fr/models/automations/create-automations/webhook) à la place.
...
Après avoir [ajouté une intégration Slack](#add-a-slack-integration), sélectionnez **Registre** ou **Projet**, puis suivez ces étapes pour créer une automatisation qui envoie une notification au canal Slack.
