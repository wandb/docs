...
1. Installez `ultralytics` et `wandb`.
   ...
   <Tabs>
     ...
     <Tab title="Notebook">`bash !pip install --upgrade ultralytics==8.0.238 wandb `</Tab>
   </Tabs>
...
<blockquote class="imgur-embed-pub" lang="en" data-id="a/TB76U9O">
  <a href="https://imgur.com/a/TB76U9O">Expériences de fine-tuning YOLO</a>
</blockquote>

<script async src="https://s.imgur.com/min/embed.js" charset="utf-8" />

Voici comment les résultats de validation à chaque époque sont visualisés à l&#39;aide d&#39;une [W&amp;B Table](/fr/models/tables/) :

<blockquote class="imgur-embed-pub" lang="en" data-id="a/kU5h7W4">
  <a href="https://imgur.com/a/kU5h7W4">Table de visualisation de validation W&amp;B</a>
</blockquote>
...
<blockquote class="imgur-embed-pub" lang="en" data-id="a/UTSiufs">
  <a href="https://imgur.com/a/UTSiufs">Superposition d’image W&amp;B</a>
</blockquote>
