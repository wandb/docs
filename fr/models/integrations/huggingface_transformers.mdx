...
## Premiers pas : suivre les expériences {#get-started-track-experiments}
...
### Nommez le projet {#name-the-project}
...
### Enregistrez vos runs d&#39;entraînement dans W&amp;B {#log-your-training-runs-to-wb}
...
### Activez l&#39;enregistrement des points de contrôle du modèle {#turn-on-model-checkpointing}
...
### Visualiser les sorties d’évaluation pendant l’entraînement {#visualize-evaluation-outputs-during-training}
...
### Terminez votre run W&amp;B (notebook uniquement) {#finish-your-wb-run-notebook-only}
...
### Visualisez vos résultats {#visualize-your-results}
...
## Fonctionnalités avancées et FAQ {#advanced-features-and-faqs}
...
### Enregistrer le meilleur modèle {#save-the-best-model}
...
### Charger un modèle enregistré {#load-a-saved-model}
...
### Reprendre l’entraînement à partir d’un point de contrôle {#resume-training-from-a-checkpoint}
...
### Journaliser et afficher des échantillons d’évaluation pendant l’entraînement {#log-and-view-evaluation-samples-during-training}
...
#### Afficher des échantillons d’évaluation pendant l’entraînement {#view-evaluation-samples-during-training}
...
### Paramètres W&amp;B supplémentaires {#additional-wb-settings}
...
### Personnaliser `wandb.init()` {#customize-wandbinit}
...
## Obtenir de l&#39;aide ou suggérer des fonctionnalités {#get-help-or-request-features}
