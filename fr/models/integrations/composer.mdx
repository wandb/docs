...
<div id="log-prediction-samples">
  ## Journalisation des échantillons de prédictions
</div>

Vous pouvez utiliser le système de [Callbacks de Composer](https://docs.mosaicml.com/projects/composer/en/stable/trainer/callbacks.html) pour contrôler quand vous faites de la journalisation dans W&amp;B via le `WandBLogger` ; dans cet exemple, un échantillon d’images de validation et de prédictions fait l’objet d’une journalisation :