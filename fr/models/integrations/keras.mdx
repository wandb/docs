...
<Note>
  Voir notre [dépôt d&#39;exemples](https://github.com/wandb/examples) pour des scripts, notamment un [exemple Fashion MNIST](https://github.com/wandb/examples/blob/master/examples/keras/keras-cnn-fashion/train.py)
  et le [tableau de bord W&amp;B](https://wandb.ai/wandb/keras-fashion-mnist/runs/5z1d85qs) qu&#39;il génère.
</Note>
