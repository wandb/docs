...
## Installer ou mettre à jour API Python OpenAI {#install-or-update-openai-python-api}
...
## Synchronisez vos résultats de fine-tuning OpenAI {#sync-your-openai-fine-tuning-results}
...
### Synchronisez vos fine-tunings {#sync-your-fine-tunes}
...
## Gestion des versions et visualisation des jeux de données {#dataset-versioning-and-visualization}
...
## Le modèle affiné et la gestion des versions des modèles {#the-fine-tuned-model-and-model-versioning}
...
### Partagez les résultats obtenus en effectuant le fine-tuning avec votre équipe {#share-fine-tune-results-with-your-team}
...
### Organisez vos runs {#organize-your-runs}
...
### Accédez à votre modèle affiné {#access-your-fine-tuned-model}
...
### Récupérer un fine-tuning qui ne s’est pas synchronisé {#recover-a-fine-tune-that-didnt-sync}
...
### Suivre les jeux de données et les modèles avec W&amp;B {#track-datasets-and-models-with-wb}
