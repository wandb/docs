...
## Activez la journalisation W&amp;B {#enable-wb-logging}
...
## Utiliser le logger de métriques W&amp;B {#use-the-wb-metric-logger}
...
## Données enregistrées {#logged-data}
...
### Métriques enregistrées {#logged-metrics}
...
## Enregistrer et charger des points de contrôle du modèle {#save-and-load-checkpoints}
