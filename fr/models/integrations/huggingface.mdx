...
## Pourquoi utiliser W&amp;B {#why-use-wb}
...
## Installez, importez et connectez-vous {#install-import-and-log-in}
...
## Ajoutez votre clé API {#add-your-api-key}
...
## Entraîner le modèle {#train-the-model}
...
## Visualisez les résultats dans le tableau de bord {#visualize-results-in-the-dashboard}
...
### Visualisez les performances du modèle {#visualize-model-performance}
...
### Comparez les architectures {#compare-architectures}
...
## Suivre automatiquement les informations clés {#track-key-information-by-default}
