...
2. [Mode hors ligne](/fr/models/support/run_wandb_offline/): Utilisez le mode `dryrun` pour effectuer l&#39;entraînement hors ligne et synchroniser les résultats plus tard.
