...
## Ce que vous trouverez dans ce notebook {#what-this-notebook-covers}
...
## Installer, importer et se connecter {#install-import-and-log-in}
...
### Étape 0 : Installer W&amp;B {#step-0-install-wb}
...
### Étape 1 : Importer W&amp;B et vous connecter {#step-1-import-wb-and-log-in}
...
## Définir l’expérience et le pipeline {#define-the-experiment-and-pipeline}
...
### Suivre les métadonnées et les hyperparamètres avec `wandb.init()` {#track-metadata-and-hyperparameters-with-wandbinit}
...
### Définir le chargement des données et le modèle {#define-the-data-loading-and-model}
...
### Définir la logique d&#39;entraînement {#define-training-logic}
...
### Suivre les gradients avec `run.watch()` et tout le reste avec `run.log()` {#track-gradients-with-runwatch-and-everything-else-with-runlog}
...
### Définir la logique de test {#define-testing-logic}
...
### Facultatif : Appelez `run.save()` {#optional-call-runsave}
...
### Exécutez l&#39;entraînement et regardez vos métriques en direct sur wandb.ai {#run-training-and-watch-your-metrics-live-on-wandbai}
...
### Tester des hyperparamètres avec des balayages {#test-hyperparameters-with-sweeps}
...
## Galerie d&#39;exemples {#example-gallery}
