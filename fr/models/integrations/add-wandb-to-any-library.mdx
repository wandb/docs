...
## Concevoir l’intégration {#design-the-integration}
...
### Faites de W&amp;B une dépendance facultative {#make-wb-an-optional-dependency}
...
## Authentifiez les utilisateurs {#authenticate-users}
...
### S’authentifier depuis la ligne de commande {#authenticate-from-the-command-line}
...
### S’authentifier depuis Python {#authenticate-from-python}
...
## Rendre la journalisation W&amp;B facultative {#make-wb-logging-optional}
...
### Utiliser le mode `disabled` {#use-disabled-mode}
...
### Utiliser le mode `offline` {#use-offline-mode}
...
## Enregistrez la configuration et les métriques {#log-configuration-and-metrics}
...
### Enregistrer les valeurs de configuration {#log-configuration-values}
...
### Consigner des métriques {#log-metrics}
...
### Définir un axe personnalisé pour le journal {#define-a-custom-log-axis}
...
## Suivre les modèles et les jeux de données avec des artefacts {#track-models-and-datasets-with-artifacts}
...
### Journaliser les points de contrôle du modèle {#log-model-checkpoints}
...
### Suivre les entrées d’un run {#track-run-inputs}
...
### Suivre les sorties d’une exécution {#track-run-outputs}
...
### Télécharger des artefacts {#download-artifacts}
...
## Lier des artefacts au W&amp;B Registry {#link-artifacts-to-the-wb-registry}
...
## Ajuster les hyperparamètres {#tune-hyperparameters}
...
## Prise en charge de l’entraînement distribué {#support-distributed-training}
