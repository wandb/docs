...
2. Créez une clé API dans les [Paramètres utilisateur](https://wandb.ai/settings). Pour un environnement de production, nous vous recommandons d’utiliser un [compte de service](/fr/models/support/service_account_useful) comme propriétaire de cette clé.
