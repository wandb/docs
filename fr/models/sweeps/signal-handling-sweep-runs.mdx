...
Pour les jobs SLURM multi-GPU où un seul processus doit appeler `wandb.agent()`, voir [Comment exécuter des balayages sur SLURM ?](/fr/support/models/articles/how-should-i-run-sweeps-on-slurm).
