...
## 1. journaliser un tableau {#1-log-a-table}
...
## 2. Visualisez les tableaux dans l’espace de travail du projet {#2-visualize-tables-in-your-project-workspace}
...
## 3. Comparer différentes versions de modèle {#3-compare-across-model-versions}
