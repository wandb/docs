...
## Créer et journaliser un tableau {#create-and-log-a-table}
...
## Modes de journalisation {#logging-modes}
...
### Enrichir les résultats d’évaluation avec MUTABLE {#enriching-evaluation-results-with-mutable}
...
### Reprendre des runs avec des tableaux INCREMENTAL {#resuming-runs-with-incremental-tables}
...
### Entraînement avec entraînement incrémentiel par lots {#training-with-incremental-batch-training}
