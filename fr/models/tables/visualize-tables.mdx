...
## Options de comparaison des tableaux {#table-comparison-options}
...
### Vue côte à côte {#side-by-side-view}
...
## Comparer les Artifacts {#compare-artifacts}
...
### Comparer des tableaux au fil du temps {#compare-tables-across-time}
...
### Comparer des tableaux entre différentes variantes de modèle {#compare-tables-across-model-variants}
...
## Visualisez comment les valeurs évoluent au fil de vos runs {#visualize-how-values-change-throughout-your-runs}
...
### Clé d’étape personnalisée {#custom-step-key}
...
## Enregistrez votre vue {#save-your-view}
