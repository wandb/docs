...
### Explorez vos données de manière interactive {#interactively-explore-your-data}
...
### Comparer les versions de modèles {#compare-model-versions}
...
### Suivre chaque détail et voir la vue d&#39;ensemble {#track-every-detail-and-see-the-bigger-picture}
...
## Exemples de Projects avec W&amp;B Tables {#example-projects-with-wb-tables}
...
### Données tabulaires {#tabular-data}
...
### Comparer des variantes de modèle (segmentation sémantique) {#comparing-model-variants-semantic-segmentation}
...
### Analyser l’amélioration au fil de l’entraînement {#analyzing-improvement-over-training-time}
