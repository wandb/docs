...
# Démonstration du guide de style {#style-guide-demo}

Cette page présente les styles de marque personnalisés appliqués à la documentation W&amp;B.

## 1. Typographie {#1-typography}

### Titres avec Source Serif 4 {#headings-with-source-serif-4}

# Titre de niveau 1 - Source Serif 4 {#h1-heading-source-serif-4}

## Titre H2 - Source Serif 4 {#h2-heading-source-serif-4}

### Titre de niveau 3 - Source Serif 4 {#h3-heading-source-serif-4}

#### Titre H4 - Source Serif 4 {#h4-heading-source-serif-4}

Le corps de texte utilise la pile de polices du système pour une lisibilité optimale sur toutes les plateformes.

## 2. Couleurs de la marque {#2-brand-colors}
...
## 3. Composants de bannière {#3-banner-components}
...
## 4. Styles de boutons {#4-button-styles}
...
## 5. Arrière-plans en gradient {#5-gradient-backgrounds}
...
### Section Gradient {#gradient-section}
