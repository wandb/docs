...
Les liens utilisent des <a href="#">couleurs sarcelle</a> pour garantir la cohérence.
...
<div className="gradient-banner custom-banner">
  <h3>Bannière en gradient</h3>
  <p>Utilise le gradient coucher de soleil pour des annonces percutantes.</p>
</div>
