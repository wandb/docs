...
linkTitle: "Exemples"
description: >
  Apprenez à utiliser Serverless Inference à l'aide d'exemples de code pratiques
keywords: ["traçage Weave", "évaluation de modèle", "leaderboard", "tracer les appels LLM"]
---
...
Les sections suivantes présentent un exemple de traçage de base et un flux de travail d&#39;évaluation plus avancé. Avant d&#39;exécuter l&#39;un ou l&#39;autre exemple, complétez les [prérequis](/fr/inference/prerequisites/).

## Exemple de base : traçage de Llama 3.1 8B avec Weave {#basic-example-trace-llama-31-8b-with-weave}
...
<Tip>
  Pour en savoir plus, consultez [traçage dans Weave](/fr/weave/guides/tracking/tracing).
</Tip>
...
* Accédez à [https://wandb.ai](https://wandb.ai) et sélectionnez l’onglet **Traces**.
...
## Exemple avancé : utiliser Weave évaluations et les leaderboards {#advanced-example-use-weave-evaluations-and-leaderboards}

En plus du traçage des appels de modèle, vous pouvez évaluer les performances et publier des leaderboards. Cet exemple compare deux modèles sur un jeu de données de questions-réponses pour montrer comment Llama 3.1 8B et DeepSeek V3.1 se comportent avec les mêmes prompts.
...
Après avoir exécuté ce code, accédez à votre compte W&amp;B sur [https://wandb.ai/](https://wandb.ai/) et effectuez les opérations suivantes :
...
* Sélectionnez l’onglet **Leaders** pour [consulter le leaderboard généré](/fr/weave/guides/core-types/leaderboards).
