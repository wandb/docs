...
| Moonshot AI Kimi K2.7 Code   | `moonshotai/Kimi-K2.7-Code`                    | Texte         | 262k                | 32B-1T (actifs-total)     | Kimi K2.7 Code est un modèle MoE de 1T de paramètres avec 32B de paramètres actifs, spécialement conçu pour la programmation agentique à long horizon et l’ingénierie logicielle.           |
