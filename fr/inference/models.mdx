...
| Z.AI GLM 5.2                  | `zai-org/GLM-5.2`                              | Texte         | 262k                | 40B-744B (Actifs-Total)   | GLM-5.2 est un modèle de langage de type Mixture-of-Experts, avec 40 milliards de paramètres activés et un total de 744 milliards de paramètres.                                                                             |
...
| ---------------------------- | ---------------------------------------------- | ----- | ------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MiniMax M2.5                 | `MiniMaxAI/MiniMax-M2.5`                       | Texte | 197k                | 10B-230B (actifs-total) | Modèle MoE à l’architecture très clairsemée, conçu pour offrir un débit élevé et une faible latence, avec de solides capacités de codage.                                       |
...
| Qwen3 Coder 480B A35B        | `Qwen/Qwen3-Coder-480B-A35B-Instruct`          | Texte | 262k                | 35B-480B (actifs-total) | Modèle de mélange d’experts optimisé pour les tâches de codage agentiques, telles que les appels de fonction, l’utilisation d’outils et le raisonnement sur de longs contextes. |
| Z.AI GLM 5.1                 | `zai-org/GLM-5.1`                              | Texte | 203k                | 40B-744B (actifs-total) | Puissant modèle MoE pour l’ingénierie agentique à long horizon et le raisonnement avancé.                                                                                       |
