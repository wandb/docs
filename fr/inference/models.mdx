...
| Meta Llama 4 Scout (obsolète) | `meta-llama/Llama-4-Scout-17B-16E-Instruct`    | Texte, vision | 64k                 | 17B-109B (actifs-total)    | Modèle multimodal intégrant la compréhension du texte et des images, idéal pour les tâches visuelles et l’analyse combinée.                                                            |
