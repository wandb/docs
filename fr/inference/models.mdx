...
| ----------------- | -------------------------------------------- | ------------- | ------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| DeepSeek V4-Flash | `deepseek-ai/DeepSeek-V4-Flash`              | Texte         | 1049k               | 13B-284B (Active-Total) | DeepSeek V4-Flash est un modèle MoE avec une longueur de contexte de 1M, idéal pour le codage, le raisonnement et les charges de travail d’agent. |
