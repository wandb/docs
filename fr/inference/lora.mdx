...
## Pourquoi utiliser Serverless Inference pour les LoRAs {#why-use-serverless-inference-for-loras}
...
## Ajouter et utiliser des LoRA {#add-and-use-loras}
...
### Exigences clés {#key-requirements}
  ...
  <Tab title="Entraîner un nouveau LoRA avec W&B">
    Entraînez un nouveau LoRA avec [Serverless RL](/fr/serverless-training). Votre LoRA devient automatiquement un artifact W&amp;B que vous pouvez utiliser directement.
...
## Modèles de base pris en charge {#supported-base-models}
