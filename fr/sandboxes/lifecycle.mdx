...
## États du sandbox {#sandbox-states}
...
## Attendre que le sandbox soit prêt ou terminé {#wait-for-readiness-or-completion}
...
### Attendre qu’un sandbox démarre {#wait-for-a-sandbox-to-start}
...
### Attendre la fin d’un sandbox {#wait-for-a-sandbox-to-complete}
...
## Contrôle explicite du cycle de vie {#explicit-lifecycle-control}
...
### Arrêter le sandbox {#stop-a-sandbox}
