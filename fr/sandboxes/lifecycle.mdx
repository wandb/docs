...
description: Découvrez le cycle de vie d’un Serverless Sandbox, notamment ses états, comment attendre les changements d’état et comment arrêter un sandbox.
---

<Warning>
  Serverless Sandboxes est en aperçu privé, disponible sur invitation uniquement. Pour demander à y accéder, contactez l’[assistance](mailto:support@wandb.com) ou votre AISE.
</Warning>
