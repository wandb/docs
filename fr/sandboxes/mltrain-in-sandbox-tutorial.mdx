...
### Installez le SDK Python de W&amp;B {#install-the-wb-python-sdk}
...
### Connectez-vous et authentifiez-vous auprès de W&amp;B {#log-in-and-authenticate-with-wb}
...
## Copiez le script d&#39;entraînement et les dépendances {#copy-the-training-script-and-dependencies}
...
## Créer le sandbox et exécuter le script d’entraînement {#create-the-sandbox-and-run-the-training-script}
