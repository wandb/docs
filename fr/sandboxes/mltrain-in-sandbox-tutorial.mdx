...
description: "Découvrez comment entraîner un modèle PyTorch dans un environnement Serverless Sandbox grâce à ce tutoriel pas à pas."
---

<Warning>
  Serverless Sandboxes est en préversion privée, accessible uniquement sur invitation. Pour demander à y accéder, contactez l&#39;[assistance](mailto:support@wandb.com) ou votre AISE.
</Warning>
