...
def process_task(input_data):
    ...
    try:
        # Votre logique de tâche qui crée des traces
...
Pour une protection supplémentaire contre la perte de données, envisagez d’activer le [journal de préécriture](/fr/weave/guides/tracking/write-ahead-log), qui écrit les données de trace sur disque avant de les envoyer au serveur.
