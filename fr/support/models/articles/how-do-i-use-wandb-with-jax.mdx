...
## Consigner des métriques depuis une boucle d’entraînement JAX {#log-metrics-from-a-jax-training-loop}
...
## Journaliser les métriques de validation {#log-validation-metrics}
...
## Enregistrer des points de contrôle du modèle comme artefacts {#save-checkpoints-as-artifacts}
...
## Déboguer les valeurs NaN {#debug-nan-values}
