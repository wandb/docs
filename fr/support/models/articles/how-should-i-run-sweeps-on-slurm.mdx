...
## Jobs monoprocessus ou mono-GPU {#single-process-or-single-gpu-jobs}
...
## Jobs multi-GPU avec entraînement distribué {#multi-gpu-jobs-with-distributed-training}
...
### Choisissez entre `SLURM_PROCID` et `SLURM_LOCALID` {#choose-between-slurm_procid-and-slurm_localid}
...
### Journaliser à partir des rangs autres que le rang 0 {#log-from-non-rank-0-ranks}
