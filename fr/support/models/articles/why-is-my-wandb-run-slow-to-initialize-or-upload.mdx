...
## `wandb.init()` est lent {#slow-wandbinit}
...
## Téléversement lent des métriques pendant l’entraînement {#slow-metric-uploads-during-training}
...
## La finalisation du run est lente {#run-finalization-is-slow}
...
## Diagnostic à l’aide des journaux de débogage {#diagnosing-with-debug-logs}
